	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		hi64xx_update_bits(codec, ADC_DAC_CLK_EN_REG,
			0x1 << CLK_DACL_EN_OFFSET, 0x1 << CLK_DACL_EN_OFFSET);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi64xx_update_bits(codec, ADC_DAC_CLK_EN_REG,
			0x1 << CLK_DACL_EN_OFFSET, 0);
		break;
	default:
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		/* filter */
		hi64xx_update_bits(codec, ADC_DAC_CLK_EN_REG,
			0x1 << CLK_DACR_EN_OFFSET, 0x1 << CLK_DACR_EN_OFFSET);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi64xx_update_bits(codec, ADC_DAC_CLK_EN_REG,
			0x1 << CLK_DACR_EN_OFFSET, 0);
		break;
	default:
		AUDIO_LOGW("power event err: %d", event);
		break;
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		/* filter clk */
		hi64xx_update_bits(codec, ADC_DAC_CLK_EN_REG,
			0x1 << CLK_DACSL_EN_OFFSET, 0x1 << CLK_DACSL_EN_OFFSET);
		/* hbf1i_bypass_en */
		hi64xx_update_bits(codec, DACSL_CTRL_REG,
			0x1 << DACSL_HBF1I_BYPASS_EN_OFFSET,
			0x1 << DACSL_HBF1I_BYPASS_EN_OFFSET);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi64xx_update_bits(codec, DACSL_CTRL_REG,
			0x1 << DACSL_HBF1I_BYPASS_EN_OFFSET, 0);
		hi64xx_update_bits(codec, ADC_DAC_CLK_EN_REG,
			0x1 << CLK_DACSL_EN_OFFSET, 0);
		break;
	default:
		AUDIO_LOGW("power event err: %d", event);
		break;
...
static const struct reg_seq_config dacl_pga_mux_up_regs[] = {
	/* pga */
	{ { MISC_CLK_EN_REG, 0x1 << DACL_PRE_PGA_CLK_EN_OFFSET,
		0x1 << DACL_PRE_PGA_CLK_EN_OFFSET, true }, 0, 0 },
	{ { MISC_CLK_EN_REG, 0x1 << DACL_POST_PGA_CLK_EN_OFFSET,
		0x1 << DACL_POST_PGA_CLK_EN_OFFSET, true }, 0, 0 },
	/* src */
	{ { S1_MIXER_EQ_CLK_EN_REG, 0x1 << CLK_DACL_UP16_EN_OFFSET,
		0x1 << CLK_DACL_UP16_EN_OFFSET, true }, 0, 0 },
	/* sdm valid */
	{ { HP_SDM_L_CTRL0_REG, 0x1 << HP_SDM_L_DEM_DSEN_OFFSET,
		0x1 << HP_SDM_L_DEM_DSEN_OFFSET, true }, 0, 0 },
	...
	{ { HP_SDM_L_CTRL12_REG, 0x1 << HP_SDM_L_CALT_VLD_OFFSET,
		0x1 << HP_SDM_L_CALT_VLD_OFFSET, true }, 0, 0 },
	/* dacl dc */
...
static const struct reg_seq_config dacl_pga_mux_dn_regs[] = {
	...
	{ { HP_SDM_L_CTRL0_REG,
		0x1 << HP_SDM_L_DEM_DSEN_OFFSET, 0x1 << HP_SDM_L_DEM_DSEN_OFFSET,
		true }, 0, 0 },
	/* src */
	{ { S1_MIXER_EQ_CLK_EN_REG, 0x1 << CLK_DACL_UP16_EN_OFFSET, 0, true }, 0, 0 },
	/* pga */
	{ { MISC_CLK_EN_REG, 0x1 << DACL_POST_PGA_CLK_EN_OFFSET, 0, true }, 0, 0 },
	{ { MISC_CLK_EN_REG, 0x1 << DACL_PRE_PGA_CLK_EN_OFFSET, 0, true }, 0, 0 },
};

static const struct reg_seq_config dacr_pga_mux_up_regs[] = {
	/* pga */
	{ { MISC_CLK_EN_REG, 0x1 << DACR_PRE_PGA_CLK_EN_OFFSET,
		0x1 << DACR_PRE_PGA_CLK_EN_OFFSET, true }, 0, 0 },
	{ { MISC_CLK_EN_REG, 0x1 << DACR_POST_PGA_CLK_EN_OFFSET,
		0x1 << DACR_POST_PGA_CLK_EN_OFFSET, true }, 0, 0 },
	/* src */
	{ { S1_MIXER_EQ_CLK_EN_REG, 0x1 << CLK_DACR_UP16_EN_OFFSET,
		0x1 << CLK_DACR_UP16_EN_OFFSET, true }, 0, 0 },
	/* sdm */
	{ { HP_SDM_R_CTRL0_REG, 0x1 << HP_SDM_R_DEM_DSEN_OFFSET,
		0x1 << HP_SDM_R_DEM_DSEN_OFFSET, true }, 0, 0 },
	...
	{ { HP_SDM_R_CTRL12_REG, 0x1 << HP_SDM_R_CALT_VLD_OFFSET,
		0x1 << HP_SDM_R_CALT_VLD_OFFSET, true }, 0, 0 },
	/* dacr dc */
...
static const struct reg_seq_config dacr_pga_mux_dn_regs[] = {
	...
	{ { HP_SDM_R_CTRL0_REG, 0x1 << HP_SDM_R_DEM_DSEN_OFFSET,
		0x1 << HP_SDM_R_DEM_DSEN_OFFSET, true }, 0, 0 },
	/* src */
	{ { S1_MIXER_EQ_CLK_EN_REG, 0x1 << CLK_DACR_UP16_EN_OFFSET, 0, true }, 0, 0 },
	/* pga */
	{ { MISC_CLK_EN_REG, 0x1 << DACR_POST_PGA_CLK_EN_OFFSET, 0, true }, 0, 0 },
	{ { MISC_CLK_EN_REG, 0x1 << DACR_PRE_PGA_CLK_EN_OFFSET, 0, true }, 0, 0 },
};
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		hi64xx_update_bits(codec, DMIC_CLK_EN_REG,
			0x1 << DACL_S_PGA_CLK_EN_OFFSET,
			0x1 << DACL_S_PGA_CLK_EN_OFFSET);
		hi64xx_update_bits(codec, DACSL_PGA_CTRL0_REG,
			0x1 << DACSL_PGA_BYPASS_OFFSET,
			0x1 << DACSL_PGA_BYPASS_OFFSET);
		/* src */
		hi64xx_update_bits(codec, S1_MIXER_EQ_CLK_EN_REG,
			0x1 << CLK_DACL_S_UP16_EN_OFFSET,
			0x1 << CLK_DACL_S_UP16_EN_OFFSET);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi64xx_update_bits(codec, S1_MIXER_EQ_CLK_EN_REG,
			0x1 << CLK_DACL_S_UP16_EN_OFFSET, 0);
		hi64xx_update_bits(codec, DACSL_PGA_CTRL0_REG,
			0x1 << DACSL_PGA_BYPASS_OFFSET, 0);
		hi64xx_update_bits(codec, DMIC_CLK_EN_REG,
			0x1 << DACL_S_PGA_CLK_EN_OFFSET, 0);
		break;
	default:
		AUDIO_LOGW("power event err: %d", event);
		break;
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		hi64xx_update_bits(codec, EP_SDM_L_CTRL3_REG,
			0x1 << EP_SDM_L_CALT_VLD_OFFSET,
			0x1 << EP_SDM_L_CALT_VLD_OFFSET);

		/* bypass pga */
		hi64xx_update_bits(codec, DACSL_MIXER4_PGA_CTRL0_REG,
			0x1 << DACSL_MIXER4_PGA_BYPASS_OFFSET,
			0x1 << DACSL_MIXER4_PGA_BYPASS_OFFSET);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi64xx_update_bits(codec, DACSL_MIXER4_PGA_CTRL0_REG,
			0x1 << DACSL_MIXER4_PGA_BYPASS_OFFSET, 0);

		hi64xx_update_bits(codec, EP_SDM_L_CTRL3_REG,
			0x1 << EP_SDM_L_CALT_VLD_OFFSET, 0);
		hi64xx_update_bits(codec, EP_SDM_L_CTRL2_REG,
			MASK_ON_BIT(EP_SDM_L_DEMLO_SEL_LEN, EP_SDM_L_DEMLO_SEL_OFFSET),
...
static void classH_headphone_select(struct snd_soc_codec *codec)
{
	...
	hi64xx_update_bits(codec, I2S_DSPIF_CLK_EN_REG,
		0x1 << CLK_CLASSH_EN_OFFSET, 0x1 << CLK_CLASSH_EN_OFFSET);
	/* classA/B -> classH */
	hi64xx_update_bits(codec, CLASSH_CTRL6_REG,
		0x1 << CLASSH_EN_OFFSET, 0x1 << CLASSH_EN_OFFSET);

	/* set dacl/r_up16_din_sel=classh */
	hi64xx_update_bits(codec, SC_CODEC_MUX_CTRL33_REG,
		0x1 << DACL_UP16_DIN_SEL_OFFSET | 0x1 << DACR_UP16_DIN_SEL_OFFSET,
		0x1 << DACL_UP16_DIN_SEL_OFFSET | 0x1 << DACR_UP16_DIN_SEL_OFFSET);
	/* classh_hp_en */
	hi64xx_update_bits(codec, CLASSH_CTRL1_REG,
		0x1 << CLASSH_HP_EN_OFFSET, 0x1 << CLASSH_HP_EN_OFFSET);
	/* classh_ng_en */
	hi64xx_update_bits(codec, CLASSH_CTRL8_REG,
		0x1 << CLASSH_NG_EN_OFFSET, 0x1 << CLASSH_NG_EN_OFFSET);
	/* set dacl/r_up16_din_sel=classh */
	hi64xx_update_bits(codec, CLASSH_CTRL8_REG,
		0x1 << CLASSH_NG_EN_OFFSET, 0x1 << CLASSH_NG_EN_OFFSET);
	/* cp_pop_clk_pd */
	hi64xx_update_bits(codec, CODEC_ANA_RWREG_140,
		0x1 << CODEC_ANA_CTCM_CHOP_BPS_OFFSET,
		0x1 << CODEC_ANA_CTCM_CHOP_BPS_OFFSET);
	/* rst_clk_calib_pop_ng_lp */
	hi64xx_update_bits(codec, CODEC_ANA_RWREG_056,
		0x1 << CODEC_ANA_RST_CLK_POP_OFFSET,
		0x1 << CODEC_ANA_RST_CLK_POP_OFFSET);
	hi64xx_update_bits(codec, CODEC_ANA_RWREG_056,
		0x1 << CODEC_ANA_RST_CLK_POP_OFFSET, 0);
...
static void classAB_headphone_select(struct snd_soc_codec *codec)
{
	...
	/* classH -> classA/B */
	hi64xx_update_bits(codec, CLASSH_CTRL6_REG,
		0x1 << CLASSH_EN_OFFSET, 0x0 << CLASSH_EN_OFFSET);
	...
	/* classh_hp_en */
	hi64xx_update_bits(codec, CLASSH_CTRL1_REG,
		0x1 << CLASSH_HP_EN_OFFSET, 0x0 << CLASSH_HP_EN_OFFSET);
	/* classh_ng_en */
	hi64xx_update_bits(codec, CLASSH_CTRL8_REG,
		0x1 << CLASSH_NG_EN_OFFSET, 0x1 << CLASSH_NG_EN_OFFSET);
...
static void classH_earpiece_select(struct snd_soc_codec *codec)
{
	...
	/* classh_ep_en */
	hi64xx_update_bits(codec, CLASSH_CTRL1_REG,
		0x1 << CLASSH_EP_EN_OFFSET, 0x1 << CLASSH_EP_EN_OFFSET);
	...
	hi64xx_update_bits(codec, SC_CODEC_MUX_CTRL33_REG,
		0x1 << DACL_S_UP16_DIN_SEL_OFFSET,
		0x1 << DACL_S_UP16_DIN_SEL_OFFSET);
...
static const struct reg_seq_config headphone_pop_on_regs[] = {
	/* hp sdm clk dis */
	{ { DAC_DP_CLK_EN_2_REG, 0x1 << HP_SDM_L_CLK_EN_OFFSET | 0x1 << HP_SDM_R_CLK_EN_OFFSET,
		0, true }, 0, 0 },
	...
	{ { CODEC_ANA_RWREG_056, 0, 0x4A, false }, 0, 0 }, /* tx_hp default */
	{ { CODEC_ANA_RWREG_056, 0, 0xA, false }, 0, 0 }, /* tx_hp pop work */
	...
	{ { DAC_DP_CLK_EN_2_REG, 0x1 << HP_SDM_L_CLK_EN_OFFSET | 0x1 << HP_SDM_R_CLK_EN_OFFSET,
		0x1 << HP_SDM_L_CLK_EN_OFFSET | 0x1 << HP_SDM_R_CLK_EN_OFFSET, true }, 0, 0},
};
...
static const struct reg_seq_config headphone_pop_off_regs[] = {
	{ { DAC_DP_CLK_EN_2_REG,
		0x1 << HP_SDM_L_CLK_EN_OFFSET | 0x1 << HP_SDM_R_CLK_EN_OFFSET,
		0, true }, 0, 0 },
...
static void headphone_power_param_pass(struct hi6405_platform_data *data,
	...
	case SND_SOC_DAPM_PRE_PMU:
		*hs_pwron_flag = true;
		if (data->hsl_power_on && data->hsr_power_on) {
			data->rcv_hp_classH_state = (unsigned int)data->rcv_hp_classH_state | HP_POWER_STATE;
			hi6405_set_classH_config(codec,
				data->rcv_hp_classH_state);
			hi6405_headphone_pop_on(codec);
			headphone_power_param_pass_delay(data, event);
		}
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (data->hsl_power_on && data->hsr_power_on) {
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		hi64xx_update_bits(codec, S2_DP_CLK_EN_REG,
			0x1 << S2_OL_PGA_CLK_EN_OFFSET | 0x1 << S2_OR_PGA_CLK_EN_OFFSET,
			0x1 << S2_OL_PGA_CLK_EN_OFFSET | 0x1 << S2_OR_PGA_CLK_EN_OFFSET);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi64xx_update_bits(codec, S2_DP_CLK_EN_REG,
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPDAC_OFFSET, 0);
		/* earpiece pga on */
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPPGA_OFFSET, 0);
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPINT_OFFSET, 0);
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPVB_OFFSET, 0);
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_RSUB_EP_OFFSET, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* earpiece pga off */
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_RSUB_EP_OFFSET,
			0x1 << CODEC_ANA_PD_RSUB_EP_OFFSET);
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPVB_OFFSET,
			0x1 << CODEC_ANA_PD_EPVB_OFFSET);
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPINT_OFFSET,
			0x1 << CODEC_ANA_PD_EPINT_OFFSET);
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPPGA_OFFSET,
			0x1 << CODEC_ANA_PD_EPPGA_OFFSET);
		/* earpiece dac pb */
		hi64xx_update_bits(codec, CODEC_ANA_RWREG_014,
			0x1 << CODEC_ANA_PD_EPDAC_OFFSET,
			0x1 << CODEC_ANA_PD_EPDAC_OFFSET);
		priv->rcv_hp_classH_state = (unsigned int)priv->rcv_hp_classH_state & (~RCV_POWER_STATE);
		hi6405_set_classH_config(codec, priv->rcv_hp_classH_state);
		break;
