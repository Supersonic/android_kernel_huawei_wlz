...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_RESERVED,                  694*1024,        150*1024,    EMMC_USER_PART},/* reserved         150M    p49*/
  {PART_RAMDISK,                   844*1024,          2*1024,    EMMC_USER_PART},/* ramdisk           32M    p50*/
  {PART_VBMETA_SYSTEM,             846*1024,          1*1024,    EMMC_USER_PART},/* vbmeta_system      1M    p51*/
  {PART_VBMETA_VENDOR,             847*1024,          1*1024,    EMMC_USER_PART},/* vbmeta_vendor      1M    p52*/
  {PART_VBMETA_ODM,                848*1024,          1*1024,    EMMC_USER_PART},/* vbmeta_odm         1M    p53*/
  {PART_VBMETA_CUST,               849*1024,          1*1024,    EMMC_USER_PART},/* vbmeta_cust        1M    p54*/
  {PART_VBMETA_HW_PRODUCT,         850*1024,          1*1024,    EMMC_USER_PART},/* vbmeta_hw_product  1M    p55*/
  {PART_RECOVERY_RAMDISK,          851*1024,         32*1024,    EMMC_USER_PART},/* recovery_ramdisk  32M    p56*/
  {PART_RECOVERY_VENDOR,           883*1024,         16*1024,    EMMC_USER_PART},/* recovery_vendor   16M    p57*/
  {PART_DTS,                       899*1024,          1*1024,    EMMC_USER_PART},/* dtimage            1M    p58*/
  {PART_DTO,                       900*1024,         20*1024,    EMMC_USER_PART},/* dtoimage          20M    p59*/
  {PART_TRUSTFIRMWARE,             920*1024,          2*1024,    EMMC_USER_PART},/* trustfirmware      2M    p60*/
  {PART_MODEM_FW,                  922*1024,        134*1024,    EMMC_USER_PART},/* modem_fw         134M    p61*/
  {PART_ENG_VENDOR,               1056*1024,         20*1024,    EMMC_USER_PART},/* eng_vendor        20M    p62*/
  {PART_MODEM_PATCH_NV,           1076*1024,         16*1024,    EMMC_USER_PART},/* modem_patch_nv    16M    p63*/
  {PART_MODEM_DRIVER,             1092*1024,         20*1024,    EMMC_USER_PART},/* modem_driver      20M    p64*/
  {PART_RECOVERY_VBMETA,          1112*1024,          2*1024,    EMMC_USER_PART},/* recovery_vbmeta    2M    p65*/
  {PART_ERECOVERY_VBMETA,         1114*1024,          2*1024,    EMMC_USER_PART},/* erecovery_vbmeta   2M    p66*/
  {PART_VBMETA,                   1116*1024,          4*1024,    EMMC_USER_PART},/* PART_VBMETA        4M    p67*/
  {PART_MODEMNVM_UPDATE,          1120*1024,         16*1024,    EMMC_USER_PART},/* modemnvm_update   16M    p68*/
  {PART_MODEMNVM_CUST,            1136*1024,         16*1024,    EMMC_USER_PART},/* modemnvm_cust     16M    p69*/
  {PART_PATCH,                    1152*1024,         32*1024,    EMMC_USER_PART},/* patch             32M    p70*/
#ifdef CONFIG_FACTORY_MODE
  {PART_SUPER,                    1184*1024,       9568*1024,    EMMC_USER_PART},/* super           9568M    p71*/
  {PART_VERSION,                 10752*1024,        576*1024,    EMMC_USER_PART},/* version          576M    p72*/
  {PART_PRELOAD,                 11328*1024,       1144*1024,    EMMC_USER_PART},/* preload         1144M    p73*/
  {PART_HIBENCH_IMG,             12472*1024,        128*1024,    EMMC_USER_PART},/* hibench_img      128M    p74*/
  {PART_HIBENCH_DATA,            12600*1024,        512*1024,    EMMC_USER_PART},/* hibench_data     512M    p75*/
  {PART_FLASH_AGEING,            13112*1024,        512*1024,    EMMC_USER_PART},/* FLASH_AGEING     512M    p76*/
  {PART_HIBENCH_LOG,             13624*1024,         32*1024,    EMMC_USER_PART},/* HIBENCH_LOG       32M    p77*/
  {PART_HIBENCH_LPM3,            13656*1024,         32*1024,    EMMC_USER_PART},/* HIBENCH_LPM3      32M    p78*/
  {PART_USERDATA,                13688*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p79*/
#elif defined CONFIG_MARKET_INTERNAL
#ifdef CONFIG_USE_EROFS
  {PART_SUPER,                    1184*1024,       7408*1024,    EMMC_USER_PART},/* super           7408M    p71*/
  {PART_VERSION,                  8592*1024,        576*1024,    EMMC_USER_PART},/* version          576M    p72*/
  {PART_PRELOAD,                  9168*1024,       1144*1024,    EMMC_USER_PART},/* preload         1144M    p73*/
  {PART_USERDATA,                10312*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p74*/
#else
  {PART_SUPER,                    1184*1024,       9568*1024,    EMMC_USER_PART},/* super           9568M    p71*/
  {PART_VERSION,                 10752*1024,        576*1024,    EMMC_USER_PART},/* version          576M    p72*/
  {PART_PRELOAD,                 11328*1024,       1144*1024,    EMMC_USER_PART},/* preload         1144M    p73*/
  {PART_USERDATA,                12472*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p74*/
#endif
#else
#ifdef CONFIG_USE_EROFS
  {PART_SUPER,                    1184*1024,       8232*1024,    EMMC_USER_PART},/* super           8232M    p71*/
  {PART_VERSION,                  9416*1024,        576*1024,    EMMC_USER_PART},/* version          576M    p72*/
  {PART_PRELOAD,                  9992*1024,       1144*1024,    EMMC_USER_PART},/* preload         1144M    p73*/
  {PART_USERDATA,                11136*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p74*/
#else
  {PART_SUPER,                    1184*1024,      10696*1024,    EMMC_USER_PART},/* super          10696M    p71*/
  {PART_VERSION,                 11880*1024,        576*1024,    EMMC_USER_PART},/* version          576M    p72*/
  {PART_PRELOAD,                 12456*1024,       1144*1024,    EMMC_USER_PART},/* preload         1144M    p73*/
  {PART_USERDATA,                13600*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p74*/
#endif
#endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_RESERVED,                  686*1024,        150*1024,    UFS_PART_3},/* reserved         132M    p45*/
  {PART_RAMDISK,                   836*1024,          2*1024,    UFS_PART_3},/* ramdisk           32M    p46*/
  {PART_VBMETA_SYSTEM,             838*1024,          1*1024,    UFS_PART_3},/* vbmeta_system      1M    p47*/
  {PART_VBMETA_VENDOR,             839*1024,          1*1024,    UFS_PART_3},/* vbmeta_vendor      1M    p48*/
  {PART_VBMETA_ODM,                840*1024,          1*1024,    UFS_PART_3},/* vbmeta_odm         1M    p49*/
  {PART_VBMETA_CUST,               841*1024,          1*1024,    UFS_PART_3},/* vbmeta_cust        1M    p50*/
  {PART_VBMETA_HW_PRODUCT,         842*1024,          1*1024,    UFS_PART_3},/* vbmeta_hw_product  1M    p51*/
  {PART_RECOVERY_RAMDISK,          843*1024,         32*1024,    UFS_PART_3},/* recovery_ramdisk  32M    p52*/
  {PART_RECOVERY_VENDOR,           875*1024,         16*1024,    UFS_PART_3},/* recovery_vendor   16M    p53*/
  {PART_DTS,                       891*1024,          1*1024,    UFS_PART_3},/* dtimage            1M    p54*/
  {PART_DTO,                       892*1024,         20*1024,    UFS_PART_3},/* dtoimage          20M    p55*/
  {PART_TRUSTFIRMWARE,             912*1024,          2*1024,    UFS_PART_3},/* trustfirmware      2M    p56*/
  {PART_MODEM_FW,                  914*1024,        134*1024,    UFS_PART_3},/* modem_fw         134M    p57*/
  {PART_ENG_VENDOR,               1048*1024,         20*1024,    UFS_PART_3},/* eng_vendor        20M    p58*/
  {PART_MODEM_PATCH_NV,           1068*1024,         16*1024,    UFS_PART_3},/* modem_patch_nv    16M    p59*/
  {PART_MODEM_DRIVER,             1084*1024,         20*1024,    UFS_PART_3},/* modem_driver      20M    p60*/
  {PART_RECOVERY_VBMETA,          1104*1024,          2*1024,    UFS_PART_3},/* recovery_vbmeta    2M    p61*/
  {PART_ERECOVERY_VBMETA,         1106*1024,          2*1024,    UFS_PART_3},/* erecovery_vbmeta   2M    p62*/
  {PART_VBMETA,                   1108*1024,          4*1024,    UFS_PART_3},/* PART_VBMETA        4M    p63*/
  {PART_MODEMNVM_UPDATE,          1112*1024,         16*1024,    UFS_PART_3},/* modemnvm_update   16M    p64*/
  {PART_MODEMNVM_CUST,            1128*1024,         16*1024,    UFS_PART_3},/* modemnvm_cust     16M    p65*/
  {PART_PATCH,                    1144*1024,         32*1024,    UFS_PART_3},/* patch             32M    p66*/
#ifdef CONFIG_FACTORY_MODE
  {PART_SUPER,                    1176*1024,       9568*1024,    UFS_PART_3},/* super           9568M    p67*/
  {PART_VERSION,                 10744*1024,        576*1024,    UFS_PART_3},/* version          576M    p68*/
  {PART_PRELOAD,                 11320*1024,       1144*1024,    UFS_PART_3},/* preload         1144M    p69*/
  {PART_HIBENCH_IMG,             12464*1024,        128*1024,    UFS_PART_3},/* hibench_img      128M    p70*/
  {PART_HIBENCH_DATA,            12592*1024,        512*1024,    UFS_PART_3},/* hibench_data     512M    p71*/
  {PART_FLASH_AGEING,            13104*1024,        512*1024,    UFS_PART_3},/* FLASH_AGEING     512M    p72*/
  {PART_HIBENCH_LOG,             13616*1024,         32*1024,    UFS_PART_3},/* HIBENCH_LOG       32M    p73*/
  {PART_HIBENCH_LPM3,            13648*1024,         32*1024,    UFS_PART_3},/* HIBENCH_LPM3      32M    p74*/
  {PART_USERDATA,                13680*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p75*/
#elif defined CONFIG_MARKET_INTERNAL
#ifdef CONFIG_USE_EROFS
  {PART_SUPER,                    1176*1024,       7408*1024,    UFS_PART_3},/* super           7408M    p67*/
  {PART_VERSION,                  8584*1024,        576*1024,    UFS_PART_3},/* version          576M    p68*/
  {PART_PRELOAD,                  9160*1024,       1144*1024,    UFS_PART_3},/* preload         1144M    p69*/
  {PART_USERDATA,                10304*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p70*/
#else
  {PART_SUPER,                    1176*1024,       9568*1024,    UFS_PART_3},/* super           9568M    p67*/
  {PART_VERSION,                 10744*1024,        576*1024,    UFS_PART_3},/* version          576M    p68*/
  {PART_PRELOAD,                 11320*1024,       1144*1024,    UFS_PART_3},/* preload         1144M    p69*/
  {PART_USERDATA,                12464*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p70*/
#endif
#else
#ifdef CONFIG_USE_EROFS
  {PART_SUPER,                    1176*1024,       8232*1024,    UFS_PART_3},/* super           8232M    p67*/
  {PART_VERSION,                  9408*1024,        576*1024,    UFS_PART_3},/* version          576M    p68*/
  {PART_PRELOAD,                  9984*1024,       1144*1024,    UFS_PART_3},/* preload         1144M    p69*/
  {PART_USERDATA,                11128*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p70*/
#else
  {PART_SUPER,                    1176*1024,      10696*1024,    UFS_PART_3},/* super          10696M    p67*/
  {PART_VERSION,                 11872*1024,        576*1024,    UFS_PART_3},/* version          576M    p68*/
  {PART_PRELOAD,                 12448*1024,       1144*1024,    UFS_PART_3},/* preload         1144M    p69*/
  {PART_USERDATA,                13592*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p70*/
#endif
#endif
  {"0", 0, 0, 0},
};
