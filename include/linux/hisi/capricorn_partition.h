...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_RESERVED5,                  745*1024,           6*1024,        EMMC_USER_PART},/* reserved5          6M    p49*/
#else
  ...
  {PART_RESERVED5,                  737*1024,          14*1024,        EMMC_USER_PART},/* reserved5         14M    p49*/
#endif
  ...
  {PART_USERDATA,                 12384*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p82*/
#else
  ...
  {PART_SUPER,                     1200*1024,        4232*1024,        EMMC_USER_PART},/* super           4232M    p75*/
  {PART_VERSION,                   5432*1024,         200*1024,        EMMC_USER_PART},/* version          200M    p76*/
  ...
  {PART_SUPER,                     1016*1024,        4536*1024,        EMMC_USER_PART},/* super           4616M    p72*/
  {PART_VERSION,                   5552*1024,         200*1024,        EMMC_USER_PART},/* version          200M    p73*/
  {PART_PRELOAD,                   5752*1024,         928*1024,        EMMC_USER_PART},/* preload          928M    p74*/
  {PART_USERDATA,                  6680*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata         4G      p75*/
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_RESERVED5,                  737*1024,           6*1024,        UFS_PART_3},/* reserved5                   6M    p45*/
#else
  ...
  {PART_RESERVED5,                  729*1024,          14*1024,        UFS_PART_3},/* reserved5                  14M    p45*/
#endif
  ...
  {PART_USERDATA,                 12376*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                    4G    p78*/
#else
#ifdef CONFIG_NEW_PRODUCT_Q
#ifdef CONFIG_USE_EROFS
  #ifdef CONFIG_MARKET_INTERNAL
  ...
  {PART_SUPER,                     1192*1024,        4232*1024,        UFS_PART_3},/* super                    4232M    p71*/
  {PART_VERSION,                   5424*1024,         200*1024,        UFS_PART_3},/* version                   200M    p72*/
  ...
  #elif defined CONFIG_MARKET_OVERSEA
  {PART_SUPER,                     1008*1024,        4536*1024,        UFS_PART_3},/* super                    4616M    p68*/
  {PART_VERSION,                   5544*1024,         200*1024,        UFS_PART_3},/* version                   200M    p69*/
  {PART_PRELOAD,                   5744*1024,         928*1024,        UFS_PART_3},/* preload                   928M    p70*/
  {PART_USERDATA,                  6672*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                    4G    p71*/
  #elif defined CONFIG_MARKET_FULL_INTERNAL
  {PART_METADATA,                  1008*1024,          16*1024,        UFS_PART_3},/* metadata                   16M    p68*/
