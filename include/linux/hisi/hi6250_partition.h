...
static const struct partition partition_table_emmc[] =
{
    ...
    {PART_HW_PRODUCT,        6720*1024, 192*1024, EMMC_USER_PART}, /* hw_product       192M  p56*/
    ...
    {PART_HW_PRODUCT,        5568*1024, 192*1024, EMMC_USER_PART}, /* hw_product       192M  p56*/
    ...
    {PART_HW_PRODUCT,        5584*1024, 192*1024, EMMC_USER_PART}, /* hw_product       192M  p56*/
    ...
    {PART_HW_PRODUCT,        5120*1024, 192*1024, EMMC_USER_PART}, /* hw_product       192M  p56*/
    ...
    {PART_HW_PRODUCT,        4800*1024, 512*1024, EMMC_USER_PART}, /* hw_product       512M  p56*/
    {PART_USERDATA,          5312*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p57*/
    ...
    {PART_HW_PRODUCT,        5040*1024, 192*1024, EMMC_USER_PART}, /* hw_product       192M  p56*/
    ...
    {PART_HW_PRODUCT,        4752*1024, 192*1024, EMMC_USER_PART}, /* hw_product       192M  p56*/
    ...
    {PART_HW_PRODUCT,        4848*1024, 192*1024, EMMC_USER_PART}, /* hw_product        200M  p56*/
    ...
    {PART_HW_PRODUCT,        4528*1024, 192*1024, EMMC_USER_PART}, /* hw_product        192M  p56*/
    ...
    {PART_HW_PRODUCT,        7248*1024, 592*1024, EMMC_USER_PART}, /* hw_product        592M  p56*/
    ...
    {PART_HW_PRODUCT,        6368*1024, 592*1024, EMMC_USER_PART}, /* hw_product        592M  p56*/
    ...
    {PART_HW_PRODUCT,        7648*1024, 192*1024, EMMC_USER_PART}, /* hw_product        192M  p56*/
    {PART_USERDATA,          7840*1024, 4096*1024,EMMC_USER_PART}, /* userdata          4096M p57*/
    ...
    {PART_HW_PRODUCT,        6768*1024, 192*1024, EMMC_USER_PART}, /* hw_product        192M  p56*/
    {PART_USERDATA,          6960*1024, 4096*1024,EMMC_USER_PART}, /* userdata          4096M p57*/
#else
    ...
    {PART_HW_PRODUCT,        4400*1024, 192*1024, EMMC_USER_PART}, /* hw_product        192M  p56*/
