...
typedef enum{
    MODE_EIS_PRE = 0,
    MODE_EIS_VID,
    MODE_EIS_MULTI,//v200 add¡ê?two buffer warp request type
    MODE_DMAP,
	MODE_EIS_4K_60FPS,
    MODE_MAX,
} warp_request_mode_e;
...
typedef struct _dopt_algo_cfg_t
{
    ...
    unsigned char  blue_sky_en;
    /* dopt algo param */
    unsigned char  bluesky_disp_default;
    unsigned char  bluesky_threshold_high;
    unsigned char  bluesky_threshold_low;
    unsigned char  bluesky_conf;

    unsigned char  bluesky_texture_shift;
    unsigned short bluesky_var_th;
