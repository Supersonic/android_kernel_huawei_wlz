...
typedef enum
{
    ...
    SUBCMD_SET_SOFTLIGHT_MODE  = 186,
    SUBCMD_LASER_VERSION = 187,

    SUBCMD_SET_PDALGO_ENABLE = 188,
    SUBCMD_SET_PD_INFO = 189,
    SUBCMD_SET_SWPD_KEY = 190,
    SUBCMD_GET_SWPD_KEY = 191,
    ...
    SUBCMD_SET_BOKEH_MODE = 216,
    SUBCMD_SET_DISABLE_TAE = 217,
