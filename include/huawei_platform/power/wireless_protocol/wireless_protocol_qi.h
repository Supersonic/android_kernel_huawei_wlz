...
#define QI_CMD_START_SAMPLE                   0x1d /* rx output voltage */
#define QI_CMD_STOP_SAMPLE                    0x1e /* output current */
...
#define QI_CMD_GET_TX_ALARM                   0x4a
...
#define QI_ACK_TX_FWVER_S_OFFSET              1
#define QI_ACK_TX_FWVER_E_OFFSET              4
...
/* cmd 0x23 */
#define QI_PARA_CHARGER_MODE_LEN              1
...
#define QI_PARA_TX_EXT_TYPE_CAR               0x4 /* bit[2:3]=01b */

/* cmd 0x43 */
#define QI_PARA_CHARGER_STATE_LEN             1
...
struct qi_protocol_device_info {
	u8 tx_fwver[QI_ACK_TX_FWVER_LEN];
};
...
struct qi_protocol_handle {
	int (*handle_ask_packet)(void); /* rx to tx */
};
...
struct qi_protocol_ops {
	...
	int (*set_rx_max_power_post)(void); /* process non protocol flow */
};
