...
TRACE_EVENT(l3_cache_request_enter, /* [false alarm]:TRACE_EVENT是原生宏定义 */
...
TRACE_EVENT(l3_cache_request_succ, /* [false alarm]:TRACE_EVENT是原生宏定义 */
...
TRACE_EVENT(l3_cache_release_enter, /* [false alarm]:TRACE_EVENT是原生宏定义 */
	TP_PROTO(int request_id, unsigned int g_acp_flag),
	TP_ARGS(request_id, g_acp_flag),
	TP_STRUCT__entry(
		__field(int, request_id)
...
TRACE_EVENT(l3_cache_release_succ, /* [false alarm]:TRACE_EVENT是原生宏定义 */
	TP_PROTO(int request_id, unsigned int g_acp_flag),
	TP_ARGS(request_id, g_acp_flag),
	TP_STRUCT__entry(
		__field(int, request_id)
...
TRACE_EVENT(l3_cache_share_perf, /* [false alarm]:TRACE_EVENT是原生宏定义 */
