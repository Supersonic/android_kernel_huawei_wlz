...
#define HISP_GET_MAPBUFFER          _IOWR('i', 0x1210, rpmsg_ioctl_arg_t)
#define HISP_UNMAP_BUFFER           _IOWR('i', 0x1211, rpmsg_ioctl_arg_t)
#define HISP_POOL_STEUP             _IOWR('i', 0x1212, rpmsg_ioctl_arg_t)
