...
#define FRW_TIMER_CREATE_TIMER(_pst_timeout, _p_timeout_func, _ul_timeout, \
    ...
    frw_timer_create_timer_etc(THIS_FILE_ID, __LINE__, _pst_timeout, _p_timeout_func, _ul_timeout, \
                               _p_timeout_arg, _en_is_periodic, _en_module_id, _ul_core_id)
...
#define frw_get_event_payload(pst_event_mem) ((oal_uint8 *)((frw_event_stru *) \
                                                            (pst_event_mem)->puc_data)->auc_event_data)

/*
 * 函 数 名  : frw_event_alloc_etc
 * 功能描述  : 申请事件内存
                                                              ...
                                                              oal_uint16 us_payload_length)
{
    ...
    pst_event_mem = oal_mem_alloc_enhanced_etc(ul_file_id, ul_line_num, OAL_MEM_POOL_ID_EVENT,
...
extern oal_bool_enum_uint8 en_event_track_switch_etc;
...
#endif
extern oal_void frw_event_table_register_etc(frw_event_type_enum_uint8 en_event_type,
...
extern oal_void frw_timer_create_timer_etc(oal_uint32 ul_file_id,
                                           oal_uint32 ul_line_num,
...
extern oal_void frw_timer_immediate_destroy_timer_etc(oal_uint32 ul_file_id,
                                                      oal_uint32 ul_line_num,
                                                      frw_timeout_stru *pst_timeout);
extern oal_void frw_timer_restart_timer_etc(frw_timeout_stru *pst_timeout, oal_uint32 ul_timeout,
                                            oal_bool_enum_uint8 en_is_periodic);
...
extern oal_bool_enum_uint8 frw_is_vap_event_queue_empty_etc(oal_uint32 ul_core_id, oal_uint8 uc_vap_id,
