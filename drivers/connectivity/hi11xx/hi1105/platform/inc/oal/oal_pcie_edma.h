...
typedef union {
    struct {
        oal_uint32 soc_outband_pwrup_cmd : 1;   /* 0 */
        oal_uint32 soc_apps_pm_xmt_pme : 1;   /* 1 */
        oal_uint32 soc_app_req_entr_l1 : 1;   /* 2 */
        oal_uint32 soc_app_ready_entr_l23 : 1;   /* 3 */
        oal_uint32 soc_app_req_exit_l1 : 1;   /* 4 */
        oal_uint32 reserved1 : 1;   /* 5 */
        oal_uint32 soc_sys_aux_pwr_det : 1;   /* 6 */
        oal_uint32 soc_app_xfer_pending : 1;   /* 7 */
        oal_uint32 reserved2 : 24;   /* 8:31 */
    }bits;
    oal_uint32 AsDword;
}LOW_POWER_CFG_U;
...
typedef union {
    struct {
        oal_uint32 phy_cr_addr : 16;   /* 0:15 */
        oal_uint32 reserved : 16;      /* 16:31 */
    }bits;
    oal_uint32 AsDword;
}PCIE_PHY_CFG_ADDR_U;
...
typedef union {
    struct {
        oal_uint32 phy_cr_wr_data : 16;   /* 0:15 */
        oal_uint32 reserved : 16;      /* 16:31 */
    }bits;
    oal_uint32 AsDword;
}PCIE_PHY_WR_DATA_U;
...
typedef union {
    struct {
        oal_uint32 phy_cr_rd_data : 16;   /* 0:15 */
        oal_uint32 reserved : 16;      /* 16:31 */
    }bits;
    oal_uint32 AsDword;
}PCIE_PHY_RD_DATA_U;
...
typedef union {
    struct {
        oal_uint32 phy_config_en : 1;   /* 0 */
        oal_uint32 reserved1 : 1; /* 1 */
        oal_uint32 phy_write : 1; /* 2 */
        oal_uint32 reserevd2 : 12; /* 3:14 */
        oal_uint32 phy_config_rdy : 1; /* 15 */
        oal_uint32 reserved : 16;      /* 16:31 */
    }bits;
    oal_uint32 AsDword;
}PCIE_PHY_CFG_U;
