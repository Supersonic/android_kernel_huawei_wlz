...
/*
 * 函 数 名  : oam_netlink_ops_register_etc
...
/*
 * 函 数 名  : oam_netlink_ops_unregister_etc
...
/*
 * 函 数 名  : oam_netlink_kernel_recv_etc
...
/*
 * 函 数 名  : oam_netlink_kernel_send_etc
...
/*
 * 函 数 名  : oam_netlink_kernel_send_ex_etc
 * 功能描述  : netlink消息发送函数(方向: 内核 -> host app)
