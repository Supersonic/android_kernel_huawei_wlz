...
extern oal_uint32 frw_ipc_msg_queue_send_etc(frw_ipc_msg_queue_stru *pst_ipc_tx_msg_queue,
...
extern oal_uint32 frw_ipc_log_send_etc(frw_ipc_log_stru *pst_log,
                                       oal_uint16 us_seq_num,
                                       oal_uint8 uc_target_cpuid,
                                       oal_uint8 uc_msg_type);
extern oal_uint32 frw_ipc_log_recv_etc(frw_ipc_log_stru *pst_log,
                                       oal_uint16 us_seq_num,
                                       oal_uint8 uc_target_cpuid,
                                       oal_uint8 uc_msg_type);
