...
/*
 * 函 数 名  : frw_event_dispatch_event_etc
...
/*
 * 函 数 名  : frw_event_queue_enqueue_etc
 * 功能描述  : 将事件内存放入相应的事件队列
 * 输入参数  : pst_event_mem: 指向事件内存块的指针
 */
...
/*
 * 函 数 名  : frw_event_queue_dequeue_etc
 * 功能描述  : 事件内存出队
...
/*
 * 函 数 名  : frw_event_post_event_etc
 * 功能描述  : 将事件内存放入相应的事件队列
 * 输入参数  : pst_event_mem: 指向事件内存块的指针
 */
...
/*
 * 函 数 名  : frw_event_table_register_etc
...
/*
 * 函 数 名  : frw_event_deploy_register_etc
...
/*
 * 函 数 名  : frw_event_ipc_event_queue_full_register_etc
...
/*
 * 函 数 名  : frw_event_ipc_event_queue_empty_register_etc
 * 功能描述  : 供IPC模块注册核间中断频度管理接口
 * 输入参数  : p_func: 核间中断频度管理接口
 */
...
/*
 * 函 数 名  : frw_event_dump_event_etc
 * 功能描述  : 打印事件
...
/*
 * 函 数 名  : frw_event_get_info_from_event_queue_etc
...
/*
 * 函 数 名  : frw_event_queue_info_etc
...
/*
 * 函 数 名  : frw_event_vap_pause_event_etc
...
/*
 * 函 数 名  : frw_event_vap_resume_event_etc
...
/*
 * 函 数 名  : frw_event_vap_flush_event_etc
...
/*
 * 函 数 名  : frw_event_get_sched_queue_etc
...
/*
 * 函 数 名  : frw_is_event_queue_empty_etc
...
/*
 * 函 数 名  : frw_is_vap_event_queue_empty_etc
...
/*
 * 函 数 名  : frw_task_thread_condition_check_etc
 * 功能描述  : 判断是否有事件需要调度
 */
