...
//    WLAN_CFGID_GET_SMPS_EN           = 472,
    ...
    WLAN_CFGID_ALTX_HW                     = 812,   /* 1105 硬件长发命令 */
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_dot11FtmInitiatorModeActivated;              /* dot11FineTimingMsmtInitActivated TruthValue,                      */
    oal_bool_enum_uint8 en_dot11FtmResponderModeActivated;              /* dot11FineTimingMsmtRespActivated TruthValue,                      */
    oal_bool_enum_uint8 en_dot11LciCivicInNeighborReport;               /* dot11LciCivicInNeighborReport TruthValue,                         */
    oal_bool_enum_uint8 en_dot11RMFtmRangeReportImplemented;            /* dot11RMFineTimingMsmtRangeRepImplemented TruthValue,              */
    oal_bool_enum_uint8 en_dot11RMFtmRangeReportActivated;              /* dot11RMFineTimingMsmtRangeRepActivated TruthValue,                */
...
typedef struct
{
    ...
    oal_uint8             uc_dot11MaxAMPDULengthExponent;
