...
#if defined(_PRE_WLAN_FEATURE_11AX)
    oal_uint32                              bit_tx_data_include_om  : 1,             /* 发送数据含有om字段 */
...
OAL_STATIC OAL_INLINE oal_void mac_user_set_smps_opmode_notify_nss(mac_user_stru *pst_mac_user, oal_uint8 uc_nss)
{
...
#if defined(_PRE_WLAN_FEATURE_11AX)
OAL_STATIC OAL_INLINE oal_void mac_user_set_he_rom_nss(mac_user_stru *pst_mac_user, oal_uint8 uc_nss)
{
    pst_mac_user->en_he_rom_nss = uc_nss;
}
OAL_STATIC OAL_INLINE oal_void mac_user_set_he_rom_bw(mac_user_stru *pst_mac_user, oal_uint8 uc_bw)
{
    pst_mac_user->en_he_rom_bw = uc_bw;
}
#endif
OAL_STATIC OAL_INLINE wlan_nss_enum_uint8 mac_user_get_avail_num_spatial_stream_etc(mac_user_stru *pst_mac_user)
{
...
extern oal_uint8 mac_user_get_sta_cap_bandwidth_11ac(wlan_channel_band_enum_uint8 en_band,
                                                     ...
                                                     mac_user_stru *pst_mac_user);
extern oal_void mac_user_set_apsd_ram_etc(mac_user_stru *pst_mac_user, oal_bool_enum_uint8 en_apsd);
