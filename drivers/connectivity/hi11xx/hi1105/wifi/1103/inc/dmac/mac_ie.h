...
extern oal_uint32 mac_smps_update_user_status(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user, oal_bool_enum_uint8 en_from_beacon);
#endif
...
extern oal_uint32 mac_ie_from_he_cap_get_nss(mac_he_hdl_stru *pst_mac_he_hdl, wlan_nss_enum_uint8 *puc_nss);
...
extern oal_uint32  mac_ie_parse_multi_bssid_opt_subie(oal_uint8 *puc_frame_data, mac_multi_bssid_frame_info_stru *pst_mbssid_info, oal_uint8 *puc_mbssid_body_ie_len);
...
extern oal_uint32  mac_ie_proc_opmode_field_etc(mac_vap_stru *pst_mac_vap,
        mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify, oal_bool_enum_uint8 en_from_beacon);
