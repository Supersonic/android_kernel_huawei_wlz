...
#endif
#ifdef _PRE_WLAN_FEATURE_PRIV_CLOSED_LOOP_TPC
extern oal_void mac_set_adjust_pow_vendor_ie(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
#endif
...
extern oal_void mac_get_htc_uph_om_value(oal_uint8 uc_nss, oal_uint8 uc_bw,
    oal_uint8 uc_mimo_resound, oal_uint8 uc_ul_mu_disable, oal_uint32 *pul_htc_value);
...
extern oal_void mac_set_he_ie_in_assoc_rsp(oal_void *pst_mac_ap, oal_uint16 us_assoc_id, oal_uint8 *puc_asoc_rsp, oal_uint8 *puc_ie_len);
...
extern oal_void mac_set_supported_operating_classes_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
