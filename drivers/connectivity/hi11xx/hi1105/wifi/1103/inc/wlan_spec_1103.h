...
#define HAL_SMALL_RX_BUFFS                  40
#define HAL_SMALL_RX_DEFAULT_BUFFS          80
#else
#define WLAN_DSCR_SUB_MSDU_MAX_NUM          1
#endif

#define HAL_RX_DSCR_NORMAL_MAX_THRES        72       /* Rx normal队列最大挂载描述符个数 */
/*****************************************************************************
  2.5.6 小包优化
*****************************************************************************/
/* 管理帧长度  */
...
#else
#define WLAN_PHY_EXTLNA_CHGPTDBM_TH_VAL(_en_band, _en_pm_flag) (      \
            ((_en_pm_flag) == OAL_FALSE) ? (((_en_band) == WLAN_BAND_2G) ? -52:-40): \
            (((_en_band) == WLAN_BAND_2G) ? -58:-40))
#endif
