...
{
    /* 乘2为IQ两路数据 */
    oal_uint8   uc_cmp_cali[HI1105_CALI_ADC_CH_NUM*2];
    oal_uint32  ul_cap_cali_w1[HI1105_CALI_ADC_CH_NUM*2];
    oal_uint32  ul_cap_cali_w2[HI1105_CALI_ADC_CH_NUM*2];
    oal_uint32  ul_cap_cali_w3[HI1105_CALI_ADC_CH_NUM*2];
    oal_uint32  ul_cap_cali_w4[HI1105_CALI_ADC_CH_NUM*2];
    oal_uint32  ul_cap_cali_w5[HI1105_CALI_ADC_CH_NUM*2];
    oal_int32   l_moec[HI1105_CALI_ADC_CH_NUM*2];
    oal_uint16  us_mgec[HI1105_CALI_ADC_CH_NUM*2];
...
typedef struct
{
    oal_uint16  us_ppa_cmp;
    oal_uint16  us_atx_pwr_cmp;
...
typedef struct
{
    oal_uint16  aus_txdc_cmp_i[HI1105_TXDC_LPF_DAC_GAIN_LVL_NUM];
    oal_uint16  aus_txdc_cmp_q[HI1105_TXDC_LPF_DAC_GAIN_LVL_NUM];
}hi1105_txdc_comp_val_stru;

typedef struct
{
    oal_uint8   uc_ppf_val;
    oal_uint8   uc_logen_ssb_ppf;
    oal_uint8   auc_reserve[2];
}hi1105_ppf_comp_val_stru;

typedef struct
{
    oal_int32  l_txiq_cmp_alpha[HI1105_CALI_TXIQ_GAIN_LVL_NUM];
    oal_int32  l_txiq_cmp_beta[HI1105_CALI_TXIQ_GAIN_LVL_NUM];
...
typedef struct
{
    ...
    hi1105_txdc_comp_val_stru          ast_txdc_cmp_val[HI1105_2G_CHANNEL_NUM];
...
struct hi1105_cali_param_tag
{
    ...
    hi1105_5Gcali_param_stru        ast_5Gcali_param[HI1105_5G_CHANNEL_NUM];
#ifdef _PRE_WLAN_NEW_IQ
    hi1105_new_rxiq_comp_stru       ast_20M_rxiq_cmp[HI1105_2G_CHANNEL_NUM + HI1105_5G_20M_CHANNEL_NUM][HI1105_CALI_CHAIN_NUM_BUTT];
    hi1105_new_rxiq_comp_stru       ast_20M_rxiq_dbdc_cmp[HI1105_2G_CHANNEL_NUM][HI1105_CALI_CHAIN_NUM_BUTT];
#endif
#ifdef _PRE_WLAN_ONLINE_DPD
