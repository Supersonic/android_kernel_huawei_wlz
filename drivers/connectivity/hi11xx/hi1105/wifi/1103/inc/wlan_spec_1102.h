...
/*****************************************************************************
  2.5.8 DEVICE 接收中断最大个数
*****************************************************************************/
#define WLAN_RX_INTERRUPT_MAX_NUM_PER_DEVICE  8          /* 一个device最多一次处理8个rx中断 */
...
#define WLAN_TXBF_BFER_MATRIX_BUFFER_SIZE       (320)    /* 每buffer unit最大为320byte = 10*2/2*256/8(80M),另外为snr值预留10byte */
