...
#define HAL_FULL_CALI_UPLOAD_DATA_MAX_NUM   (100)  /* 产线校准全量拟合适配单次上报的最大个数 */
#endif
...
#define HAL_POW_UPC_LUT_NUM             40     /* 筛选使用的UPC档位数目(03A pilot upc code 修订为10bit) */
#else
#define HAL_POW_UPC_LUT_NUM             25
#endif
...
#endif
#else //((((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_DEV))))
...
#endif //((((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1105_DEV))))

#define HAL_POW_AXPA_LUT_NUM                3
...
#define GET_DEV_RX_DSCR_ELE_AVR_CNT(_pst_hal_dev, _uc_queue_id)    \
    (((alg_rx_dscr_ctl_alg_info_stru *)((_pst_hal_dev)->st_rx_dscr_ctl.pst_rx_dscr_ctl_alg_info + (_uc_queue_id)))->us_rx_max_element_avr_cnt)

#define GET_DEV_RX_DSCR_SMOOTH_EVENT_PKTS(_pst_hal_dev, _uc_queue_id)    \
        (((alg_rx_dscr_ctl_alg_info_stru *)((_pst_hal_dev)->st_rx_dscr_ctl.pst_rx_dscr_ctl_alg_info + (_uc_queue_id)))->us_rx_smooth_event_pkts)
...
typedef oal_uint8 wlan_monitor_state_enum_uint8;
...
/* 8 bytes */
typedef struct {
    oal_uint8     it_version;            /* 使用radiotap header的主要版本, 目前总是为0 */
    oal_uint8     it_pad;                /* 目前并未使用, 只是为了4字节对齐 */
    oal_uint16    it_len;                /* radiotap的长度, 包括：header+fields */
    oal_uint32    it_present;            /* 通过bit位标明fields有哪些成员 */
...
typedef struct {
    ...
    oal_uint8   bit_rx_himit_flag         : 1;      /* rx himit flag = 1103 bit_preabmle */
...
typedef struct {
    ...
    /*byte 1-4 */
    oal_uint8           uc_code_book;
    oal_uint8           uc_grouping;
    oal_uint8           uc_row_number;
...
#define SNIFFER_RX_INFO_SIZE (OAL_SIZEOF(hal_sniffer_rx_status_stru) + OAL_SIZEOF(hal_sniffer_rx_statistic_stru) + OAL_SIZEOF(oal_uint32) + OAL_SIZEOF(hal_statistic_stru))
#endif
...
/* power gating操作 */
typedef enum {
    HAL_MAC_AUTO_PG_DISABLE        = 0,
    HAL_MAC_AUTO_PG_ENABLE         = 1,
    HAL_MAC_AUTO_PG_REFRESH        = 2,

    HAL_MAC_AUTO_PG_BUTT
}hal_mac_auto_pg_enum_uint8;
...
typedef struct
{
    ...
    oal_uint8                               bit_alg_log_print        : 1;  /* TODO:暂时认证维测用，后期删除 */
    ...
    oal_uint8                               bit_fix_bw                      : 1;
    oal_uint8                               bit_reserve                     : 2;
...
typedef struct
{
    ...
    oal_uint16                           us_now_time_ms;
    oal_uint8                            uc_ul_ofdma_flag;
    oal_uint8                            uc_ssn;
...
#define MAX_RADAR_PULSE_NUM_ROM   32            /* 软件申请雷达脉冲内存大小，应为16，ROM无法修改 */
#define MAX_RADAR_PULSE_NUM       16            /* 最大雷达脉冲数 */
...
typedef struct
{
    hal_pulse_info_stru     ast_pulse_info[MAX_RADAR_PULSE_NUM_ROM];
...
typedef union {
    ...
    struct {
        oal_uint32   bit_lsb    : 16;
        oal_uint32   bit_msb    : 16;
    } st_reg;
} dmac_ftm_correlation_peak_union;
...
typedef struct
{
    ...
    union {
        oal_uint32      ul_reg_value;
        struct {
            oal_uint32   bit_phase_incr       : 13;
            oal_uint32   bit_reserved0        : 3;
            oal_uint32   bit_snr              : 13;
            oal_uint32   bit_reserved1        : 3;
        } st_reg0;
    } ftm_rpt_reg0;
    ...
    union {
        oal_uint32      ul_reg_value;
        struct {
            oal_uint32   bit_max_power        : 13;
            oal_uint32   bit_reserved0        : 3;
            oal_uint32   bit_left0_power      : 13;
            oal_uint32   bit_reserved1        : 3;
        } st_reg1;
    } ftm_rpt_reg1;
    ...
    union {
        oal_uint32      ul_reg_value;
        struct {
            oal_uint32   bit_r0_power         : 13;
            oal_uint32   bit_reserved0        : 3;
            oal_uint32   bit_l1_power         : 13;
            oal_uint32   bit_reserved1        : 3;
        } st_reg2;
    } ftm_rpt_reg2;
    ...
    union {
        oal_uint32      ul_reg_value;
        struct {
            oal_uint32   bit_l2_power         : 13;
            oal_uint32   bit_reserved0        : 3;
            oal_uint32   bit_l3_power         : 13;
            oal_uint32   bit_reserved1        : 3;
        } st_reg3;
    } ftm_rpt_reg3;
    ...
    union {
        oal_uint32      ul_reg_value;
        struct {
            oal_uint32   bit_l4_power         : 13;
            oal_uint32   bit_reserved0        : 3;
            oal_uint32   bit_l5_power         : 13;
            oal_uint32   bit_reserved1        : 3;
        } st_reg4;
    } ftm_rpt_reg4;
    ...
    dmac_ftm_correlation_peak_union  ast_ftm_correlation_peak[32];
#endif
}ftm_toda_stru;
...
#ifdef _PRE_WLAN_FEATURE_FULL_QUAN_PROD_CAL
    oal_uint8               uc_full_data_coll_idx;
#endif
...
#endif
    oal_uint8                               uc_phy_cap_bitmap;    /* phy支持的特性开关 */
    oal_uint8                               auc_resv[2];
#else
    oal_uint8                               uc_phy_cap_bitmap;
...
typedef struct
{
...
#ifdef _PRE_WLAN_1103_PILOT
    oal_uint16                             aus_resv[NUM_OF_NV_MAX_TXPOWER-8];
    ...
    wlan_channel_band_enum_uint8           uc_ax_lut_band_svs_reg;
    oal_uint8                              uc_ax_lut_sub_band_svs_reg;    /* 保存当前MAC AX LUT中存在的code对应的频段和band */
    oal_uint8                              uc_fix_tpc_idx;
    oal_int16                              s_11b_ofdm_delt_pow;    /* 11b和OFDM在相同upc下的功率差，精度0.01dBm */
    oal_uint8                              uc_reg_pow;
    oal_int16                              s_tx_power;
    /* PAPR=5.5时的功率偏差值 */
...
typedef struct
{
    ...
    oal_uint16                      aus_pending_isr_cnt[HAL_RX_DSCR_QUEUE_ID_BUTT]; /* 记录pending在乒乓队列里的isr info数量 */
...
typedef struct hal_csi_agc_stru {
   ...
   oal_uint8            uc_rpt_lna_code_1ch;
   oal_uint8            uc_rpt_vga_code_0ch;
   oal_uint8            uc_rpt_vga_code_1ch;
} hal_csi_agc_stru;
#endif
...
#pragma pack(push,1)
/* himit描述符字段定义 ul_himit_tx_adn_word0~ul_himit_tx_adn_word4为软件填写字段 */
typedef struct {
    ...
    oal_uint8  uc_himit_evm_ss0_avg;            /* 空间流0基于symbol的EVM平均值。上报绝对值，取值范围[0,255],对应EVM是（-64,0]dB，精度1/4dB */
    ...
    oal_uint8  uc_himit_evm_ss1_avg;            /* 空间流1基于symbol的EVM平均值。上报绝对值，取值范围[0,255],对应EVM是（-64,0]dB，精度1/4dB */
...
/* 接收端数据统计结构体 */
typedef struct {
    oal_uint32  ul_rx_frame_mu_succ_cnt;            /* 接收成功的MU帧总数 */
    oal_uint32  ul_rx_frame_mu_other_cnt;           /* 其他状态MU帧总数 */
    oal_uint32  ul_rx_frame_ofdma_succ_cnt;         /* 接收成功的OFDMA帧总数 */
    oal_uint32  ul_rx_frame_ofdma_other_cnt;        /* 其他状态OFDMA帧总数 */
} dmac_rx_frame_statistics_stru;

/* 发送端数据统计结构体 */
typedef struct {
    oal_uint32  ul_tx_frame_succ_not_tb_cnt;        /* 接收成功的非tb帧 */
    oal_uint32  ul_tx_frame_succ_tb_all_mpdu_cnt;   /* 接收成功的tb帧,且全部聚合包已发送 */
    oal_uint32  ul_tx_frame_succ_tb_part_mpdu_cnt;  /* 接收成功的tb帧,只有部分聚合包发送 */
    oal_uint32  ul_tx_frame_fail_not_tb_cnt;        /* 接收失败的非tb帧 */
    oal_uint32  ul_tx_frame_fail_tb_all_mpdu_cnt;   /* 接收失败的tb帧,且全部聚合包已发送 */
    oal_uint32  ul_tx_frame_fail_tb_part_mpdu_cnt;  /* 接收失败的tb帧,只有部分聚合包发送 */
} dmac_tx_frame_statistics_stru;

typedef union {
    oal_uint32  ul_trig_para_value;

    struct {
        oal_uint16  us_psdu_tx_time;             /* AP允许TB PPDU发送时常,单位ms */

        oal_uint16  us_ltf_gi_type    : 4;       /* AP指定gi */
        oal_uint16  us_ru_type        : 4;       /* AP指定ru size */
        oal_uint16  us_mcs            : 4;       /* AP指定mcs */
        oal_uint16  us_nss            : 4;       /* AP指定nss */
    }st_basic_trig_para;
...
typedef struct
{
    ...
    oal_uint8                            bit_dfsmode                 : 2;
#else
    oal_uint8                            bit_resv                    : 2;
#endif
    oal_uint8                            bit_warning_mode            : 1;
    oal_uint8                            bit_rsv                     : 5;
    ...
    oal_uint8                            uc_himit_flag;            /* flag 1:表示st_himit_tx_adn正在使用 0:没有被使用 防止同一块内存导致himit描述符覆盖 */
    oal_uint8                            uc_himit_enable;
    oal_uint8                            auc_himit_rsv[2];
#endif
...
#endif
#ifdef _PRE_WLAN_FEATURE_MONITOR
    oal_uint32                           ul_mgmt_frames_cnt;
    oal_uint32                           ul_control_frames_cnt;
    oal_uint32                           ul_data_frames_cnt;
    oal_uint32                           ul_others_frames_cnt;
    oal_bool_enum_uint8                  en_is_addr_filter_on;
    oal_uint8                            auc_resv4[1];
    oal_uint8                            auc_monitor_mac_addr[WLAN_MAC_ADDR_LEN];   /* 需要过滤的MAC地址 */
#endif
#ifdef _PRE_WLAN_FEATURE_11AX
    hal_tx_ul_ofdma_para_stru        st_ul_ofdma_para;
#endif
#ifdef _PRE_WLAN_FEATURE_CSI
    ...
    //#ifdef _PRE_WLAN_FEATURE_11AX
#if 0
    dmac_rx_frame_statistics_stru        st_rx_frame_statistics;  /* 接受帧统计 */
    dmac_tx_frame_statistics_stru        st_tx_frame_statistics;  /* 发送帧统计 */
#endif
#ifdef _PRE_WLAN_RX_LISTEN_POWER_SAVING
    oal_void                            *pst_hal_ps_fsm;
#endif
...
#if defined(_PRE_WLAN_FEATURE_11AX) || defined(_PRE_WLAN_FEATURE_11AX_ROM)
    oal_uint8               uc_mac_tx_ul_ofdma;        /* MAC处于ul fodma流程中 */
...
typedef struct
{
    oal_uint32                       ul_vector[8];
}hal_al_tx_hw_vect_stru;
...
typedef struct
{
    ...
    hal_al_tx_hw_vect_stru           st_vector;
}hal_al_tx_hw_stru;
...
typedef struct
{
    oal_uint8 uc_tpc_index0;
    oal_uint8 uc_tpc_index1;
    oal_uint8 uc_tb_tx_chain;
    oal_uint8 uc_tb_uph;
}hal_tb_ppdu_tpc_code_stru;
...
extern oal_void  hi1103_dyn_cali_vdet_val_amend(hal_to_dmac_device_stru *pst_hal_device, wlan_channel_band_enum_uint8 en_freq,
                                                         oal_uint8 uc_rf_id, oal_int16 s_vdet_val_in, oal_int16 *ps_det_val_out, oal_int16 s_vdet_offset);
...
extern oal_uint8 hi1103_set_mac_phy_freq(hal_to_dmac_device_stru *pst_hal_device, wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_bool_enum_uint8 hi1103_device_dpd_is_on(hal_to_dmac_device_stru *pst_hal_device, wlan_channel_band_enum_uint8 en_band);
#endif
...
extern oal_void hi1103_get_ftm_rtp_reg(hal_to_dmac_device_stru *pst_hal_device,
                                              ...
                                              oal_uint32 *pul_reg3,
                                              oal_uint32 *pul_reg4);
extern oal_void hi1103_ftm_get_divider(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_divider);
#ifdef _PRE_WLAN_FTM_PPU_SUPPORT
extern oal_void hi1103_set_ftm_flag(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru * pst_tx_dscr, oal_bool_enum_uint8 en_ftm_flag);
...
#ifdef _PRE_WLAN_FEATURE_FULL_QUAN_PROD_CAL
extern oal_void hi1103_set_pdet_info_report_param(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 en_report_flag, oal_uint8 uc_full_data_coll_idx);
extern oal_void hi1103_pow_refresh_full_cali_pro_line_data(hal_to_dmac_device_stru *pst_hal_device, hal_pdet_info_stru * OAL_CONST pst_pdet_info);
#endif
#ifdef _PRE_WLAN_FEATURE_MLD_AGC_BUGFIX
...
#endif
extern oal_void  hi1103_set_ru_test(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint16 us_aid, oal_uint16 us_rudir, oal_uint32 *pul_ret);
...
extern oal_void  hi1105_dyn_cali_vdet_val_amend(hal_to_dmac_device_stru *pst_hal_device, wlan_channel_band_enum_uint8 en_freq,
                                                         oal_uint8 uc_rf_id, oal_int32 l_vdet_val_in, oal_int16 *ps_det_val_out, oal_int16 s_vdet_offset);
...
extern oal_void hi1105_set_himit_info_report_reg(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_reg_val);
extern oal_void hi1105_set_peer_sta_himit_en(hal_to_dmac_device_stru * pst_hal_device, oal_uint8 uc_himit_enable, oal_uint16 us_lut_idx);
extern oal_void hi1105_set_himit_dscr(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru * pst_tx_dscr, hal_tx_ppdu_feature_stru *pst_ppdu_feature);
...
extern oal_void hi1105_get_tb_basic_trigger_txtime(hal_to_dmac_device_stru *pst_hal_device, hal_tx_ul_ofdma_para_stru *pst_tb_para);
extern oal_void hi1105_get_tb_ppdu_pwr_para(hal_to_dmac_device_stru *pst_device, hal_tb_ppdu_tpc_code_stru *pst_tb_tpc_ctrl);
...
#endif
#ifdef _PRE_WLAN_FEATURE_CSI
extern oal_void hi1105_set_csi_buf_base_addr(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_ftm_info_addr);
extern oal_void hi1105_set_csi_buf_size(hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_cfg_csi_buf_size);
extern oal_void hi1105_set_csi_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1105_set_phy_info_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1105_set_csi_bw(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1105_set_csi_frame_type(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1105_set_csi_sample_period(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1105_set_csi_phy_report_mode(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_reg_value);
...
extern oal_void hi1105_set_primary_channel(
                    ...
                    oal_uint8                         uc_channel_idx,
                    wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1105_set_mac_phy_freq(hal_to_dmac_device_stru *pst_hal_device, wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_void hi1105_aux_adc_init(oal_void);
...
extern oal_bool_enum_uint8 hi1105_device_dpd_is_on(hal_to_dmac_device_stru *pst_hal_device, wlan_channel_band_enum_uint8 en_band);
#endif
...
#endif
#ifdef _PRE_WLAN_FEATURE_MONITOR
extern oal_void hi1105_sniffer_mode_init(hal_to_dmac_device_stru *pst_hal_device);
...
#ifdef _PRE_WLAN_FEATURE_P2P_2_NOA
extern oal_void  hi1105_swap_noa(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 en_src_noa_type, oal_uint8 uc_is_trigger_enabled);
...
#endif
#endif
extern oal_void hi1105_al_tx_set_vect(hal_to_dmac_device_stru *pst_hal_device, hal_al_tx_hw_stru *pst_al_tx_hw);
...
extern oal_void hi1105_set_ftm_flag(hal_to_dmac_device_stru *pst_hal_device, hal_tx_dscr_stru * pst_tx_dscr, oal_bool_enum_uint8 en_ftm_flag);
...
extern oal_void hi1105_get_ftm_rtp_reg(hal_to_dmac_device_stru *pst_hal_device,
                                              ...
                                              oal_uint32 *pul_reg3,
                                              oal_uint32 *pul_reg4);
extern oal_void hi1105_ftm_get_divider(hal_to_dmac_device_stru *pst_hal_device,
                                       oal_uint32 *pul_divider);
#ifdef _PRE_WLAN_FTM_PPU_SUPPORT
extern oal_void dmac_ftm_get_ppu(hal_to_dmac_device_stru *pst_hal_device, hi1105_ftm_ppu_stru *pst_ftm_ppu);
extern oal_void dmac_csi_get_ppu(hal_to_dmac_device_stru *pst_hal_device, hi1105_csi_ppu_stru *pst_csi_ppu);
...
extern oal_void hi1105_device_set_power_gating(hal_to_dmac_device_stru *pst_hal_device, hal_mac_auto_pg_enum_uint8 en_state);
...
extern oal_uint32 hi1105_comb_pow_code(oal_bool_enum_uint8 en_dpd_enable, oal_uint8 uc_upc_idx, oal_uint8 uc_pa_idx,
                                        oal_uint8 uc_dac_idx, oal_uint8 uc_lpf_idx,oal_uint16 us_delta_dbb_scaling,
                                        oal_uint8 uc_dpd_tpc_lv, oal_uint8 uc_cfr_index);
extern oal_void hi1105_update_mimo_upc_amend(hal_to_dmac_device_stru *pst_hal_device);
...
extern oal_uint8 hi1105_get_phy_gi_type_beacon(wlan_gi_type_enum_uint8 en_wlan_gi_type);
...
#ifdef _PRE_WLAN_FEATURE_FULL_QUAN_PROD_CAL
extern oal_void hi1105_set_pdet_info_report_param(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 en_report_flag, oal_uint8 uc_full_data_coll_idx);
extern oal_void hi1105_pow_refresh_full_cali_pro_line_data(hal_to_dmac_device_stru *pst_hal_device, hal_pdet_info_stru * OAL_CONST pst_pdet_info);
#endif
extern oal_void  hi1105_set_ru_test(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint16 us_aid, oal_uint16 us_rudir, oal_uint32 *pul_ret);
