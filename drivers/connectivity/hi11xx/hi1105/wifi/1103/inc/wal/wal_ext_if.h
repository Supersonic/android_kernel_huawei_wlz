...
extern oal_uint8         custom_cali_done_etc; /* 标识是否是上电第一次校准 */
...
extern oal_int32  wal_recv_memory_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len);
extern oal_int32  wal_recv_global_var_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len);
extern oal_int32  wal_recv_reg_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len);
extern oal_int32  wal_recv_config_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len);

extern oal_uint32  wal_hipriv_get_mac_addr_etc(oal_int8 *pc_param,
                                            oal_uint8 auc_mac_addr[],
                                            oal_uint32 *pul_total_offset);

#ifdef _PRE_WLAN_FEATURE_ARP_OFFLOAD
extern oal_uint32 wal_hipriv_register_inetaddr_notifier_etc(oal_void);
extern oal_uint32 wal_hipriv_unregister_inetaddr_notifier_etc(oal_void);
extern oal_uint32 wal_hipriv_register_inet6addr_notifier_etc(oal_void);
extern oal_uint32 wal_hipriv_unregister_inet6addr_notifier_etc(oal_void);
#endif
