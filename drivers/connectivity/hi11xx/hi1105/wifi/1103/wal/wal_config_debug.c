...
extern oal_bool_enum_uint8 en_report_product_log_flag;  // ont log的开关
#endif
...
OAL_STATIC oal_uint32 wal_config_waveapp_32plus_user_enable(mac_vap_stru *pst_mac_vap,
                                                            oal_uint16 us_len, oal_uint8 *puc_param)
{
...
OAL_STATIC oal_uint32 wal_config_show_profiling(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if ((uc_show_profiling_type == OAM_PROFILING_RX)) {
        oam_profiling_rx_show_offset(uc_show_level);
    } else if (uc_show_profiling_type == OAM_PROFILING_TX) {
        oam_profiling_tx_show_offset(uc_show_level);
    } else if (uc_show_profiling_type == OAM_PROFILING_ALG) {
        oam_profiling_alg_show_offset();
    } else if (uc_show_profiling_type == OAM_PROFILING_CHIPSTART) {
        oam_profiling_starttime_show_offset();
    } else if (uc_show_profiling_type == OAM_PROFILING_CHSWTICH) {
...
OAL_STATIC oal_uint32 wal_config_profiling_packet_add(mac_vap_stru *pst_mac_vap,
                                                      oal_uint16 us_len, oal_uint8 *puc_param)
{
#ifdef _PRE_PROFILING_MODE
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                         "{wal_config_set_feature_log::hmac_config_send_event_etc failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_config_set_rfch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_config_set_rfch::hmac_config_set_rfch_etc error!}\r\n");
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_config_narrow_bw(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                         "{wal_config_narrow_bw::hmac_config_send_event_etc failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32 wal_config_dync_txpower(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_config_dync_txpower::hmac_config_dync_txpower failed!}\r\n");
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_config_dync_pow_debug_switch(mac_vap_stru *pst_mac_vap,
                                                       oal_uint16 us_len, oal_uint8 *puc_param)
{
    oal_uint32 ul_ret;
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_config_dync_pow_debug_switch::hmac_config_dync_txpower failed!}\r\n");
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_config_get_thruput(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_config_get_thruput::hmac_config_get_thruput failed!}\r\n");
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_config_adjust_ppm(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_config_adjust_ppm::hmac_config_set_freq_skew failed!}\r\n");
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_config_radar_set(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_radar_set(pst_mac_vap, us_len, puc_param);
}
#endif

OAL_STATIC oal_uint32 wal_config_ru_set(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
oal_uint32 wal_config_dump_reg(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (pst_hal_dmac_dev == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                         "{wal_config_dump_reg::vap id [%d],DMAC_VAP_GET_HAL_DEVICE null}",
...
OAL_STATIC oal_uint32 wal_config_m2u_snoop_on(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_config_m2u_snoop_on:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
    ...
    /* uc_m2u_snoop_on */
    if (pst_m2u_snoop_on_param->uc_m2u_snoop_on == 1 || pst_m2u_snoop_on_param->uc_m2u_snoop_on == 0) {
    ...
    /* uc_m2u_mcast_mode */
    if (pst_m2u_snoop_on_param->uc_m2u_mcast_mode == 1 ||
        pst_m2u_snoop_on_param->uc_m2u_mcast_mode == 0 ||
        pst_m2u_snoop_on_param->uc_m2u_mcast_mode == 2) {
...
OAL_STATIC oal_uint32 wal_add_m2u_deny_table(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_add_m2u_deny_table:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /* 判断输入ipv4地址是否是组播地址 */
    if ((pst_m2u_deny_table_param->ip_type == OAL_FALSE) &&
        (ul_deny_group_addr1 >= HMAC_M2U_MIN_DENY_GROUP) &&
        (ul_deny_group_addr1 <= HMAC_M2U_MAX_DENY_GROUP)) {
        hmac_m2u_add_snoop_ipv4_deny_entry(pst_hmac_vap, &ul_deny_group_addr1);
    }
    /* 判断输入ipv6地址是否是组播地址 */
    else if ((pst_m2u_deny_table_param->ip_type == OAL_TRUE) &&
             (OAL_IPV6_IS_MULTICAST(pst_m2u_deny_table_param->ul_deny_group_ipv6_addr))) {
...
OAL_STATIC oal_uint32 wal_config_m2u_deny_table(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_config_m2u_deny_table:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC oal_uint32 wal_show_m2u_snoop_table(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_show_m2u_snoop_table:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC oal_uint32 wal_show_m2u_snoop_deny_table(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_show_m2u_snoop_deny_table:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_show_m2u_snoop_deny_table_param->uc_m2u_show_snoop_deny_table == 1) {
        hmac_m2u_show_snoop_deny_table(pst_hmac_vap);
    } else {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_M2U,
                       "{wal_show_m2u_snoop_deny_table::pst_m2u_snoop_on_param->uc_m2u_snoop_on %d!}\r\n",
...
OAL_STATIC oal_uint32 wal_config_m2u_tid_set(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_config_m2u_tid_set:: pst_mac_vap/puc_param is null ptr %p, %p!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
/*
 * 函 数 名  : wal_config_m2u_frequency_on
 * 功能描述  : 打开异频组播转发开关
 */
OAL_STATIC oal_uint32 wal_config_m2u_frequency_on(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_config_m2u_frequency_on:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    pst_m2u_frequency_on_param = (mac_cfg_m2u_frequency_on_param_stru *)puc_param;
    /* uc_m2u_snoop_on */
    if (pst_m2u_frequency_on_param->uc_m2u_frequency_on == 1 ||
        pst_m2u_frequency_on_param->uc_m2u_frequency_on == 0) {
        pst_m2u->en_frequency_enable = pst_m2u_frequency_on_param->uc_m2u_frequency_on;
    } else {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_M2U,
                       "{wal_config_m2u_frequency_on::pst_m2u_frequency_on_param->uc_m2u_frequency_on %d!}\r\n",
...
/*
 * 函 数 名  : wal_config_m2u_adaptive_on
 * 功能描述  : 配网模式参数设置
 */
OAL_STATIC oal_uint32 wal_config_m2u_adaptive_on(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_M2U,
                       "{wal_config_m2u_adaptive_on:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /* uc_m2u_adaptive_on */
    if (pst_m2u_adaptive_on_param->uc_m2u_adaptive_on == 0) {
        pst_m2u->en_adaptive_enable = pst_m2u_adaptive_on_param->uc_m2u_adaptive_on;
        return OAL_SUCC;
    } else if (pst_m2u_adaptive_on_param->uc_m2u_adaptive_on == 1 && pst_m2u_adaptive_on_param->ul_threshold_time > 0 &&
        ...
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_M2U,
                       "{wal_config_m2u_adaptive_on::pst_m2u_adaptive_on_param->uc_m2u_adaptive_on %d!}\r\n",
...
/*
 * 函 数 名  : wal_config_qos_enhance_on
 * 功能描述  : 打开qos enhance开关
 */
OAL_STATIC oal_uint32 wal_config_qos_enhance_on(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_QOS,
                       "{wal_config_qos_enhance_on:: pst_mac_vap/puc_param is null ptr %x, %x!}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    pst_qos_enhance_on_param = (mac_cfg_qos_enhance_on_param_stru *)puc_param;
    /* uc_qos_enhance_on */
    if (pst_qos_enhance_on_param->uc_qos_enhance_on == 1 ||
        pst_qos_enhance_on_param->uc_qos_enhance_on == 0) {
        pst_qos_enhance->en_qos_enhance_enable = pst_qos_enhance_on_param->uc_qos_enhance_on;
    } else {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_QOS,
                       "{wal_config_qos_enhance_on::pst_qos_enhance->en_qos_enhance_enable %d!}\r\n",
...
OAL_STATIC oal_uint32 wal_config_wifi_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR2(pst_mac_vap, puc_param))) {
        OAM_ERROR_LOG2(0, OAM_SF_ANY,
                       "{wal_config_wifi_enable::pst_mac_vap or puc_param null ptr error [%x],[%x].}\r\n",
                       (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_config_wifi_enable:: return error code [%d].}\r\n", ul_ret);
        return ul_ret;
    }
                                                            ...
                                                            oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_set_performance_log_switch(pst_mac_vap,
                                                  WLAN_CFGID_SET_PERFORMANCE_LOG_SWITCH,
                                                  us_len, puc_param);
}
#endif
#endif
...
OAL_STATIC oal_uint32 wal_config_get_frw_max_event(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    *((oal_uint32 *)puc_param) = (mac_process_event == 0) ? FRW_PROCESS_MAX_EVENT : mac_process_event;
    return OAL_SUCC;
}
...
OAL_STATIC oal_uint32 wal_config_packet_capture_switch(mac_vap_stru *pst_mac_vap,
                                                       oal_uint16 us_len, oal_uint8 *puc_param)
{
...
OAL_STATIC oal_uint32 wal_config_set_dbdc_debug_switch(mac_vap_stru *pst_mac_vap,
                                                       oal_uint16 us_len, oal_uint8 *puc_param)
{
...
OAL_STATIC oal_uint32 wal_config_set_str_cmd(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_set_str_cmd(pst_mac_vap, us_len, puc_param);
}


OAL_STATIC oal_uint32 wal_config_set_owe(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_set_owe_etc(pst_mac_vap, us_len, puc_param);
}

#ifdef _PRE_WLAN_FEATURE_TWT

OAL_STATIC oal_uint32 wal_config_twt_setup_req(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_twt_setup_req_etc(pst_mac_vap, us_len, puc_param);
}


OAL_STATIC oal_uint32 wal_config_twt_teardown_req(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_twt_teardown_req_etc(pst_mac_vap, us_len, puc_param);
}
#endif
...
OAL_CONST wal_wid_op_stru g_ast_board_wid_op_debug_etc[] = {
    ...
    { WLAN_CFGID_SET_ADDBA_RSP_EXTEND, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_set_tlv_cmd },
#endif
#ifdef _PRE_WLAN_FEATURE_DFS_ENABLE
    ...
    { WLAN_CFGID_ALTX_HW,              OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_set_str_cmd },
...
#ifdef _PRE_WLAN_FEATURE_TWT
    { WLAN_CFGID_TWT_SETUP_REQ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_twt_setup_req },
    { WLAN_CFGID_TWT_TEARDOWN_REQ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_twt_teardown_req },
#endif
