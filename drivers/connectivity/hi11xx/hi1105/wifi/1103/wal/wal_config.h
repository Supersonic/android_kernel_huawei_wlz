...
#define WAL_MSG_WRITE_MAX_LEN \
    (WLAN_MEM_EVENT_SIZE2 - FRW_EVENT_HDR_LEN - FRW_IPC_MSG_HEADER_LENGTH - WAL_MSG_WRITE_MSG_HDR_LENGTH)
...
extern oal_int32 wal_config_get_snoop_table(oal_net_device_stru *pst_net_dev,
                                            oal_net_dev_ioctl_data_stru *pst_ioctl_data);
#endif
#ifdef _PRE_WLAN_FEATURE_WDS
extern oal_uint32 wal_config_get_wds_vap_info(oal_net_device_stru *pst_net_dev,
                                              oal_net_dev_ioctl_data_stru *pst_ioctl_data);
#endif
extern oal_int32 wal_recv_config_cmd_etc(oal_uint8 *puc_buf, oal_uint16 us_len);
extern oal_uint32 wal_config_get_assoc_req_ie_etc(mac_vap_stru *pst_mac_vap,
                                                  oal_uint16 *pus_len,
                                                  oal_uint8 *puc_param);
