...
/* 9 OTHERS定义 */
/* 10 函数声明 */
extern oal_int32 wal_atcmdsrv_wifi_priv_cmd_etc(oal_net_device_stru *pst_net_dev,
                                                oal_ifreq_stru *pst_ifr,
                                                oal_int32 ul_cmd);
extern oal_int32 wal_atcmsrv_ioctl_get_hw_status_etc(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
extern oal_void wal_atcmsrv_ioctl_get_fem_pa_status_etc(oal_net_device_stru *pst_net_dev,
                                                        oal_int32 *pl_fem_pa_status);
