...
typedef oal_uint32 (*pwal_get_cmd_one_arg_etc)(oal_int8 *pc_cmd, oal_int8 *pc_arg, oal_uint32 ul_arg_len, oal_uint32 *pul_cmd_offset);
...
#ifdef _PRE_WLAN_FEATURE_11AX_ER_SU
extern oal_uint32 wal_hipriv_set_mcsax_er(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
#endif
#endif
...
extern oal_int32 wal_send_cfg_event_etc(oal_net_device_stru *pst_net_dev,
                                        wal_msg_type_enum_uint8 en_msg_type,
                                        oal_uint16 us_len,
                                        oal_uint8 *puc_param,
                                        oal_bool_enum_uint8 en_need_rsp,
                                        wal_msg_stru **ppst_rsp_msg);
extern oal_uint32 wal_hipriv_process_rate_params(oal_net_device_stru *pst_net_dev,
                                                 oal_int8 *pc_cmd,
...
extern oal_int32 wal_init_wlan_netdev_etc(oal_wiphy_stru *pst_wiphy, const char *dev_name);
...
extern oal_uint32 wal_hipriv_set_essid_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
extern int wal_ioctl_set_essid_etc(oal_net_device_stru *pst_net_dev, oal_iw_request_info_stru *pst_info,
                                   oal_iwreq_data_union *pst_wrqu, char *pc_extra);
#endif
extern oal_uint32 wal_get_cmd_one_arg_etc(oal_int8 *pc_cmd, oal_int8 *pc_arg,
                                          oal_uint32 ul_arg_len, oal_uint32 *pul_cmd_offset);
...
extern oal_int32 wal_set_assigned_filter_enable_etc(oal_int32 l_filter_id, oal_int32 l_on);
...
extern oal_uint32 wal_ioctl_set_ap_mode(oal_net_device_stru *pst_net_dev, oal_uint8 uc_param);
extern oal_uint32 wal_vendor_cmd_gather_handler(oal_net_device_stru *pst_net_dev, oal_int8 *pc_command);
extern oal_uint8 wal_vendor_cmd_gather(oal_int8 *pc_command);
