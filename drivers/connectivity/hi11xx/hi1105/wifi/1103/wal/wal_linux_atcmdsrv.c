...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_txpower(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_freq(oal_net_device_stru *pst_net_dev,
                                                wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_mode(oal_net_device_stru *pst_net_dev,
                                                wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_datarate(oal_net_device_stru *pst_net_dev,
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_bandwidth(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_always_tx(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_dbb_num(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
oal_int32 wal_atcmsrv_ioctl_get_hw_status_etc(oal_net_device_stru *pst_net_dev,
                                              wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_always_rx(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_hw_addr_etc(oal_net_device_stru *pst_net_dev,
                                                       wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_rx_pckg_etc(oal_net_device_stru *pst_net_dev,
                                                       wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_pm_switch(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_rx_rssi(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_chipcheck_result(oal_net_device_stru *pst_net_dev,
                                                            wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_chipcheck_time(oal_net_device_stru *pst_net_dev,
                                                          wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_uart_loop(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_wifi_chan_loop(oal_net_device_stru *pst_net_dev,
                                                          wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_efuse_check(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_dieid_inform(oal_net_device_stru *pst_net_dev,
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_country(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_wipin_test(oal_net_device_stru *pst_net_dev,
                                                  wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_mimo_ch(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_dp_init(oal_net_device_stru *pst_net_dev,
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_pd_tran_param(oal_net_device_stru *pst_net_dev,
                                                         wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_io_test(oal_net_device_stru *pst_net_dev,
                                               wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_pcie_ip_test(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_pcie_sdio_set(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_dyn_intervel_set(oal_net_device_stru *pst_net_dev,
                                                         wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_pt_set(oal_net_device_stru *pst_net_dev,
                                               wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_tas_ant_set(oal_net_device_stru *pst_net_dev,
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_wifi_connect_info(oal_net_device_stru *pst_net_dev,
                                                             wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_set_ru_test(oal_net_device_stru *pst_net_dev,
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd);
...
OAL_STATIC wal_atcmd_ioctl_set_stru g_ast_wal_atcmd_table[] = {
    ...
    { WAL_ATCMDSRV_IOCTL_CMD_HW_STATUS_GET,    wal_atcmsrv_ioctl_get_hw_status_etc,    1 },
    { WAL_ATCMDSRV_IOCTL_CMD_ALWAYS_RX_SET,    wal_atcmsrv_ioctl_set_always_rx,        0 },
    { WAL_ATCMDSRV_IOCTL_CMD_HW_ADDR_SET,      wal_atcmsrv_ioctl_set_hw_addr_etc,      0 },
    { WAL_ATCMDSRV_IOCTL_CMD_RX_PCKG_GET,      wal_atcmsrv_ioctl_get_rx_pckg_etc,      1 },
...
oal_int32 wal_atcmsrv_ioctl_get_rx_pckg_old_etc(oal_net_device_stru *pst_net_dev,
                                                oal_int32 *pl_rx_pckg_succ_num)
{
    ...
    ***************************************************************************/
    ...
    i_leftime = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q,
        (oal_uint32)(OAL_TRUE == pst_hmac_vap->st_atcmdsrv_get_status.uc_get_rx_pkct_flag),
        WAL_ATCMDSRB_GET_RX_PCKT);

    if (i_leftime == 0) {
        /* 超时还没有上报扫描结束 */
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_atcmsrv_ioctl_get_rx_pckg_etc::dbb_num wait for %ld ms timeout!}",
                         ((WAL_ATCMDSRB_DBB_NUM_TIME * 1000) / OAL_TIME_HZ));
        return -OAL_EINVAL;
    } else if (i_leftime < 0) {
        /* 定时器内部错误 */
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_atcmsrv_ioctl_get_rx_pckg_etc::dbb_num wait for %ld ms error!}",
                         ((WAL_ATCMDSRB_DBB_NUM_TIME * 1000) / OAL_TIME_HZ));
        return -OAL_EINVAL;
    } else {
        /* 正常结束  */
...
oal_int32 wal_atcmsrv_ioctl_get_rx_pckg_etc(oal_net_device_stru *pst_net_dev,
                                            wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_ret;
    mac_cfg_rx_fcs_info_stru *pst_rx_fcs_info = OAL_PTR_NULL;
    ...
    hmac_vap_stru *pst_hmac_vap = OAL_PTR_NULL;
    oal_int32 i_leftime;
    oal_int32 *pl_rx_pckg_succ_num = &(pst_priv_cmd->pri_data.l_rx_pkcg);
    ...
    ***************************************************************************/
    ...
    /* 阻塞等待dmac上报 */
    i_leftime = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q,
        (oal_uint32)(pst_hmac_vap->st_atcmdsrv_get_status.uc_get_rx_pkct_flag == OAL_TRUE),
        WAL_ATCMDSRB_GET_RX_PCKT);
...
oal_int32 wal_atcmsrv_ioctl_set_hw_addr_etc(oal_net_device_stru *pst_net_dev,
                                            wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_ret;
    mac_cfg_staion_id_param_stru *pst_mac_cfg_para = OAL_PTR_NULL;
    wal_msg_write_stru st_write_msg;
    oal_uint8 *pc_hw_addr = pst_priv_cmd->pri_data.auc_mac_addr;
...
{
    wal_msg_write_stru st_write_msg;
    oal_int32 l_freq = pst_priv_cmd->pri_data.l_freq;
                                                   ...
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int32 l_ret;
    oal_int8 *puc_countrycode = pst_priv_cmd->pri_data.auc_country_code;
...
{
    wal_msg_write_stru st_write_msg;
    oal_int32 l_txpower = pst_priv_cmd->pri_data.l_pow;
    oal_int32 l_ret;
                                                ...
                                                wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    mac_vap_stru *pst_mac_vap;
    oal_int32 l_mode = pst_priv_cmd->pri_data.l_mode;
    ...
    ***************************************************************************/
    ...
    } else if ((l_mode == WLAN_HE_MODE_5G) || (l_mode == WLAN_HE_MODE_2G)) {
                                                    ...
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    wal_msg_write_stru st_write_msg;
    oal_int32 l_datarate = pst_priv_cmd->pri_data.l_datarate;
    oal_int32 l_ret;
    ...
    if (g_l_mode_etc == WLAN_HT_ONLY_MODE) { /* 当速率设置为7时表示MCS7 */
        ul_ret = wal_hipriv_set_mcs_etc(pst_net_dev,
                                        (oal_int8 *)past_atcmdsrv_non_ht_rate_table[uc_prot_idx].puc_datarate);
    } else if (g_l_mode_etc == WLAN_VHT_MODE) {
        ul_ret = wal_hipriv_set_mcsac_etc(pst_net_dev,
                                          (oal_int8 *)past_atcmdsrv_non_ht_rate_table[uc_prot_idx].puc_datarate);
    } else if (g_l_mode_etc == WLAN_HE_MODE) {
        ul_ret = wal_hipriv_set_mcsax(pst_net_dev,
                                      (oal_int8 *)past_atcmdsrv_non_ht_rate_table[uc_prot_idx].puc_datarate);
    } else {
        ul_ret = wal_hipriv_set_rate_etc(pst_net_dev,
                                         (oal_int8 *)past_atcmdsrv_non_ht_rate_table[uc_prot_idx].puc_datarate);
    }
    if (ul_ret != OAL_SUCC) {
        return -OAL_EFAIL;
                                                     ...
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    wal_msg_write_stru st_write_msg;
    mac_cfg_mode_param_stru *pst_mode_param;
    oal_int32 l_bandwidth = pst_priv_cmd->pri_data.l_bandwidth;
    oal_int32 l_ret;
                                                     ...
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_uint16 us_len;
    oal_int32 l_always_tx = pst_priv_cmd->pri_data.l_awalys_tx;
    oal_uint32 *pul_num;
                                                   ...
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int32 l_ret;
    oal_int32 i_leftime;
    oal_int8 *pc_dbb_num = pst_priv_cmd->pri_data.auc_dbb;
    mac_vap_stru *pst_mac_vap;
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
                         "{wal_atcmsrv_ioctl_get_dbb_num::wal_send_cfg_event_etc return err_code [%d]!}",
                         l_ret);
        return l_ret;
    }
    /* 阻塞等待dmac上报 */
    /*lint -e730*/
    i_leftime = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q,
        (oal_uint32)(pst_hmac_vap->st_atcmdsrv_get_status.uc_get_dbb_completed_flag == OAL_TRUE),
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_lte_gpio_mode(oal_net_device_stru *pst_net_dev, oal_int32 l_check_lte_gpio_step)
{
    ...
    *(oal_int32 *)(st_write_msg.auc_value) = l_check_lte_gpio_step;
    ...
    /*lint -e730*/
    i_leftime = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q,
        (oal_uint32)(OAL_TRUE == pst_hmac_vap->st_atcmdsrv_get_status.uc_lte_gpio_check_flag),
        WAL_ATCMDSRB_DBB_NUM_TIME);
    /*lint +e730*/
    if (i_leftime == 0) {
        /* 超时还没有上报扫描结束 */
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_lte_gpio_level_check(oal_net_device_stru *pst_net_dev, oal_int32 l_gpio_level)
{
    ...
    if (l_gpio_level == 0) {
        if (g_uc_dev_lte_gpio_level_etc == 0x0) {
...
#if (_PRE_PRODUCT_ID != _PRE_PRODUCT_ID_HI1103_HOST)
    {
        ...
        if (g_uc_dev_lte_gpio_level_etc == 0x64) {
    ...
    {
        /* CHECK BIT_3 BIT_4 */
        if (g_uc_dev_lte_gpio_level_etc == 0x18) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_atcmsrv_ioctl_lte_gpio_level_check::check gpio high mode SUCC!}");
            l_ret = OAL_SUCC;
        }
    }
                                                  ...
                                                  wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int32 *pl_pin_status = &(pst_priv_cmd->pri_data.l_pin_status);

#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    OAM_WARNING_LOG1(0, OAM_SF_ANY,
                     "{wal_atcmsrv_ioctl_wipin_test::wlan_customize_etc.ul_lte_gpio_check_switch is %d",
                     wlan_customize_etc.ul_lte_gpio_check_switch);
    /* 定制化是否检测lte共存管脚 */
...
OAL_STATIC oal_int32 wal_get_hw_status_etc(oal_net_device_stru *pst_net_dev,
                                              wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_ret = 0;
    ...
    oal_int32 *pl_fem_pa_status = &(pst_priv_cmd->pri_data.l_fem_pa_status);
    ...
    if ((pst_cali_data_c0 == NULL) || (pst_cali_data_c1 == NULL)) {
        OAM_ERROR_LOG0(0, 0, "wal_get_hw_status_etc::null ptr happened");
        return -OAL_EINVAL;
    }

    *pl_fem_pa_status = (oal_int32)((pst_cali_data_c0->ul_check_hw_status) |
                                    (pst_cali_data_c1->ul_check_hw_status << 4) | (ul_lte_status << 8));
    if (*pl_fem_pa_status != 0) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_get_hw_status_etc::FEM pa[%x].Bit:[0-1]2gc0,[2-3]5gc0,[4-5]2gc1,[6-7]5gc1,[8]lte_gpio}",
            *pl_fem_pa_status);
        return -OAL_EINVAL;
    }
...
OAL_STATIC oal_int32 wal_get_1105_hw_status_etc(oal_net_device_stru *pst_net_dev,
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32                       l_ret = 0;
    oal_uint32                      ul_lte_status = 0;
    ...
    pst_cali_data_c0 = (hi1105_cali_param_stru *)get_cali_data_buf_addr_etc();
    pst_cali_data_c1 = pst_cali_data_c0 + 1;
    if ((pst_cali_data_c0 == NULL) || (pst_cali_data_c1 == NULL)) {
        OAM_ERROR_LOG0(0, 0, "wal_get_1105_hw_status_etc::null ptr happened");
        return -OAL_EINVAL;
    }
    ...
    *pl_fem_pa_status = (oal_int32)((pst_cali_data_c0->ul_check_hw_status) |
    ...
    if (*pl_fem_pa_status != 0) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_get_1105_hw_status_etc::FEM pa status[%x].Bit:[0-1]2gc0,[2-3]5gc0,[4-5]2gc1,[6-7]5gc1,[8]lte_gpio}",
            *pl_fem_pa_status);
        return -OAL_EINVAL;
    }
                                                    ...
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    if (l_chip_type == BOARD_VERSION_HI1105) {
       l_ret = wal_get_1105_hw_status_etc(pst_net_dev, pst_priv_cmd);
    } else {
       l_ret = wal_get_hw_status_etc(pst_net_dev, pst_priv_cmd);
    }
    return l_ret;
}


OAL_STATIC oal_void wal_get_fem_pa_status_etc(oal_net_device_stru *pst_net_dev, oal_int32 *pl_fem_pa_status)
{
    hi1103_cali_param_stru            *pst_cali_data_c0;
    hi1103_cali_param_stru            *pst_cali_data_c1;
    ...
    pst_cali_data_c1 = pst_cali_data_c0 + 1;
    if ((pst_cali_data_c0 == NULL) || (pst_cali_data_c1 == NULL)) {
        OAM_ERROR_LOG0(0, 0, "wal_get_fem_pa_status_etc::null ptr happened");
        return;
    }
    ...
    *pl_fem_pa_status = (oal_int32)((pst_cali_data_c0->ul_check_hw_status) |
    ...
    if (*pl_fem_pa_status != 0) {
        ...
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_get_fem_pa_status_etc::FEM pa status[%x].Bit:[0-1]2gc0,[2-3]5gc0,[4-5]2gc1,[6-7]5gc1}",
            *pl_fem_pa_status);
...
OAL_STATIC oal_void wal_get_1105_fem_pa_status_etc(oal_net_device_stru *pst_net_dev, oal_int32 *pl_fem_pa_status)
{
    hi1105_cali_param_stru            *pst_cali_data_c0;
    hi1105_cali_param_stru            *pst_cali_data_c1;
    ...
    pst_cali_data_c1 = pst_cali_data_c0 + 1;
    if ((pst_cali_data_c0 == NULL) || (pst_cali_data_c1 == NULL)) {
        OAM_ERROR_LOG0(0, 0, "wal_get_1105_fem_pa_status_etc::null ptr happened");
        return;
    }
    ...
    *pl_fem_pa_status = (oal_int32)((pst_cali_data_c0->ul_check_hw_status) |
    ...
    if (*pl_fem_pa_status != 0) {
        CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DEV,
                             CHR_WIFI_DEV_EVENT_CHIP, CHR_WIFI_DEV_ERROR_FEM_FAIL);
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_get_1105_fem_pa_status_etc::FEM pa status[%x].Bit:[0-1]2gc0,[2-3]5gc0,[4-5]2gc1,[6-7]5gc1}",
            *pl_fem_pa_status);
#ifdef CONFIG_HUAWEI_DSM
        hw_1103_dsm_client_notify(SYSTEM_TYPE_WIFI, DSM_WIFI_FEMERROR, "%s: fem error",  __FUNCTION__);
#endif
...
oal_void wal_atcmsrv_ioctl_get_fem_pa_status_etc(oal_net_device_stru *pst_net_dev, oal_int32 *pl_fem_pa_status)
{
    ...
    if (l_chip_type == BOARD_VERSION_HI1105) {
       wal_get_1105_fem_pa_status_etc(pst_net_dev, pl_fem_pa_status);
    } else {
       wal_get_fem_pa_status_etc(pst_net_dev, pl_fem_pa_status);
    }
}
                                                     ...
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_uint8 auc_param[] = { "all" };
    oal_uint16 us_len;
    oal_int32 l_always_rx = pst_priv_cmd->pri_data.l_awalys_rx;
                                                     ...
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int32 l_pm_switch = pst_priv_cmd->pri_data.l_pm_switch;
                                                   ...
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    hmac_vap_stru *pst_hmac_vap;
    oal_int32 i_leftime;
    oal_int32 *pl_rx_rssi = &(pst_priv_cmd->pri_data.l_rx_rssi);
    ...
    ***************************************************************************/
    ...
    if (i_leftime == 0) {
        ...
        *pl_rx_rssi = (oal_int)pst_hmac_vap->st_atcmdsrv_get_status.s_rx_rssi;
        /*lint -e571*/
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{wal_atcmsrv_ioctl_get_rx_rssi::get rssi [%d]!}",
                         *pl_rx_rssi);
        /*lint -e571*/
        return OAL_SUCC;
    }
...
{
    oal_int32 ul_ret;
    oal_int32 l_runing_test_mode = pst_priv_cmd->pri_data.l_runingtest_mode;
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_chipcheck_result(oal_net_device_stru *pst_net_dev,
                                                            wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 *l_chipcheck_result = &(pst_priv_cmd->pri_data.l_chipcheck_result);
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_get_chipcheck_time(oal_net_device_stru *pst_net_dev,
                                                          wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_uint64 *ull_chipcheck_time = &(pst_priv_cmd->pri_data.ull_chipcheck_time);
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_uart_loop(oal_net_device_stru *pst_net_dev,
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 *l_uart_loop_set = &(pst_priv_cmd->pri_data.l_uart_loop_set);
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_wifi_chan_loop(oal_net_device_stru *pst_net_dev,
                                                          wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 *l_wifi_chan_loop_set = &(pst_priv_cmd->pri_data.l_wifi_chan_loop_set);
...
OAL_STATIC oal_int32 wal_atcmdsrv_efuse_regs_read(oal_net_device_stru *pst_net_dev)
{
    ...
    ***************************************************************************/
    ...
    /* 阻塞等待dmac上报 */
    i_leftime = OAL_WAIT_EVENT_INTERRUPTIBLE_TIMEOUT(pst_hmac_vap->query_wait_q,
        (oal_uint32)(pst_hmac_vap->st_atcmdsrv_get_status.uc_report_efuse_reg_flag == OAL_TRUE),
        WAL_ATCMDSRB_DBB_NUM_TIME);
...
OAL_STATIC void wal_atcmdsrv_efuse_info_print(void)
{
    ...
    for (loop = 0; loop < WAL_ATCMDSRV_EFUSE_BUFF_LEN; loop++) {
        OAM_WARNING_LOG3(0, 0,
                         ...
                         high_bit, low_bit, g_us_efuse_buffer_etc[loop]);
...
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_efuse_bits_check(void)
{
    ...
    *******************************************/
    if (l_chip_type == BOARD_VERSION_HI1105) {
        if (st_efuse_bits_etc->efuse_rd_10_11.chip_id != WAL_ATCMDSRV_EFUSE_CHIP_ID_1105) {
            OAM_ERROR_LOG1(0, 0,
        ...
        if (st_efuse_bits_etc->efuse_rd_10_11.chip_id != WAL_ATCMDSRV_EFUSE_CHIP_ID_1103) {
            OAM_ERROR_LOG1(0, 0,
                                                    ...
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_uint16 *pl_die_id = pst_priv_cmd->pri_data.die_id;
...
{
    oal_int32 l_ret;
    oal_int32 *pl_efuse_check_result = &(pst_priv_cmd->pri_data.l_efuse_check_result);
                                                   ...
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int32 l_mimo_channel = pst_priv_cmd->pri_data.l_mimo_channel;
                                                   ...
                                                   wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_ret = OAL_SUCC;
    oal_uint8 uc_i;
    oal_int8 *c_dp_init = pst_priv_cmd->pri_data.ac_dp_init;
    ...
    if (c_dp_init[0] == OAL_TRUE) {
        ...
        if (get_cali_data_buf_addr_etc() == NULL) {
...
{
    oal_int32 l_ret = OAL_SUCC;
    oal_int8 *c_pd_param = pst_priv_cmd->pri_data.ac_pd_tran_param;
...
{
    oal_int32 l_ret;
    oal_int16 *s_wkup_io_status = &(pst_priv_cmd->pri_data.s_wkup_io_status);
                                                     ...
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int16 *s_pcie_status = &(pst_priv_cmd->pri_data.s_pcie_status);
                                                         ...
                                                         wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int8 c_i = 0;
    oal_int8 *c_dyn_intv = pst_priv_cmd->pri_data.c_dyn_interval;
...
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_selfcali_intervel_set(oal_net_device_stru *pst_net_dev,
                                                              wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_selfcali_en = pst_priv_cmd->pri_data.l_selfcali_interval_set;
    /* selcali_en: 1 for sel_cali every time, 0 for never sel_cal */
    if (!l_selfcali_en) {
        wlan_cal_disable_switch = OAL_TRUE;
    }
    if (l_selfcali_en) {
        wlan_cal_intvl_enable = OAL_FALSE; /* 使能每次上下电自校准 */
...
{
    wal_msg_write_stru st_write_msg;
    st_wal_atcmdsrv_wifi_rumode_info *pst_ru_param;
    oal_int32 l_ret;
...
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_pt_set(oal_net_device_stru *pst_net_dev,
                                               wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_pt_set = pst_priv_cmd->pri_data.l_pt_set;
...
OAL_STATIC oal_int32 wal_atcmdsrv_ioctl_tas_ant_set(oal_net_device_stru *pst_net_dev,
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_int32 l_tas_ant_set = pst_priv_cmd->pri_data.l_tas_ant_set;
...
OAL_STATIC oal_int32 wal_atcmsrv_ioctl_set_bss_expire_age(oal_net_device_stru *pst_net_dev,
                                                          wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    oal_uint32 ul_expire_age = pst_priv_cmd->pri_data.ul_bss_expire_age;
    g_pd_bss_expire_time_etc = (ul_expire_age < WAL_ATCMSRV_MIN_BSS_EXPIRATION_AGE) ?
        WAL_ATCMSRV_MIN_BSS_EXPIRATION_AGE : ul_expire_age;
    g_pd_bss_expire_time_etc = (g_pd_bss_expire_time_etc > WAL_ATCMSRV_MAX_BSS_EXPIRATION_AGE) ?
        WAL_ATCMSRV_MAX_BSS_EXPIRATION_AGE : g_pd_bss_expire_time_etc;
                                                     ...
                                                     wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    oal_int16 s_pcie_sdio_set = pst_priv_cmd->pri_data.s_pcie_sdio_set;

    if (s_pcie_sdio_set == 1) {
        ret = conn_test_hcc_chann_switch(input_1);
        if (ret != OAL_SUCC) {
            return -OAL_EINVAL;
        }
    } else if (s_pcie_sdio_set == 2) {
...
oal_int32 wal_atcmdsrv_wifi_priv_cmd_etc(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr, oal_int32 ul_cmd)
{
    ...
    oal_int32 l_ret = OAL_SUCC;
    oal_uint32 ul_arrSize = OAL_ARRAY_SIZE(g_ast_wal_atcmd_table);
    oal_uint8 uc_i;
    ...
    if (uc_i >= ul_arrSize) {
        OAM_ERROR_LOG1(0, 0, "wal_atcmdsrv_wifi_priv_cmd_etc::err cmd[%d]", st_priv_cmd.ul_cmd);
        return -OAL_EINVAL;
    }
