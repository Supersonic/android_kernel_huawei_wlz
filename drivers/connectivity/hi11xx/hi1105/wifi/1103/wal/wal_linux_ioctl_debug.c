...
ITCM_EXT_T OAL_STATIC oal_uint32 wal_hipriv_print_phy_debug_help_info(oal_int8 *pc_param, oal_uint8 uc_para_len)
{
...
OAL_STATIC OAL_INLINE oal_void ftm_debug_cmd_format_info(void)
{
    ...
    OAM_WARNING_LOG0(0, OAM_SF_FTM,
                     "{CMD format::hipriv.sh wlan0 ftm_debug \
                      send_initial_ftm_request channel[] ftms_per_burst[n] burst_num[n] en_lci_civic_request[0|1] asap[0|1] bssid[xx:xx:xx:xx:xx:xx] format_bw[9~13]\
...
OAL_STATIC oal_uint32 ftm_debug_parase_ftm_set_white_list(oal_int8 *pc_param, mac_ftm_debug_switch_stru *pst_debug_info, oal_uint32 *pul_offset)
{
    ...
    *pul_offset += ul_off_set;
    ...
    pc_param += ul_off_set;
    ul_off_set = 0;
    OAM_WARNING_LOG1(0, OAM_SF_FTM, "{ftm_debug_parase_ftm_set_white_list::index=[%d].}", pst_debug_info->st_set_white_list_bit17.uc_index);
    ...
    if (ul_ret != OAL_SUCC) {
       ...
       *pul_offset += ul_off_set;
       l_ret = memset_s(pst_debug_info->st_set_white_list_bit17.auc_mac, OAL_SIZEOF(pst_debug_info->st_set_white_list_bit17.auc_mac),
...
OAL_STATIC oal_uint32 ftm_debug_parase_nbr_rpt_req_cmd(oal_int8 *pc_param, mac_ftm_debug_switch_stru *pst_debug_info, oal_uint32 *pul_offset)
{
    ...
    *pul_offset = 0;
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_value, WAL_HIPRIV_CMD_VALUE_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG0(0, OAM_SF_FTM,"{ftm_debug_parase_nbr_rpt_req_cmd::No bssid,set the associated bssid.}");
        *pul_offset += ul_off_set;
        memset_s(pst_debug_info->st_nbr_rpt_req_bit15.auc_bssid, OAL_SIZEOF(pst_debug_info->st_nbr_rpt_req_bit15.auc_bssid), 0, OAL_SIZEOF(pst_debug_info->st_nbr_rpt_req_bit15.auc_bssid));
        pc_param += ul_off_set;
        ul_off_set = 0;
    ...
    *pul_offset += ul_off_set;
    oal_strtoaddr(ac_value, OAL_SIZEOF(ac_value), pst_debug_info->st_nbr_rpt_req_bit15.auc_bssid, WLAN_MAC_ADDR_LEN);
    pc_param += ul_off_set;
    ul_off_set = 0;
...
OAL_STATIC oal_uint32 ftm_debug_parase_gas_init_req_cmd(oal_int8 *pc_param, mac_ftm_debug_switch_stru *pst_debug_info, oal_uint32 *pul_offset)
{
    ...
    *pul_offset = 0;
    ...
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_value, WAL_HIPRIV_CMD_VALUE_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG0(0, OAM_SF_FTM,"{ftm_debug_parase_gas_init_req_cmd::get lci_enable error, use default value [true].}");
        ac_value[0] = OAL_TRUE;
    }
    *pul_offset += ul_off_set;
    ...
    if (ul_ret != OAL_SUCC) {
        ...
        *pul_offset += ul_off_set;
        memset_s(pst_debug_info->st_gas_init_req_bit16.auc_bssid, OAL_SIZEOF(pst_debug_info->st_gas_init_req_bit16.auc_bssid), 0, OAL_SIZEOF(pst_debug_info->st_gas_init_req_bit16.auc_bssid));
        pc_param += ul_off_set;
        ul_off_set = 0;
    ...
    *pul_offset += ul_off_set;
    oal_strtoaddr(ac_value, OAL_SIZEOF(ac_value), pst_debug_info->st_gas_init_req_bit16.auc_bssid, WLAN_MAC_ADDR_LEN);
    pc_param += ul_off_set;
    ul_off_set = 0;
    ...
    *pul_offset += ul_off_set;
    ...
    switch (g_ast_ftm_common_cmd[uc_cmd_index].ul_bit) {
        ...
        case BIT12:
            ...
            break;
        case BIT14:
            pst_ftm_debug->uc_tsf_fix_bit14 = ((oal_uint8)oal_atoi(ac_value));
            pst_ftm_debug->ul_cmd_bit_map |= BIT14;
            break;
        default:
...
OAL_STATIC oal_uint32 wal_hipriv_ftm(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    do {
        ...
        if (wal_hipriv_ftm_is_common_cmd(ac_name, &uc_cmd_index)) {
            ...
            ul_ret = ftm_debug_parase_nbr_rpt_req_cmd(pc_param,&st_ftm_debug,&ul_off_set);
            if (OAL_SUCC != ul_ret) {
                ftm_debug_cmd_format_info();
                return ul_ret;
            }
...
OAL_STATIC oal_uint32  wal_hipriv_set_csi(oal_net_device_stru *pst_cfg_net_dev, oal_int8 *pc_param)
{
    ...
    */
    ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
    if (ul_ret != OAL_SUCC) {
         OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_csi::wal_get_cmd_one_arg_etc get mac addr return err_code [%d]!}\r\n", ul_ret);
         return ul_ret;
    }
    oal_strtoaddr(ac_name, OAL_SIZEOF(ac_name), auc_mac_addr, WLAN_MAC_ADDR_LEN);
...
/*
 * 函 数 名  : wal_hipriv_qos_enhance_on
 * 功能描述  : 开启或关闭qos enhance功能
 */
...
OAL_STATIC oal_uint32 wal_hipriv_roam_homenetwork_thr(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    oal_uint32 ul_off_set;
    oal_int8 ac_name[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    oal_int8 c_trigger_rssi;       /* 家庭网络优选触发rssi */
    oal_int8 c_5g_rssi_th;         /* 家庭网络5g漫游门限 */
    oal_int8 c_5g_hold_th;         /* 家庭网络5g保持漫游门限 */
...
OAL_STATIC oal_uint32 wal_hipriv_send_radio_meas_req(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    /*
     * vap0 send_radio_meas_req [action_type] [对端mac地址] [meas type]
     * [meas duration][chn_num] [BCN meas_type] [BCN mac addr]
     */
    ...
    ***************************************************************************/
    ...
    memset_s(pst_radio_meas_cfg, OAL_SIZEOF(mac_cfg_radio_meas_info_stru),
             0, OAL_SIZEOF(mac_cfg_radio_meas_info_stru));
    ...
    if (pst_radio_meas_cfg->uc_action_type == MAC_RM_ACTION_RADIO_MEASUREMENT_REQUEST) {
        ...
        if (pst_radio_meas_cfg->uc_means_type == RM_RADIO_MEAS_BCN) {
            /* means_mode for bcn */
            pc_param = pc_param + ul_off_set;
            ul_ret = wal_get_cmd_one_arg_etc(pc_param, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &ul_off_set);
            if (ul_ret != OAL_SUCC) {
...
OAL_CONST wal_hipriv_cmd_entry_stru g_ast_hipriv_cmd_debug_etc[] = {
    ...
    /* -------------------------- enable_ftm_initiator [0|1]*/
    /* -------------------------- send_iftmr channel[] burst[0|1] ftms_per_burst[n] en_lci_civic_request[0|1] asap[0|1] bssid[xx:xx:xx:xx:xx:xx]*/
    /* -------------------------- enable [0|1]*/
    /* -------------------------- cali [0|1]*/
    /* -------------------------- send_ftm bssid[xx:xx:xx:xx:xx:xx]*/
    /* -------------------------- set_ftm_time t1[] t2[] t3[] t4[]*/
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 44))
    { "essid",   wal_hipriv_set_essid_etc },        /* 设置AP ssid */
...
#endif
#ifdef _PRE_WLAN_FEATURE_ROAM
    {"roam_network_thr", wal_hipriv_roam_homenetwork_thr}, /* 设置家庭漫游场景的门限 */
