...
/* 9 OTHERS定义 */
/* 10 函数声明 */
extern oal_uint16 wal_netdev_select_queue_etc(oal_net_device_stru *pst_dev, oal_netbuf_stru *pst_buf);
...
extern oal_uint16 wal_netdev_select_queue_etc(oal_net_device_stru *pst_dev, oal_netbuf_stru *pst_buf);
#else
extern oal_uint16 wal_netdev_select_queue_etc(oal_net_device_stru *pst_dev,
