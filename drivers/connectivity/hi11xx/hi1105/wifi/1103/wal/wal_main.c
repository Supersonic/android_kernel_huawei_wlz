...
OAL_STATIC ssize_t wal_get_packet_statistics_wlan0_info(struct kobject *dev, struct kobj_attribute *attr, char *buf)
{
    ...
    if (OAL_UNLIKELY(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
                         "{wal_packet_statistics_wlan0_info_print::wal_atcmsrv_ioctl_get_rx_pckg_etc failed, failed err:%d!}\r\n",
                         l_ret);
        return ret;
    }
...
oal_int32 wal_main_init_etc(oal_void)
{
    ...
    if ((en_init_state == FRW_INIT_STATE_BUTT) || (en_init_state < FRW_INIT_STATE_HMAC_CONFIG_VAP_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
                         "{wal_main_init_etc::en_init_state has a invalid value [%d]!}\r\n", en_init_state);
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
                         "{wal_main_init_etc::wal_hipriv_create_proc_etc has a wrong return value [%d]!}\r\n", ul_ret);
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
                         "{wal_main_init_etc::wal_cfg80211_init_etc has a wrong return value [%d]!}\r\n", ul_ret);
