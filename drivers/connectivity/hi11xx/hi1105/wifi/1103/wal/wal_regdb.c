...
OAL_CONST oal_ieee80211_regdomain_stru *wal_regdb_find_db_etc(oal_int8 *pc_str)
{
    ...
    OAM_WARNING_LOG4(0, OAM_SF_ANY,
                     "{wal_regdb_find_db_etc::regdomain %c,%c was not found,return default regdomain %c,%c.}\r\n",
                     pc_str[0], pc_str[1], reg_regdb_etc[HI1103_SPECIFIC_COUNTRY_CODE_IDX]->alpha2[0],
                     reg_regdb_etc[HI1103_SPECIFIC_COUNTRY_CODE_IDX]->alpha2[1]);
