...
oal_uint32 wal_scan_comp_proc_sta_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_hmac_vap == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_SCAN,
                         "{wal_scan_comp_proc_sta_etc::pst_hmac_vap is NULL!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if ((pst_scan_rsp->uc_result_code != MAC_SCAN_SUCCESS) && (pst_scan_rsp->uc_result_code != MAC_SCAN_PNO)) {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_SCAN,
                         "{wal_scan_comp_proc_sta_etc::scan not succ, err_code[%d]!}",
                         pst_scan_rsp->uc_result_code);
    }
...
oal_uint32 wal_asoc_comp_proc_sta_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                       "{wal_asoc_comp_proc_sta_etc::get net device ptr is null!}");
    ...
    if (st_connet_result.us_status_code == MAC_SUCCESSFUL_STATUSCODE) {
        ...
        hmac_bss_mgmt_stru *pst_bss_mgmt = OAL_PTR_NULL;
        pst_hmac_device = hmac_res_get_mac_dev_etc(pst_event->st_event_hdr.uc_device_id);
        if (OAL_ANY_NULL_PTR3(pst_hmac_device,
                              pst_hmac_device->pst_device_base_info,
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                         "{wal_asoc_comp_proc_sta_etc::oal_cfg80211_connect_result_etc fail[%d]!}", ul_ret);
    }
#endif
    oal_free(pst_asoc_rsp->puc_asoc_rsp_ie_buff);
    pst_asoc_rsp->puc_asoc_rsp_ie_buff = OAL_PTR_NULL;
    ...
    OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                     "{wal_asoc_comp_proc_sta_etc status_code[%d] OK!}",
                     st_connet_result.us_status_code);
...
oal_uint32 wal_roam_comp_proc_sta_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_mac_device == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_SCAN,
                         "{wal_asoc_comp_proc_sta_etc::pst_mac_device is null ptr!}");
        oal_free(pst_roam_rsp->puc_asoc_rsp_ie_buff);
        pst_roam_rsp->puc_asoc_rsp_ie_buff = OAL_PTR_NULL;
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_roam_rsp->st_channel.en_band >= WLAN_BAND_BUTT) {
        OAM_ERROR_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ROAM,
                       "{wal_asoc_comp_proc_sta_etc::unexpected band[%d]!}",
...
oal_uint32 wal_ft_event_proc_sta_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ROAM,
                       "{wal_ft_event_proc_sta_etc::get net device ptr is null!}");
...
oal_uint32 wal_disasoc_comp_proc_sta_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                       "{wal_disasoc_comp_proc_sta_etc::get net device ptr is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                         "{wal_disasoc_comp_proc_sta_etc::oal_cfg80211_disconnected_etc fail[%d]!}", ul_ret);
        return ul_ret;
    }
#endif
    ...
    OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                     "{wal_disasoc_comp_proc_sta_etc reason_code[%d] OK!}",
                     st_disconnect_result.us_reason_code);
...
oal_uint32 wal_connect_new_sta_proc_ap_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                       "{wal_connect_new_sta_proc_ap_etc::get net device ptr is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (st_station_info.assoc_req_ies == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                       "{wal_connect_new_sta_proc_ap_etc::asoc ie is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                         "{wal_connect_new_sta_proc_ap_etc::oal_cfg80211_new_sta_etc fail[%d]!}", ul_ret);
        return ul_ret;
    }
#endif
    ...
    OAM_WARNING_LOG4(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                     "{wal_connect_new_sta_proc_ap_etc mac[%02X:XX:XX:%02X:%02X:%02X] OK!}",
...
oal_uint32 wal_disconnect_sta_proc_ap_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                       "{wal_disconnect_sta_proc_ap_etc::get net device ptr is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                         "{wal_disconnect_sta_proc_ap_etc::oal_cfg80211_del_sta_etc return fail[%d]!}", l_ret);
        return OAL_FAIL;
    }
#endif
    OAM_WARNING_LOG3(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC,
                     "{wal_disconnect_sta_proc_ap_etc mac[%x %x %x] OK!}",
...
oal_uint32 wal_mic_failure_proc_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_CRYPTO,
                       "{wal_mic_failure_proc_etc::get net device ptr is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    /* 调用内核接口，上报mic攻击 */
    oal_cfg80211_mic_failure_etc(pst_net_device, pst_mic_event->auc_user_mac,
...
oal_uint32 wal_send_mgmt_to_host_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_net_device == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ANY,
                       "{wal_send_mgmt_to_host_etc::get net device ptr is null!}");
    ...
    ***********************************************************************************************/
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG2(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ANY,
                         "{wal_send_mgmt_to_host_etc::fc[0x%02x], if_type[%d]!}\r\n",
        ...
        OAM_WARNING_LOG3(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ANY,
                         "{wal_send_mgmt_to_host_etc::oal_cfg80211_rx_mgmt_etc fail[%d]!len[%d], freq[%d]}",
...
oal_uint32 wal_report_external_auth_req_etc(frw_event_mem_stru *pst_event_mem)
{
    ...
    OAM_WARNING_LOG4(0, OAM_SF_SAE,
                     "{wal_report_external_auth_req_etc::action %x, status %d, key_mgmt 0x%X, ssid_len %d}",
