...
oal_uint32 hmac_tcp_opt_add_node_etc(hmac_vap_stru *pst_hmac_vap,
...
oal_uint16 hmac_tcp_opt_rx_tcp_ack_filter_etc(void *hmac_device,
                                              hmac_tcp_opt_queue type,
                                              hcc_chan_type dir, void *data);
oal_uint16 hmac_tcp_opt_tx_tcp_ack_filter_etc(void *hmac_device,
                                              hmac_tcp_opt_queue type,
                                              hcc_chan_type dir, void *data);
oal_uint32 hmac_tcp_opt_tcp_ack_filter_etc(oal_netbuf_stru *skb,
                                           hmac_vap_stru *pst_hmac_vap,
                                           hcc_chan_type dir);
