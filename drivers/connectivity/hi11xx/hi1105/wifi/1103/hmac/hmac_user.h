...
#define HMAC_USER_SET_AMSDU_NOT_SUPPORT(_user, _tid)      \
    (((_user)->uc_amsdu_supported) &= (oal_uint8)(~(0x01 << ((_tid)&0x07))))
...
typedef struct {
    ...
    oal_uint8 auc_ba_flag[WLAN_TID_MAX_NUM];
...
/* 10 函数声明 */
extern oal_uint32 hmac_user_set_asoc_req_ie(hmac_user_stru *pst_hmac_user, oal_uint8 *puc_payload,
                                            oal_uint32 ul_payload_len, oal_uint8 uc_reass_flag);
...
extern oal_uint32 hmac_user_set_avail_num_space_stream_etc(mac_user_stru *pst_mac_user,
...
extern oal_uint32 hmac_user_add_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_mac_addr,
...
extern oal_uint32 hmac_update_user_last_active_time(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len,
                                                    oal_uint8 *puc_param);
...
extern hmac_user_stru *mac_vap_get_hmac_user_by_addr_etc(mac_vap_stru *pst_mac_vap,
                                                         oal_uint8 *puc_mac_addr);
extern mac_ap_type_enum_uint16 hmac_compability_ap_tpye_identify_etc(mac_vap_stru *pst_mac_vap,
                                                                     oal_uint8 *puc_mac_addr);

#ifdef _PRE_WLAN_FEATURE_WAPI
extern hmac_wapi_stru *hmac_user_get_wapi_ptr_etc(mac_vap_stru *pst_mac_vap,
