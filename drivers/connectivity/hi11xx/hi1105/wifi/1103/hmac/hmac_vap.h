...
typedef struct mac_vap_rrm_info_tag {
    ...
    /* 最后一个tbtt中断开始时启动offset定时器，offset时间后超时处理进入quiet，并启动quiet定时器 */
    frw_timeout_stru st_offset_timer;
#endif
...
typedef struct hmac_vap_tag {
    ...
    defined(_PRE_WLAN_FEATURE_11K_EXTERN) || defined(_PRE_WLAN_FEATURE_11V_ENABLE)
