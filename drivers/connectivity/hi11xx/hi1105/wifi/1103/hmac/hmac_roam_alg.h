...
typedef struct {
    oal_uint8 auc_bssid[MAX_RECORD_BSSID_NUM][WLAN_MAC_ADDR_LEN]; /* 记录网络的bssid */
    mac_channel_stru st_channel[MAX_RECORD_BSSID_NUM];            /* 记录网络信息 */
    oal_uint8 uc_bssid_num;                                       /* 记录bssid num的个数 */
...
typedef struct {
    ...
    oal_int8 c_5g_rssi_th;       /* 家庭网络5g漫游门限 */
    oal_int8 c_5g_hold_th;       /* 家庭网络5g保持漫游门限 */
    oal_uint8 uc_max_retry_cnt;  /* 每个rssi最多触发几次漫游 */
    oal_uint8 uc_roam_fail_cnt;  /* 漫游失败次数 */
    oal_uint8 uc_is_homenetwork; /* 是否是家庭网络场景 */
    oal_uint8 auc_resv[2];
    hmac_roam_record_stru st_2g_bssid; /* 记录扫描到的2g的bssid */
    hmac_roam_record_stru st_5g_bssid; /* 记录扫描到的5g的bssid */
    oal_uint32 ul_5g_scan_timestamp;   /* 记录扫描5g rssi时间戳，30s扫描一次 */
...
typedef struct {
    ...
    oal_uint8 uc_candidate_bss_num;          /* 相同SSID的BSS Num总数目，包括good, weak, and roaming */
    oal_uint8 uc_candidate_good_rssi_num;    /* 相同SSID强信号强度的BSS Num */
    oal_uint8 uc_candidate_weak_rssi_num;    /* 相同SSID弱信号强度的BSS Num */
...
/* 9 OTHERS定义 */
/* 10 函数声明 */
oal_uint32 hmac_roam_alg_add_blacklist_etc(hmac_roam_info_stru *pst_roam_info, oal_uint8 *puc_bssid,
...
oal_uint32 hmac_roam_alg_bss_check_etc(hmac_roam_info_stru *pst_roam_info,
                                       mac_bss_dscr_stru *pst_bss_dscr);
oal_uint32 hmac_roam_alg_scan_channel_init_etc(hmac_roam_info_stru *pst_roam_info,
...
oal_bool_enum_uint8 hmac_roam_alg_find_in_blacklist_etc(hmac_roam_info_stru *pst_roam_info,
                                                        oal_uint8 *puc_bssid);
oal_bool_enum_uint8 hmac_roam_alg_find_in_history_etc(hmac_roam_info_stru *pst_roam_info,
                                                      oal_uint8 *puc_bssid);
oal_bool_enum_uint8 hmac_roam_alg_need_to_stop_roam_trigger_etc(hmac_roam_info_stru *pst_roam_info);
oal_uint32 hmac_roam_alg_bss_in_ess_etc(hmac_roam_info_stru *pst_roam_info,
                                        mac_bss_dscr_stru *pst_bss_dscr);
