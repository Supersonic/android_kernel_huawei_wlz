...
extern frw_event_mem_stru *hmac_rx_process_mgmt_event_rx_adapt_etc(
    frw_event_mem_stru *pst_hcc_event_mem);
extern frw_event_mem_stru *hmac_hcc_rx_convert_netbuf_to_event_default_etc(
    frw_event_mem_stru *pst_hcc_event_mem);
/* Tx适配部分 */
...
extern oal_uint32 hmac_scan_proc_sched_scan_req_event_tx_adapt_etc(
...
extern frw_event_mem_stru *hmac_rx_convert_netbuf_to_netbuf_default_etc(
    frw_event_mem_stru *pst_hcc_event_mem);
...
extern oal_uint32 hmac_chan_initiate_switch_to_new_channel_tx_adapt_etc(
    frw_event_mem_stru *pst_event_mem);
extern oal_uint32 hmac_sdt_recv_reg_cmd_tx_adapt(frw_event_mem_stru *pst_event_mem);
extern frw_event_mem_stru *hmac_cali2hmac_misc_event_rx_adapt_etc(
    frw_event_mem_stru *pst_hcc_event_mem);
...
extern oal_uint32 hmac_proc_rx_process_twt_sync_event_tx_adapt_etc(
    frw_event_mem_stru *pst_event_mem);
#endif
