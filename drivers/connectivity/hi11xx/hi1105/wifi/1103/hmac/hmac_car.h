...
/* 9 OTHERS定义 */
/* 10 函数声明 */
extern oal_uint32 hmac_car_device_bw_limit(hmac_device_stru *pst_hmac_dev,
...
extern oal_uint32 hmac_car_device_multicast(hmac_device_stru *pst_hmac_dev,
                                            mac_cfg_car_stru *pst_car_cfg_param);
extern oal_uint32 hmac_car_device_timer_cycle_limit(hmac_device_stru *pst_hmac_dev,
                                                    mac_cfg_car_stru *pst_car_cfg_param);
...
extern oal_uint32 hmac_car_process_uplink(oal_uint16 us_ta_user_idx, hmac_vap_stru *pst_hmac_vap,
                                          ...
                                          hmac_car_up_down_type_enum_uint8 en_car_type);
extern oal_uint32 hmac_car_enable_switch(hmac_device_stru *pst_hmac_dev,
                                         mac_cfg_car_stru *pst_car_cfg_param);
...
extern oal_uint32 hmac_car_device_multicast_pps_num(hmac_device_stru *pst_hmac_dev,
                                                    mac_cfg_car_stru *pst_car_cfg_param);
