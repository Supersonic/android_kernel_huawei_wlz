...
extern hmac_neighbor_bss_info_stru *hmac_get_neighbor_ie(oal_uint8 *puc_data,
                                                         oal_uint16 us_len, oal_uint8 *pst_bss_num);
/* STA 处理AP发送的bss transition request frame */
extern oal_uint32 hmac_rx_bsst_req_action(hmac_vap_stru *pst_hmac_vap,
