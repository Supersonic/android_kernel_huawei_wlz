...
oal_int32 oam_cfg_get_all_item_etc(oal_void)
{
    ...
    oal_uint32 ul_loop;
    oal_int32 l_ret;
    oal_int i_key[OAL_AES_KEYSIZE_256] = {
...
{
    return (oal_uint32)oam_cfg_get_all_item_etc();
}
...
/* 获取 */
oal_void hmac_chr_get_del_ba_info(mac_vap_stru *pst_mac_vap,
    ...
    switch (chr_event_id) {
        ...
        case CHR_WIFI_WEB_SLOW_QUERY_EVENTID:
            ...
            if (ul_ret != OAL_SUCC) {
                ...
                "{hmac_chr_get_chip_info::hmac_chr_get_web_fail_slow_info fail.}");
                return ul_ret;
            }
            break;
        default:
