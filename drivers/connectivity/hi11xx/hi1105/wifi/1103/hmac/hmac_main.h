...
extern oal_uint32 hmac_sdt_recv_autocali_cmd(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_buf,
                                             oal_uint16 us_len);
...
extern oal_uint32 hmac_proc_query_response_event_etc(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len,
                                                     oal_uint8 *puc_param);
