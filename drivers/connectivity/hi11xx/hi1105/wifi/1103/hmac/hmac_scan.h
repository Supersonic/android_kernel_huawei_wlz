...
extern hmac_scanned_bss_info *hmac_scan_find_scanned_bss_by_bssid_etc(
    hmac_bss_mgmt_stru *pst_bss_mgmt, oal_uint8 *puc_bssid);
extern oal_void *hmac_scan_get_scanned_bss_by_bssid(mac_vap_stru *pst_mac_vap,
...
extern oal_uint32 hmac_scan_proc_scan_req_event_exception_etc(hmac_vap_stru *pst_hmac_vap,
                                                              oal_void *p_params);
extern oal_uint32 hmac_scan_proc_scan_req_event_etc(hmac_vap_stru *pst_hmac_vap, oal_void *p_params);
extern oal_uint32 hmac_scan_proc_sched_scan_req_event_etc(hmac_vap_stru *pst_hmac_vap,
                                                          oal_void *p_params);
...
#endif
extern oal_uint32 hmac_bgscan_enable_etc(mac_vap_stru *pst_mac_vap, oal_uint16 us_len,
                                         oal_uint8 *puc_param);
#if defined(_PRE_SUPPORT_ACS) || defined(_PRE_WLAN_FEATURE_DFS) || defined(_PRE_WLAN_FEATURE_20_40_80_COEXIST)
extern oal_uint32 hmac_init_scan_process_etc(hmac_device_stru *pst_hmac_dev,
                                             mac_vap_stru *pst_mac_vap,
                                             hmac_acs_cfg_stru *pst_acs_cfg);
extern oal_uint32 hmac_init_scan_try_etc(mac_device_stru *pst_mac_device, mac_vap_stru *pst_mac_vap,
