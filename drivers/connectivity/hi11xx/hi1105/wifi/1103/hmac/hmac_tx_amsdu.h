...
/* 10 函数声明 */
extern oal_uint32 hmac_amsdu_notify_etc(hmac_vap_stru *pst_vap, hmac_user_stru *pst_user,
                                        oal_netbuf_stru *pst_buf);
extern oal_void hmac_amsdu_init_user_etc(hmac_user_stru *pst_hmac_user_sta);
#ifdef _PRE_WLAN_FEATURE_MULTI_NETBUF_AMSDU
extern oal_void hmac_tx_encap_large_skb_amsdu(hmac_vap_stru *pst_vap, hmac_user_stru *pst_user,
