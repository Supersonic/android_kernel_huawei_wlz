...
OAL_STATIC oal_uint32 hmac_rrm_chn_load_scan_do(hmac_vap_stru *pst_hmac_vap,
                                                mac_chn_load_req_stru *pst_chn_load_req);
OAL_STATIC oal_void hmac_rrm_chn_load_scan_cb(void *p_scan_record);
OAL_STATIC oal_uint32 hmac_rrm_bcn_scan_do(hmac_vap_stru *pst_hmac_vap,
                                           mac_bcn_req_stru *pst_bcn_req, mac_scan_req_stru *pst_scan_req);
OAL_STATIC oal_void hmac_rrm_bcn_scan_cb(void *p_scan_record);
OAL_STATIC oal_void hmac_rrm_encap_meas_rpt_bcn(hmac_vap_stru *pst_hmac_vap,
                                                oal_dlist_head_stru *pst_bss_list_head);
OAL_STATIC oal_void hmac_rrm_get_bcn_info_from_rpt(hmac_user_stru *pst_hmac_user,
                                                   mac_meas_rpt_ie_stru *pst_meas_rpt_ie);
OAL_STATIC oal_uint32 hmac_rrm_fill_basic_rm_rpt_action(hmac_vap_stru *pst_hmac_vap);
OAL_STATIC oal_void hmac_rrm_send_rm_rpt_action(hmac_vap_stru *pst_hmac_vap);
OAL_STATIC oal_void hmac_rrm_parse_beacon_req(hmac_vap_stru *pst_hmac_vap,
                                              mac_meas_req_ie_stru *pst_meas_req_ie);
OAL_STATIC oal_void hmac_rrm_parse_chn_load_req(hmac_vap_stru *pst_hmac_vap,
                                                mac_meas_req_ie_stru *pst_meas_req_ie);
OAL_STATIC oal_void hmac_rrm_rpt_notify(hmac_user_stru *pst_user);
OAL_STATIC oal_void hmac_rrm_neighbor_scan_cb(void *p_scan_record);
OAL_STATIC oal_void hmac_rrm_encap_meas_rpt_neighbor(hmac_vap_stru *pst_hmac_vap,
                                                     oal_dlist_head_stru *pst_bss_list_head);
OAL_STATIC oal_void hmac_rrm_encap_meas_rpt_reject(hmac_vap_stru *pst_hmac_vap,
                                                   mac_meas_rpt_mode_stru *pst_rptmode);
OAL_STATIC oal_void hmac_rrm_get_chn_load_info_from_rpt(hmac_user_stru *pst_hmac_user,
                                                        mac_meas_rpt_ie_stru *pst_meas_rpt_ie);
OAL_STATIC oal_void hmac_rrm_get_neighbor_info_from_rpt(hmac_user_stru *pst_hmac_user,
...
OAL_STATIC oal_uint32 hmac_rrm_bcn_rpt_filter(hmac_vap_stru *pst_hmac_vap,
                                              mac_bss_dscr_stru *pst_bss_dscr, mac_scan_req_stru *pst_scan_params);
OAL_STATIC oal_uint32 hmac_rrm_encap_meas_rpt_refuse_new_req(hmac_vap_stru *pst_hmac_vap,
                                                             hmac_user_stru *pst_hmac_user,
                                                             mac_action_rm_req_stru *pst_rm_req);
OAL_STATIC oal_uint32 hmac_rrm_check_user_cap(mac_rrm_enabled_cap_ie_stru *pst_rrm_enabled_cap,
    ...
    if (pst_hmac_vap->bit_11k_enable
        ...
        if (pst_hmac_vap->pst_rrm_info == OAL_PTR_NULL) {
            OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY,
                           "{hmac_11k_init_vap::pst_rrm_info null.}");
            return;
        }
...
{
    if (pst_hmac_vap->pst_rrm_info != OAL_PTR_NULL) {
        if (pst_hmac_vap->pst_rrm_info->st_neighbor_req_info.puc_ssid != OAL_PTR_NULL) {
            OAL_MEM_FREE(pst_hmac_vap->pst_rrm_info->st_neighbor_req_info.puc_ssid, OAL_TRUE);
        }
        if (pst_hmac_vap->pst_rrm_info->st_bcn_req_info.puc_ssid != OAL_PTR_NULL) {
            OAL_MEM_FREE(pst_hmac_vap->pst_rrm_info->st_bcn_req_info.puc_ssid, OAL_TRUE);
        }
        if (pst_hmac_vap->pst_rrm_info->st_bcn_req_info.puc_reqinfo_ieid != OAL_PTR_NULL) {
            OAL_MEM_FREE(pst_hmac_vap->pst_rrm_info->st_bcn_req_info.puc_reqinfo_ieid, OAL_TRUE);
        }

        if (pst_hmac_vap->pst_rrm_info->st_meas_status_timer.en_is_registerd == OAL_TRUE) {
...
{
    /* 关联时申请用户结构体空间 */
    if (pst_hmac_user->pst_user_rrm_info == OAL_PTR_NULL) {
        pst_hmac_user->pst_user_rrm_info = OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
                                                         OAL_SIZEOF(mac_user_rrm_info_stru), OAL_TRUE);
        if (pst_hmac_user->pst_user_rrm_info == OAL_PTR_NULL) {
            OAM_ERROR_LOG0(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_ANY,
                           "{hmac_11k_init_user::pst_user_rrm_info null.}");
            return;
        }

        memset_s(pst_hmac_user->pst_user_rrm_info, OAL_SIZEOF(mac_user_rrm_info_stru), 0,
                 OAL_SIZEOF(mac_user_rrm_info_stru));
...
{
    if (pst_hmac_user->pst_user_rrm_info != OAL_PTR_NULL) {
        if (pst_hmac_user->pst_user_rrm_info->st_timer.en_is_registerd == OAL_TRUE) {
...
oal_uint32 hmac_rrm_bcn_rpt_notify_hook(hmac_user_stru *pst_hmac_user, mac_rrm_state_enum en_rpt_state)
{
    ...
    if (en_rpt_state != MAC_RRM_STATE_GET_RSP) {
        return OAL_FAIL;
    }

    if (oal_dlist_is_empty(&(pst_rrm_info->st_meas_rpt_list))) {
        OAM_WARNING_LOG1(0, OAM_SF_RRM,
                         "{hmac_rrm_bcn_rpt_notify_hook:pst_rrm_info->st_meas_rpt_list null, en_meas_status[%d].",
                         pst_rrm_info->en_meas_status);

        OAM_WARNING_LOG3(0, OAM_SF_RRM,
                         "{hmac_rrm_bcn_rpt_notify_hook::bit_late[%d],bit_incapable[%d],bit_refused[%d]!}",
    ...
    OAL_DLIST_SEARCH_FOR_EACH(pst_meas_rpt_node, &(pst_rrm_info->st_meas_rpt_list))
    {
        ...
        if (pst_meas_rpt_bcn->pst_meas_rpt_bcn_item == OAL_PTR_NULL) {
            continue;
        }
...
oal_uint32 hmac_rrm_proc_rm_request(hmac_vap_stru *pst_hmac_vap,
                                    hmac_user_stru *pst_hmac_user, oal_netbuf_stru *pst_netbuf)
{
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_vap, pst_hmac_user, pst_netbuf)) {
        OAM_ERROR_LOG3(0, OAM_SF_RRM,
                       "{hmac_rrm_proc_rm_request::input is NULL, pst_hmac_vap[%p],pst_hmac_user[%p],pst_netbuf[%p]!}",
                       (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)pst_netbuf);
        return OAL_ERR_CODE_PTR_NULL;
    }

    pst_rrm_info = pst_hmac_vap->pst_rrm_info;
    if (pst_rrm_info == OAL_PTR_NULL) {
    ...
    /*************************************************************************/
    /* 判断VAP是否正在进行测量 */
    if (pst_rrm_info->en_is_measuring == OAL_TRUE) {
    ...
    OAM_WARNING_LOG4(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                     "hmac_rrm_proc_rm_request::Category[%d],Action[%d],Dialog Token[%d],Number of Repetitions[%d].",
                     pst_rm_req->uc_category,
                     pst_rm_req->uc_action_code,
                     pst_rm_req->uc_dialog_token,
                     pst_rm_req->us_num_rpt);

    if (pst_rm_req->us_num_rpt &&
        ...
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "hmac_rrm_proc_rm_request::RepeatedMeasurements not support, num_rpt[%u].",
                         pst_rm_req->us_num_rpt);
        return OAL_FAIL;
    }
    ...
    OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                     "hmac_rrm_proc_rm_request::framebody::Meas Type[%d].",
                     pst_meas_req_ie->uc_reqtype);

    if (pst_meas_req_ie->uc_eid == MAC_EID_MEASREQ) {
        if (pst_meas_req_ie->st_reqmode.bit_enable == 1) {
            /* Req中拒绝某种类型的测量,一旦对端拒绝，在当前关联状态无法恢复测量能力位，需要重新关联 */
            if (pst_meas_req_ie->st_reqmode.bit_request == 0) {
                OAM_WARNING_LOG1(0, OAM_SF_RRM,
                                 "{hmac_rrm_proc_rm_request::update user rrm capability,reqtype[%d] not support!}",
                                 pst_meas_req_ie->uc_reqtype);
                if (pst_meas_req_ie->uc_reqtype == RM_RADIO_MEAS_BCN) {
                ...
                } else if (pst_meas_req_ie->uc_reqtype == RM_RADIO_MEAS_CHANNEL_LOAD) {
                    pst_hmac_user->st_user_base_info.st_rrm_enabled_cap.bit_chn_load_cap = 0;
                }
            }

            /* Req中不允许发送对应的report */
            if (pst_meas_req_ie->st_reqmode.bit_rpt == 0) {
        ...
        if (pst_meas_req_ie->st_reqmode.bit_parallel != 0
            && OAL_FALSE == mac_mib_get_dot11RMParallelMeasurementsActivated(&pst_hmac_vap->st_vap_base_info)) {
            st_rptmode.bit_incapable = 1;
            hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
            OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                             "hmac_rrm_proc_rm_request::ParallelMeasurement not support.");
            return OAL_FAIL;
        }
        ...
        /* 处理Chn load req */
            ...
            hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
            OAM_WARNING_LOG1(0, OAM_SF_RRM,
                             "{Error Request, Expect Measurement Request, but got reqtype[%d]!}",
                             pst_meas_req_ie->uc_reqtype);
            return OAL_FAIL;
        }
    }
    /* MR IE错误，不回，报错 */
        ...
        OAM_WARNING_LOG1(0, OAM_SF_RRM, "{Error Request, Expect Measurement Request, but got EID[%d]!}",
                         pst_meas_req_ie->uc_eid);
        return OAL_FAIL;
    }
...
oal_uint32 hmac_rrm_proc_rm_report(hmac_vap_stru *pst_hmac_vap,
                                   hmac_user_stru *pst_hmac_user, oal_netbuf_stru *pst_netbuf)
{
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_vap, pst_hmac_user, pst_netbuf)) {
        OAM_ERROR_LOG3(0, OAM_SF_RRM,
                       "{hmac_rrm_proc_rm_report::input is NULL, pst_hmac_vap[%p],pst_hmac_user[%p],pst_netbuf[%p]!}",
                       (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)pst_netbuf);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_rm_rpt->uc_dialog_token != pst_rrm_info->uc_dialog_token ||
        ...
        OAM_WARNING_LOG3(0, OAM_SF_RRM,
                         "{hmac_rrm_proc_rm_report::uc_dialog_token diff: request[%d], report[%d]},en_meas_status[%d].",
    ...
    if (s_framebody_len < WLAN_MEM_NETBUF_SIZE2 - MAC_80211_FRAME_LEN - MAC_BEACON_RPT_FIX_LEN) {
        ...
        if (pst_hmac_user->pst_user_rrm_info->st_timer.en_is_registerd == OAL_TRUE) {
            FRW_TIMER_IMMEDIATE_DESTROY_TIMER(&(pst_hmac_user->pst_user_rrm_info->st_timer));
            OAM_WARNING_LOG0(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_RRM,
                             "{hmac_rrm_proc_rm_report:: cancel Timer.}");
        }
    } else {
        OAM_WARNING_LOG1(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_proc_rm_report:: wait for another report, s_framebody_len=%d.}",
    ...
    do {
        ...
        /*************************************************************************/
        /* TO BE DONE:可能有多个Measurement Req IEs */
        if (pst_meas_rpt_ie->uc_eid == MAC_EID_MEASREP) {
            uc_rpttype = pst_meas_rpt_ie->uc_rpttype;

            /* check Measurement Report field exist */
            if ((pst_meas_rpt_ie->st_rptmode.bit_late == 1) ||
                (pst_meas_rpt_ie->st_rptmode.bit_incapable == 1) ||
                (pst_meas_rpt_ie->st_rptmode.bit_refused == 1)) {
                OAM_WARNING_LOG4(0, OAM_SF_RRM,
                    "{hmac_rrm_proc_rm_report::rpt now allowed, reqtype[%d], late[%d], incapable[%d], refused[%d]!}",
            ...
            if (pst_meas_rpt_ie->uc_token != pst_rrm_info->uc_meas_token) {
                OAM_WARNING_LOG2(0, OAM_SF_RRM,
                                 "{hmac_rrm_proc_rm_report::meas token diff,req meas token[%d],rpr meas token[%d]!}",
            ...
            if (pst_meas_rpt_ie->uc_len <= MAC_MEASUREMENT_RPT_FIX_LEN - MAC_IE_HDR_LEN) {
                OAM_WARNING_LOG1(0, OAM_SF_RRM,
                                 "{hmac_rrm_proc_rm_report::Measurement Report filed empty, length=%d!}",
                                 pst_meas_rpt_ie->uc_len);
                break;
            }

            /* beacon report */
            if (pst_meas_rpt_ie->uc_rpttype == RM_RADIO_MEAS_BCN) {
                hmac_rrm_get_bcn_info_from_rpt(pst_hmac_user, pst_meas_rpt_ie);
            }
            /* channel load report */
            else if (pst_meas_rpt_ie->uc_rpttype == RM_RADIO_MEAS_CHANNEL_LOAD) {
                hmac_rrm_get_chn_load_info_from_rpt(pst_hmac_user, pst_meas_rpt_ie);
            } else {
                OAM_WARNING_LOG1(0, OAM_SF_RRM,
                                 "{hmac_rrm_proc_rm_report::rpttype[%d] not support!}", pst_meas_rpt_ie->uc_rpttype);
            }
        }
        /* MR IE错误 */
        else {
            OAM_WARNING_LOG1(0, OAM_SF_RRM,
                             "{Error Request, Expect Measurement Request, but got EID[%d]!}", pst_meas_rpt_ie->uc_eid);
        }
    ...
    if (pst_hmac_user->pst_user_rrm_info->st_timer.en_is_enabled) {
        return OAL_SUCC;
    }

    pst_hmac_user->pst_user_rrm_info->en_meas_status = MAC_RRM_STATE_GET_RSP;
    /* 收发类型一致则通知对应模块 */
    if ((uc_rpttype == RM_RADIO_MEAS_BCN && pst_hmac_user->pst_user_rrm_info->en_reqtype == MAC_RRM_TYPE_BCN) ||
        (uc_rpttype == RM_RADIO_MEAS_CHANNEL_LOAD &&
        pst_hmac_user->pst_user_rrm_info->en_reqtype == MAC_RRM_TYPE_CHANNEL_LOAD)) {
...
oal_uint32 hmac_rrm_proc_neighbor_request(hmac_vap_stru *pst_hmac_vap,
                                          hmac_user_stru *pst_hmac_user, oal_netbuf_stru *pst_netbuf)
{
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_vap, pst_hmac_user, pst_netbuf)) {
        OAM_ERROR_LOG3(0, OAM_SF_RRM,
                       "{hmac_rrm_proc_neighbor_request::input is NULL, hmac_vap[%p], hmac_user[%p], netbuf[%p]!}",
                       (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)pst_netbuf);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    memset_s(&(pst_rrm_info->st_neighbor_req_info), OAL_SIZEOF(mac_neighbor_req_info_stru), 0,
             OAL_SIZEOF(mac_neighbor_req_info_stru));
    if (us_framebody_len > MAC_NEIGHBOR_REPORT_ACTION_REQ_FIX_LEN) {
        puc_ssid_search_addr = pst_neighbor_req->auc_subelm;
        puc_ssid_sub_element = mac_find_ie_etc(MAC_EID_SSID, puc_ssid_search_addr,
                                               us_framebody_len - MAC_NEIGHBOR_REPORT_ACTION_REQ_FIX_LEN);
        if (puc_ssid_sub_element != OAL_PTR_NULL) {
            /* check ssid len */
            if (puc_ssid_sub_element[1] >= WLAN_SSID_MAX_LEN || puc_ssid_sub_element[1] == 0) {
                OAM_ERROR_LOG1(0, OAM_SF_RRM, "{hmac_rrm_proc_neighbor_request::neighbor req ssid_len[%d] invalid.}",
                               puc_ssid_sub_element[1]);
                return OAL_FAIL;
            }

            pst_rrm_info->st_neighbor_req_info.uc_ssid_len = *(puc_ssid_sub_element + 1);
            pst_rrm_info->st_neighbor_req_info.puc_ssid = OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
                pst_rrm_info->st_neighbor_req_info.uc_ssid_len, OAL_TRUE);
            if (pst_rrm_info->st_neighbor_req_info.puc_ssid == OAL_PTR_NULL) {
...
oal_uint32 hmac_rrm_proc_neighbor_report(hmac_vap_stru *pst_hmac_vap,
                                         hmac_user_stru *pst_hmac_user, oal_netbuf_stru *pst_netbuf)
{
    mac_action_rm_rpt_stru *pst_rm_rpt;
    mac_neighbor_rpt_ie_stru *pst_neighbor_rpt_ie;
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_vap, pst_hmac_user, pst_netbuf)) {
        OAM_ERROR_LOG3(0, OAM_SF_RRM,
                       "{hmac_rrm_proc_neighbor_report::input is NULL, hmac_vap[%p],hmac_user[%p],netbuf[%p]!}",
                       (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)pst_netbuf);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_rm_rpt->uc_dialog_token != pst_rrm_info->uc_dialog_token ||
        pst_hmac_user->pst_user_rrm_info->en_meas_status != MAC_RRM_STATE_WAIT_RSP) {
        OAM_WARNING_LOG3(0, OAM_SF_RRM,
                         "{hmac_rrm_proc_neighbor_report::dialog_token diff:request[%d],report[%d]},meas_status[%d].",
                         pst_rrm_info->uc_dialog_token, pst_rm_rpt->uc_dialog_token,
                         pst_hmac_user->pst_user_rrm_info->en_meas_status);
        return OAL_FAIL;
    }
    ...
    if (s_framebody_len < WLAN_MEM_NETBUF_SIZE2 - MAC_80211_FRAME_LEN - MAC_NEIGHBOR_RPT_FIX_LEN) {
        ...
        if (pst_hmac_user->pst_user_rrm_info->st_timer.en_is_registerd == OAL_TRUE) {
            FRW_TIMER_IMMEDIATE_DESTROY_TIMER(&(pst_hmac_user->pst_user_rrm_info->st_timer));
            OAM_WARNING_LOG0(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_RRM,
                             "{hmac_rrm_proc_neighbor_report:: cancel Timer.}");
        }
    } else {
        OAM_WARNING_LOG1(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_proc_rm_report:: wait for another report, s_framebody_len=%d.}",
    ...
    do {
        ...
        /* 下一个Measurement Report的位置 */
        pst_neighbor_rpt_ie = (mac_neighbor_rpt_ie_stru *)((oal_uint8 *)pst_neighbor_rpt_ie +
                                                           pst_neighbor_rpt_ie->uc_len + 2);
                                     ...
                                     mac_rrm_req_cfg_stru *pst_req_cfg)
{
    ...
    /* 检测用户是否支持11K */
    if (pst_hmac_user->st_user_base_info.st_cap_info.bit_11k_enable == OAL_FALSE) {
    ...
    /* 清除rpt mode记录 */
    memset_s(&(pst_hmac_user->pst_user_rrm_info->st_rptmode), OAL_SIZEOF(mac_meas_rpt_mode_stru), 0,
    ...
    /* 检查该用户是否正在进行测量 */
    if (pst_hmac_user->pst_user_rrm_info->en_meas_status != MAC_RRM_STATE_INIT) {
        OAM_WARNING_LOG1(pst_mac_user->uc_vap_id, OAM_SF_RRM,
                         "{hmac_config_send_meas_req::en_meas_status[%d] not allow new req.}",
                         pst_hmac_user->pst_user_rrm_info->en_meas_status);
    ...
    /* 申请管理帧BUF */
    pst_mgmt_buf = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF,
                                                           WLAN_MEM_NETBUF_SIZE2, OAL_NETBUF_PRIORITY_MID);
    if (pst_mgmt_buf == OAL_PTR_NULL) {
    ...
    if (pst_req_cfg->en_reqtype <= MAC_RRM_TYPE_BCN) {
        if (pst_req_cfg->p_arg == OAL_PTR_NULL) {
            oal_netbuf_free(pst_mgmt_buf);
            OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_RRM,
                             "{hmac_config_send_meas_req::radio meas req element null.}");
            return OAL_ERR_CODE_PTR_NULL;
        }
        ...
        *puc_req_mode = pst_req_cfg->uc_req_mode;
        ...
        } else if (pst_req_cfg->en_reqtype == MAC_RRM_TYPE_CHANNEL_LOAD) {
        ...
        if ((pst_meas_req_ie->st_reqmode.bit_enable == 1) && (pst_meas_req_ie->st_reqmode.bit_rpt == 0)) {
    ...
    else if (pst_req_cfg->en_reqtype == MAC_RRM_TYPE_NEIGHBOR_RPT) {
        /*************************************************************************/
        /* Neighbor Report Request Frame - Frame Body */
        /* --------------------------------------------------------------------- */
        /* |Category |Action |Dialog Token| Optional subs                       | */
    ...
    if (ul_ret != OAL_SUCC) {
        oal_netbuf_free(pst_mgmt_buf);
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_RRM,
                         "{hmac_config_send_meas_req::hmac_tx_mgmt_send_event_etc failed[%d].}", ul_ret);
        return ul_ret;
    }

    /* Radio Measurement Req中不允许对端发送report，则不起定时器 */
    if (en_timer_flag == OAL_FALSE) {
        return OAL_SUCC;
    }
...
OAL_STATIC oal_void hmac_rrm_rpt_notify(hmac_user_stru *pst_user)
{
    ...
    /* notify other module */
    if (gst_rrm_rpt_hook.pa_rrm_rpt_notify_func[en_rpt_notify_id][en_reqtype] != OAL_PTR_NULL) {
                                              ...
                                              mac_rrm_req_cfg_stru *pst_req_cfg)
{
    ...
    /* Neighbor report Request */
    if ((pst_req_cfg->en_reqtype == MAC_RRM_TYPE_NEIGHBOR_RPT) &&
        (pst_rrm_enabled_cap->bit_neighbor_rpt_cap == OAL_FALSE)) {
        OAM_WARNING_LOG2(0, OAM_SF_RRM,
                         "{hmac_rrm_check_user_cap::en_reqtype[%d],bit_neighbor_rpt_cap[%d] not support.}",
                         pst_req_cfg->en_reqtype, pst_rrm_enabled_cap->bit_neighbor_rpt_cap);
        return OAL_FAIL;
    }

    /* Channel Load Request */
    if ((pst_req_cfg->en_reqtype == MAC_RRM_TYPE_CHANNEL_LOAD) &&
        (pst_rrm_enabled_cap->bit_chn_load_cap == OAL_FALSE)) {
        OAM_WARNING_LOG2(0, OAM_SF_RRM,
                         "{hmac_rrm_check_user_cap::en_reqtype[%d],bit_chn_load_cap[%d] not support.}",
    ...
    if (pst_req_cfg->en_reqtype == MAC_RRM_TYPE_BCN) {
        ...
        if ((pst_bcn_req->en_mode == RM_BCN_REQ_MEAS_MODE_PASSIVE) &&
            pst_rrm_enabled_cap->bit_bcn_passive_cap == OAL_FALSE) {
        ...
        if ((pst_bcn_req->en_mode == RM_BCN_REQ_MEAS_MODE_ACTIVE) &&
            pst_rrm_enabled_cap->bit_bcn_active_cap == OAL_FALSE) {
        ...
        if (pst_bcn_req->en_mode == RM_BCN_REQ_MEAS_MODE_TABLE &&
            pst_rrm_enabled_cap->bit_bcn_table_cap == OAL_FALSE) {
...
oal_void hmac_rrm_free_rpt_list(hmac_user_stru *pst_hmac_user, mac_rrm_type_enum en_reqtype)
{
    mac_user_rrm_info_stru *pst_rrm_info;
    mac_meas_rpt_bcn_stru *pst_meas_rpt_bcn;
    mac_meas_rpt_bcn_item_stru *pst_meas_rpt_bcn_item;
    ...
    /* 遍历扫描到的bss信息 */
    /* Beacon Report */
    if (en_reqtype == MAC_RRM_TYPE_BCN) {
        do {
            /* 获取节点 */
            pst_meas_rpt_node = pst_rrm_info->st_meas_rpt_list.pst_next;
            pst_meas_rpt_bcn = OAL_DLIST_GET_ENTRY(pst_meas_rpt_node, mac_meas_rpt_bcn_stru, st_dlist_head);
            if (pst_meas_rpt_bcn == OAL_PTR_NULL) {
                continue;
            }
            ...
            if (pst_meas_rpt_bcn->puc_rpt_detail_data != OAL_PTR_NULL) {
    ...
    /* CHANNEL LOAD Report */
    if (en_reqtype == MAC_RRM_TYPE_CHANNEL_LOAD) {
        do {
            /* 获取节点 */
            pst_meas_rpt_node = pst_rrm_info->st_meas_rpt_list.pst_next;
            pst_meas_rpt_chn_load = OAL_DLIST_GET_ENTRY(pst_meas_rpt_node,
                                                        mac_meas_rpt_chn_load_stru, st_dlist_head_chn_load);
            if (pst_meas_rpt_chn_load == OAL_PTR_NULL) {
                continue;
            }

            if (pst_meas_rpt_chn_load->pst_meas_rpt_chn_load_item != OAL_PTR_NULL) {
    ...
    /* Neighbor Report */
    if (en_reqtype == MAC_RRM_TYPE_NEIGHBOR_RPT) {
        do {
            /* 获取节点 */
            pst_meas_rpt_node = pst_rrm_info->st_meas_rpt_list.pst_next;
            pst_meas_rpt_neighbor = OAL_DLIST_GET_ENTRY(pst_meas_rpt_node,
                                                        mac_meas_rpt_neighbor_stru, st_dlist_head_neighbor);
            if (pst_meas_rpt_neighbor == OAL_PTR_NULL) {
                continue;
            }

            if (pst_meas_rpt_neighbor->pst_meas_rpt_neighbor_item != OAL_PTR_NULL) {
...
OAL_STATIC oal_uint32 hmac_wait_meas_rsp_timeout(oal_void *p_arg)
{
    ...
    if (pst_hmac_user->pst_user_rrm_info == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_wait_meas_rsp_timeout::pst_hmac_user->pst_user_rrm_info null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    OAM_WARNING_LOG1(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_RRM,
                     "{hmac_wait_meas_rsp_timeout::en_reqtype=%d.}",
...
oal_uint32 hmac_rrm_get_meas_start_time(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_ANY_NULL_PTR2(pst_hmac_vap, puc_param)) {
        OAM_ERROR_LOG2(0, OAM_SF_RRM, "{hmac_rrm_get_meas_start_time:: null param vap:0x%x puc_param:0x%x.}",
    ...
    if (pst_hmac_vap->bit_11k_enable && pst_hmac_vap->pst_rrm_info != OAL_PTR_NULL) {
...
OAL_STATIC oal_uint32 hmac_rrm_fill_basic_rm_rpt_action(hmac_vap_stru *pst_hmac_vap)
{
    ...
    if (pst_rrm_info->pst_rm_rpt_mgmt_buf != OAL_PTR_NULL) {
        oal_netbuf_free(pst_rrm_info->pst_rm_rpt_mgmt_buf);
        pst_hmac_vap->pst_rrm_info->pst_rm_rpt_mgmt_buf = OAL_PTR_NULL;
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_fill_basic_rm_rpt_action::pst_mgmt_buf not be freed in history.}");
    }

    /* 申请管理帧内存 */
    pst_rrm_info->pst_rm_rpt_mgmt_buf = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF,
                                                             WLAN_LARGE_NETBUF_SIZE, OAL_NETBUF_PRIORITY_MID);
    if (pst_rrm_info->pst_rm_rpt_mgmt_buf == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                       "{hmac_rrm_fill_basic_rm_rpt_action::pst_mgmt_buf null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_mac_user == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(0, OAM_SF_TX, "{hmac_rrm_fill_basic_rm_rpt_action::pst_mac_user[%d] null.",
                         pst_rrm_info->us_req_user_id);
        oal_netbuf_free(pst_rrm_info->pst_rm_rpt_mgmt_buf);
...
OAL_STATIC oal_void hmac_rrm_send_rm_rpt_action(hmac_vap_stru *pst_hmac_vap)
{
    ...
    if (pst_hmac_vap->pst_rrm_info == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                       "{hmac_rrm_send_rm_rpt_action::pst_rrm_info NULL!}");
        return;
    }
    ...
    if (pst_hmac_vap->pst_rrm_info->st_meas_status_timer.en_is_registerd == OAL_TRUE) {
        FRW_TIMER_IMMEDIATE_DESTROY_TIMER(&(pst_hmac_vap->pst_rrm_info->st_meas_status_timer));
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_send_rm_rpt_action:: cancel st_meas_status_timer.}");
    }

    pst_mgmt_buf = pst_hmac_vap->pst_rrm_info->pst_rm_rpt_mgmt_buf;
    if (pst_mgmt_buf == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                       "{hmac_rrm_send_rm_rpt_action::pst_mgmt_buf NULL!}");
        return;
    }

    pst_mac_user = mac_res_get_mac_user_etc(pst_hmac_vap->pst_rrm_info->us_req_user_id);
    if (pst_mac_user == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
            "{hmac_rrm_send_rm_rpt_action::pst_mac_user[%d] null.",
            pst_hmac_vap->pst_rrm_info->us_req_user_id);
    ...
    ul_ret = hmac_tx_mgmt_send_event_etc(&(pst_hmac_vap->st_vap_base_info),
                                         pst_mgmt_buf, pst_hmac_vap->pst_rrm_info->us_rm_rpt_action_len);
    if (ul_ret != OAL_SUCC) {
        oal_netbuf_free(pst_mgmt_buf);
        pst_hmac_vap->pst_rrm_info->pst_rm_rpt_mgmt_buf = OAL_PTR_NULL;
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                       "{hmac_rrm_send_rm_rpt_action::tx link meas rpt action failed.}");
        return;
    }
                                                   ...
                                                   mac_meas_rpt_mode_stru *pst_rptmode)
{
    ...
    if (OAL_ANY_NULL_PTR2(pst_hmac_vap, pst_rptmode)) {
        OAM_ERROR_LOG2(0, OAM_SF_RRM, "{hmac_rrm_encap_meas_rpt_reject:: null param, vap:0x%x rptmode:0x%x!}",
                       (uintptr_t)pst_hmac_vap, (uintptr_t)pst_rptmode);
        return;
    }
    if (pst_hmac_vap->pst_rrm_info == OAL_PTR_NULL) {
    ...
    if (pst_hmac_vap->pst_rrm_info->st_meas_status_timer.en_is_registerd == OAL_TRUE) {
        FRW_TIMER_IMMEDIATE_DESTROY_TIMER(&(pst_hmac_vap->pst_rrm_info->st_meas_status_timer));
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_encap_meas_rpt_reject:: cancel st_meas_status_timer.}");
    }
                                                             ...
                                                             mac_action_rm_req_stru *pst_rm_req)
{
    ...
    if (pst_mgmt_buf == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                       "{hmac_rrm_encap_meas_rpt_refuse_new_req::pst_mgmt_buf null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        oal_netbuf_free(pst_mgmt_buf);
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                       "{hmac_rrm_encap_meas_rpt_refuse_new_req::tx link meas rpt action failed.}");
        return ul_ret;
    }
                                                ...
                                                mac_chn_load_req_stru *pst_chn_load_req)
{
    ...
    ul_ret = mac_get_channel_idx_from_num_etc(en_chan_band, pst_chn_load_req->uc_channum,
                                              &st_scan_req.ast_channel_list[0].uc_chan_idx);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_RRM,
                         "{hmac_rrm_chn_load_scan_do::chn num invalid[%d]}", pst_chn_load_req->uc_channum);
        /* 无效信道回复refuse bit */
        memset_s(&st_rptmode, OAL_SIZEOF(mac_meas_rpt_mode_stru), 0, OAL_SIZEOF(mac_meas_rpt_mode_stru));
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_RRM,
                         "hmac_rrm_chn_load_scan_do:hmac_scan_proc_scan_req_event_etc failed, ret=%d", ul_ret);
        /* 扫描失败回复refuse bit */
        memset_s(&st_rptmode, OAL_SIZEOF(mac_meas_rpt_mode_stru), 0, OAL_SIZEOF(mac_meas_rpt_mode_stru));
        st_rptmode.bit_refused = 1;
        hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
...
OAL_STATIC oal_void hmac_rrm_chn_load_scan_cb(void *p_scan_record)
{
    ...
    if (pst_scan_record->en_scan_rsp_status != MAC_SCAN_SUCCESS) {
        ...
        hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "hmac_chn_load_scan_cb::scan fail, status[%d].",
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_RRM,
                       "{hmac_chn_load_scan_cb: hmac_rrm_fill_basic_rm_rpt_action ret[%d].}", ul_ret);
        return;
    }
                                                ...
                                                mac_meas_req_ie_stru *pst_meas_req_ie)
{
    ...
    if (pst_chn_load_req->us_duration < 10) {
        st_rptmode.bit_refused = 1;
        hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
        OAM_WARNING_LOG1(0, OAM_SF_RRM, "{hmac_rrm_parse_chn_load_req: us_duration[%d] not support.}",
                         pst_chn_load_req->us_duration);
        return;
    }
                                                        ...
                                                        mac_meas_rpt_ie_stru *pst_meas_rpt_ie)
{
    ...
    pst_meas_rpt_chn_load = (mac_meas_rpt_chn_load_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
        OAL_SIZEOF(mac_meas_rpt_chn_load_stru), OAL_TRUE);
    if (pst_meas_rpt_chn_load == OAL_PTR_NULL) {
    ...
    pst_meas_rpt_chn_load_item = (mac_meas_rpt_chn_load_item_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
        OAL_SIZEOF(mac_meas_rpt_chn_load_item_stru), OAL_TRUE);
    if (pst_meas_rpt_chn_load_item == OAL_PTR_NULL) {
        OAL_MEM_FREE(pst_meas_rpt_chn_load, OAL_TRUE);
    ...
    pst_meas_rpt_chn_load_item->uc_chn_load = pst_chn_load_rpt->uc_channel_load; /* fill node end */
                                              ...
                                              mac_bss_dscr_stru *pst_bss_dscr, mac_scan_req_stru *pst_scan_params)
{
    ...
    if (pst_rrm_info->st_bcn_req_info.uc_ssid_len != 0) {
        uc_ssid_len = (oal_uint8)OAL_STRLEN(pst_bss_dscr->ac_ssid);
        /* ssid不匹配的不处理 */
        if ((pst_rrm_info->st_bcn_req_info.uc_ssid_len != uc_ssid_len) ||
            (0 != OAL_MEMCMP(pst_rrm_info->st_bcn_req_info.puc_ssid, pst_bss_dscr->ac_ssid,
                                                ...
                                                oal_dlist_head_stru *pst_bss_list_head)
{
    ...
    if (pst_mac_device == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_encap_meas_rpt_bcn::pst_hmac_device[%d] null.}",
    ...
    OAL_DLIST_SEARCH_FOR_EACH(pst_entry, pst_bss_list_head)
    {
        ...
        if ((pst_rrm_info->us_rm_rpt_action_len + MAC_MEASUREMENT_RPT_FIX_LEN + MAC_BEACON_RPT_FIX_LEN) >
        ...
        if (0) {  // (pst_rrm_info->st_bcn_req_info.uc_rpt_detail)
            hmac_scan_update_bcn_rpt_detail(pst_hmac_vap, pst_bss_dscr,
                                            pst_bcn_rpt_item->auc_subelm + 2, &ul_rpt_detail_act_len);
        ...
        /* 下一个Measurement Report的位置 */
        pst_meas_rpt_ie = (mac_meas_rpt_ie_stru *)((oal_uint8 *)pst_meas_rpt_ie +
                                                   pst_meas_rpt_ie->uc_len + MAC_IE_HDR_LEN);
    }
...
OAL_STATIC oal_void hmac_rrm_bcn_scan_cb(void *p_scan_record)
{
    ...
    if (pst_scan_record->en_scan_rsp_status != MAC_SCAN_SUCCESS) {
        st_rptmode.bit_refused = 1;
        hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id,
                         OAM_SF_RRM, "hmac_bcn_scan_cb::scan fail, status[%d].",
                         pst_scan_record->en_scan_rsp_status);
        return;
    }
...
oal_void hmac_rrm_meas_bcn(hmac_vap_stru *pst_hmac_vap,
                             mac_bcn_req_stru *pst_bcn_req, mac_scan_req_stru *pst_scan_req)
{
    mac_vap_rrm_info_stru *pst_rrm_info;
    ...
    switch (pst_bcn_req->en_mode) {
        ...
        case RM_BCN_REQ_MEAS_MODE_PASSIVE:
            if (OAL_FALSE == mac_mib_get_dot11RMBeaconPassiveMeasurementActivated(&pst_hmac_vap->st_vap_base_info)) {
                OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                                 "passive measurement mode not enable");
                st_rptmode.bit_incapable = 1;
                hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
                return;
            }
        ...
        case RM_BCN_REQ_MEAS_MODE_ACTIVE:
            if (OAL_FALSE == mac_mib_get_dot11RMBeaconActiveMeasurementActivated(&pst_hmac_vap->st_vap_base_info)) {
                OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                                 "active measurement mode not enable");
                st_rptmode.bit_incapable = 1;
                hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
                return;
            }
        ...
        case RM_BCN_REQ_MEAS_MODE_TABLE:
            ...
            hmac_scan_rrm_proc_save_bss_etc(&(pst_hmac_vap->st_vap_base_info),
                                            OAL_SIZEOF(st_trans_req_info), (oal_uint8 *)&st_trans_req_info);
            break;
...
oal_uint32 hmac_rrm_get_bcn_rpt_channels(mac_bcn_req_stru *pst_bcn_req,
                                         mac_ap_chn_rpt_stru **ppst_ap_chn_rpt, oal_uint8 uc_ap_chn_rpt_num,
                                         mac_scan_req_stru *pst_scan_req, wlan_channel_band_enum_uint8 en_chan_band)
{
    oal_uint8 uc_chan_idx;
    ...
    else if (pst_bcn_req->uc_channum == 255) {
        if (uc_ap_chn_rpt_num == 0) {
    ...
    /* 当前chan num */
        ...
        if (ul_ret != OAL_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_RRM,
                "hmac_rrm_get_bcn_rpt_channels: mac_get_channel_idx_from_num_etc fail,error_code=%d", ul_ret);
            return ul_ret;
        }
        /* 临时调试，需要更新管制类表格 */
                                              ...
                                              mac_meas_req_ie_stru *pst_meas_req_ie)
{
    ...
    /*************************************************************************/
    OAM_WARNING_LOG4(0, OAM_SF_RRM,
        "{hmac_rrm_parse_beacon_req::Opt Class[%d],Channel Num[%d],Rand Interval[%u],Meas Duration[%u]}",
    ...
    if (c_bcn_req_sub_len <= 0) {
        ul_ret = hmac_rrm_get_bcn_rpt_channels(pst_bcn_req, apst_ap_chn_rpt,
                                               uc_ap_chn_rpt_count, &st_scan_req,
        ...
        do {
            apst_ap_chn_rpt[uc_ap_chn_rpt_count] =
                (mac_ap_chn_rpt_stru *)mac_find_ie_etc(MAC_EID_AP_CHAN_REPORT,
                                                       puc_ap_ch_rpt_search_addr, c_ap_ch_rpt_search_len);
            if (apst_ap_chn_rpt[uc_ap_chn_rpt_count] == OAL_PTR_NULL) {
                break;
            }
            puc_ap_ch_rpt_search_addr = (oal_uint8 *)apst_ap_chn_rpt[uc_ap_chn_rpt_count] + 2 +
                                        apst_ap_chn_rpt[uc_ap_chn_rpt_count]->uc_length;
            c_ap_ch_rpt_search_len = (oal_int8)(c_bcn_req_sub_len -
                                                (oal_uint8)((oal_uint8 *)apst_ap_chn_rpt[uc_ap_chn_rpt_count] -
                                                pst_bcn_req->auc_subelm) -
                                                (2 + apst_ap_chn_rpt[uc_ap_chn_rpt_count]->uc_length));
            uc_ap_chn_rpt_count++;
            if (uc_ap_chn_rpt_count == MAC_11K_SUPPORT_AP_CHAN_RPT_NUM) {
                OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                                 "ap chan rpt num is larger than 8, truncate the later ones");
                break;
            }
        ...
        if (puc_rpt_info_sub_element != OAL_PTR_NULL) {
            ...
            OAM_WARNING_LOG2(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                             "hmac_rrm_parse_beacon_req::frame_body::rpt_condition[%d],rpt_ref_val[%d].",
                             pst_rrm_info->st_bcn_req_info.uc_rpt_condition,
                             pst_rrm_info->st_bcn_req_info.uc_rpt_ref_val);
            /* Repeat模式下使能Report Condition */
            if ((pst_rrm_info->st_bcn_req_info.uc_rpt_condition) &&
                (!mac_mib_get_dot11RMRepeatedMeasurementsActivated(&pst_hmac_vap->st_vap_base_info) ||
                (!mac_mib_get_dot11RMBeaconMeasurementReportingConditionsActivated(&pst_hmac_vap->st_vap_base_info)) ||
                (pst_rrm_info->st_bcn_req_info.us_repetition == 0))) {
                OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                                 "BeaconMeasurementReportingConditions not enable");
                st_rptmode.bit_incapable = 1;
                hmac_rrm_encap_meas_rpt_reject(pst_hmac_vap, &st_rptmode);
                return;
            }
        ...
        if (puc_ssid_sub_element != OAL_PTR_NULL) {
            ...
            if (puc_ssid_sub_element[1] >= WLAN_SSID_MAX_LEN || puc_ssid_sub_element[1] == 0) {
                OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                               "hmac_rrm_parse_beacon_req::frame_body::ssid_len[%d] invalid.", puc_ssid_sub_element[1]);

                return;
            }

            pst_rrm_info->st_bcn_req_info.uc_ssid_len = *(puc_ssid_sub_element + 1);
            pst_rrm_info->st_bcn_req_info.puc_ssid = OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
                pst_rrm_info->st_bcn_req_info.uc_ssid_len, OAL_TRUE);
            if (pst_rrm_info->st_bcn_req_info.puc_ssid == OAL_PTR_NULL) {
        ...
        if (puc_reporting_detail != OAL_PTR_NULL) {
            pst_rrm_info->st_bcn_req_info.uc_rpt_detail = *(puc_reporting_detail + 2);
            OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                             "hmac_rrm_parse_beacon_req::frame_body::rpt_detail[%d].",
        ...
        if (puc_reqinfo != OAL_PTR_NULL) {
            pst_rrm_info->st_bcn_req_info.uc_req_ie_num = *(puc_reqinfo + 1);
            OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                             "hmac_rrm_parse_beacon_req::frame_body::req_ie_num[%d].",
                             pst_rrm_info->st_bcn_req_info.uc_req_ie_num);
            pst_rrm_info->st_bcn_req_info.puc_reqinfo_ieid = OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
                pst_rrm_info->st_bcn_req_info.uc_req_ie_num, OAL_TRUE);
            if (pst_rrm_info->st_bcn_req_info.puc_reqinfo_ieid == OAL_PTR_NULL) {
                                                   ...
                                                   mac_meas_rpt_ie_stru *pst_meas_rpt_ie)
{
    ...
    /* ---------------------------------------------------------------------  */
    /**************************************************************************/
    pst_meas_rpt_bcn = (mac_meas_rpt_bcn_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
                                                              OAL_SIZEOF(mac_meas_rpt_bcn_stru), OAL_TRUE);
    if (pst_meas_rpt_bcn == OAL_PTR_NULL) {
    ...
    pst_meas_rpt_bcn_item = (mac_meas_rpt_bcn_item_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
        OAL_SIZEOF(mac_meas_rpt_bcn_item_stru), OAL_TRUE);
    if (pst_meas_rpt_bcn_item == OAL_PTR_NULL) {
        OAL_MEM_FREE(pst_meas_rpt_bcn, OAL_TRUE);
        pst_meas_rpt_bcn = OAL_PTR_NULL;
    ...
    /* Parent TSF */
    pst_meas_rpt_bcn_item->ul_parent_tsf = pst_bcn_rpt->ul_parent_tsf; /* fill node end */
                                                     ...
                                                     oal_dlist_head_stru *pst_bss_list_head)
{
    ...
    if (pst_rrm_info == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_encap_meas_rpt_neighbor::pst_rrm_info null.}");
        return;
    }

    /* 设置rpt IE point */
    pst_neighbor_rpt_ie = (mac_neighbor_rpt_ie_stru *)pst_hmac_vap->pst_rrm_info->pst_rm_rpt_action->auc_rpt_ies;
    if (pst_neighbor_rpt_ie == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_encap_meas_rpt_neighbor::pst_neighbor_rpt_ie null.}");
        return;
    }
    ...
    if (pst_mac_device == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "{hmac_rrm_encap_meas_rpt_neighbor::pst_hmac_device[%d] null.}",
                         pst_hmac_vap->st_vap_base_info.uc_device_id);
        return;
    }
    ...
    OAL_DLIST_SEARCH_FOR_EACH(pst_entry, pst_bss_list_head)
    {
        ...
        /* SSID过滤，若请求中ssid长度为0，则不过滤 */
        if (pst_rrm_info->st_neighbor_req_info.uc_ssid_len != 0) {
            uc_ssid_len = (oal_uint8)OAL_STRLEN(pst_bss_dscr->ac_ssid);
            /* ssid不匹配的不处理 */
            if ((pst_rrm_info->st_neighbor_req_info.uc_ssid_len != uc_ssid_len) ||
                (0 != OAL_MEMCMP(pst_rrm_info->st_neighbor_req_info.puc_ssid,
                                 pst_bss_dscr->ac_ssid, pst_rrm_info->st_bcn_req_info.uc_ssid_len))) {
                continue;
            }
        }

        if ((pst_rrm_info->us_rm_rpt_action_len + MAC_IE_HDR_LEN + MAC_NEIGHBOR_REPORT_IE_LEN) >
            WLAN_LARGE_NETBUF_SIZE) {
            break;
        }
        /* Neighbor Report IE */
...
oal_void hmac_rrm_neighbor_scan_do(hmac_vap_stru *pst_hmac_vap,
                                     mac_neighbor_req_info_stru *pst_neighbor_req, oal_bool_enum_uint8 en_local_meas)
{
    mac_scan_req_stru st_scan_req;
    oal_uint32 ul_ret;
    ...
    st_scan_req.uc_probe_delay = 0;
    /* SSID过滤 */
    if (pst_neighbor_req->uc_ssid_len != 0) {
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_RRM,
                         "hmac_rrm_neighbor_scan_do:hmac_scan_proc_scan_req_event_etc failed[%d]", ul_ret);
        if (en_local_meas == OAL_FALSE) {
...
OAL_STATIC oal_void hmac_rrm_neighbor_scan_cb(void *p_scan_record)
{
    ...
    if (pst_scan_record->en_scan_rsp_status != MAC_SCAN_SUCCESS) {
        ...
        hmac_rrm_send_rm_rpt_action(pst_hmac_vap);
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RRM,
                         "hmac_rrm_neighbor_scan_cb::scan fail, status[%d].",
                         pst_scan_record->en_scan_rsp_status);
        return;
    }
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_RRM,
                       "{hmac_rrm_neighbor_scan_cb:hmac_rrm_fill_basic_rm_rpt_action ret[%d]}", ul_ret);
        return;
    }
                                                        ...
                                                        mac_neighbor_rpt_ie_stru *pst_neighbor_rpt_ie)
{
    ...
    /* --------------------------------------------------------------------- */
    /*************************************************************************/
    pst_meas_rpt_neighbor = (mac_meas_rpt_neighbor_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
        OAL_SIZEOF(mac_meas_rpt_neighbor_stru), OAL_TRUE);
    if (pst_meas_rpt_neighbor == OAL_PTR_NULL) {
    ...
    pst_meas_rpt_neighbor_item = (mac_neighbor_rpt_ie_stru *)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,
        OAL_SIZEOF(mac_neighbor_rpt_ie_stru), OAL_TRUE);
    if (pst_meas_rpt_neighbor_item == OAL_PTR_NULL) {
        OAL_MEM_FREE(pst_meas_rpt_neighbor, OAL_TRUE);
    ...
    OAM_WARNING_LOG4(0, OAM_SF_RRM,
                     "{hmac_rrm_get_neighbor_info_from_rpt:bssid_info=0x%x, optclass=%d, channum=%d, phy_type=%d.",
                     *pul_bssid_info,
                     pst_meas_rpt_neighbor_item->uc_optclass,
                     pst_meas_rpt_neighbor_item->uc_channum,
                     pst_meas_rpt_neighbor_item->uc_phy_type); /* fill node end */
...
OAL_STATIC oal_uint32 hmac_rrm_encap_local_bssid_rpt(hmac_vap_stru *pst_hmac_vap)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_RRM,
                       "{hmac_rrm_encap_local_bssid_rpt: hmac_rrm_fill_basic_rm_rpt_action ret[%d].}", ul_ret);
        return ul_ret;
    }
    pst_neighbor_rpt_ie = (mac_neighbor_rpt_ie_stru *)pst_hmac_vap->pst_rrm_info->pst_rm_rpt_action->auc_rpt_ies;
