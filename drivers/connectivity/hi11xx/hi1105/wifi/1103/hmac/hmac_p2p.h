...
extern oal_uint32 hmac_check_p2p_vap_num_etc(mac_device_stru *pst_mac_device,
...
extern oal_void hmac_set_p2p_status_etc(oal_uint32 *pul_p2p_status,
                                        hmac_cfgp2p_status_enum_uint32 en_status);
extern oal_void hmac_clr_p2p_status_etc(oal_uint32 *pul_p2p_status,
                                        hmac_cfgp2p_status_enum_uint32 en_status);

#else /* _PRE_WLAN_FEATURE_P2P */
OAL_STATIC OAL_INLINE oal_uint32 hmac_check_p2p_vap_num_etc(mac_device_stru *pst_mac_device,
                                                            wlan_p2p_mode_enum_uint8 en_p2p_mode)
{
    return OAL_TRUE;
}
