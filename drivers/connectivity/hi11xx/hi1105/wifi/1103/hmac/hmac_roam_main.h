...
oal_uint32 hmac_roam_connect_ft_ds_change_to_air_etc(hmac_vap_stru *pst_hmac_vap,
                                                     oal_void *p_param);
oal_void hmac_roam_add_key_done_etc(hmac_vap_stru *pst_hmac_vap);
oal_void hmac_roam_wpas_connect_state_notify_etc(hmac_vap_stru *pst_hmac_vap,
...
oal_void hmac_roam_home_network_set_thr_etc(oal_int8 c_trigger_rssi,
                                            oal_int8 c_5g_rssi_th,
                                            oal_int8 c_5g_hold_th);
