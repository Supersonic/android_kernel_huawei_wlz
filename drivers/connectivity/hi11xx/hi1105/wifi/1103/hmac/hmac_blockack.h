...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern oal_uint32 hmac_ba_filter_serv_etc(hmac_user_stru *pst_hmac_user,
...
extern oal_uint8 hmac_mgmt_check_set_rx_ba_ok_etc(hmac_vap_stru *pst_hmac_vap,
                                                  hmac_user_stru *pst_hmac_user,
                                                  hmac_ba_rx_stru *pst_ba_rx_info,
                                                  mac_device_stru *pst_device,
                                                  hmac_tid_stru *pst_tid_info);

extern oal_void hmac_reorder_ba_rx_buffer_bar_etc(hmac_ba_rx_stru *pst_rx_ba,
                                                  oal_uint16 us_start_seq_num,
                                                  mac_vap_stru *pst_vap);
extern oal_uint32 hmac_ba_reset_rx_handle_etc(mac_device_stru *pst_mac_device,
                                              hmac_user_stru *pst_hmac_user, oal_uint8 uc_tid,
                                              oal_bool_enum_uint8 en_is_aging);
extern oal_void hmac_up_rx_bar_etc(hmac_vap_stru *pst_hmac_vap,
                                   dmac_rx_ctl_stru *pst_rx_ctl,
                                   oal_netbuf_stru *pst_netbuf);
extern oal_bool_enum_uint8 hmac_is_device_ba_setup_etc(void);
extern oal_void hmac_ba_rx_hdl_init_etc(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user, oal_uint8 uc_tid);
