...
oal_uint32 hmac_init_scan_do_etc(hmac_device_stru *pst_mac_dev, mac_vap_stru *pst_vap,
...
oal_uint32 hmac_acs_got_init_rank(hmac_device_stru *pst_hmac_dev, mac_vap_stru *pst_mac_vap,
...
{
    /* 注册WLAN_CTX事件处理函数表 */
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_MGMT].p_tx_adapt_func =
        hmac_proc_tx_host_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_ADD_USER].p_tx_adapt_func =
        hmac_proc_add_user_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_DEL_USER].p_tx_adapt_func =
        hmac_proc_del_user_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_STA_SET_EDCA_REG].p_tx_adapt_func =
        hmac_proc_set_edca_param_tx_adapt_etc;
#ifdef _PRE_WLAN_FEATURE_11AX
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_STA_SET_MU_EDCA_REG].p_tx_adapt_func =
        hmac_proc_set_mu_edca_param_tx_adapt;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_STA_SET_SPATIAL_REUSE_REG].p_tx_adapt_func =
        hmac_proc_set_spatial_reuse_param_tx_adapt;
#endif
#ifdef _PRE_WLAN_FEATURE_TWT
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_UPDATE_TWT].p_tx_adapt_func =
        hmac_proc_rx_process_twt_sync_event_tx_adapt_etc;
#endif

    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_SCAN_REQ].p_tx_adapt_func =
        hmac_scan_proc_scan_req_event_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_CALI_HMAC2DMAC].p_tx_adapt_func =
        hmac_send_event_netbuf_tx_adapt;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_CALI_MATRIX_HMAC2DMAC].p_tx_adapt_func =
        hmac_send_event_netbuf_tx_adapt;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_APP_IE_H2D].p_tx_adapt_func =
        hmac_send_event_netbuf_tx_adapt;
#ifdef _PRE_WLAN_FEATURE_IP_FILTER
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_IP_FILTER].p_tx_adapt_func =
        hmac_config_update_ip_filter_tx_adapt_etc;
#endif  // _PRE_WLAN_FEATURE_IP_FILTER
#ifdef _PRE_WLAN_FEATURE_APF
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_APF_CMD].p_tx_adapt_func =
        hmac_send_event_netbuf_tx_adapt;
#endif
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_SCHED_SCAN_REQ].p_tx_adapt_func =
        hmac_scan_proc_sched_scan_req_event_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_ASOC_WRITE_REG].p_tx_adapt_func =
        hmac_mgmt_update_user_qos_table_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_JOIN_SET_REG].p_tx_adapt_func =
        hmac_proc_join_set_reg_event_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_JOIN_DTIM_TSF_REG].p_tx_adapt_func =
        hmac_proc_join_set_dtim_reg_event_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_CONN_RESULT].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint32_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_NOTIFY_ALG_ADD_USER].p_tx_adapt_func =
        hmac_user_add_notify_alg_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_BA_SYNC].p_tx_adapt_func =
        hmac_proc_rx_process_sync_event_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WALN_CTX_EVENT_SUB_TYPR_SELECT_CHAN].p_tx_adapt_func =
        hmac_chan_select_channel_mac_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_SWITCH_TO_NEW_CHAN].p_tx_adapt_func =
        hmac_chan_initiate_switch_to_new_channel_tx_adapt_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPR_RESTART_NETWORK].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WALN_CTX_EVENT_SUB_TYPR_DISABLE_TX].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WALN_CTX_EVENT_SUB_TYPR_ENABLE_TX].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;

#ifdef _PRE_WLAN_FEATURE_EDCA_OPT_AP
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPR_EDCA_OPT].p_tx_adapt_func =
        hmac_edca_opt_stat_event_tx_adapt_etc;
#endif
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_DSCR_OPT].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint8_etc;

#ifdef _PRE_WLAN_FEATURE_DFS
#ifdef _PRE_WLAN_FEATURE_OFFCHAN_CAC
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPR_SWITCH_TO_OFF_CHAN].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPR_SWITCH_TO_HOME_CHAN].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
#endif
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1103_HOST)
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WALN_CTX_EVENT_SUB_TYPR_DFS_CAC_CTRL_TX].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
#endif
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPR_DFS_TEST].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
#endif
    g_ast_dmac_wlan_ctx_event_sub_table_etc[DMAC_WLAN_CTX_EVENT_SUB_TYPE_RESET_PSM].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
    ...
    /* 注册HOST_CRX事件处理函数表 */
    g_ast_dmac_host_crx_table_etc[HMAC_TO_DMAC_SYN_INIT].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
    g_ast_dmac_host_crx_table_etc[HMAC_TO_DMAC_SYN_CREATE_CFG_VAP].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16_etc;
...
OAL_STATIC oal_void hmac_event_fsm_rx_adapt_subtable_register(oal_void)
{
    frw_event_sub_rx_adapt_table_init_etc(g_ast_hmac_wlan_drx_event_sub_table_etc,
                                          OAL_SIZEOF(g_ast_hmac_wlan_drx_event_sub_table_etc) /
    ...
    frw_event_sub_rx_adapt_table_init_etc(g_ast_hmac_wlan_crx_event_sub_table_etc,
                                          OAL_SIZEOF(g_ast_hmac_wlan_crx_event_sub_table_etc) /
                                          OAL_SIZEOF(frw_event_sub_table_item_stru),
                                          hmac_hcc_rx_convert_netbuf_to_event_default_etc);

    frw_event_sub_rx_adapt_table_init_etc(g_ast_hmac_wlan_ctx_event_sub_table_etc,
                                          OAL_SIZEOF(g_ast_hmac_wlan_ctx_event_sub_table_etc) /
                                          OAL_SIZEOF(frw_event_sub_table_item_stru),
                                          hmac_hcc_rx_convert_netbuf_to_event_default_etc);

    frw_event_sub_rx_adapt_table_init_etc(g_ast_hmac_tbtt_event_sub_table_etc,
                                          OAL_SIZEOF(g_ast_hmac_tbtt_event_sub_table_etc) /
                                          OAL_SIZEOF(frw_event_sub_table_item_stru),
                                          hmac_hcc_rx_convert_netbuf_to_event_default_etc);

    frw_event_sub_rx_adapt_table_init_etc(g_ast_hmac_wlan_misc_event_sub_table_etc,
                                          OAL_SIZEOF(g_ast_hmac_wlan_misc_event_sub_table_etc) /
                                          OAL_SIZEOF(frw_event_sub_table_item_stru),
                                          hmac_hcc_rx_convert_netbuf_to_event_default_etc);

    /* 注册HMAC模块WLAN_DRX事件子表 */
    g_ast_hmac_wlan_drx_event_sub_table_etc[DMAC_WLAN_DRX_EVENT_SUB_TYPE_RX_DATA].p_rx_adapt_func =
        hmac_rx_process_data_rx_adapt;

    /* 注册HMAC模块WLAN_CRX事件子表 */
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_INIT].p_rx_adapt_func =
        hmac_rx_convert_netbuf_to_netbuf_default_etc;
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_RX].p_rx_adapt_func =
        hmac_rx_process_mgmt_event_rx_adapt_etc;
#ifdef _PRE_WLAN_FEATURE_FLOWCTL
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_FLOWCTL_BACKP].p_rx_adapt_func =
        hmac_alg_flowctl_backp_rx_adapt;
#endif

    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_EVERY_SCAN_RESULT].p_rx_adapt_func =
        hmac_rx_convert_netbuf_to_netbuf_default_etc;

    /* 注册MISC事件子表 */
    g_ast_hmac_wlan_misc_event_sub_table_etc[DMAC_MISC_SUB_TYPE_CALI_TO_HMAC].p_rx_adapt_func =
        hmac_cali2hmac_misc_event_rx_adapt_etc;
...
#ifdef _PRE_WLAN_FEATURE_APF
    g_ast_hmac_wlan_misc_event_sub_table_etc[DMAC_MISC_SUB_TYPE_APF_REPORT].p_rx_adapt_func =
        hmac_apf_program_report_rx_adapt;
#endif

#ifdef _PRE_WLAN_RF_AUTOCALI
    g_ast_hmac_wlan_ctx_event_sub_table_etc[DMAC_TO_HMAC_AUTOCALI_DATA].p_rx_adapt_func =
        hmac_cali2hmac_misc_event_rx_adapt_etc;
#endif
}
...
OAL_STATIC oal_void hmac_event_fsm_action_subtable_register(oal_void)
{
    ...
    g_ast_hmac_wlan_drx_event_sub_table_etc[DMAC_WLAN_DRX_EVENT_SUB_TYPE_TKIP_MIC_FAILE].p_func =
        hmac_rx_tkip_mic_failure_process_etc;
    ...
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_EVERY_SCAN_RESULT].p_func =
        hmac_scan_proc_scanned_bss_etc;
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_SCAN_COMP].p_func =
        hmac_scan_proc_scan_comp_event_etc;
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_CHAN_RESULT].p_func =
        hmac_scan_process_chan_result_event_etc;
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_DISASSOC].p_func =
        hmac_mgmt_send_disasoc_deauth_event_etc;
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_DEAUTH].p_func =
        hmac_mgmt_send_disasoc_deauth_event_etc;
...
#ifdef _PRE_WLAN_FEATURE_FLOWCTL
    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPE_FLOWCTL_BACKP].p_func =
        hmac_flowctl_backp_event;
#endif

    g_ast_hmac_wlan_crx_event_sub_table_etc[DMAC_WLAN_CRX_EVENT_SUB_TYPR_CH_SWITCH_COMPLETE].p_func =
        hmac_chan_switch_to_new_chan_complete_etc;
...
OAL_STATIC ssize_t hmac_show_roam_status(struct kobject *dev, struct kobj_attribute *attr, char *buf)
{
    ...
    for (uc_vap_id = 0; uc_vap_id < WLAN_VAP_SUPPORT_MAX_NUM_LIMIT; uc_vap_id++) {
        ...
        pst_hmac_user_multi =
            (hmac_user_stru *)mac_res_get_hmac_user_etc(pst_hmac_vap->st_vap_base_info.us_multi_user_idx);
        ...
        if (pst_hmac_vap->st_ps_sw_timer.en_is_registerd == OAL_TRUE) {
            ...
            if (pst_hmac_vap->us_check_timer_pause_cnt % 1000 == 0) {
                OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_CFG,
                                 "{hmac_get_pm_pause_func_etc::g_uc_check_timer_cnt[%d]",
                                 pst_hmac_vap->us_check_timer_pause_cnt);
            }

            if (pst_hmac_vap->us_check_timer_pause_cnt > HMAC_SWITCH_STA_PSM_MAX_CNT) {
                uc_is_any_cnt_exceed_limit = OAL_TRUE;
                OAM_ERROR_LOG2(0, OAM_SF_CFG, "{hmac_get_pm_pause_func_etc::sw ps timer cnt too large[%d]> max[%d]}",
                               pst_hmac_vap->us_check_timer_pause_cnt, HMAC_SWITCH_STA_PSM_MAX_CNT);
            }
        } else {
            if (pst_hmac_vap->us_check_timer_pause_cnt != 0) {
                OAM_WARNING_LOG2(0, OAM_SF_CFG, "{hmac_get_pm_pause_func_etc::g_uc_check_timer_cnt end[%d],max[%d]",
                                 pst_hmac_vap->us_check_timer_pause_cnt, HMAC_SWITCH_STA_PSM_MAX_CNT);
            }
...
oal_void hmac_rxdata_update_napi_weight_etc(oal_netdev_priv_stru *pst_netdev_priv)
{
    ...
    if (OAL_TIME_GET_RUNTIME(pst_netdev_priv->ul_period_start, ul_now) > NAPI_STAT_PERIOD) {
        ...
        if (uc_new_napi_weight != pst_netdev_priv->uc_napi_weight) {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_rxdata_update_napi_weight_etc::new_napi_weight [%d]",
                             uc_new_napi_weight);
        }
    }
...
OAL_STATIC oal_uint32 hmac_hisi_cpufreq_init(oal_void)
{
    ...
    if (g_uc_lock_max_cpu_freq_switch == OAL_FALSE) {
        return OAL_SUCC;
    }
...
oal_uint32 hmac_sdt_recv_reg_cmd_etc(mac_vap_stru *pst_mac_vap,
                                     oal_uint8 *puc_buf,
                                     oal_uint16 us_len)
{
...
#ifdef _PRE_WLAN_RF_AUTOCALI
oal_uint32 hmac_sdt_recv_autocali_cmd(mac_vap_stru *pst_mac_vap,
                                      oal_uint8 *puc_buf,
                                      oal_uint16 us_len)
{
    frw_event_mem_stru *pst_event_mem;
    ...
    for (uc_tid = 0; uc_tid < WLAN_TID_MAX_NUM; uc_tid++) {
        ...
        if (ul_ret != OAL_SUCC) {
            OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY,
                             "{hmac_del_ba_event::hmac_mgmt_tx_action_etc failed.}");
            continue;
        }
    }
...
oal_uint32 hmac_config_set_acs_cmd(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_device, pst_hmac_device->pst_device_base_info, puc_param)) {
        OAM_ERROR_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                       "{hmac_config_set_acs_cmd::null param,pst_hmac_device=%x puc_param=%x}",
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{hmac_config_set_acs_cmd::hmac_config_send_event_etc failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32 hmac_flowctl_backp_event(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (pst_mac_vap == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_flowctl_backp_event::pst_mac_vap null,vap id=[%d].}",
    ...
    if (pst_flowctl_backp_event->us_assoc_id == 0xFFFF) {
    ...
    } else if (pst_flowctl_backp_event->uc_tidno == WLAN_TID_MAX_NUM) {
        ...
        if (OAL_UNLIKELY(pst_hmac_user == OAL_PTR_NULL)) {
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_flowctl_backp_event::null param,pst_hmac_user[%d].}",
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                         "{hmac_flowctl_backp_event::frw_event_dispatch_event_etc null.}", ul_ret);
        return ul_ret;
    }
