...
extern oal_void hmac_sta_handle_disassoc_rsp_etc(hmac_vap_stru *pst_hmac_vap,
...
extern oal_uint32 hmac_sta_get_user_protocol_etc(mac_bss_dscr_stru *pst_bss_dscr,
                                                 wlan_protocol_enum_uint8 *pen_protocol_mode);
oal_void hmac_sta_update_wmm_info(hmac_vap_stru *pst_hmac_vap, mac_user_stru *pst_mac_user,
                                  oal_uint8 *puc_wmm_ie);
#ifdef _PRE_WLAN_FEATURE_20_40_80_COEXIST
oal_void hmac_update_join_req_params_2040_etc(mac_vap_stru *pst_mac_vap,
                                              mac_bss_dscr_stru *pst_bss_dscr);
#endif
extern oal_uint32 hmac_sta_up_update_edca_params_machw_etc(hmac_vap_stru *pst_hmac_sta,
...
extern oal_void hmac_sta_up_update_edca_params_etc(oal_uint8 *puc_payload,
...
extern oal_uint32 hmac_process_assoc_rsp_etc(hmac_vap_stru *pst_hmac_sta,
                                             ...
                                             oal_uint16 us_msg_len);
extern oal_uint32 hmac_sta_sync_vap(hmac_vap_stru *pst_hmac_vap, mac_channel_stru *pst_channel,
                                    wlan_protocol_enum_uint8 en_protocol);
extern oal_uint8 *hmac_sta_find_ie_in_probe_rsp_etc(mac_vap_stru *pst_mac_vap, oal_uint8 uc_eid,
                                                    oal_uint16 *pus_index);
extern oal_uint32 hmac_sta_get_min_rate(dmac_set_rate_stru *pst_rate_params,
                                        hmac_join_req_stru *pst_join_req);

#ifdef _PRE_WLAN_FEATURE_11AX
extern oal_uint32 hmac_sta_up_update_mu_edca_params_machw(hmac_vap_stru *pst_hmac_sta,
                                                          mac_wmm_set_param_type_enum_uint8 en_wmm_set_param_type);
#endif
#ifdef __cplusplus
#if __cplusplus
