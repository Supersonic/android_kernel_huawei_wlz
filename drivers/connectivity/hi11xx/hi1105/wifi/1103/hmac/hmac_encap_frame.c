...
oal_uint16 hmac_encap_sa_query_req_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_data,
...
oal_uint16 hmac_mgmt_encap_deauth_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_data,
    ...
    if (us_err_code & MAC_SEND_TWO_DEAUTH_FLAG) {
        ...
        if (OAL_UNLIKELY(pst_mac_device == OAL_PTR_NULL)) {
            ...
            OAM_ERROR_LOG1(0, OAM_SF_ANY,
                           "{hmac_mgmt_encap_deauth_etc::pst_mac_device[%d] null!}",
        ...
        if (ul_ret == OAL_SUCC) {
            ...
            if (pst_up_vap2->pst_mib_info == OAL_PTR_NULL) {
                ...
                OAM_ERROR_LOG0(pst_up_vap2->uc_vap_id, OAM_SF_AUTH,
                               "hmac_mgmt_encap_deauth_etc: pst_up_vap2 mib ptr null.");
                return us_deauth_len;
            }
        ...
        OAM_WARNING_LOG1(0, OAM_SF_AUTH,
                         "hmac_mgmt_encap_deauth_etc: send the second deauth frame. error code:%d", us_err_code);
    } else
#endif
    {
        if (pst_mac_vap->pst_mib_info == OAL_PTR_NULL) {
            ...
            OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_AUTH,
                           "hmac_mgmt_encap_deauth_etc: pst_mac_vap mib ptr null.");
            return us_deauth_len;
        }
...
oal_uint16 hmac_mgmt_encap_disassoc_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_data,
