...
extern oal_void hmac_handle_disconnect_rsp_ap_etc(hmac_vap_stru *pst_hmac_vap,
...
extern oal_uint32 hmac_ap_save_user_assoc_req(hmac_user_stru *pst_hmac_user, oal_uint8 *puc_payload,
