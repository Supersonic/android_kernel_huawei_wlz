...
oal_uint32 hmac_roam_connect_set_dtim_param_etc(mac_vap_stru *pst_mac_vap, oal_uint8 uc_dtim_cnt,
...
oal_void hmac_roam_connect_rx_mgmt_etc(hmac_vap_stru *pst_hmac_vap,
