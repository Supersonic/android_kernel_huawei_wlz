...
/* 10 函数声明 */
extern oal_uint32 hmac_wds_update_table(hmac_vap_stru *pst_hmac_vap, oal_uint8 *puc_node_mac,
                                        oal_uint8 *puc_sta_mac, oal_uint8 uc_update_mode);
...
extern oal_uint32 hmac_wds_add_sta(hmac_vap_stru *pst_hmac_vap,
                                   oal_uint8 *puc_node_mac, oal_uint8 *puc_sta_mac);
extern oal_uint32 hmac_wds_del_sta(hmac_vap_stru *pst_hmac_vap, oal_uint8 *puc_addr);
extern oal_uint32 hmac_find_valid_user_by_wds_sta(hmac_vap_stru *pst_hmac_vap,
                                                  oal_uint8 *puc_sta_mac_addr, oal_uint16 *pus_user_idx);
extern oal_uint32 hmac_wds_node_ergodic(hmac_vap_stru *pst_hmac_vap, oal_uint8 *src_addr,
                                        p_hmac_wds_node_func pst_hmac_wds_node, oal_void *pst_arg);
...
#ifdef _PRE_WLAN_FEATURE_VIRTUAL_MULTI_STA
extern oal_bool_enum_uint8 hmac_vmsta_get_user_a4_support(hmac_vap_stru *pst_hmac_vap,
                                                          oal_uint8 *pst_addr);
extern oal_bool_enum_uint8 hmac_vmsta_check_vap_a4_support(oal_uint8 *puc_ie, oal_uint32 ul_ie_len);
extern oal_bool_enum_uint8 hmac_vmsta_check_user_a4_support(oal_uint8 *puc_frame,
...
extern oal_uint32 hmac_wds_find_sta(hmac_vap_stru *pst_hmac_vap, oal_uint8 *puc_addr,
                                    hmac_wds_stas_stru **ppst_wds_node);
extern oal_uint32 hmac_wds_tx_broadcast_pkt(hmac_vap_stru *pst_vap,
                                            oal_uint8 *puc_addr, oal_void *pst_arg);
