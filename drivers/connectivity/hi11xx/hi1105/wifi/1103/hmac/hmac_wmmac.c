                                         ...
                                         mac_wmm_tspec_stru *pst_delts_args)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_tx_delts::frw_event_dispatch_event_etc failed[%d].}", ul_ret);
        oal_netbuf_free(pst_delts);
                                             ...
                                             mac_wmm_tspec_stru *pst_addts_args)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_tx_addts_req::frw_event_dispatch_event_etc failed[%d].}", ul_ret);
        oal_netbuf_free(pst_addts_req);
        FRW_EVENT_FREE(pst_event_mem);
        return ul_ret;
    }
...
oal_uint32 hmac_mgmt_rx_addts_rsp_etc(hmac_vap_stru *pst_hmac_vap,
                                      hmac_user_stru *pst_hmac_user,
                                      oal_uint8 *puc_payload)
{
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_vap, pst_hmac_user, puc_payload)) {
        OAM_ERROR_LOG3(0, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_rsp_etc::null param, %p %p %p.}",
    ...
    if (uc_user_prio >= WLAN_TID_MAX_NUM) {
        ...
        OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_rsp_etc::addts rsp tsid[%d]} token[%d] status[%d]",
    ...
    if (pst_ts->uc_tsid != uc_tsid) {
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_rsp_etc::addba rsp tsid[%d],old_tsid[%d]} ",
    ...
    if (uc_dialog_token != pst_ts->uc_ts_dialog_token) {
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_rsp_etc::addts rspuc_dialog_token wrong.rsp dialog[%d], req dialog[%d]}",
    ...
    OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
                     "{hmac_mgmt_rx_addts_rsp_etc::medium_time[%d], tsid[%d], uc_up[%d], en_direction[%d].}",
    ...
    OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
                     "{hmac_mgmt_rx_addts_rsp_etc::ts status[%d], dialog_token[%d], vap id[%d], ac num[%d].}",
...
oal_uint32 hmac_mgmt_rx_delts_etc(hmac_vap_stru *pst_hmac_vap,
                                  hmac_user_stru *pst_hmac_user,
                                  oal_uint8 *puc_payload)
{
    mac_vap_stru *pst_mac_vap = OAL_PTR_NULL;
    ...
    if (OAL_ANY_NULL_PTR3(pst_hmac_vap, pst_hmac_user, puc_payload)) {
        OAM_ERROR_LOG3(0, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_delts_etc::null param, %p %p %p.}",
            (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)puc_payload);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (uc_tsid >= WLAN_TID_MAX_NUM) {
        /* 对于tid > 7的resp直接忽略 */
        OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_delts_etc::tsid[%d]} token[%d] status[%d]",
    ...
    for (uc_ac_num = 0; uc_ac_num < WLAN_WME_AC_BUTT; uc_ac_num++) {
        ...
        if (pst_ts->uc_tsid != uc_tsid) {
            OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
                "{hmac_mgmt_rx_delts_etc::tsid[%d],old_tsid[%d]} ", uc_tsid, pst_ts->uc_tsid);
            continue;
        }
...
oal_uint32 hmac_mgmt_rx_addts_req_frame_etc(hmac_vap_stru *pst_hmac_vap, oal_netbuf_stru *pst_netbuf)
{
    ...
    if (OAL_ANY_NULL_PTR2(pst_hmac_vap, pst_netbuf)) {
        OAM_ERROR_LOG2(0, OAM_SF_WMMAC,
                       "{hmac_mgmt_rx_addts_req_frame_etc::pst_hmac_vap = [%x], pst_netbuf = [%x]!}\r\n",
    ...
    if (pst_mac_user == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_req_frame_etc::pst_mac_user null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_addts_rsp == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_req_frame_etc::pst_addts_rsp null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (us_frame_len == 0) {
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_req_frame_etc::encap_addts_rsp, but frame len is zero.}");
    ...
    if (ul_ret != OAL_SUCC) {
        oal_netbuf_free(pst_addts_rsp);
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_WMMAC,
            "{hmac_mgmt_rx_addts_req_frame_etc::hmac_tx_mgmt_send_event_etc failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32 hmac_config_addts_req_etc(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (g_en_wmmac_switch_etc == OAL_FALSE) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_config_addts_req_etc::wmmac switch is false[%d].}", g_en_wmmac_switch_etc);
        return OAL_SUCC;
    }
    ...
    if (OAL_FALSE == mac_mib_get_QAPEDCATableMandatory(&(pst_hmac_vap->st_vap_base_info), uc_ac)) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_config_addts_req_etc::user prio[%d] is false.}", uc_ac);
        return OAL_SUCC;
    }
...
oal_uint32 hmac_config_delts_etc(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (g_en_wmmac_switch_etc == OAL_FALSE) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_config_delts_etc::wmmac switch is false[%d].}", g_en_wmmac_switch_etc);
        return OAL_SUCC;
    }
...
oal_uint32 hmac_config_wmmac_switch_etc(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (pst_hmac_user == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_config_wmmac_switch_etc::pst_hmac_user is deleted already.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_config_wmmac_switch_etc::hmac_config_send_event_etc failed[%d].}", ul_ret);
        return ul_ret;
    }
#endif
...
oal_uint32 hmac_tx_mgmt_reassoc_req_etc(hmac_vap_stru *pst_hmac_vap_sta)
{
    ...
    if (pst_asoc_req_frame == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap_sta->st_vap_base_info.uc_vap_id, OAM_SF_ASSOC,
            "{hmac_tx_mgmt_reassoc_req_etc::pst_asoc_req_frame null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    ul_asoc_frame_len = hmac_mgmt_encap_asoc_req_sta_etc(pst_hmac_vap_sta,
        (oal_uint8 *)(OAL_NETBUF_HEADER(pst_asoc_req_frame)), puc_curr_bssid);
    oal_netbuf_put(pst_asoc_req_frame, ul_asoc_frame_len);

    if (ul_asoc_frame_len == 0) {
        OAM_WARNING_LOG0(pst_hmac_vap_sta->st_vap_base_info.uc_vap_id, OAM_SF_ASSOC,
            "{hmac_tx_mgmt_reassoc_req_etc::hmac_mgmt_encap_asoc_req_sta_etc null.}");
    ...
    if (pst_hmac_user_ap == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap_sta->st_vap_base_info.uc_vap_id, OAM_SF_ASSOC,
            "{hmac_tx_mgmt_reassoc_req_etc::pst_hmac_user_ap null.}");
        oal_netbuf_free(pst_asoc_req_frame);
    ...
    /* 抛事件让DMAC将该帧发送 */
    ul_ret = hmac_tx_mgmt_send_event_etc(&(pst_hmac_vap_sta->st_vap_base_info),
                                         pst_asoc_req_frame,
                                         (oal_uint16)ul_asoc_frame_len);
    if (ul_ret != OAL_SUCC) {
        oal_netbuf_free(pst_asoc_req_frame);
        OAM_WARNING_LOG1(pst_hmac_vap_sta->st_vap_base_info.uc_vap_id, OAM_SF_ASSOC,
            "{mac_tx_mgmt_reassoc_req::hmac_tx_mgmt_send_event_etc failed[%d].}", ul_ret);
        return ul_ret;
    }
    return OAL_SUCC;
}
...
oal_uint32 hmac_config_reassoc_req_etc(mac_vap_stru *pst_mac_vap)
{
    ...
    if (g_en_wmmac_switch_etc == OAL_FALSE) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC,
            "{hmac_config_reassoc_req_etc::wmmac switch is false[%d].}",
            g_en_wmmac_switch_etc);
        return OAL_SUCC;
    }
