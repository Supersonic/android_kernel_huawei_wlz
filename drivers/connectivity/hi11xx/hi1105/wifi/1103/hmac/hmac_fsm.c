...
oal_void hmac_fsm_change_state_check_etc(hmac_vap_stru *pst_hmac_vap,
...
oal_void hmac_fsm_change_state_etc(hmac_vap_stru *pst_hmac_vap, mac_vap_state_enum_uint8 en_vap_state)
{
    ...
    ul_ret = hmac_config_vap_state_syn_etc(&(pst_hmac_vap->st_vap_base_info),
                                           sizeof(en_vap_state),
...
OAL_STATIC oal_void hmac_fsm_init_sta(oal_void)
{
    ...
    */
    ...
    g_pa_hmac_sta_fsm_func[MAC_VAP_STATE_STA_JOIN_COMP][HMAC_FSM_INPUT_RX_MGMT]      = hmac_sta_not_up_rx_mgmt_etc;
#endif
...
oal_uint32 hmac_fsm_call_func_ap_etc(hmac_vap_stru *pst_hmac_vap,
...
oal_uint32 hmac_fsm_call_func_sta_etc(hmac_vap_stru *pst_hmac_vap,
                                      hmac_fsm_input_type_enum_uint8 en_input,
                                      oal_void *p_param)
{
    if (OAL_UNLIKELY(pst_hmac_vap == OAL_PTR_NULL)) {
