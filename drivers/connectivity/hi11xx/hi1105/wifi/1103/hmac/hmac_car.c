...
OAL_STATIC oal_uint32 hmac_car_inject_token(hmac_device_stru *pst_hmac_dev, hmac_car_limit_stru *pst_car_cfg)
{
    ...
    if (pst_car_cfg == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(0, OAM_SF_CAR, "{hmac_car_inject_token::pst_car_cfg null}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    /* 注入令牌 */
    if (pst_car_cfg->en_car_limit_flag == OAL_TRUE) {
        if (pst_car_cfg->en_car_same_left_bytes_flag == OAL_FALSE) {
            // 将Kbit 转化为 Byte; 采用64bit存储数据，64bit除法用do_div; win32下可以直接除/
            ull_left_bytes_tmp =
                ((oal_uint64)pst_car_cfg->ul_car_limit_kbps * (1024 >> 3) * pst_hmac_dev->us_car_ctl_cycle_ms);
        ...
        } else if (pst_car_cfg->en_car_same_left_bytes_flag == OAL_TRUE) {
            pst_car_cfg->ul_car_limit_left_bytes = pst_car_cfg->ul_car_orgin_limit_left_bytes;
        } else {
            OAM_ERROR_LOG1(0, OAM_SF_CAR, "{hmac_car_inject_token::en_car_same_left_bytes_flag[%d]}",
                           pst_car_cfg->en_car_same_left_bytes_flag);
            return OAL_FAIL;
        }

        OAM_INFO_LOG3(0, OAM_SF_CAR,
            "{hmac_car_inject_token:: en_car_limit_flag:%d, en_car_same_left_bytes_flag:%d,ul_car_limit_left_bytes:%d}",
            pst_car_cfg->en_car_limit_flag,
...
OAL_STATIC oal_uint32 hmac_car_inject_device_token(hmac_device_stru *pst_hmac_dev)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_CAR,
            "{hmac_car_inject_device_token::hmac_car_inject_token device down MULTICAST wrong![%d]}", ul_ret);
        return ul_ret;
    }

    // 组播PPS注入
    pst_hmac_dev->st_car_device_multicast_cfg.ul_car_multicast_pps_num_left =
        pst_hmac_dev->st_car_device_multicast_cfg.ul_car_orgin_multicast_pps_num;
...
OAL_STATIC oal_uint32 hmac_car_limit_timer_timeout_handle(oal_void *pst_void_hmac_dev)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_CAR,
                       "{hmac_car_limit_timer_timeout_handle::hmac_car_inject_token down wrong![%d]}", ul_ret);
        return ul_ret;
    }
    ...
    for (uc_vap_index = 0; uc_vap_index < pst_mac_device->uc_vap_num; uc_vap_index++) {
        ...
        if (pst_mac_vap == OAL_PTR_NULL) {
            OAM_ERROR_LOG1(0, OAM_SF_CAR, "{hmac_car_limit_timer_timeout_handle::pst_vap null,vap_id=%d.}",
        ...
        if (pst_mac_vap->en_vap_mode != WLAN_VAP_MODE_BSS_AP) {
            OAM_INFO_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_TX,
                          "{hmac_car_limit_timer_timeout_handle:: CAR only used in AP mode; en_vap_mode=%d.}",
...
oal_uint32 hmac_car_device_multicast(hmac_device_stru *pst_hmac_dev, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    pst_car_device_cfg->en_car_limit_flag = ((pst_car_device_cfg->ul_car_limit_kbps != 0) ||
        (pst_car_device_cfg->ul_car_orgin_multicast_pps_num != 0)) ? 1 : 0;
    // flag置为0，说明下一次需要重新计算剩余令牌数
    pst_car_device_cfg->en_car_same_left_bytes_flag = OAL_FALSE;

    OAM_WARNING_LOG3(0, OAM_SF_CAR,
                     "{hmac_car_device_multicast: uc_device_id[%d], ul_car_limit_kbps =[%d], uc_car_limit_flag =[%d]}",
...
oal_uint32 hmac_car_device_multicast_pps_num(hmac_device_stru *pst_hmac_dev, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    pst_car_device_cfg->ul_car_orgin_multicast_pps_num =
        pst_car_cfg_param->ul_car_multicast_pps_num * pst_hmac_dev->us_car_ctl_cycle_ms / 1000;
    pst_car_device_cfg->en_car_limit_flag = ((pst_car_device_cfg->ul_car_orgin_multicast_pps_num != 0) ||
                                             (pst_car_device_cfg->ul_car_limit_kbps != 0))
                                            ? 1
                                            : 0;

    OAM_WARNING_LOG4(0, OAM_SF_CAR,
        "{hmac_car_device_multicast_pps_num: uc_device_id[%d], cfg_pps_num =[%d], cycle_ms =[%d], orgin_pps_num[%d] }",
        pst_hmac_dev->pst_device_base_info->uc_device_id,
...
oal_uint32 hmac_car_device_bw_limit(hmac_device_stru *pst_hmac_dev, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    OAM_WARNING_LOG3(0, OAM_SF_CAR,
                     "{hmac_car_device_bw_limit: uc_device_id[%d], ul_car_limit_kbps =[%d], uc_car_limit_flag =[%d]}",
                     pst_hmac_dev->pst_device_base_info->uc_device_id,
                     pst_car_device_cfg->ul_car_limit_kbps,
                     pst_car_device_cfg->en_car_limit_flag);
...
oal_uint32 hmac_car_vap_bw_limit(hmac_vap_stru *pst_hmac_vap, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    OAM_WARNING_LOG3(0, OAM_SF_CAR,
                     "{hmac_car_vap_bw_limit: uc_vap_id[d], ul_car_limit_kbps =[%d], uc_car_limit_flag =[%d]}",
...
oal_uint32 hmac_car_user_bw_limit(hmac_vap_stru *pst_hmac_vap, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    pst_hmac_user = mac_vap_get_hmac_user_by_addr_etc(&pst_hmac_vap->st_vap_base_info,
                                                      pst_car_cfg_param->auc_user_macaddr);
    if (pst_hmac_user == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_MULTI_TRAFFIC,
                       "{hmac_car_user_bw_limit: mac_vap_find_user_by_macaddr_etc failed}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    OAM_WARNING_LOG4(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_MULTI_TRAFFIC,
                     "{hmac_car_user_bw_limit: uc_vap_id[%d], user_id = %d, bw = %d, flag = %d \n}",
                     pst_hmac_vap->st_vap_base_info.uc_vap_id,
...
oal_uint32 hmac_car_device_timer_cycle_limit(hmac_device_stru *pst_hmac_dev, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    if (pst_hmac_dev->pst_device_base_info) {
        ...
        // 若car未使能，则关闭定时器
        if (pst_hmac_dev->en_car_enable_flag == OAL_FALSE) {
...
oal_uint32 hmac_car_enable_switch(hmac_device_stru *pst_hmac_dev, mac_cfg_car_stru *pst_car_cfg_param)
{
    ...
    if (pst_hmac_dev->en_car_enable_flag == OAL_TRUE) {
        /* 打开定时器 */
        if (pst_hmac_dev->st_car_timer.en_is_enabled == OAL_FALSE) {
            ...
            OAM_WARNING_LOG1(0, OAM_SF_CAR, "{hmac_car_enable_switch:: car_enable[%d].}",
                             pst_hmac_dev->en_car_enable_flag);
        }
...
oal_uint32 hmac_car_show_info(hmac_device_stru *pst_hmac_dev)
{
    ...
    OAL_IO_PRINT("\n******************************************************\n");
    OAL_IO_PRINT("car_enable_switch:[%d]    timer_timeout:[%d]",
                 pst_hmac_dev->en_car_enable_flag,
                 pst_hmac_dev->us_car_ctl_cycle_ms);
    OAL_IO_PRINT("   device: id[%d]\n"
        ...
        pst_hmac_dev->st_car_device_cfg[HMAC_CAR_UPLINK].en_car_limit_flag,
        pst_hmac_dev->st_car_device_cfg[HMAC_CAR_UPLINK].ul_car_limit_kbps,
        pst_hmac_dev->ul_car_packet_drop_num[HMAC_CAR_UPLINK],
        pst_hmac_dev->st_car_device_cfg[HMAC_CAR_DOWNLINK].en_car_limit_flag,
        pst_hmac_dev->st_car_device_cfg[HMAC_CAR_DOWNLINK].ul_car_limit_kbps,
        pst_hmac_dev->ul_car_packet_drop_num[HMAC_CAR_DOWNLINK],
        pst_hmac_dev->st_car_device_multicast_cfg.en_car_limit_flag,
        pst_hmac_dev->st_car_device_multicast_cfg.ul_car_limit_kbps,
    ...
    for (uc_vap_index = 0; uc_vap_index < pst_mac_device->uc_vap_num; uc_vap_index++) {
        pst_mac_vap = (mac_vap_stru *)mac_res_get_mac_vap(pst_mac_device->auc_vap_id[uc_vap_index]);
        if (pst_mac_vap == OAL_PTR_NULL) {
            OAM_ERROR_LOG1(0, OAM_SF_CAR, "{hmac_car_show_info::pst_vap null,vap_id=%d.}",
                           pst_mac_device->auc_vap_id[uc_vap_index]);
            continue;
        }
        ...
        if (pst_mac_vap->en_vap_mode != WLAN_VAP_MODE_BSS_AP) {
            OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_TX,
                             "{hmac_car_show_info:: CAR only used in AP mode; en_vap_mode=%d.}",
                             pst_mac_vap->en_vap_mode);
            continue;
        }
        ...
        OAL_IO_PRINT("   vap: id:[%d]\n"
                     ...
                     pst_hmac_vap->st_car_vap_cfg[HMAC_CAR_UPLINK].en_car_limit_flag,
                     pst_hmac_vap->st_car_vap_cfg[HMAC_CAR_UPLINK].ul_car_limit_kbps,
                     pst_hmac_vap->st_car_vap_cfg[HMAC_CAR_DOWNLINK].en_car_limit_flag,
                     pst_hmac_vap->st_car_vap_cfg[HMAC_CAR_DOWNLINK].ul_car_limit_kbps);
        ...
        HMAC_VAP_FOREACH_USER(pst_mac_user, &pst_hmac_vap->st_vap_base_info, pst_list_pos)
        {
            ...
            OAL_IO_PRINT("          uplink:   flag:[%d] limit_kbps_bw:[%d]\n"
                         "          downlink: flag:[%d] limit_kbps_bw:[%d]\n\n",
                         pst_hmac_user->st_car_user_cfg[HMAC_CAR_UPLINK].en_car_limit_flag,
                         pst_hmac_user->st_car_user_cfg[HMAC_CAR_UPLINK].ul_car_limit_kbps,
                         pst_hmac_user->st_car_user_cfg[HMAC_CAR_DOWNLINK].en_car_limit_flag,
                         pst_hmac_user->st_car_user_cfg[HMAC_CAR_DOWNLINK].ul_car_limit_kbps);
        }
    }
...
{
    if (pst_car_cfg->en_car_limit_flag == OAL_FALSE) {
        return HMAC_TX_PASS;
    }
    ...
    pst_car_cfg->ul_car_limit_left_bytes = (pst_car_cfg->ul_car_limit_left_bytes > us_mpdu_payload_len) ?
        (pst_car_cfg->ul_car_limit_left_bytes - us_mpdu_payload_len) : 0;

    OAM_INFO_LOG3(0, OAM_SF_CAR,
        "{hmac_car_consume_process:: car_orgin_limit_left_bytes:%d, car_limit_left_bytes:%d, mpdu_payload_len:%d}",
                                   ...
                                   oal_netbuf_stru *pst_netbuf, hmac_car_up_down_type_enum_uint8 en_car_type)
{
    ...
    if (OAL_UNLIKELY(pst_hmac_dev == OAL_PTR_NULL)) {
        return OAL_ERR_CODE_PTR_NULL;
    }
    // 若car没使能，则直接返回succ
    if (pst_hmac_dev->en_car_enable_flag == OAL_FALSE) {
    ...
    if (OAL_UNLIKELY(pst_hmac_user == OAL_PTR_NULL)) {
        OAM_WARNING_LOG1(0, OAM_SF_CAR, "{hmac_car_process_uplink::mac_res_get_hmac_user_etc error, user id=%d}",
                         us_ta_user_idx);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC oal_uint32 hmac_car_judge_packet_drop(hmac_vap_stru *pst_hmac_vap,
                                                 hmac_car_limit_stru *pst_car_device_cfg,
                                                 hmac_car_limit_stru *pst_car_vap_cfg,
                                                 hmac_car_limit_stru *pst_car_user_cfg,
                                                 oal_uint16 us_mpdu_payload_len)
{
    ...
    if (ul_ret == HMAC_TX_DROP_CAR_LIMIT) {
        return HMAC_TX_DROP_CAR_LIMIT;
    }
                            ...
                            hmac_car_up_down_type_enum_uint8 en_car_type)
{
    ...
    if (pst_hmac_vap->st_vap_base_info.en_vap_mode != WLAN_VAP_MODE_BSS_AP) {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_TX,
                         "{hmac_car_process:: CAR only used in AP mode; en_vap_mode=%d.}",
    ...
    // 上行 RX需要减去20
    if (en_car_type == HMAC_CAR_UPLINK) {
        us_mpdu_payload_len -= HMAC_CAR_WIFI_ETH;
    }

    ul_ret = hmac_car_judge_packet_drop(pst_hmac_vap, pst_car_device_cfg,
                                        pst_car_vap_cfg, pst_car_user_cfg,
                                        us_mpdu_payload_len);
    if (ul_ret == HMAC_TX_DROP_CAR_LIMIT) {
...
oal_uint32 hmac_car_multicast_process(hmac_device_stru *pst_hmac_dev, oal_netbuf_stru *pst_buf)
{
    ...
    OAM_INFO_LOG4(0, OAM_SF_CAR,
        "{hmac_car_multicast_process::car_limit_flag:%d car_limit_left_bytes:%d, mpdu_payload_len:%d, pps_left_num:%d}",
    ...
    if (pst_car_device_multicast_cfg->en_car_limit_flag == OAL_FALSE) {
        return OAL_SUCC;
    }
    ...
    if (pst_car_device_multicast_cfg->ul_car_limit_kbps) {
        ...
        if (ul_ret == HMAC_TX_DROP_CAR_LIMIT) {
            pst_hmac_dev->ul_car_multicast_packet_drop_num++;
            OAM_WARNING_LOG2(0, OAM_SF_CAR, "{hmac_car_multicast_process:: left_bytes[%d], consume[%d]}",
                             pst_car_device_multicast_cfg->ul_car_limit_left_bytes,
                             us_mpdu_payload_len);
            return HMAC_TX_DROP_CAR_LIMIT;
        }
