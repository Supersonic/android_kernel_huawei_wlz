...
#define HMAC_RRM_CAL_CHN_LOAD(_pst_chan_results) \
    ...
    ((((_pst_chan_results)->ul_total_stats_time_us) - ((_pst_chan_results)->ul_total_free_time_20M_us)) * 255 /   \
...
extern oal_uint32 hmac_rrm_bcn_rpt_notify_hook(hmac_user_stru *pst_hmac_user,
    mac_rrm_state_enum en_rpt_state);
extern oal_uint32 hmac_rrm_proc_rm_report(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
...
extern oal_uint32 hmac_rrm_proc_rm_request(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    oal_netbuf_stru *pst_netbuf);
extern oal_uint32 hmac_rrm_get_meas_start_time(mac_vap_stru *pst_mac_vap,
    oal_uint8 uc_len, oal_uint8 *puc_param);
extern oal_uint32 hmac_rrm_proc_neighbor_request(hmac_vap_stru *pst_hmac_vap,
    hmac_user_stru *pst_hmac_user, oal_netbuf_stru *pst_netbuf);
extern oal_uint32 hmac_rrm_proc_neighbor_report(hmac_vap_stru *pst_hmac_vap,
    hmac_user_stru *pst_hmac_user, oal_netbuf_stru *pst_netbuf);
extern oal_uint32 hmac_rrm_neighbor_rpt_notify_hook(hmac_user_stru *pst_hmac_user,
    mac_rrm_state_enum en_rpt_state);
extern oal_void hmac_rrm_neighbor_scan_do(hmac_vap_stru *pst_hmac_vap,
    mac_neighbor_req_info_stru *pst_neighbor_req, oal_bool_enum_uint8 en_local_meas);
extern oal_void hmac_rrm_free_rpt_list(hmac_user_stru *pst_hmac_user, mac_rrm_type_enum en_reqtype);
