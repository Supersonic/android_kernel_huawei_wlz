...
#endif
extern oal_void hmac_chan_multi_select_channel_mac_etc(mac_vap_stru *pst_mac_vap,
...
extern oal_void hmac_chan_multi_switch_to_new_channel_etc(mac_vap_stru *pst_mac_vap,
                                                          oal_uint8 uc_channel,
                                                          wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_uint32 hmac_chan_start_bss_etc(hmac_vap_stru *pst_hmac_vap, mac_channel_stru *pst_channel,
                                          wlan_protocol_enum_uint8 en_protocol);
extern oal_void hmac_40M_intol_sync_data(mac_vap_stru *pst_mac_vap,
...
extern oal_uint32 hmac_check_ap_channel_follow_sta(mac_vap_stru *pst_check_mac_vap,
