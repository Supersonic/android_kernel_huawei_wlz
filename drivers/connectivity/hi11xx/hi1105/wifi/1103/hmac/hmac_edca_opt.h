...
/* 9 OTHERS定义 */
/* 10 函数声明 */
extern oal_void hmac_edca_opt_rx_pkts_stat_etc(oal_uint16 us_assoc_id, oal_uint8 uc_tidno,
                                               mac_ip_header_stru *pst_ip);
extern oal_void hmac_edca_opt_tx_pkts_stat_etc(mac_tx_ctl_stru *pst_tx_ctl, oal_uint8 uc_tidno,
                                               mac_ip_header_stru *pst_ip);
