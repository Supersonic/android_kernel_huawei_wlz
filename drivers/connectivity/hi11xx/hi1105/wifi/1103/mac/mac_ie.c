...
oal_bool_enum_uint8 mac_ie_proc_ht_supported_channel_width_etc(mac_user_stru *pst_mac_user_sta,
...
oal_bool_enum_uint8 mac_ie_proc_ht_green_field_etc(mac_user_stru *pst_mac_user_sta,
                                                   mac_vap_stru *pst_mac_vap,
...
oal_bool_enum_uint8 mac_ie_proc_lsig_txop_protection_support_etc(mac_user_stru *pst_mac_user_sta,
                                                                 mac_vap_stru *pst_mac_vap,
...
oal_uint32 mac_ie_proc_ht_sta_etc(mac_vap_stru *pst_mac_sta,
                                  ...
                                  oal_uint16 *pus_amsdu_maxsize)
{
    ...
    if ((pst_mac_sta == OAL_PTR_NULL) || (puc_payload == OAL_PTR_NULL) ||
        (pst_mac_user_ap == OAL_PTR_NULL) || (pus_amsdu_maxsize == OAL_PTR_NULL)) {
...
oal_uint32 mac_smps_update_user_status(mac_vap_stru *pst_mac_vap,
        mac_user_stru *pst_mac_user, oal_bool_enum_uint8 en_from_beacon)
{
    ...
    if ((pst_mac_vap == OAL_PTR_NULL) || (pst_mac_user == OAL_PTR_NULL)) {
        OAM_ERROR_LOG2(0, OAM_SF_SMPS,
                       "{mac_smps_update_user_status: NULL PTR pst_mac_vap is [%x] and pst_mac_user is [%x].}",
    ...
    switch (en_user_smps_mode) {
        ...
        case WLAN_MIB_MIMO_POWER_SAVE_DYNAMIC:
            OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_SMPS,
                             "{mac_smps_update_user_status:user smps_mode update DYNAMIC!}");
        ...
        default:
            OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SMPS,
                             "{mac_smps_update_user_status: en_user_smps_mode mode[%d] fail!}",
                             en_user_smps_mode);
            return OAL_FAIL;
    }

    mac_user_set_smps_opmode_notify_nss(pst_mac_user, en_avail_num_spatial_stream);
#ifdef _PRE_WLAN_FEATURE_11AX
    if (en_from_beacon && pst_mac_user->bit_have_recv_he_rom_flag &&
            pst_mac_user->en_he_rom_nss < en_avail_num_spatial_stream) {
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_SMPS,
                                    "{mac_smps_update_user_status:en_avail_num_spatial_stream=[%d],\
                                    en_he_rom_nss=[%d]!}",
                                    en_avail_num_spatial_stream,pst_mac_user->en_he_rom_nss);
        return OAL_SUCC;
    }
#endif
    mac_user_set_avail_num_spatial_stream_etc(pst_mac_user, en_avail_num_spatial_stream);
    return OAL_SUCC;
}
#endif
...
#ifdef _PRE_WLAN_FEATURE_11AX
oal_uint32 mac_ie_from_he_cap_get_nss(mac_he_hdl_stru *pst_mac_he_hdl, wlan_nss_enum_uint8 *puc_nss)
{
    if (pst_mac_he_hdl->st_he_cap_ie.st_he_mcs_nss.st_rx_he_mcs_below_80mhz.bit_max_he_mcs_for_4ss != 3) {
        *puc_nss = WLAN_FOUR_NSS;
    } else if (pst_mac_he_hdl->st_he_cap_ie.st_he_mcs_nss.st_rx_he_mcs_below_80mhz.bit_max_he_mcs_for_3ss != 3) {
        *puc_nss = WLAN_TRIPLE_NSS;
    } else if (pst_mac_he_hdl->st_he_cap_ie.st_he_mcs_nss.st_rx_he_mcs_below_80mhz.bit_max_he_mcs_for_2ss != 3) {
        *puc_nss = WLAN_DOUBLE_NSS;
    } else if (pst_mac_he_hdl->st_he_cap_ie.st_he_mcs_nss.st_rx_he_mcs_below_80mhz.bit_max_he_mcs_for_1ss != 3) {
        *puc_nss = WLAN_SINGLE_NSS;
    } else {
        *puc_nss = WLAN_SINGLE_NSS;
        OAM_WARNING_LOG0(0, OAM_SF_ANY,
                         "{mac_ie_from_he_cap_get_nss::invalid he nss.}");
        return OAL_FAIL;
    }
...
oal_uint32 mac_ie_parse_he_cap(oal_uint8 *puc_he_cap_ie, mac_frame_he_cap_ie_stru *pst_he_cap_value)
{
    ...
    if (OAL_ANY_NULL_PTR2(puc_he_cap_ie, pst_he_cap_value)) {
        OAM_ERROR_LOG2(0, OAM_SF_11AX,
                       "{mac_ie_parse_he_cap::param null,puc_he_cap_ie[0x%x], pst_he_cap_value[0x%x].}",
                       (uintptr_t)puc_he_cap_ie, (uintptr_t)pst_he_cap_value);
    ...
    **************************************************************************************************/
    ...
    if ((pst_he_cap_value->st_he_phy_cap.bit_channel_width_set & BIT2) != 0) {
        uc_mcs_nss_set_size += 2;
    }
    if ((pst_he_cap_value->st_he_phy_cap.bit_channel_width_set & BIT3) != 0) {
        uc_mcs_nss_set_size += 2;
    }
...
oal_uint32 mac_ie_parse_he_oper(oal_uint8 *puc_he_oper_ie, mac_frame_he_oper_ie_stru *pst_he_oper_ie_value)
{
    ...
    ***************************************************************************/
    ...
    if (pst_he_oper_ie_value->st_he_oper_param.bit_vht_operation_info_present == 1) {
...
oal_uint32 mac_ie_parse_mu_edca_parameter(oal_uint8 *puc_he_edca_ie,
                                          mac_frame_he_mu_edca_parameter_ie_stru *pst_he_mu_edca_value)
{
    ...
    if (puc_he_edca_ie[1] != MAC_HE_MU_EDCA_PARAMETER_SET_LEN) {
        OAM_WARNING_LOG1(0, OAM_SF_11AX,
                         "{mac_ie_parse_mu_edca_parameter::invalid mu edca ie len[%d].}",
                         puc_he_edca_ie[1]);
        return OAL_FAIL;
    }
...
/*lint -save -e438 */
oal_uint32 mac_ie_parse_spatial_reuse_parameter(oal_uint8 *puc_he_srp_ie,
                                                mac_frame_he_spatial_reuse_parameter_set_ie_stru *pst_he_srp_value)
{
    ...
    if (pst_he_sr_control->bit_srg_information_present == 1) {
        ...
        /* SRG BSS Color Bitmap */
        l_ret += memcpy_s((oal_uint8 *)(&pst_he_srp_value->auc_srg_partial_bssid_bitmap),
...
oal_uint32 mac_ie_proc_he_opern_ie(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload, mac_user_stru *pst_mac_user)
{
    ...
    if (OAL_UNLIKELY(OAL_ANY_NULL_PTR3(pst_mac_vap, pst_mac_user, puc_payload))) {
        OAM_ERROR_LOG3(0, OAM_SF_11AX, "{mac_ie_proc_he_opern_ie::param null,%X %X %X.}",
                       (uintptr_t)pst_mac_vap, (uintptr_t)pst_mac_user, (uintptr_t)puc_payload);
...
oal_uint32 mac_ie_parse_he_ndp_feedback_report_ie(oal_uint8 *puc_he_ndp_ie,
                                                  oal_uint8 *puc_resource_req_buff_threshold_exp)
{
    oal_uint8 *puc_data = OAL_PTR_NULL;

    if (puc_he_ndp_ie[1] != MAC_HE_NDP_FEEDBACK_REPORT_LEN) {
        return OAL_FAIL;
    }
...
oal_uint32 mac_ie_parse_he_bss_color_change_announcement_ie(
    oal_uint8 *puc_payload, mac_frame_bss_color_change_annoncement_ie_stru *pst_bss_color)
{
...
oal_uint32 mac_ie_parse_multi_bssid_opt_subie(oal_uint8 *puc_frame_data,
                                       mac_multi_bssid_frame_info_stru *pst_mbssid_frame_info,
                                       oal_uint8 *puc_mbssid_body_ie_len)
{
    oal_uint8 *puc_data = puc_frame_data;
    ...
    oal_uint8 uc_bssid_profile_len;
    ...
    ***************************************************************************/
    ...
    if (puc_non_transmitted_bssid_cap == OAL_PTR_NULL) {
    ...
    if (puc_ssid == OAL_PTR_NULL || puc_ssid[1] > WLAN_SSID_MAX_LEN) {
        return OAL_FAIL;
    }
    ...
    if (puc_mbssid_index == OAL_PTR_NULL) {
...
oal_uint8 *mac_ie_find_vendor_vht_ie(oal_uint8 *puc_frame, oal_uint16 us_frame_len)
{
    ...
    if ((puc_vendor_ie != OAL_PTR_NULL) && (puc_vendor_ie[1] >= MAC_WLAN_OUI_VENDOR_VHT_HEADER)) {
        puc_vht_ie = mac_find_ie_etc(MAC_EID_VHT_CAP,
                                     puc_vendor_ie + us_offset_vendor_vht,
...
oal_void mac_proc_ht_opern_ie_cb(mac_vap_stru *pst_mac_vap,
                                 oal_uint8 *puc_payload,
                                 ...
                                 oal_uint32 *pst_ch)
{
    ...
    if ((pst_ht_opern->bit_sta_chan_width == WLAN_BAND_WIDTH_20M) &&
...
OAL_STATIC oal_uint32 mac_ie_check_proc_opmode_param(mac_user_stru *pst_mac_user,
...
OAL_STATIC wlan_bw_cap_enum_uint8 mac_ie_proc_opmode_channel_width_etc(mac_user_stru *pst_mac_user,
                                                                       mac_opmode_notify_stru *pst_opmode_notify)
{
...
OAL_STATIC oal_void mac_ie_proc_opmode_nss_handle_etc(mac_vap_stru *pst_mac_vap,
                                        mac_user_stru *pst_mac_user,
                                        mac_opmode_notify_stru *pst_opmode_notify,
                                        oal_bool_enum_uint8 en_from_beacon)
{
    ...
    if (en_avail_nss != pst_mac_user->en_avail_num_spatial_stream) {
        ...
        mac_user_set_avail_num_spatial_stream_etc(pst_mac_user, en_avail_nss);
        OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE,
            "{mac_ie_proc_opmode_nss_handle_etc::change nss.en_vap_rx_nss=[%x],\
...
oal_uint32 mac_ie_proc_opmode_field_etc(mac_vap_stru *pst_mac_vap,
                                        mac_user_stru *pst_mac_user,
                                        mac_opmode_notify_stru *pst_opmode_notify,
                                        oal_bool_enum_uint8 en_from_beacon)
{
    ...
    if (en_opmode_notify_bw != pst_mac_user->en_avail_bandwidth) {
        ...
        if (en_bwcap_vap == WLAN_BW_CAP_160M &&
            en_opmode_notify_bw == WLAN_BW_CAP_80M &&
        ...
        OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE,
            "{mac_ie_proc_opmode_field_etc::change bandwidth. en_bwcap_vap[%x], user avail bandwidth = [%x]!}",
    ...
    if (pst_opmode_notify->bit_rx_nss_type == 1) {
        OAM_INFO_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE,
                      "{mac_ie_proc_opmode_field_etc::pst_opmode_notify->bit_rx_nss_type == 1!}\r\n");

        /* 判断Rx Nss是否与user之前使用Rx Nss相同 */
        if (pst_opmode_notify->bit_rx_nss != pst_mac_user->en_avail_bf_num_spatial_stream) {
            /* 需要获取vap和更新nss的取小，如果我们不支持mimo了，对端宣传切换mimo也不执行 */
            mac_user_avail_bf_num_spatial_stream_etc(pst_mac_user,
                OAL_MIN(pst_mac_vap->en_vap_rx_nss, pst_opmode_notify->bit_rx_nss));
        }
    } else {
        mac_ie_proc_opmode_nss_handle_etc(pst_mac_vap, pst_mac_user,
            pst_opmode_notify, en_from_beacon);
    }

    if (g_st_mac_ie_rom_cb.opmode_field_cb != OAL_PTR_NULL) {
