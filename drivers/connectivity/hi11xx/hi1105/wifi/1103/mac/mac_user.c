...
oal_uint8 mac_user_get_sta_cap_bandwidth_11ac(wlan_channel_band_enum_uint8 en_band,
...
oal_void mac_user_set_he_capable(mac_user_stru *pst_mac_user, oal_bool_enum_uint8 en_he_capable)
{
    ...
    if (pst_mac_user->_rom != OAL_PTR_NULL) {
...
{
    if (EOK != memcpy_s((oal_uint8 *)(MAC_USER_HE_HDL_STRU(pst_mac_user)),
                        OAL_SIZEOF(mac_he_hdl_stru),
                        (oal_uint8 *)pst_he_hdl,
                        OAL_SIZEOF(mac_he_hdl_stru))) {
