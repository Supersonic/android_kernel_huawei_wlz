...
oal_uint32 pm_wifi_rxtx_count = 0; /* 在平台侧统计接收发送数据包数量 */
/*lint -e19 */
...
oal_uint32 hcc_credit_bottom_value = 1;
...
static oal_int32 hcc_tx_param_check(struct hcc_handler *hcc, oal_netbuf_stru *netbuf,
