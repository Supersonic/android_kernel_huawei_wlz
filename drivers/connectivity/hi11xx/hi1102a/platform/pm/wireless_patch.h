...
#define PATCH_SEND_CAN_SDIO                                \
    do {                                                   \
        patch_send_char(CAN, NO_RESPONSE, ENUM_INFO_SDIO); \
    } while (0)
#define PATCH_SEND_EOT_SDIO                                  \
    do {                                                     \
        patch_send_char(EOT, WAIT_RESPONSE, ENUM_INFO_SDIO); \
    } while (0)
#define PATCH_SEND_A_SDIO                                  \
    do {                                                   \
        patch_send_char('a', NO_RESPONSE, ENUM_INFO_SDIO); \
    } while (0)
#define PATCH_SEND_N_SDIO                                  \
    do {                                                   \
        patch_send_char('n', NO_RESPONSE, ENUM_INFO_SDIO); \
    } while (0)
...
extern uint8 *pucDataBuf_t;
extern int32 usemalloc;
extern PATCH_GLOBALS_STUR global[ENUM_INFO_TOTAL];
