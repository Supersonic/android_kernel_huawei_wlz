...
OAL_INLINE oal_int32 oal_net_device_set_macaddr(oal_net_device_stru *pst_dev, oal_void *pst_addr)
{
    ...
    oal_memcopy((oal_void *)pst_dev->dev_addr, (oal_void *)pst_mac->sa_data, ul_protocol_addr_len);
                                                      ...
                                                      oal_netbuf_stru **pst_expect_netbuf)
{
    ...
    if ((pst_netbuf == OAL_PTR_NULL) || (pst_expect_netbuf == OAL_PTR_NULL)) {
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC OAL_INLINE oal_sock_stru *oal_netlink_kernel_create(oal_net_stru *pst_net,
                                                               oal_int32 l_unit,
