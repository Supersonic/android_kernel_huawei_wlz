...
/*****************************************************************************
  2 全局变量定义
*****************************************************************************/
wal_packet_check_rx_info_stru g_st_pkt_check_rx_info;
...
OAL_STATIC oal_uint32  wal_config_set_2040_coext_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
OAL_STATIC oal_uint32  wal_config_set_btcoex_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_set_btcoex_params(pst_mac_vap, us_len, puc_param);
}
#endif

OAL_STATIC oal_uint32  wal_config_bindcpu_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_bindcpu(pst_mac_vap, us_len, puc_param);
}


OAL_STATIC oal_uint32  wal_config_napi_weight_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
OAL_STATIC oal_uint32  wal_config_packet_check(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAL_MEMZERO(&g_st_pkt_check_rx_info, OAL_SIZEOF(g_st_pkt_check_rx_info));
    g_st_pkt_check_rx_info.us_pkt_check_send_num       = uc_skb_num;
...
OAL_STATIC oal_uint32  wal_config_narrow_bw(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{wal_config_narrow_bw::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32  wal_config_set_nbfh(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{wal_config_set_nbfh::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32  wal_config_hitalk_listen(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{wal_config_hitalk_listen::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32  wal_config_set_bt_upc_by_freq(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
OAL_CONST wal_wid_op_stru g_ast_board_wid_op_debug[] =
{
...
#endif
#ifdef _PRE_WLAN_FEATURE_AUTO_FREQ
    {WLAN_CFGID_SET_DEVICE_FREQ_ENABLE,           OAL_FALSE,  {0},  OAL_PTR_NULL,           wal_config_set_auto_freq_enable},
#endif
    ...
    {WLAN_CFGID_NAPIWEIGHT,                     OAL_FALSE,  {0},    OAL_PTR_NULL,         wal_config_napi_weight_params},
    ...
    {WLAN_CFGID_SET_BT_UPC_BY_FREQ,             OAL_FALSE,  {0},    OAL_PTR_NULL,         wal_config_set_bt_upc_by_freq},
