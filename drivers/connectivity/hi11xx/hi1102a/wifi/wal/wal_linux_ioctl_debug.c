...
OAL_STATIC oal_uint32 wal_hipriv_set_phy_debug_switch (oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    OAM_INFO_LOG2(0, OAM_SF_ANY, "{wal_hipriv_set_rssi_switch::rssi_switch: %d, interval: %d.}",
                  st_phy_debug_switch.en_rssi_debug_switch, st_phy_debug_switch.ul_rx_comp_isr_interval);
...
OAL_STATIC oal_uint32 wal_hipriv_bindcpu(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    OAM_WARNING_LOG2(0, OAM_SF_ROAM, "{wal_hipriv_bindcpu::bindcpu thread[%d](0:hisi_hcc;1:hmac_rxdata;2:rx_tsk), cpumask[%d]}",
...
OAL_STATIC oal_uint32 wal_protocol_debug_parse_csa_cmd(oal_int8 *pc_param, mac_protocol_debug_switch_stru *pst_debug_info, oal_uint32 *pul_offset)
{
...
OAL_STATIC oal_uint32 wal_hipriv_set_protocol_debug_info(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_protocol_debug_info::ul_cmd_bit_map: 0x%08x.}", st_protocol_debug.ul_cmd_bit_map);
...
OAL_CONST wal_hipriv_cmd_entry_stru  g_ast_hipriv_cmd_debug[] =
{
    ...
    {"2040_coext_switch",       wal_hipriv_set_2040_coext_switch},       /* 设置mac_vap_cap_flag: hipriv "vap0 2040_coext_switch 0|1" */
    ...
    {"wmmac_switch",            wal_hipriv_wmmac_switch},           /* 设置删除TS的配置命令: hipriv "vap0 wmmac_switch 1/0(使能) 0|1(WMM_AC认证使能) AC xxx(limit_medium_time)" */
#endif
   ...
   // {"reset_hw",                wal_hipriv_reset_device},           /* 复位硬件phy&mac: hipriv "Hisilicon0 reset_hw 0|1|2|3(all|phy|mac|debug) 0|1(reset phy reg) 0|1(reset mac reg) */
    ...
    {"thread_bindcpu",          wal_hipriv_bindcpu},                /* hipriv "wlan0 thread_bindcpu 0|1|2(hisi_hcc,hmax_rxdata,rx_tsk) 0(cpumask)"*/
    {"napi_weight",             wal_hipriv_napi_weight},            /* hipriv "wlan0 napi_weight 0|1(动态调) 16(weight)"*/
    ...
    {"phy_debug",             wal_hipriv_set_phy_debug_switch},        /* 设置打印接收报文rssi信息的开关，sh hipriv.sh "Hisilicon0 rssi_switch 0|1(打开|关闭) N(间隔N个帧打印)" */
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
#ifdef _PRE_DEBUG_MODE
