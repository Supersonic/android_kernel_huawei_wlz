...
typedef enum
{
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_FBT_SCAN_LIST_CLEAR          = 622,
    WLAN_CFGID_FBT_SCAN_SPECIFIED_STA       = 623,
    WLAN_CFGID_FBT_START_SCAN               = 624,
    WLAN_CFGID_FBT_PRINT_SCAN_LIST          = 625,
    WLAN_CFGID_FBT_SCAN_ENABLE              = 626,
