...
typedef oal_void (*p_mac_set_rrm_enabled_cap_field_cb)(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
typedef oal_void (*p_mac_set_ext_capabilities_ie_cb)(oal_void *pst_mac_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
typedef oal_void (*p_mac_set_vht_capabilities_ie_cb)(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);

typedef oal_void (*p_mac_set_ht_capabilities_ie_cb)(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
typedef oal_rom_cb_result_enum_uint8 (*p_mac_set_rsn_ie_cb)(oal_void *pst_vap, oal_uint8 *puc_pmkid, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint32 *pul_ret);
typedef oal_rom_cb_result_enum_uint8 (*p_mac_set_wpa_ie_cb)(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint32 *pul_ret);
...
#ifdef _PRE_WLAN_FEATURE_NBFH
extern oal_void mac_set_nbfh_vendor_ie(oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint32 ul_hi_tsf, oal_uint32 ul_lo_tsf);
#endif
...
extern oal_uint32  mac_set_csa_ie(oal_uint8 uc_mode, oal_uint8 uc_channel, oal_uint8 uc_csa_cnt, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);
...
{
    return (oal_bool_enum_uint8)(ETHER_ONE_X_TYPE == oal_byteorder_host_to_net_uint16(pst_mac_llc_snap->us_ether_type));
}
...
extern oal_rom_cb_result_enum_uint8 mac_set_rsn_ie_cb(oal_void *pst_vap, oal_uint8 *puc_pmkid, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint32 *pul_ret);
extern oal_rom_cb_result_enum_uint8 mac_set_wpa_ie_cb(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint32 *pul_ret);
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
