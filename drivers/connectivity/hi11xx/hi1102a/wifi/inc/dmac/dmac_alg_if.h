...
typedef oal_uint32 (*p_alg_txmgmt_notify_func)(mac_vap_stru *pst_vap, mac_user_stru *pst_user, oal_netbuf_stru *pst_buf);;
...
extern oal_uint32  dmac_alg_register_nbfh_start_notify_func_ram(dmac_alg_nbfh_start_notify_enum_uint8    en_notify_sub_type,
                                                      p_alg_nbfh_start_notify_func             p_func);
extern oal_uint32  dmac_alg_nbfh_start_notify_ram(mac_vap_stru *pst_mac_vap);
extern oal_uint32  dmac_alg_unregister_nbfh_start_notify_func_ram(dmac_alg_nbfh_start_notify_enum_uint8    en_notify_sub_type);


extern oal_uint32  dmac_alg_register_nbfh_stop_notify_func_ram(dmac_alg_nbfh_stop_notify_enum_uint8    en_notify_sub_type,
                                                      p_alg_nbfh_stop_notify_func             p_func);
extern oal_uint32  dmac_alg_nbfh_stop_notify_ram(mac_vap_stru *pst_mac_vap);
extern oal_uint32  dmac_alg_unregister_nbfh_stop_notify_func_ram(dmac_alg_nbfh_stop_notify_enum_uint8    en_notify_sub_type);
extern oal_uint32  dmac_alg_register_nbfh_sync_notify_func_ram(dmac_alg_nbfh_sync_notify_enum_uint8    en_notify_sub_type,
                                                      p_alg_nbfh_sync_notify_func             p_func);
extern oal_uint32  dmac_alg_nbfh_sync_notify_ram(mac_vap_stru *pst_mac_vap, oal_netbuf_stru *pst_netbuf);
extern oal_uint32  dmac_alg_unregister_nbfh_sync_notify_func_ram(dmac_alg_nbfh_sync_notify_enum_uint8    en_notify_sub_type);
#endif
...
#endif
extern oal_uint32 dmac_alg_get_user_index(mac_user_stru *pst_mac_user, oal_uint32 *pul_user_index, dmac_alg_id_enum_uint32 en_user_stru_type);
