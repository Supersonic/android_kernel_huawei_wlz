...
OAL_STATIC oal_uint32  hmac_mgmt_tx_addts_req_timeout(oal_void *p_arg)
{
    ...
    {
        OAM_WARNING_LOG0(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_WMMAC, "{hmac_mgmt_tx_addts_req_timeout::pst_hmac_user null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
                ...
                mac_wmm_tspec_stru                 *pst_addts_args)
{
    ...
    if (ul_ret != OAL_SUCC)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC, "{hmac_mgmt_tx_addts_req::frw_event_dispatch_event failed[%d].}", ul_ret);
        oal_netbuf_free(pst_addts_req);
    ...
    /* 启动ADDTS REQ超时计时器 */
    FRW_TIMER_CREATE_TIMER(&pst_ts->st_addts_timer,
                       ...
                       mac_wmm_tspec_stru                 *pst_delts_args)
{
    ...
    if (ul_ret != OAL_SUCC)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC, "{hmac_mgmt_tx_delts::frw_event_dispatch_event failed[%d].}", ul_ret);
        oal_netbuf_free(pst_delts);
        FRW_EVENT_FREE(pst_event_mem);
        return ul_ret;
    }
                ...
                oal_uint8                  *puc_payload)
{
    ...
    {
        OAM_WARNING_LOG3(0, OAM_SF_WMMAC, "{hmac_mgmt_rx_addts_rsp::null param, %p %p %p.}", (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)puc_payload);
        return OAL_ERR_CODE_PTR_NULL;
    }
                ...
                oal_uint8                  *puc_payload)
{
    ...
    if ((OAL_PTR_NULL == pst_hmac_vap) || (OAL_PTR_NULL == pst_hmac_user) || (OAL_PTR_NULL == puc_payload))
    {
        OAM_WARNING_LOG3(0, OAM_SF_WMMAC, "{hmac_mgmt_rx_delts::null param, %p %p %p.}", (uintptr_t)pst_hmac_vap, (uintptr_t)pst_hmac_user, (uintptr_t)puc_payload);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_mgmt_rx_addts_req_frame(hmac_vap_stru *pst_hmac_vap, oal_netbuf_stru *pst_netbuf)
{
    ...
    {
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_WMMAC, "{hmac_mgmt_rx_addts_req_frame::pst_mac_user null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    {
        OAM_WARNING_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_WMMAC, "{hmac_mgmt_rx_addts_req_frame::pst_addts_rsp null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_config_wmmac_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if(!g_en_wmmac_switch)
    {
        ...
        {
            if (OAL_TRUE == pst_mac_user->st_ts_info[uc_ac_idx].st_addts_timer.en_is_registerd)
            {
                FRW_TIMER_IMMEDIATE_DESTROY_TIMER(&(pst_mac_user->st_ts_info[uc_ac_idx].st_addts_timer));
            }
            ...
            if (OAL_TRUE == pst_mac_user->st_ts_tmp_info[uc_ac_idx].st_addts_timer.en_is_registerd)
            {
                FRW_TIMER_IMMEDIATE_DESTROY_TIMER(&(pst_mac_user->st_ts_tmp_info[uc_ac_idx].st_addts_timer));
            }
    ...
    ***************************************************************************/
    ...
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WMMAC, "{hmac_config_wmmac_switch::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
#endif
...
oal_uint32  hmac_tx_mgmt_reassoc_req(hmac_vap_stru *pst_hmac_vap_sta)
{
    ...
    {
        OAM_WARNING_LOG0(pst_hmac_vap_sta->st_vap_base_info.uc_vap_id, OAM_SF_ASSOC, "{hmac_tx_mgmt_reassoc_req::pst_asoc_req_frame null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
