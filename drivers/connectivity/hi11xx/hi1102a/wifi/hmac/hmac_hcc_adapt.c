...
{
    memset_s(g_wlan_queue_to_dmac_queue, OAL_SIZEOF(g_wlan_queue_to_dmac_queue), DATA_LO_QUEUE, OAL_SIZEOF(g_wlan_queue_to_dmac_queue));
...
{
    return hmac_hcc_tx_event_payload_to_netbuf (pst_event_mem, (oal_uint32)((frw_get_event_stru(pst_event_mem))->st_event_hdr.us_length) - OAL_SIZEOF(frw_event_hdr_stru));
}
#endif
