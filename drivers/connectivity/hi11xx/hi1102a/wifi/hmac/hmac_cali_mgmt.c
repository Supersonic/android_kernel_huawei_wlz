...
oal_int16 rxiq_h_comp_80M[HI1102_CALI_RXIQ_LS_FILTER_TAP_NUM][HI1102_CALI_RXIQ_LS_FILTER_FEQ_NUM_80M] = {
...
oal_int16 rxiq_h_comp_160M[HI1102_CALI_RXIQ_LS_FILTER_TAP_NUM][HI1102_CALI_RXIQ_LS_FILTER_FEQ_NUM_160M] = {
...
oal_int16 txiq_h_comp_320M[HI1102_CALI_TXIQ_LS_FILTER_TAP_NUM][HI1102_CALI_TXIQ_LS_FILTER_FEQ_NUM_320M] = {
...
#else
/*  大小:16bit * 11 * 64 = 1408 Byte */
oal_int16 txiq_h_comp_160M[HI1102_CALI_TXIQ_LS_FILTER_TAP_NUM][HI1102_CALI_TXIQ_LS_FILTER_FEQ_NUM_160M] =
{
        ...
        while (l_remain_len > 0) {
            ...
            if (pst_event_mem == OAL_PTR_NULL) {
                OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CALIBRATE,
                               "{hmac_send_cali_matrix_data::pst_event_mem null.}");
                                                  ...
                                                  oal_cali_param_stru *pst_cali_data)
{
    ...
    return OAL_SPRINTF(pc_print_buff, (oal_uint32)l_remainder_len, pc_string,
        uc_cali_chn_idx,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].ppf_cmp_val.uc_ppf_val,
#ifdef _PRE_WLAN_NEW_RXDC
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_5G.aus_analog_rxdc_cmp[0],
#else
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_5G.us_analog_rxdc_cmp,
#endif
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_5G.us_digital_rxdc_cmp_i,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_5G.us_digital_rxdc_cmp_q,

        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.upc_ppa_cmp,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.upc_mx_cmp,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.ac_atx_pwr_cmp,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.dtx_pwr_cmp,
#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.s_5g_tx_power_dc_q,
#endif

#ifdef _PRE_WLAN_NEW_TXDC
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txdc_cmp_val[0].us_txdc_cmp_i,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txdc_cmp_val[0].us_txdc_cmp_q
#else
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txdc_cmp_val.us_txdc_cmp_i,
        pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txdc_cmp_val.us_txdc_cmp_q
#endif
    );
                                                  ...
                                                  oal_cali_param_stru *pst_cali_data)
{
    ...
    return OAL_SPRINTF(pc_print_buff, ul_remainder_len, pc_string,
                       ...
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.upc_ppa_cmp,
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.upc_mx_cmp,
                       (oal_uint8)pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_5G.ac_atx_pwr_cmp,
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].ppf_cmp_val.uc_ppf_val,
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txdc_cmp_val.us_txdc_cmp_i,
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txdc_cmp_val.us_txdc_cmp_q,
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txiq_cmp_val_5G.us_txiq_cmp_p,
                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].txiq_cmp_val_5G.us_txiq_cmp_e);
}
#endif
...
oal_void hmac_dump_cali_result(oal_void)
{
    ...
    for (uc_cali_chn_idx = 0; uc_cali_chn_idx < OAL_2G_CHANNEL_NUM; uc_cali_chn_idx++) {
        OAM_WARNING_LOG4(0, OAM_SF_CFG,
                         "2G cali data index:%u, rx_dc_lna1_comp: 0x%x, digital_rxdc_cmp_i:0x%x digital_rxdc_cmp_q:0x%x",
                         uc_cali_chn_idx,
#ifdef _PRE_WLAN_NEW_RXDC
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_2G.aus_analog_rxdc_cmp[1],
#else
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_2G.us_analog_rxdc_cmp,
#endif
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_2G.us_digital_rxdc_cmp_i,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].cali_rx_dc_cmp_2G.us_digital_rxdc_cmp_q
            );
        OAM_WARNING_LOG4(0, OAM_SF_CFG,
                         "2G cali data index:%u, ac_atx_pwr_cmp:0x%x tx_dc txdc_cmp_i:0x%x txdc_cmp_q:0x%x",
                         uc_cali_chn_idx,
                         (oal_uint8)pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].cali_tx_power_cmp_2G.ac_atx_pwr_cmp,
#ifdef _PRE_WLAN_NEW_TXDC
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].txdc_cmp_val[0].us_txdc_cmp_i,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].txdc_cmp_val[0].us_txdc_cmp_q
#else
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].txdc_cmp_val.us_txdc_cmp_i,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].txdc_cmp_val.us_txdc_cmp_q
#endif
            );
        ...
        OAM_WARNING_LOG4(0, OAM_SF_CFG, " 2G tx_iq txiq_cmp_alpha:0x%x, txiq_cmp_beta:0x%x, rx_iq txiq_cmp_alpha:0x%x, txiq_cmp_beta:0x%x",
                         ...
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.l_txiq_cmp_alpha,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.l_txiq_cmp_beta,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.l_rxiq_cmp_alpha,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.l_rxiq_cmp_beta
#else
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].txiq_cmp_val_2G.us_txiq_cmp_p,
                         pst_cali_data->ast_2Gcali_param[uc_cali_chn_idx].txiq_cmp_val_2G.us_txiq_cmp_e,
                         0,
                         0
#endif
                );
    ...
    for (uc_cali_chn_idx = 0; uc_cali_chn_idx < OAL_5G_20M_CHANNEL_NUM; uc_cali_chn_idx++) {
        l_string_tmp_len = OAL_SPRINTF(pc_print_buff + ul_string_len, (OAM_REPORT_MAX_STRING_LEN - ul_string_len - 1),
                                       ...
                                       uc_cali_chn_idx,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.l_rxiq_cmp_alpha,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.l_rxiq_cmp_beta,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.l_rxiq_cmp_u1,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.l_rxiq_cmp_u2,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[0],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[1],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[2],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[3],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[4],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[5],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[6],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[7],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[8],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[9],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_rxiq_cmp_val.as_rxiq_comp_ls_filt[10]);
        if (l_string_tmp_len < 0) {
            goto sprint_fail;
        }
        ul_string_len += (oal_uint32)l_string_tmp_len;
    ...
    for (uc_cali_chn_idx = 0; uc_cali_chn_idx < OAL_5G_20M_CHANNEL_NUM; uc_cali_chn_idx++) {
        l_string_tmp_len = OAL_SPRINTF(pc_print_buff + ul_string_len, (OAM_REPORT_MAX_STRING_LEN - ul_string_len - 1),
                                       ...
                                       uc_cali_chn_idx,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.l_txiq_cmp_alpha,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.l_txiq_cmp_beta,
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[0],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[1],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[2],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[3],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[4],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[5],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[6],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[7],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[8],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[9],
                                       pst_cali_data->ast_5Gcali_param[uc_cali_chn_idx].new_txiq_time_cmp_val.as_txiq_comp_ls_filt[10]);
        if (l_string_tmp_len < 0) {
            goto sprint_fail;
        }
        ul_string_len += (oal_uint32)l_string_tmp_len;
...
oal_uint32 hmac_send_cali_data(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (pst_mac_vap == OAL_PTR_NULL) {
        OAM_ERROR_LOG2(0, OAM_SF_CALIBRATE,
                       "{hmac_dpd_data_processed_send::param null, %p %p.}",
