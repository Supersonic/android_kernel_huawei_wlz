                                     ...
                                     const oal_uint8 *puc_rsn_ie, mac_status_code_enum_uint16 *pen_status_code)
{
    ...
    if ((OAL_TRUE == mac_mib_get_dot11RSNAMFPC(pst_mac_vap)) && (en_dot11RSNAMFPC == OAL_TRUE)) {
                             ...
                             oal_uint8 *puc_iv_len)
{
    ...
    if ((pst_hmac_vap == OAL_PTR_NULL) ||
        ...
        OAM_ERROR_LOG4(0, OAM_SF_WPA, "{hmac_en_mic::pst_hmac_vap=%x pst_hmac_user=%x pst_netbuf=%x puc_iv_len=%x.}",
