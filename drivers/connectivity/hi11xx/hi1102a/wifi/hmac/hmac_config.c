...
oal_uint32  hmac_config_alg_send_event(
                mac_vap_stru                     *pst_mac_vap,
                wlan_cfgid_enum_uint16            en_cfg_id,
                oal_uint16                        us_len,
                oal_uint8                        *puc_param)
...
oal_uint32  hmac_config_add_vap(mac_vap_stru *pst_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_ERROR_LOG2(0, OAM_SF_CFG, "{hmac_config_add_vap::param null,pst_vap=%x puc_param=%x.}", (uintptr_t)pst_vap, (uintptr_t)puc_param);
...
oal_uint32  hmac_config_del_vap(mac_vap_stru *pst_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
#endif
    hmac_config_set_event_netbuf_num(&pst_hmac_vap->st_vap_base_info, OAL_FALSE);
    ...
    ***************************************************************************/
    ...
    OAM_WARNING_LOG4(pst_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_del_vap::Del succ.vap_mode[%d], p2p_mode[%d], multi user idx[%d], uc_vap_num[%d]}",
                pst_vap->en_vap_mode, pst_del_vap_param->en_p2p_mode, pst_vap->us_multi_user_idx, pst_device->uc_vap_num);
    ...
    if(WLAN_VAP_MODE_BSS_STA == pst_vap->en_vap_mode && (0 == pst_device->uc_vap_num))
    {
        ...
        if (OAL_ERR_CODE_FOBID_CLOSE_DEVICE != ul_pm_close_ret)
        {
...
oal_uint32 hmac_config_down_vap(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_down_vap::multi_user[%d] null.}", pst_mac_vap->us_multi_user_idx);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    for (pst_entry = pst_user_list_head->pst_next; pst_entry != pst_user_list_head;)
    {
        ...
        {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WPA, "{hmac_config_down_vap::pst_hmac_user_tmp null.idx:%u}",pst_user_tmp->us_assoc_id);
            continue;
        }
...
oal_uint32 hmac_config_wifi_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_PTR_NULL == pst_mac_device))
    {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hmac_config_wifi_enable::pst_mac_device[%p] null!}", pst_mac_vap);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_config_init_bt_env(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_init_bt_env::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_set_bt_freq(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_bt_freq::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_set_bt_upc_by_freq(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_bt_upc_by_freq::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_print_bt_gm(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_print_bt_gm::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_set_smps_mode(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
    {
        ...
        for (pst_entry = pst_user_list_head->pst_next; pst_entry != pst_user_list_head;)
        {
            ...
            if(OAL_PTR_NULL == pst_hmac_user_tmp)
            {
                OAM_WARNING_LOG1(pst_mac_vap_tmp->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_smps_mode::pst_hmac_user_tmp is NULL.us_assoc_id[%d]}", pst_user_tmp->us_assoc_id);
                continue;
            }
...
oal_uint32 hmac_config_set_channel(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        ...
        pst_channel_param->en_bandwidth = mac_vap_get_bandwith(pst_mac_device->en_bandwidth_cap, pst_channel_param->en_bandwidth);
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_channel::Updated bw = %d}", pst_channel_param->en_bandwidth);
    }
...
#endif /* _PRE_WLAN_FEATURE_DBAC */
    {
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            ul_ret = mac_get_channel_idx_from_num(pst_channel_param->en_band, pst_channel_param->uc_channel, &(pst_mac_vap_tmp->st_channel.uc_idx));
            if (OAL_SUCC != ul_ret)
            {
...
oal_uint32  hmac_config_vap_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if(OAL_TRUE == mac_mib_get_privacyinvoked(pst_mac_vap))
    {
        ...
        if (OAL_PTR_NULL == pst_multi_user)
        {
            OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_vap_info::pst_multi_user[%d] null.}", pst_mac_vap->us_multi_user_idx);
            OAL_MEM_FREE(pc_print_buff, OAL_TRUE);
            return OAL_ERR_CODE_PTR_NULL;
        }
        ...
        if (OAL_TRUE == mac_mib_get_rsnaactivated(pst_mac_vap))
        {
            ...
            {
                uc_group_suite = OAL_MIN(pst_wlan_mib_rsna_cfg->uc_wpa_group_suite, 15);
                ...
                while (uc_loop < WLAN_AUTHENTICATION_SUITES && puc_akm_suite[uc_loop] != 0)
                {
                    l_string_tmp_len = OAL_SPRINTF(pc_print_buff + ul_string_len, (OAM_REPORT_MAX_STRING_LEN - ul_string_len - 1),
                                                   "WPA AKM[%d]: %s\n",
                                                   uc_loop,
                                                   hmac_config_akm2string(OAL_MIN(puc_akm_suite[uc_loop], 10)));
                    if (l_string_tmp_len < 0)
                    {
                        goto sprint_fail;
                    }
            ...
            {
                uc_group_suite = OAL_MIN(pst_wlan_mib_rsna_cfg->uc_rsn_group_suite, 15);
...
oal_uint32 hmac_config_set_2040_coext_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_2040_coext_switch::2040_autoswitch = [%d].", pst_mac_vap->st_cap_flag.bit_2040_autoswitch);
    return OAL_SUCC;
}
...
oal_uint32 hmac_config_set_vowifi_nat_keep_alive_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_vowifi_nat_keep_alive_params::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_set_power_rf_ctl(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_power_rf_ctl::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_amsdu_ampdu_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    tx_large_amsdu.uc_cur_amsdu_ampdu_enable = (oal_uint8)l_value;
#endif
...
oal_uint32  hmac_config_delba_req(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (MAC_RECIPIENT_DELBA == pst_delba_req->en_direction)
    {
        ...
        {
            OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_delba_req::the rx hdl[tid_no=%d] is not exist.}",pst_delba_req->uc_tidno);
            return OAL_SUCC;
        }
    }
    else
    {
        ...
        {
            OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_delba_req::the tx hdl[tid_no=%d] is not exist.}",pst_delba_req->uc_tidno);
            return OAL_SUCC;
        }
    }
...
oal_uint32  hmac_config_user_info(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == pst_hmac_user)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_user_info::pst_hmac_user null[%d].}", pst_hmac_event->us_user_idx);
        return OAL_FAIL;
    }
...
oal_uint32  hmac_config_always_tx_num(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_always_tx_num::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_send_check_data(mac_vap_stru *pst_mac_vap, oal_uint8 uc_type)
{
    ...
    pst_netbuf = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_LARGE_NETBUF_SIZE, OAL_NETBUF_PRIORITY_MID);
    if (pst_netbuf == OAL_PTR_NULL) {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_send_check_data::Alloc netbuf null in normal_netbuf.}");
        return OAL_ERR_CODE_ALLOC_MEM_FAIL;
    }
    ...
    /* 将mac header清零 */
    OAL_MEMZERO((oal_uint8 *)oal_netbuf_header(pst_netbuf), MAC_80211_QOS_FRAME_LEN);
    puc_mac_header = (oal_uint8 *)(OAL_NETBUF_HEADER(pst_netbuf));
    ...
    if (ul_ret != OAL_SUCC) {
        ...
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_send_check_data::hmac_tx_data_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
    return OAL_SUCC;
}
...
oal_void hmac_set_hmac_vap_11v_ability(mac_vap_stru *pst_mac_vap,hmac_vap_stru *pst_hmac_vap)
{
   ...
   {
        pst_hmac_vap->bit_11v_enable = 1;
   }
   else
   {
        pst_hmac_vap->bit_11v_enable = 0;
   }
}
#endif

#ifdef _PRE_WLAN_FEATURE_ROAM
OAL_STATIC oal_uint32 hmac_roam_start_reconnect(hmac_vap_stru *pst_hmac_vap, oal_uint8 *puc_target_bssid)
{
    oal_uint32          ul_ret;
    hmac_roam_info_stru *pst_roam_info = OAL_PTR_NULL;

    OAM_WARNING_LOG3(0, OAM_SF_CFG, "{hmac_roam_start_reconnect:: roaming AP with ressoc frame, %02X:XX:XX:XX:%02X:%02X}",
...
oal_uint32  hmac_config_connect(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY(pst_mac_vap == OAL_PTR_NULL) || us_len != OAL_SIZEOF(mac_cfg80211_connect_param_stru)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hmac_config_connect:: connect failed, pst_mac_vap is null, or unexpected param len ! [%x]!}\r\n", us_len);
    ...
    if (pst_hmac_vap == OAL_PTR_NULL) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
            "{hmac_config_connect::connect failed, pst_hmac_vap null.uc_vap_id[%d]}", pst_mac_vap->uc_vap_id);
        hmac_free_connect_param_resource(pst_connect_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
   ...
   if(pst_hmac_vap->bit_11r_enable) {
    ...
    if (pst_bss_dscr == OAL_PTR_NULL) {
        OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_connect::find the bss failed by bssid:%02X:XX:XX:%02X:%02X:%02X}",
            pst_connect_param->auc_bssid[0], pst_connect_param->auc_bssid[3], pst_connect_param->auc_bssid[4], pst_connect_param->auc_bssid[5]);
        hmac_free_connect_param_resource(pst_connect_param);
        return OAL_FAIL;
    }
    ...
    if (pst_mac_vap->en_vap_state == MAC_VAP_STATE_UP) {
        if (!oal_memcmp(pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.auc_dot11DesiredSSID,
            ...
            OAL_STRLEN(pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.auc_dot11DesiredSSID) == pst_connect_param->uc_ssid_len) {
    ...
    if (pst_bss_dscr->uc_wapi) {
        ...
        if (pst_mac_device == OAL_PTR_NULL) {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG,
                "{hmac_config_connect::connect failed, pst_mac_device null! uc_device_id[%d]}\r\n", pst_mac_vap->uc_device_id);
            hmac_free_connect_param_resource(pst_connect_param);
            return OAL_ERR_CODE_MAC_DEVICE_NULL;
        }
...
#ifdef _PRE_WLAN_FEATURE_11V
    hmac_set_hmac_vap_11v_ability(pst_mac_vap,pst_hmac_vap);
#endif
    ...
    if (pst_hmac_vap->bit_11r_enable) {
        ...
        if (ul_ret != OAL_SUCC) {
            OAM_ERROR_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_connect::mac_mib_init_ft_cfg fail[%d] MDE[%p]!}\r\n",
                ul_ret, (uintptr_t)puc_mde);
            return ul_ret;
        }
    }
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WPA, "{hmac_config_connect::hmac_config_send_event failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_uint32  hmac_config_list_channel(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_ERROR_LOG2(0, OAM_SF_CFG, "{hmac_config_list_channel::null param,pst_mac_vap=%x puc_param=%x.}", (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_FAIL;
    }
                                            ...
                                            en_app_ie_type_uint8 en_type)
{
    ...
    if( (puc_ie != OAL_PTR_NULL) && (!pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.en_dot11ExtendedChannelSwitchActivated) )
    {
        pst_app_ie->ul_ie_len  -= (oal_uint32)(puc_ie[1] + MAC_IE_HDR_LEN);
        remain_len              = pst_app_ie->ul_ie_len - (oal_uint32)(puc_ie - pst_app_ie->auc_ie);
        oal_memmove(puc_ie, puc_ie + (oal_uint32)(puc_ie[1] + MAC_IE_HDR_LEN), remain_len);
...
oal_uint32 hmac_config_set_wps_p2p_ie(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_wps_p2p_ie::p2p_ie_type=[%d], p2p_ie_len=[%d].}",
    pst_w2h_wps_p2p_ie->en_app_ie_type, pst_w2h_wps_p2p_ie->ul_ie_len);
    ...
    if (st_app_ie.en_app_ie_type == OAL_APP_BEACON_IE)
    {
        if (0 != st_app_ie.ul_ie_len
            ...
            && OAL_PTR_NULL != mac_find_vendor_ie(MAC_WLAN_OUI_MICROSOFT, MAC_WLAN_OUI_TYPE_MICROSOFT_WPS, st_app_ie.auc_ie, (oal_int32)(st_app_ie.ul_ie_len)))
        {
            /* 设置WPS 功能使能 */
...
oal_uint32 hmac_config_set_pmf_cap(mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_pmf_capable, oal_bool_enum_uint8 en_pmf_required)
{
    oal_uint32 ul_ret;
    ...
    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "hmac_config_vap_pmf_cap::pmf cap[%d], req[%d]", en_pmf_capable, en_pmf_required);

    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_PMF_CAP, OAL_SIZEOF(mac_cfg_pmf_cap_stru), (oal_uint8 *) &st_pmf_cap);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
...
oal_uint32 hmac_config_set_btcoex_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if ((MAC_BTCOEX_CFG_BA_SIZE == pst_btcoex_params->en_cfg_type) && (0 == pst_btcoex_params->uc_cfg_value))
    {
...
oal_uint32 hmac_config_bindcpu(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG2(0, OAM_SF_CFG, "{hmac_config_bindcpu::bindcpu thread[%d](0:hisi_hcc;1:hmac_rxdata;2:rx_tsk), cpumask[%x]}",
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)&&(_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    if(MAX_FAST_PS == wlan_ps_mode)
    {
        wlan_pm_set_timeout(wlan_fast_check_cnt);
    }
    else
    {
...
oal_uint32  hmac_config_scan_abort(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (WLAN_VAP_MODE_BSS_STA == pst_hmac_vap->st_vap_base_info.en_vap_mode)
    {
        ...
        else if (MAC_VAP_STATE_STA_LISTEN == pst_hmac_vap->st_vap_base_info.en_vap_state)
        {
...
oal_uint32 hmac_config_external_auth(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    pst_hmac_vap = mac_res_get_hmac_vap(pst_mac_vap->uc_vap_id);
    if (pst_hmac_vap == OAL_PTR_NULL) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_SAE, "{hmac_config_external_auth::pst_hmac_vap null, vap_idx:%d}",
            pst_mac_vap->uc_vap_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_config_query_chr_info_ext(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_query_chr_info_ext::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
OAL_STATIC oal_uint32  hmac_config_d2h_user_info_syn(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == puc_param)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_d2h_user_info_syn::puc_param[%p]!}", (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
#endif
#ifdef _PRE_WLAN_FEATURE_BTCOEX
OAL_STATIC oal_uint32  hmac_config_btcoex_status_syn(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    oal_memcopy(&pst_hmac_device->st_hmac_device_btcoex.st_btble_status,puc_param,OAL_SIZEOF(hal_btcoex_btble_status_stru));
    ...
    {
        hmac_btcoex_process_btble_status(pst_hmac_device->pst_device_base_info, &st_btble_status_old, &st_btble_status_new);
    }
    /* 音乐或者电话场景下将绑核门限采用共存的参数值 */
#ifdef _PRE_WLAN_FEATURE_AUTO_FREQ
    if ((OAL_TRUE == st_btble_status_new.un_bt_status.st_bt_status.bit_bt_a2dp) ||
        (OAL_TRUE == st_btble_status_new.un_bt_status.st_bt_status.bit_bt_sco))
    {
...
oal_uint32  hmac_config_set_sta_pm_on(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    st_ps_mode_param.uc_vap_ps_mode = pst_sta_pm_open->uc_pm_enable ?
                  ((pst_hmac_vap->uc_cfg_sta_pm_manual != 0xFF) ? MIN_PSPOLL_PS : wlan_ps_mode)
                  : NO_POWERSAVE;
...
oal_uint32  hmac_config_set_qos_map(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_ERROR_LOG2(0, OAM_SF_ANY, "hmac_config_set_qos_map:: pointer is null: pst_hmac_vap[%x],puc_param[%x]", (uintptr_t)pst_hmac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_config_interworking_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    g_customize_interworking = *((oal_uint32 *)puc_param);

    OAM_INFO_LOG1(0, OAM_SF_CFG, "{hmac_config_interworking_switch::interworking_switch=%d.}", g_customize_interworking);
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_interworking_switch::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_filter_11v_bsstreq_switch(mac_vap_stru *pst_mac_vap, oal_uint8 uc_enable_filter)
{
    ...
    ***************************************************************************/
    ...
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_11V_FILTER_SWITCH, OAL_SIZEOF(uc_enable_filter), puc_param);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_filter_11v_bsstreq_switch::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_fft_window_offset(mac_vap_stru *pst_mac_vap,oal_bool_enum_uint8 en_fft_window_offset_enable)
{
    oal_uint32                     ul_ret;
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_fft_window_offset::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_set_mips(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    switch (pst_mips_type_param->l_mips_type)
    {
        case OAL_MIPS_TX:
        {
            ...
            {
                if (OAL_SWITCH_OFF == mips_tx_statistic.en_switch)
                {
            ...
            {
                if (OAL_SWITCH_ON == mips_tx_statistic.en_switch)
                {
        ...
        case OAL_MIPS_RX:
        {
            if (OAL_SWITCH_ON == pst_mips_type_param->l_switch)
            {
                if (OAL_SWITCH_OFF == mips_rx_statistic.en_switch)
                {
            ...
            {
                if (OAL_SWITCH_ON == mips_rx_statistic.en_switch)
                {
...
oal_uint32   hmac_config_cfg_vap_h2d(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY((OAL_PTR_NULL == pst_mac_vap) || (OAL_PTR_NULL == puc_param)))
    {
        OAM_ERROR_LOG2(0, OAM_SF_CFG, "{hmac_config_add_vap::param null,pst_vap=%d puc_param=%d.}", (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32 hmac_config_roam_start(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if ((OAL_PTR_NULL == pst_mac_vap) || (OAL_PTR_NULL == puc_param)) {
        OAM_ERROR_LOG2(0, OAM_SF_CFG, "hmac_config_roam_start:pst_mac_vap=%x,puc_param=%x",(uintptr_t)pst_mac_vap,(uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
    pst_hmac_vap = (hmac_vap_stru *)mac_res_get_hmac_vap(pst_mac_vap->uc_vap_id);
    if (OAL_PTR_NULL == pst_hmac_vap) {
    ...
    if (ETHER_IS_ALL_ZERO(pst_roam_start->auc_bssid)) {
        ...
        return hmac_roam_start(pst_hmac_vap, pst_roam_start->en_scan_type, pst_roam_start->en_current_bss_ignore, ROAM_TRIGGER_APP);
...
oal_uint32 hmac_config_set_ft_ies(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    oal_memcopy(st_ft_ie.auc_ie, pst_mac_ft_ies->auc_ie, pst_mac_ft_ies->us_len);//第一个参数数组长度496, 第二个参数数组长度257，不会越界
...
oal_uint32 hmac_config_enable_2040bss(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY((OAL_PTR_NULL == pst_mac_vap) || (OAL_PTR_NULL == puc_param)))
    {
        OAM_ERROR_LOG2(0, OAM_SF_CFG, "{hmac_config_enable_2040bss::param null,pst_mac_vap=%x puc_param=%x.}", (uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32 hmac_config_set_device_freq_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (CMD_SET_DEVICE_FREQ_ENDABLE == pst_set_h2d_freq->uc_cmd_type)
    {
        if(H2D_FREQ_MODE_ENABLE == pst_set_h2d_freq->uc_value)
        {
    ...
    else if (CMD_SET_DEVICE_FREQ_VALUE == pst_set_h2d_freq->uc_cmd_type)
    {
        if (FREQ_IDLE == pst_set_h2d_freq->uc_value)
        {
            hmac_config_set_device_freq(FREQ_IDLE);
        }
        else if (FREQ_MIDIUM == pst_set_h2d_freq->uc_value)
        {
            hmac_config_set_device_freq(FREQ_MIDIUM);
        }
        else if (FREQ_HIGHER == pst_set_h2d_freq->uc_value)
        {
            hmac_config_set_device_freq(FREQ_HIGHER);
        }
        else if (FREQ_HIGHEST == pst_set_h2d_freq->uc_value)
        {
            hmac_config_set_device_freq(FREQ_HIGHEST);
        }
    }
    else if(CMD_GET_DEVICE_AUTO_FREQ == pst_set_h2d_freq->uc_cmd_type)
    {
    ...
    OAM_WARNING_LOG2(0,OAM_SF_ANY,"{hmac_config_set_device_freq_enable:set_auto_freq_enable:uc_cmd_type = %d, uc_value = %d}\r\n",
...
oal_uint32  hmac_config_get_lauch_cap(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == pst_mac_vap || OAL_PTR_NULL == puc_param)
    {
        OAM_ERROR_LOG2(0, OAM_SF_CFG, "{hmac_config_get_lauch_cap::null param,pst_mac_vap=%x puc_param=%x.}",(uintptr_t)pst_mac_vap, (uintptr_t)puc_param);
        return OAL_FAIL;
    }
...
{
    if (OAL_SUCC != hcc_bus_flowctrl_init(uc_hcc_flowctrl_type))
    {
        OAM_ERROR_LOG1(0, OAM_SF_CFG, "{hmac_config_init_hcc_flowctrl::Flowctrl init failed! type = %d}", uc_hcc_flowctrl_type);
        return OAL_FAIL;
    }
...
oal_uint32  hmac_config_set_cus_priv(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_SUCC != hmac_config_init_hcc_flowctrl(pst_cus_priv->uc_hcc_flowctrl_type))
    {
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_cus_priv::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32 hmac_config_set_5g_high_band_max_pow_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_cus_base_power_params::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_set_cus_fcc_ce_power_params(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_set_cus_fcc_ce_power_params::hmac_config_send_event failed[%d].}", ul_ret);
    }
...
oal_uint32  hmac_config_fbt_rej_user(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (oal_is_broadcast_ether_addr(pst_kick_user_param->auc_mac_addr))
    {
        ...
        {
            memset_s(pst_fbt_mgmt->ast_fbt_disable_connect_user_list, OAL_SIZEOF(hmac_fbt_disable_user_info_stru)*HMAC_FBT_MAX_USER_NUM,
                0, OAL_SIZEOF(hmac_fbt_disable_user_info_stru)*HMAC_FBT_MAX_USER_NUM);
    ...
    else
    {
        ...
        for (uc_tmp_idx = 0; uc_tmp_idx < uc_user_num; uc_tmp_idx++)
        {
            ...
            if (OAL_TRUE == en_is_forbidden)
            {
                ...
                memset_s(pst_dis_user, OAL_SIZEOF(hmac_fbt_disable_user_info_stru), 0, OAL_SIZEOF(hmac_fbt_disable_user_info_stru));
            }
            else
            {
                if (0 == oal_memcmp(pst_dis_user->auc_user_mac_addr, pst_kick_user_param->auc_mac_addr, WLAN_MAC_ADDR_LEN))
...
#define TID_STAT_TO_USER(_stat) ((_stat[0])+(_stat[1])+(_stat[2])+(_stat[3])+(_stat[4])+(_stat[5])+(_stat[6])+(_stat[7]))
    ...
    *pus_len = OAL_SIZEOF(oal_net_dev_ioctl_data_stru);
    ...
    OAL_DLIST_SEARCH_FOR_EACH_SAFE(pst_entry, pst_dlist_tmp, &(pst_mac_vap->st_mac_user_list_head))
    {
        ...
        st_all_sta_link_info[us_sta_index].rx_rssi = (oal_get_real_rssi(pst_dmac_user_tmp->s_rx_rssi) + 100);
...
oal_uint32  hmac_config_send_neighbor_req(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == pst_mac_user)
    {
        ...
        OAM_WARNING_LOG1(0, OAM_SF_TX, "{hmac_config_send_neighbor_req::pst_mac_user[%d] null.", pst_mac_vap->uc_assoc_vap_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  hmac_config_voe_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_voe_enable::bit[4]11r_auth,bit[3]11k_auth_flag,bit[2]11k,bit[1]11v,bit[0]11r}");
    pst_hmac_vap = mac_res_get_hmac_vap(pst_mac_vap->uc_vap_id);
    if (OAL_PTR_NULL == pst_hmac_vap)
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_atcmdsrv_get_rx_pkcg::pst_hmac_vap null.}");
    ...
    {
        OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_voe_enable::custom_11k=[%d],custom_11v=[%d],custom_11r=[%d].}",
...
#endif
#if defined(_PRE_WLAN_FEATURE_11K) || defined(_PRE_WLAN_FEATURE_11R)
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_voe_enable::bit_voe_11r_auth = [%d],bit_11k_auth_oper_class=[%d].}",pst_hmac_vap->bit_voe_11r_auth,pst_hmac_vap->bit_11k_auth_oper_class);
#endif
    }
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
...
oal_uint32  hmac_config_ftm_dbg(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_UNLIKELY((OAL_PTR_NULL == pst_mac_vap) || (OAL_PTR_NULL == puc_param)))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{hmac_config_ftm_dbg: input pointer is null!}");
        return OAL_FAIL;
    }
...
oal_uint32 hmac_config_pm_debug_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_pm_debug_switch::hmac_config_send_event fail[%d].", ul_ret);
        return ul_ret;
    }
...
oal_void hmac_set_apf_switch_by_pps(hmac_device_stru *pst_hmac_device, mac_cfg_suspend_stru *pst_suspend)
{
    ...
    ul_total_rxtx_pps = pst_hmac_device->st_dscr_th_opt.ul_tx_large_pps + pst_hmac_device->st_dscr_th_opt.ul_tx_small_pps +
                        pst_hmac_device->st_dscr_th_opt.ul_rx_large_pps + pst_hmac_device->st_dscr_th_opt.ul_rx_small_pps;

    if ((ul_total_rxtx_pps < g_st_thread_bindcpu.us_throughput_pps_irq_low) && (g_us_apf_program_len > OAL_SIZEOF(oal_uint8)))
    {
    ...
    OAM_WARNING_LOG4(0, OAM_SF_CFG, "hmac_set_apf_switch_by_pps:1.enable[%d]; 2.program len [%d]; 3.ul_total_rxtx_pps [%d]; 4.pps_low_th [%d]...",
                    pst_suspend->uc_apf_switch, g_us_apf_program_len, ul_total_rxtx_pps, g_st_thread_bindcpu.us_throughput_pps_irq_low);
...
oal_uint32  hmac_apf_program_report_event(frw_event_mem_stru  *pst_event_mem)
{
    ...
    OAM_WARNING_LOG3(0, OAM_SF_CFG, "hmac_apf_program_report_event:program_len[%d],flt_pkt_cnt[%d],install_timestamp[%d]",
...
oal_uint32  hmac_config_protocol_debug_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (OAL_PTR_NULL == pst_hmac_vap)
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_protocol_debug_switch::pst_hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (OAL_PTR_NULL == pst_mac_device)
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_device_id, OAM_SF_SCAN, "{hmac_config_protocol_debug_switch::pst_mac_device is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (pst_protocol_debug->ul_cmd_bit_map & BIT0)
    {
        ...
        {
            OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_protocol_debug_switch::vap mode is not ap,vap_mode[%d],p2p_mode[%d],return.",
                             pst_mac_vap->en_vap_mode, pst_mac_vap->en_p2p_mode);
            return OAL_SUCC;
        }
        ...
        {
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_config_protocol_debug_switch::bandwidth[%d] no need to change.}", en_new_40M_bandwidth);
            return OAL_SUCC;
        }

        if ((en_new_40M_bandwidth > WLAN_BAND_WIDTH_40MINUS) && (pst_mac_device->en_bandwidth_cap < WLAN_BW_CAP_80M))
        {
            pst_protocol_debug->en_band_force_switch = mac_vap_get_bandwith(pst_mac_device->en_bandwidth_cap, pst_protocol_debug->st_csa_debug.en_bandwidth);

            /* 设置80M带宽，但device能力不支持80M， 刷新成合适带宽做业务 */
            OAM_WARNING_LOG3(0, OAM_SF_CFG, "{hmac_config_protocol_debug_switch::not support bandwidth[%d], en_new_protocol=%d en_protocol_cap=%d.}",
                             en_new_40M_bandwidth, pst_protocol_debug->st_csa_debug.en_bandwidth, pst_mac_device->en_bandwidth_cap);
        ...
        if ((WLAN_BAND_WIDTH_20M == en_new_40M_bandwidth))
        {
        ...
        OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_2040,
                        "{hmac_config_protocol_debug_switch::uc_chan_number [%d], en_bandwidth [%d], en_new_40M_bandwidth [%d].}",
        ...
        ul_ret = hmac_send_ht_notify_chan_width(pst_mac_vap, BROADCAST_MACADDR);
        if (OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_2040, "{hmac_config_protocol_debug_switch::hmac_send_ht_notify_chan_width return %d.}", ul_ret);
        }
    }
    /* csa cmd */
    if (pst_protocol_debug->ul_cmd_bit_map & BIT1)
    {
        ...
        OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_CFG,"hmac_config_protocol_debug_switch::csa_channel=%d csa_bw=%d csa_cnt=%d debug_flag=%d \n",
                         pst_protocol_debug->st_csa_debug.uc_channel,
                         en_new_40M_bandwidth,
                         pst_protocol_debug->st_csa_debug.uc_cnt,
                         pst_protocol_debug->st_csa_debug.en_debug_flag);
        ...
        if (OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG3(0, OAM_SF_CFG, "{hmac_config_protocol_debug_switch::mac_is_channel_num_valid(%d), band[%d], return ul_ret[%d].",
        ...
        if ((en_new_40M_bandwidth > WLAN_BAND_WIDTH_40MINUS) && (pst_mac_device->en_bandwidth_cap < WLAN_BW_CAP_80M))
        {
            pst_protocol_debug->st_csa_debug.en_bandwidth = mac_vap_get_bandwith(pst_mac_device->en_bandwidth_cap, pst_protocol_debug->st_csa_debug.en_bandwidth);
        ...
        if(MAC_CSA_FLAG_NORMAL == pst_protocol_debug->st_csa_debug.en_debug_flag)
        {
            if (WLAN_BAND_WIDTH_20M != en_new_40M_bandwidth)
            {
                mac_mib_set_FortyMHzOperationImplemented(pst_mac_vap, OAL_TRUE);
            ...
            hmac_chan_initiate_switch_to_new_channel(pst_mac_vap, pst_protocol_debug->st_csa_debug.uc_channel, en_new_40M_bandwidth);
        }
    }
...
oal_uint32 hmac_config_force_pass_filter(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if(wlan_pm_switch && ul_is_wlan_poweron)
    {
        ...
        if (OAL_PTR_NULL == pst_hmac_device)
        {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_force_pass_filter::pst_hmac_device[%x] null.}", (uintptr_t)pst_hmac_device);
            return OAL_ERR_CODE_PTR_NULL;
        }
        ...
        ***************************************************************************/
        ...
        ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_APF_SWITCH_SYN, OAL_SIZEOF(mac_cfg_suspend_stru), (oal_uint8 *)&st_suspend);
        if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
        {
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_config_force_pass_filter::hmac_config_send_event failed[%d]}",ul_ret);
        }
...
oal_uint32 hmac_config_set_tx_ba_policy(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_config_set_tx_ba_policy::g_uc_tx_ba_policy_select=%d.}",g_ul_tx_ba_policy_select);
...
oal_uint32 hmac_config_set_event_netbuf_num(mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_add_p2p)
{
    oal_uint32   ul_ret;
    oal_uint8    uc_netbuf_num;

    if (pst_mac_vap == OAL_PTR_NULL) {
        OAM_ERROR_LOG0(0,OAM_SF_CFG,"hmac_config_set_event_netbuf_num:pst_mac_vap is null");
        return OAL_ERR_CODE_PTR_NULL;
    }
    uc_netbuf_num = (en_add_p2p == OAL_TRUE) ? 4 : 3;
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(pst_mac_vap, WLAN_CFGID_SET_EVENT_NETBUF_NUM, OAL_SIZEOF(oal_uint8), &uc_netbuf_num);
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret)) {
        OAM_WARNING_LOG1(0, OAM_SF_CFG, "{hmac_config_set_event_netbuf_num::hmac_config_send_event fail[%d].", ul_ret);
        return ul_ret;
    }
