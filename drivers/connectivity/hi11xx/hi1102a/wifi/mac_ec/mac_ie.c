...
wlan_channel_bandwidth_enum_uint8  mac_get_bandwith_from_center_freq_seg0(oal_uint8 uc_channel, oal_uint8 uc_chan_center_freq)
{
...
oal_uint32  mac_ie_proc_opmode_field(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify)
{
    ...
    if( OAL_RETURN == g_st_mac_ie_rom_cb.p_mac_ie_proc_opmode_field(pst_mac_vap, pst_mac_user, pst_opmode_notify))
    {
        return OAL_SUCC;
    }
    ...
    {
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_ie_proc_opmode_field::pst_opmode_notify->bit_rx_nss = [%x], pst_mac_user->uc_num_spatial_stream = [%x]!}\r\n",
