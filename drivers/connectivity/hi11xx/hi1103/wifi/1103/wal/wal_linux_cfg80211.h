...
extern oal_void  wal_cfg80211_exit_etc(oal_void);
...
#endif /* wal_cfg80211_vowifi_report_etc */

extern oal_uint32 wal_cfg80211_cac_report(frw_event_mem_stru *pst_event_mem);

#ifdef _PRE_WLAN_FEATURE_ROAM
extern oal_uint32  wal_roam_comp_proc_sta_etc(frw_event_mem_stru *pst_event_mem);
#endif //_PRE_WLAN_FEATURE_ROAM
#ifdef _PRE_WLAN_FEATURE_11R
extern oal_uint32  wal_ft_event_proc_sta_etc(frw_event_mem_stru *pst_event_mem);
#endif //_PRE_WLAN_FEATURE_11R

extern oal_void wal_cfg80211_unregister_netdev_etc(oal_net_device_stru *pst_net_dev);

extern oal_uint32 wal_del_p2p_group_etc(mac_device_stru *pst_mac_device);


extern oal_uint32 wal_cfg80211_add_vap_etc(mac_cfg_add_vap_param_stru *pst_add_vap_param);
