...
mac_frame_cb g_st_mac_frame_rom_cb = {
    ...
    .set_ht_opern_ie_cb = mac_set_ht_opern_ie_rom_cb,         // set_ht_opern_ie
    .set_rsn_ie_cb = OAL_PTR_NULL,                            // set_rsn_ie
    .set_vht_cap_ie_cb = OAL_PTR_NULL,                        // set_vht_cap_ie_cb
    .set_vht_opern_ie_cb = mac_set_vht_opern_ie_rom_cb,                      // set_vht_opern_ie_cb
...
mac_frame_other_cb g_st_mac_frame_other_rom_cb = {
    .set_opmode_cb            = OAL_PTR_NULL,
    .rx_report_80211_frame_etc_cb = OAL_PTR_NULL
};
...
oal_void mac_report_beacon(mac_rx_ctl_stru *pst_rx_cb, oal_netbuf_stru *pst_netbuf)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_WIFI_BEACON,
                         "{mac_report_beacon::oam_report_beacon_etc return err: 0x%x.}\r\n", ul_ret);
    }
}
                                       ...
                                       oal_switch_enum_uint8 *pen_dscr_switch)
{
        ...
        if (pst_frame_hdr->st_frame_control.bit_sub_type == WLAN_PROBE_REQ ||
            ...
            if (ul_ret != OAL_SUCC) {
                OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                                 "{mac_report_80211_get_switch::oam_report_80211_probe_get_switch_etc failed.}");
    ...
    if (ETHER_IS_MULTICAST(puc_da)) {
        ...
        if (ul_ret == OAL_ERR_CODE_PTR_NULL) {
            ...
            OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
                             "{mac_report_80211_get_switch::mac_vap_find_user_by_macaddr_etc failed.}");
            return ul_ret;
        }
        if (ul_ret == OAL_FAIL) {
            *pen_cb_switch = 0;
        ...
        if (ul_ret != OAL_SUCC) {
            ...
            OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_RX,
                             "{oam_report_80211_ucast_get_switch_etc::frame_switch[%x], cb_switch[%x], dscr_switch[%x]",
                                  ...
                                  oam_ota_type_enum_uint8 en_ota_type)
{
    ...
    if ((en_ota_type == OAM_OTA_TYPE_RX_DSCR) || (en_ota_type == OAM_OTA_TYPE_RX_DSCR_PILOT)) {
        ...
        if (en_dscr_switch == OAL_SWITCH_ON) {
            ul_ret = oam_report_dscr_etc(&auc_user_macaddr[0], puc_des_addr, (oal_uint16)WLAN_RX_DSCR_SIZE, en_ota_type);
            if (ul_ret != OAL_SUCC) {
                OAM_WARNING_LOG1(0, OAM_SF_RX,
                                 "{mac_report_80211_frame::oam_report_dscr_etc return err: 0x%x.}\r\n", ul_ret);
            }
        }
    } else {
        /* 上报接收到的帧 */
        if (en_frame_switch == OAL_SWITCH_ON) {
            ...
            ul_ret = oam_report_80211_frame_etc(&auc_user_macaddr[0],
            ...
            if (ul_ret != OAL_SUCC) {
                OAM_WARNING_LOG1(0, OAM_SF_RX,
                                 "{mac_report_80211_frame::oam_report_80211_frame_etc return err: 0x%x.}\r\n", ul_ret);
            }
        }

        /* 上报接收帧的CB字段 */
        if (en_cb_switch == OAL_SWITCH_ON) {
            ul_ret = oam_report_netbuf_cb_etc(&auc_user_macaddr[0], (oal_uint8 *)pst_rx_cb, en_ota_type);
            if (ul_ret != OAL_SUCC) {
                OAM_WARNING_LOG1(0, OAM_SF_RX,
                                 "{mac_report_80211_frame::oam_report_netbuf_cb_etc return err: 0x%x.}\r\n", ul_ret);
            }
        }
    }
                                         ...
                                         oam_ota_type_enum_uint8 en_ota_type)
{
    ...
    if (g_st_mac_frame_other_rom_cb.rx_report_80211_frame_etc_cb) {
        g_st_mac_frame_other_rom_cb.rx_report_80211_frame_etc_cb(pst_vap, pst_rx_cb, pst_netbuf, en_ota_type);
    }
    ...
    if (uc_sub_type == (WLAN_FC0_SUBTYPE_BEACON | WLAN_FC0_TYPE_MGT)) {
        ...
        mac_report_80211_frame((oal_uint8 *)pst_mac_vap,
                               (oal_uint8 *)pst_mac_rx_cb,
...
oal_void mac_set_cap_info_sta_etc(oal_void *pst_vap, oal_uint8 *puc_cap_info)
{
    ...
    ***************************************************************************/
    ...
    l_ret = memcpy_s(puc_cap_info, OAL_SIZEOF(mac_cap_info_stru),
                     (oal_uint8 *)(&pst_mac_vap->us_assoc_user_cap_info),
                     OAL_SIZEOF(mac_cap_info_stru));
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_cap_info_sta_etc::memcpy fail!");
        return;
    }
...
oal_void mac_set_ssid_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len, oal_uint16 us_frm_type)
{
    ...
    *(puc_buffer + 1) = uc_ssid_len;
    ...
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_ssid_ie_etc::memcpy fail!");
        return;
    }
...
oal_void mac_set_supported_rates_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    if (pst_mac_vap->en_vap_mode == WLAN_VAP_MODE_BSS_STA &&
        ...
        (pst_mac_vap->en_protocol == WLAN_VHT_MODE || pst_mac_vap->en_protocol == WLAN_HE_MODE))
#else
...
oal_void mac_set_quiet_ie_etc(void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 uc_qcount,
...
oal_void mac_set_rsn_ie_etc(oal_void *pst_vap, oal_uint8 *puc_pmkid, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    uc_akm_suites_num = mac_mib_get_rsn_akm_suites(pst_mac_vap, &aul_akm[0]);
    ...
    l_ret = memcpy_s(&puc_buffer[uc_index], OAL_SIZEOF(oal_uint32),
                     (oal_uint8 *)(&ul_group_suit), OAL_SIZEOF(oal_uint32));
    uc_index += 4;
    ...
    for (uc_loop = 0; uc_loop < uc_pair_suites_num; uc_loop++) {
        l_ret += memcpy_s(&puc_buffer[uc_index], OAL_SIZEOF(oal_uint32),
                          (oal_uint8 *)(&aul_pcip[uc_loop]), OAL_SIZEOF(oal_uint32));
        uc_index += 4;
    }
    ...
    for (uc_loop = 0; uc_loop < uc_akm_suites_num; uc_loop++) {
        l_ret += memcpy_s(&puc_buffer[uc_index], OAL_SIZEOF(oal_uint32),
                          (oal_uint8 *)(&aul_akm[uc_loop]), OAL_SIZEOF(oal_uint32));
        uc_index += 4;
    }
    ...
    if ((OAL_TRUE == mac_mib_get_dot11RSNAMFPC((mac_vap_stru *)pst_mac_vap) && ul_group_mgmt_suit)) {
        ...
        l_ret += memcpy_s(&puc_buffer[uc_index], OAL_SIZEOF(oal_uint32),
                          (oal_uint8 *)(&ul_group_mgmt_suit), OAL_SIZEOF(oal_uint32));
        uc_index += 4;
    }
    ...
    *puc_ie_len = uc_index;
    ...
    if (g_st_mac_frame_rom_cb.set_rsn_ie_cb != OAL_PTR_NULL) {
...
oal_void mac_set_wpa_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    uc_akm_suites_num = mac_mib_get_wpa_akm_suites(pst_mac_vap, &aul_akm[0]);
    ...
    l_ret = memcpy_s(puc_buffer + uc_index, MAC_OUI_LEN, g_auc_wpa_oui_etc, MAC_OUI_LEN);
    ...
    l_ret += memcpy_s(&puc_buffer[uc_index], OAL_SIZEOF(oal_uint32),
                      (oal_uint8 *)(&ul_group_suit), OAL_SIZEOF(oal_uint32));
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_wpa_ie_etc::memcpy fail!");
        return;
    }
    ...
    for (uc_loop = 0; uc_loop < uc_pair_suites_num; uc_loop++) {
        if (EOK != memcpy_s(&puc_buffer[uc_index], OAL_SIZEOF(oal_uint32),
                            (oal_uint8 *)(&aul_pcip[uc_loop]), OAL_SIZEOF(oal_uint32))) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_wpa_ie_etc::memcpy fail!");
            return;
        }
    ...
    *puc_ie_len = uc_index;
    ...
    if (g_st_mac_frame_rom_cb.set_wpa_ie_cb != OAL_PTR_NULL) {
...
oal_void mac_set_wmm_params_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer,
                                   oal_bool_enum_uint8 en_is_qos, oal_uint8 *puc_ie_len)
{
    ...
    /* OUI */
    l_ret = memcpy_s(&puc_buffer[uc_index], MAC_OUI_LEN, g_auc_wmm_oui_etc, MAC_OUI_LEN);
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_wmm_params_ie_etc::memcpy fail!");
        return;
    }
...
oal_void mac_set_ht_capinfo_field(oal_void *pst_vap, oal_uint8 *puc_buffer)
{
    ...
    pst_ht_capinfo->bit_supported_channel_width =
        (MAC_VAP_GET_CAP_BW(pst_mac_vap) > WLAN_BAND_WIDTH_20M) ? OAL_TRUE : OAL_FALSE;
...
oal_void mac_set_ht_capabilities_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    *puc_ie_len = MAC_IE_HDR_LEN + MAC_HT_CAP_LEN;
    ...
    if (g_st_mac_frame_rom_cb.set_ht_cap_ie_cb != OAL_PTR_NULL) {
...
oal_void mac_set_ht_opern_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    *puc_ie_len = MAC_IE_HDR_LEN + MAC_HT_OPERN_LEN;
    ...
    if (g_st_mac_frame_rom_cb.set_ht_opern_ie_cb != OAL_PTR_NULL) {
...
oal_void mac_set_ext_capabilities_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    *puc_ie_len = MAC_IE_HDR_LEN + MAC_XCAPS_EX_LEN;
    ...
    if (g_st_mac_frame_rom_cb.set_ext_cap_ie_cb != OAL_PTR_NULL) {
...
oal_void mac_set_vht_capinfo_field_etc(oal_void *pst_vap, oal_uint8 *puc_buffer)
{
    ...
    ***************************************************************************/
    ...
    if (g_st_mac_frame_rom_cb.set_vht_capinfo_field_cb != OAL_PTR_NULL) {
...
oal_void mac_set_vht_capabilities_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    *puc_ie_len = MAC_IE_HDR_LEN + MAC_VHT_CAP_IE_LEN;
    ...
    if (g_st_mac_frame_rom_cb.set_vht_cap_ie_cb != OAL_PTR_NULL) {
...
oal_void mac_set_vht_opern_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    *puc_ie_len = MAC_IE_HDR_LEN + MAC_VHT_INFO_IE_LEN;
    ...
    if (g_st_mac_frame_rom_cb.set_vht_opern_ie_cb != OAL_PTR_NULL) {
        g_st_mac_frame_rom_cb.set_vht_opern_ie_cb(pst_mac_vap, puc_buffer, puc_ie_len);
    }
}


oal_uint32 mac_set_csa_ie_etc(oal_uint8 uc_mode, oal_uint8 uc_channel,
                              oal_uint8 uc_csa_cnt, oal_uint8 *puc_buffer,
                              oal_uint8 *puc_ie_len)
{
...
oal_uint32 mac_set_csa_bw_ie(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    if (OAL_SUCC != mac_set_second_channel_offset_ie_etc(en_bw, puc_buffer, &uc_len)) {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CSA,
                       "{mac_set_csa_bw_ie::mac_set_second_channel_offset_ie_etc failed}");
        return 0;
    }
    ...
    *puc_ie_len = uc_len;
    ...
    if (OAL_TRUE == mac_mib_get_VHTOptionImplemented(pst_mac_vap)) {
        ...
        if (OAL_SUCC != mac_set_11ac_wideband_ie_etc(uc_channel, en_bw, puc_buffer, &uc_len)) {
            OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CSA,
                           "{mac_set_csa_bw_ie::mac_set_11ac_wideband_ie_etc failed}");
            return 0;
        }
        *puc_ie_len += uc_len;
    }
...
oal_uint8 *mac_get_ssid_etc(oal_uint8 *puc_beacon_body, oal_int32 l_frame_body_len, oal_uint8 *puc_ssid_len)
{
    ...
    *puc_ssid_len = 0;
    ...
    /* 查找ssid的ie */
    puc_ssid_ie = mac_find_ie_etc(MAC_EID_SSID,
                                  (puc_beacon_body + us_offset),
                                  (oal_int32)(l_frame_body_len - us_offset));
...
oal_void mac_set_power_cap_ie_etc(oal_uint8 *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    if (OAL_FALSE == mac_mib_get_dot11SpectrumManagementRequired(pst_mac_vap) &&
        ...
        OAM_WARNING_LOG0(0, OAM_SF_TPC,
                         "{mac_set_power_cap_ie_etc::en_dot11SpectrumManagementRequired,  \
    ...
    *(puc_buffer + 1) = MAC_PWR_CAP_LEN;
    ...
    pst_regclass_info = mac_get_channel_num_rc_info_etc(pst_mac_vap->st_channel.en_band,
                                                        pst_mac_vap->st_channel.uc_chan_number);

    if (pst_regclass_info != OAL_PTR_NULL) {
        *(puc_buffer + 2) = (oal_uint8)((pst_mac_vap->st_channel.en_band == WLAN_BAND_2G) ? 4 : 3);
        *(puc_buffer + 3) = (oal_uint8)OAL_MIN(pst_regclass_info->uc_max_reg_tx_pwr,
...
oal_void mac_set_wmm_ie_sta_etc(oal_uint8 *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    l_ret = memcpy_s(&puc_buffer[uc_index], MAC_OUI_LEN, g_auc_wmm_oui_etc, MAC_OUI_LEN);
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_wmm_ie_sta_etc::memcpy fail!");
        return;
    }
...
oal_uint16 mac_set_wmmac_ie_sta_etc(oal_uint8 *pst_vap, oal_uint8 *puc_buffer, mac_wmm_tspec_stru *pst_addts_args)
{
    ...
    *************************************************************************************/
    ...
    l_ret = memcpy_s(&puc_buffer[uc_index], MAC_OUI_LEN, g_auc_wmm_oui_etc, MAC_OUI_LEN);
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_wmmac_ie_sta_etc::memcpy fail!");
                            ...
                            en_app_ie_type_uint8 en_type)
{
    ...
    if (ul_app_ie_len == 0) {
        *pus_ie_len = 0;
        ...
        if (l_ret != EOK) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_add_app_ie_etc::memcpy fail!");
            return;
        }
                            ...
                            en_app_ie_type_uint8 en_type)
{
    ...
    puc_wps_ie = mac_find_vendor_ie_etc(MAC_WLAN_OUI_MICROSOFT, MAC_WLAN_OUI_TYPE_MICROSOFT_WPS,
    ...
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_add_wps_ie_etc::memcpy fail!");
        return;
    }
...
oal_void mac_set_opmode_field_etc(oal_uint8 *pst_vap, oal_uint8 *puc_buffer, wlan_nss_enum_uint8 en_nss)
{
    ...
    if (g_st_mac_frame_other_rom_cb.set_opmode_cb != OAL_PTR_NULL) {
        g_st_mac_frame_other_rom_cb.set_opmode_cb(pst_vap, puc_buffer, en_nss);
    }
}
...
oal_void mac_set_wfa_tpc_report_ie_etc(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    l_ret = memcpy_s(puc_buffer + uc_index, MAC_OUI_LEN, g_auc_wfa_oui_etc, MAC_OUI_LEN);
    if (l_ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_set_wfa_tpc_report_ie_etc::set wfa_oui fail!");
        return;
    }
...
oal_uint16 mac_encap_2040_coext_mgmt_etc(oal_void *pst_vap,
