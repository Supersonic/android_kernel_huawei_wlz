...
oal_void dfx_set_performance_log_switch_enable_etc(dfx_performance_log_switch_enum_uint8 uc_performance_log_switch_type,
                                                   oal_uint8 uc_value)
{
    if (uc_performance_log_switch_type >= DFX_PERFORMANCE_LOG_BUTT) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY,
                         "dfx_set_performance_log_switch_enable_etc::log_switch type:%d.",
...
/*lint -e19 */
oal_module_symbol(g_en_chip_type); /*lint +e19 */
