...
#ifdef _PRE_WLAN_FTM_OPT
    mac_ftm_set_white_list_stru     st_set_white_list_bit12;
#endif
...
/* end: P2P */
    ...
    oal_uint8                           uc_dc_status;                           /* dc场景识别同步 */
...
typedef struct
{
    oal_uint32 aul_query_result[MAC_PSM_QUERY_MSG_MAX_STAT_ITEM];
...
typedef struct
{
    oal_uint32                          ul_short_sleep_cnt;   /* idle时间 60ms 计数 */
    oal_uint32                          ul_long_sleep_cnt;    /* idle时间 200ms 计数 */
    oal_bool_enum_uint8                 en_query_completed_flag;
...
extern oal_uint8 g_uc_ddr_custom_switch;
/*****************************************************************************
  10.3 杂项，待归类
*****************************************************************************/
