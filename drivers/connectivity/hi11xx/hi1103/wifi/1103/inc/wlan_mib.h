...
typedef oal_uint8   wlan_mib_ht_ecbf_enum_uint8;
...
typedef oal_uint8   wlan_mib_vht_op_width_enum_uint8;
...
typedef enum
{
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_LTECOEX_MODE_SET    = 155,
#endif
    ...
    WLAN_CFGID_SET_LOG_PM                   = 191,      /* 设置Device log 为pm模式 */

    WLAN_CFGID_AMSDU_START                  = 192,      /* AMSDUA开启关闭 参数配置 */
    ...
    WLAN_CFGID_GET_CALI_DATA       = 316,           /* 获取校准数据 */
    ...
    WLAN_CFGID_DHCP_REQ_DISABLE_SWITCH   = 382, /* dhcp req disable 开关 */
#endif
    ...
    WLAN_CFGID_PROXYARP_EN           = 469,
    WLAN_CFGID_PROXYARP_INFO         = 470,
#endif
#ifdef _PRE_WLAN_FEATURE_SMPS
    WLAN_CFGID_SET_SMPS              = 471,
//    WLAN_CFGID_GET_SMPS_EN           = 472,
    WLAN_CFGID_SET_VAP_SMPS          = 473,

#ifdef _PRE_DEBUG_MODE
    WLAN_CFGID_GET_SMPS_INFO         = 474,
#endif
#endif
    ...
    WLAN_CFGID_LOAD_INI_PWR_GAIN        = 545,   /* 重新load定制化功率增益相关参数 */
#endif
    ...
    WLAN_CFGID_FREE_RATIO_SET     = 581,  /* 设置green ap的free ratio门限 */
#endif
#ifdef _PRE_WLAN_FEATURE_AP_PM
    WLAN_CFGID_STA_SCAN_CONNECT   = 582,  /* sta扫描或关联时间 */
#endif
    ...
    WLAN_CFGID_SET_ADDBA_RSP_EXTEND= 589,
#endif
    ...
    WLAN_CFGID_SET_RESTRICT_BAND            = 655,
#endif

#if defined(_PRE_WLAN_FEATURE_DBAC) && defined(_PRE_WLAN_FEATRUE_DBAC_DOUBLE_AP_MODE)
    WLAN_CFGID_SET_OMIT_ACS                 = 656,
#endif
    WLAN_CFGID_SET_ALWAYS_TX_HW_CFG         = 657,
    WLAN_CFGID_SET_ALWAYS_TX_HW             = 658,
    ...
    WLAN_CFGID_WDS_VAP_MODE             = 662,     /* 配置VAP的 WDS模式 */
    WLAN_CFGID_WDS_VAP_SHOW             = 663,     /* 打印WDS配置信息 */
    WLAN_CFGID_WDS_STA_ADD              = 664,     /* 添加WDS STA */
    WLAN_CFGID_WDS_STA_DEL              = 665,     /* 删除WDS STA */
    WLAN_CFGID_WDS_STA_AGE              = 666,     /* 配置WDS STA的Timeout时间 */
#endif
    WLAN_CFGID_DC_STATUS                = 667,     /* 配置dc场景状态 */

#ifdef _PRE_WLAN_FEATURE_PACKET_CAPTURE
    WLAN_CFGID_PACKET_CAPTURE_SWITCH    = 670,      /* 设置抓包模式开关 */
#endif

#ifdef _PRE_WLAN_FEATURE_WMMAC
    WLAN_CFGID_ADDTS_REQ                = 671,      /* 发送ADDTS REQ的配置命令 */
    WLAN_CFGID_DELTS                    = 672,      /* 发送DELTS的配置命令 */
    WLAN_CFGID_REASSOC_REQ              = 673,      /* 发送reassoc req 的配置命令*/
    WLAN_CFGID_WMMAC_SWITCH             = 674,      /* 设置WMMAC SWITCH开关的配置命令 */
#endif

#ifdef _PRE_WLAN_11K_STAT
    WLAN_CFGID_QUERY_STAT_INFO          = 675,
#endif

#ifdef _PRE_DEBUG_MODE
    WLAN_CFGID_DYNC_POW_DEBUG               = 677,          /* 设置动态校准维测开关 */
#endif
    WLAN_CFGID_SET_PRIV_FLAG                = 678,          /* 设置标记用来区分在内核调用netdevice的.ndo_open接口时是否需要真正开启AP */
    ...
    WLAN_CFGID_M2U_TID_SET                  = 683,          /* 设置组播转单播数据使用的tid队列*/
#endif
#if (_PRE_WLAN_FEATURE_BLACKLIST_LEVEL != _PRE_WLAN_FEATURE_BLACKLIST_NONE)
...
#if defined(_PRE_WLAN_FEATURE_MCAST) || defined(_PRE_WLAN_FEATURE_HERA_MCAST)
    WLAN_SHOW_M2U_SNOOP_DENY_TABLE      = 698,         /* 显示组播转单播黑名单*/
#endif
#ifdef _PRE_WLAN_FEATURE_CAR
        WLAN_CFGID_CAR_CFG              = 699,         /* car配置命令 */
#endif
#ifdef _PRE_WLAN_FEATURE_11V
    WLAN_CFGID_11V_WL_MGMT_SWITCH       = 700,          /* 禁用|开启11v wireless mgmt总特性功能开关 */
#endif
    ...
    WLAN_CFGID_11V_TX_REQUEST           = 703,          /* 11v 触发AP发送Request帧 */
#endif

#ifdef _PRE_WLAN_FEATURE_11K_EXTERN
    WLAN_CFGID_SEND_RADIO_MEAS_REQ      = 704,
    WLAN_CFGID_GET_MEAS_START_TSF       = 705,
    WLAN_CFGID_SET_11K_SWITCH           = 706,
#endif

    WLAN_CFGID_SET_MLME                 = 707,

#ifdef  _PRE_WLAN_FEATURE_RX_AGGR_EXTEND
    WLAN_CFGID_WAVEAPP_32PLUS_USER_ENABLE      = 708,         /* waveapp 用户性能测试 */
#endif

    WLAN_CFGID_RSSI_LIMIT_CFG           = 719,
    WLAN_CFGID_GET_BCAST_RATE           = 720,
#if defined(_PRE_WLAN_FEATURE_MCAST) || defined(_PRE_WLAN_FEATURE_HERA_MCAST)
    WLAN_DEL_M2U_DENY_TABLE             = 721,         /* 删除组播转单播黑名单*/
#endif
    WLAN_CFGID_GET_ALL_STA_INFO         = 722,        /* 获取所有已关联sta信息 */
    WLAN_CFGID_GET_STA_INFO_BY_MAC      = 723,        /* 获取某个指定关联sta信息 */

#ifdef _PRE_WLAN_FEATURE_WDS
    WLAN_CFGID_GET_WDS_STA_NUM          = 727,
    ...
    WLAN_CFGID_M2U_FREQUENCY_ON         = 732,         /* 异频组播转发开关*/
    WLAN_CFGID_M2U_ADAPTIVE_ON          = 733,         /* 配网模式识别开关*/
#endif

    WLAN_CFGID_FBT_GET_STA_11H_ABILITY  = 734,          /* hilink获取sta 11h能力信息 */
#ifdef _PRE_WLAN_FEATURE_11R_AP
    WLAN_CFGID_FBT_GET_STA_11R_ABILITY  = 735,          /* hilink获取sta 11r能力信息 */
#endif
    ...
    WLAN_CFGID_SEND_ACTION_FRAME        = 763,         /* 发送11kv的action帧 */
    WLAN_CFGID_SET_MGMT_FRAME_IE        = 764,         /* 设置对应管理帧的IE内容 */
    WLAN_CFGID_SET_MGMT_CAP_INFO        = 765,         /* 设置管理帧的CAP info信息 */
#endif
    WLAN_CFGID_VAP_WMM_SWITCH           = 766,          /*打开或者关闭vap级别wmm开关*/
#ifdef _PRE_FEATURE_WAVEAPP_CLASSIFY
    WLAN_CFGID_GET_WAVEAPP_FLAG         = 767,           /*获取仪器识别状态*/
#endif
    ...
    WLAN_CFGID_FAST_AGING               = 774,          /* 配置快速老化参数 */
    WLAN_CFGID_GET_FAST_AGING           = 775,
#endif

#ifdef _PRE_WLAN_FEATURE_QOS_ENHANCE
    WLAN_CFGID_QOS_ENHANCE_ON           = 776,         /* qos enhance调试命令 */
#endif
    ...
    WLAN_CFGID_HIMIT_SWITCH             = 804,  /* 配置himit使能 */
#endif
...
#if defined(_PRE_WLAN_FEATURE_11AX) && defined(_PRE_WLAN_FEATURE_UPH_AUTO)
    WLAN_CFGID_HE_UPH_CONTROL_ACTIVATED = 808,  /* 配置dot11HEUPHControlActivated项 */
#endif
...
#ifdef _PRE_WLAN_FEATURE_STA_PM
    WLAN_CFGID_SET_FASTSLEEP_PARA          = 812,  /* 配置fastsleep相关参数 */
#endif
    /************************************************************************
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_PCIE_TEST               = 2013,      /* 配置PCIE TEST参数 */
#endif
...
typedef struct
{
    ...
    oal_uint16           us_dot11MaxAssocUserNums;
    ...
    oal_uint8            uc_dot11RxBASessionNumber;                   /* 该vap下，rx BA会话的数目 */
    oal_uint8            uc_dot11TxBASessionNumber;                   /* 该vap下，tx BA会话的数目 */
    oal_uint8            uc_dot11VAPClassifyTidNo;                    /* 仅在基于vap的流分类使能后有效 */
    ...
    oal_uint8            uc_dot11StaAuthCount;                        /* 记录STA发起关联的次数 */
    oal_uint8            uc_dot11StaAssocCount;
    oal_uint8            uc_dot11SupportRateSetNums;
    oal_uint8            en_dot11TxTrafficClassifyFlag;               /* 业务识别功能开关 */

    /* Byte1 */
    oal_bool_enum_uint8 en_dot11MultiDomainCapabilityActivated      :1;         /* dot11MultiDomainCapabilityActivated TruthValue, */
    oal_bool_enum_uint8 en_dot11SpectrumManagementImplemented       :1;          /* dot11SpectrumManagementImplemented TruthValue, */
    oal_bool_enum_uint8 en_dot11SpectrumManagementRequired          :1;             /* dot11SpectrumManagementRequired TruthValue, */
    oal_bool_enum_uint8 en_dot11QosOptionImplemented                :1;                   /* dot11QosOptionImplemented TruthValue, */
    oal_bool_enum_uint8 en_dot11ImmediateBlockAckOptionImplemented  :1;     /* dot11ImmediateBlockAckOptionImplemented TruthValue, */
    oal_bool_enum_uint8 en_dot11DelayedBlockAckOptionImplemented    :1;       /* dot11DelayedBlockAckOptionImplemented TruthValue, */
    ...
    /* Byte2 */
    oal_bool_enum_uint8 en_dot11RadioMeasurementActivated           :1;              /* dot11RadioMeasurementActivated TruthValue, */
    oal_bool_enum_uint8 en_dot11ExtendedChannelSwitchActivated      :1;         /* dot11ExtendedChannelSwitchActivated  TruthValue, */
    oal_bool_enum_uint8 en_dot11RMLinkMeasurementActivated          :1;             /* dot11RMLinkMeasurementActivated TruthValue, */
    oal_bool_enum_uint8 en_dot11RMBeaconPassiveMeasurementActivated :1;    /* dot11RMBeaconPassiveMeasurementActivated  TruthValue, */
    oal_bool_enum_uint8 en_dot11RMBeaconActiveMeasurementActivated  :1;     /* dot11RMBeaconActiveMeasurementActivated TruthValue, */
    oal_bool_enum_uint8 en_dot11RMBeaconTableMeasurementActivated   :1;      /* dot11RMBeaconTableMeasurementActivated TruthValue, */
    oal_bool_enum_uint8 en_dot11WirelessManagementImplemented       :1;      /* dot11WirelessManagementImplemented  TruthValue, */
    ...
    /* Byte4 */
    oal_uint8            en_dot1180211iMode;                  /* 指示当前的方式时WPA还是WPA2, bit0 = 1,WPA; bit1 = 1, RSN */
...
typedef struct
{
    oal_uint8           uc_dot11RSNAConfigPTKSAReplayCounters;/* dot11RSNAConfigNumberOfPTKSAReplayCountersImplemented Unsigned32, */
    oal_uint8           uc_dot11RSNAConfigGTKSAReplayCounters;/* dot11RSNAConfigNumberOfGTKSAReplayCountersImplemented Unsigned32, */
    oal_uint32            ul_wpa_group_suite;
    oal_uint32            ul_rsn_group_suite;
    oal_uint32            aul_wpa_pair_suites[WLAN_PAIRWISE_CIPHER_SUITES];
    oal_uint32            aul_wpa_akm_suites[WLAN_AUTHENTICATION_SUITES];
    oal_uint32            aul_rsn_pair_suites[WLAN_PAIRWISE_CIPHER_SUITES];
    oal_uint32            aul_rsn_akm_suites[WLAN_AUTHENTICATION_SUITES];
    oal_uint32            ul_rsn_group_mgmt_suite;
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_dot11RSNAMFPC                       :1;                       /* dot11RSNAManagementFramerProtectionCapbility TruthValue  */
    oal_bool_enum_uint8 en_dot11RSNAMFPR                       :1;                       /* dot11RSNAManagementFramerProtectionRequired TruthValue  */
...
typedef struct
{
    ...
    oal_uint8           resv;
    oal_uint16          us_dot11FTMobilityDomainID;      /* dot11FTMobilityDomainID OCTET STRING,SIZE(2) */
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_dot11RDResponderOptionImplemented        :1;       /* dot11RDResponderOptionImplemented TruthValue,        */
    oal_bool_enum_uint8 en_dot11PCOOptionImplemented                :1;               /* dot11PCOOptionImplemented TruthValue,                */
    oal_bool_enum_uint8 en_dot11LsigTxopProtectionOptionImplemented :1;/* dot11LsigTxopProtectionOptionImplemented TruthValue, */
    oal_bool_enum_uint8 en_dot11HighThroughputOptionImplemented     :1;        /* dot11HighThroughputOptionImplemented TruthValue, */
    oal_uint8          ul_dot11MinimumMPDUStartSpacing              :3;/* dot11MinimumMPDUStartSpacing Unsigned32,             */
    oal_uint8           resv[3];
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_dot11FineTimingMsmtInitActivated;              /* dot11FineTimingMsmtInitActivated TruthValue,                      */
    oal_bool_enum_uint8 en_dot11FineTimingMsmtRespActivated;              /* dot11FineTimingMsmtRespActivated TruthValue,                      */
    oal_bool_enum_uint8 en_dot11LciCivicInNeighborReport;                 /* dot11LciCivicInNeighborReport TruthValue,                         */
    oal_bool_enum_uint8 en_dot11RMFineTimingMsmtRangeRepImplemented;      /* dot11RMFineTimingMsmtRangeRepImplemented TruthValue,              */
    oal_bool_enum_uint8 en_dot11RMFineTimingMsmtRangeRepActivated;        /* dot11RMFineTimingMsmtRangeRepActivated TruthValue,                */
...
typedef struct
{
    oal_uint32            ul_dot11HERxHighestDataRateSupported;         /* ul_dot11HERxHighestDataRateSupported Unsigned32, */
    oal_uint32            ul_dot11HETxHighestDataRateSupported;         /* ul_dot11HETxHighestDataRateSupported Unsigned32, */
    oal_uint32            ul_dot11HETxMCSMap;                           /* us_dot11HETxMCSMap OCTET STRING, */
    oal_uint32            ul_dot11HERxMCSMap;                           /* us_dot11HERxMCSMap OCTET STRING, */

    oal_uint8             uc_dot11TriggerMacPaddingDuration;
    oal_uint8             uc_dot11MaxAMPDULength;
    ...
    oal_bool_enum_uint8   en_dot11HEUPHControlActivated;
#endif
...
typedef struct
{
    ...
    oal_uint8             uc_dot11HEChannelWidthSet;
    oal_uint8             uc_dot11HighestNSS;
    oal_uint8             uc_dot11HighestMCS;
...
typedef struct
{
    ...
    oal_uint8             uc_dot11HEBeamformeeSTSBelow80Mhz;
    oal_uint8             uc_dot11HEBeamformeeSTSOver80Mhz;
    oal_uint8             uc_dot11HENumberSoundingDimensionsBelow80Mhz;
    oal_uint8             uc_dot11HENumberSoundingDimensionsOver80Mhz;
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_dot11LSIGTXOPFullProtectionActivated :1;    /* dot11LSIGTXOPFullProtectionActivated TruthValue */
    ...
    oal_bool_enum_uint8 en_dot112040BSSCoexistenceManagementSupport  :1;/* dot112040BSSCoexistenceManagementSupport TruthValue */
...
typedef struct
{
    ...
    oal_bool_enum_uint8 en_dot11AntennaSelectionOptionImplemented              :1;              /* dot11AntennaSelectionOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11TransmitExplicitCSIFeedbackASOptionImplemented :1; /* dot11TransmitExplicitCSIFeedbackASOptionImplemented   TruthValue */
    oal_bool_enum_uint8 en_dot11TransmitIndicesFeedbackASOptionImplemented     :1;     /* dot11TransmitIndicesFeedbackASOptionImplemented       TruthValue */
    oal_bool_enum_uint8 en_dot11ExplicitCSIFeedbackASOptionImplemented         :1;         /* dot11ExplicitCSIFeedbackASOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11ReceiveAntennaSelectionOptionImplemented       :1;       /* dot11ReceiveAntennaSelectionOptionImplemented         TruthValue */
    oal_bool_enum_uint8 en_dot11TransmitSoundingPPDUOptionImplemented          :1;          /* dot11TransmitSoundingPPDUOptionImplemented TruthValue */
...
typedef struct
{
    oal_bool_enum_uint8 en_dot11ReceiveStaggerSoundingOptionImplemented                 :1;                    /* dot11ReceiveStaggerSoundingOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11TransmitStaggerSoundingOptionImplemented                :1;                   /* dot11TransmitStaggerSoundingOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11ReceiveNDPOptionImplemented                             :1;                                /* dot11ReceiveNDPOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11TransmitNDPOptionImplemented                            :1;                               /* dot11TransmitNDPOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11ImplicitTransmitBeamformingOptionImplemented            :1;               /* dot11ImplicitTransmitBeamformingOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11ExplicitCSITransmitBeamformingOptionImplemented         :1;            /* dot11ExplicitCSITransmitBeamformingOptionImplemented  TruthValue */
    oal_bool_enum_uint8 en_dot11ExplicitNonCompressedBeamformingMatrixOptionImplemented :1;    /* dot11ExplicitNonCompressedBeamformingMatrixOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_resv                                                         :1;

    oal_bool_enum_uint8 uc_dot11CalibrationOptionImplemented                            :2;                               /* dot11CalibrationOptionImplemented INTEGER */
    oal_bool_enum_uint8 uc_dot11ExplicitTransmitBeamformingCSIFeedbackOptionImplemented :2;    /* dot11ExplicitTransmitBeamformingCSIFeedbackOptionImplemented INTEGER */
    oal_bool_enum_uint8 uc_dot11ExplicitNonCompressedBeamformingFeedbackOptionImplemented :2;  /* dot11ExplicitNonCompressedBeamformingFeedbackOptionImplemented INTEGER */
    oal_bool_enum_uint8 uc_dot11ExplicitCompressedBeamformingFeedbackOptionImplemented   :2;     /* dot11ExplicitCompressedBeamformingFeedbackOptionImplemented INTEGER */

    oal_uint8          uc_dot11NumberBeamFormingCSISupportAntenna;                         /* dot11NumberBeamFormingCSISupportAntenna Unsigned32 */
    oal_uint8          uc_dot11NumberNonCompressedBeamformingMatrixSupportAntenna;         /* dot11NumberNonCompressedBeamformingMatrixSupportAntenna Unsigned32 */
    oal_uint8          uc_dot11NumberCompressedBeamformingMatrixSupportAntenna;            /* dot11NumberCompressedBeamformingMatrixSupportAntenna  Unsigned32 */
...
typedef struct
{
    oal_bool_enum_uint8 en_dot112GFortyMHzOperationImplemented      :1;         /* dot11FortyMHzOperationImplemented TruthValue */
    oal_bool_enum_uint8 en_dot115GFortyMHzOperationImplemented      :1;         /* dot11FortyMHzOperationImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11HTGreenfieldOptionImplemented       :1;          /* dot11HTGreenfieldOptionImplemented TruthValue */
    oal_bool_enum_uint8 en_dot11ShortGIOptionInTwentyImplemented    :1;       /* dot11ShortGIOptionInTwentyImplemented TruthValue */
    oal_bool_enum_uint8 en_dot112GShortGIOptionInFortyImplemented   :1;      /* dot11ShortGIOptionInFortyImplemented TruthValue */
    oal_bool_enum_uint8 en_dot115GShortGIOptionInFortyImplemented   :1;      /* dot11ShortGIOptionInFortyImplemented TruthValue */
...
typedef struct
{
    ...
    oal_uint8           uc_dot11VHTNumberSoundingDimensions;        /* dot11VHTNumberSoundingDimensions  Unsigned32 */
    oal_uint8           uc_dot11VHTBeamformeeNTxSupport;            /* dot11VHTBeamformeeNTxSupport Unsigned32 */
...
typedef struct
{
    wlan_mib_vht_supp_width_enum_uint8  en_dot11VHTChannelWidthOptionImplemented         :2;           /* dot11VHTChannelWidthOptionImplemented INTEGER */
    oal_bool_enum_uint8                 en_dot11VHTShortGIOptionIn80Implemented          :1;            /* dot11VHTShortGIOptionIn80Implemented TruthValue */
    oal_bool_enum_uint8                 en_dot11VHTShortGIOptionIn160and80p80Implemented :1;   /* dot11VHTShortGIOptionIn160and80p80Implemented TruthValue */
    oal_bool_enum_uint8                 en_dot11VHTLDPCCodingOptionImplemented           :1;             /* dot11VHTLDPCCodingOptionImplemented TruthValue */
    oal_bool_enum_uint8                 en_dot11VHTTxSTBCOptionImplemented               :1;                 /* dot11VHTTxSTBCOptionImplemented TruthValue */
    oal_bool_enum_uint8                 en_dot11VHTRxSTBCOptionImplemented               :1;                 /* dot11VHTRxSTBCOptionImplemented TruthValue */
    oal_uint8                           en_rev                                           :1;
