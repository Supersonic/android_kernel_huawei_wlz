...
extern oal_void  hmac_send_rsp_to_sme_sta_etc(hmac_vap_stru *pst_hmac_vap, hmac_sme_rsp_enum_uint8 en_type, oal_uint8 *puc_msg);
extern oal_void  hmac_send_rsp_to_sme_ap_etc(hmac_vap_stru *pst_hmac_vap, hmac_ap_sme_rsp_enum_uint8 en_type, oal_uint8 *puc_msg);
extern oal_uint32  hmac_send_connect_result_to_dmac_sta_etc(hmac_vap_stru *pst_hmac_vap, oal_uint32 ul_result);
