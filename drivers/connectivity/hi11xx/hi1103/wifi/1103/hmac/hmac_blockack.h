...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern oal_uint32  hmac_ba_filter_serv_etc(
...
extern oal_uint32  hmac_ba_timeout_fn_etc(oal_void *p_arg);

extern oal_uint8  hmac_mgmt_check_set_rx_ba_ok_etc(
...
extern oal_void hmac_reorder_ba_rx_buffer_bar_etc(hmac_ba_rx_stru *pst_rx_ba, oal_uint16 us_start_seq_num,  mac_vap_stru *pst_vap);
extern oal_uint32  hmac_ba_reset_rx_handle_etc(mac_device_stru *pst_mac_device, hmac_ba_rx_stru **ppst_rx_ba, oal_uint8 uc_tid, oal_bool_enum_uint8 en_is_aging);
extern oal_void  hmac_up_rx_bar_etc(hmac_vap_stru *pst_hmac_vap, dmac_rx_ctl_stru *pst_rx_ctl, oal_netbuf_stru *pst_netbuf);
extern oal_bool_enum_uint8 hmac_is_device_ba_setup_etc(void);
