...
#define DFX_SET_PERFORMANCE_LOG_SWITCH_ENABLE(_uc_type, _uc_value) dfx_set_performance_log_switch_enable_etc(_uc_type, _uc_value)
#endif
...
extern oal_void dfx_set_performance_log_switch_enable_etc(dfx_performance_log_switch_enum_uint8 uc_performance_log_switch_type, oal_uint8 uc_value);
#endif
