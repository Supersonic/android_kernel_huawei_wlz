...
/*
 * 函 数 名  : plat_beatTimer_timeOut_reset_cfg_set_etc
 * 功能描述  : beat_timer全局配置
 */
...
/*
 * 函 数 名  : bfgx_beat_timer_expire_etc
...
/*
 * 函 数 名  : get_exception_info_reference_etc
 * 功能描述  : 获得保存异常信息的全局变量
...
/*
 * 函 数 名  : plat_power_fail_exception_info_set_etc
...
/*
 * 函 数 名  : plat_power_fail_process_done_etc
...
/*
 * 函 数 名  : plat_exception_handler_etc
...
/*
 * 函 数 名  : plat_exception_reset_work_etc
...
/*
 * 函 数 名  : wifi_exception_handler_etc
...
/*
 * 函 数 名  : wifi_subsystem_reset_etc
...
/*
 * 函 数 名  : wifi_status_recovery_etc
...
/*
 * 函 数 名  : wifi_exception_mem_dump_etc
...
/*
 * 函 数 名  : wifi_exception_work_submit_etc
 * 功能描述  : 异常恢复动作触发接口
 */
...
/*
 * 函 数 名  : bfgx_exception_handler_etc
...
/*
 * 函 数 名  : bfgx_subthread_reset_etc
...
/*
 * 函 数 名  : __bfgx_subsystem_reset_etc
...
/*
 * 函 数 名  : bfgx_subsystem_reset_etc
...
/*
 * 函 数 名  : exception_bcpu_dump_recv_etc
 * 功能描述  : 回调数据处理函数
 */
...
/*
 * 函 数 名  : init_hcc_head_and_send_etc
 * 功能描述  : 初始化hcc发送header
 */
...
/*
 * 函 数 名  : bfgx_status_recovery_etc
...
/*
 * 函 数 名  : plat_exception_reset_init_etc
 * 功能描述  : 平台异常处理模块初始化函数
 */
int32 plat_exception_reset_init_etc(void)
{
...
/*
 * 函 数 名  : plat_exception_reset_exit_etc
 * 功能描述  : 平台异常处理模块退出清理函数
 */
int32 plat_exception_reset_exit_etc(void)
{
