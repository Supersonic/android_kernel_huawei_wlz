...
oal_int32 oal_pcie_saveconfigmem(oal_pcie_res *pst_pcie_res, const char *file_name, oal_uint32 cpu_address, oal_uint32 length)
{
    struct file *fp = NULL;
    oal_uint32 index;
    oal_int32 ret = OAL_SUCC;
...
oal_int32 oal_pcie_save_hostmem(oal_pcie_res *pst_pcie_res, const char *file_name, oal_ulong host_address, oal_uint32 length)
{
    struct file *fp = NULL;
    oal_uint32 index, value;
    oal_int32 ret = OAL_SUCC;
