 ...
 */
/*
 * 函 数 名  : oal_kernel_file_open_etc
 * 功能描述  : 内核文件打开函数
...
/*
 * 函 数 名  : oal_kernel_file_size_etc
 * 功能描述  : 内核文件大小获取
 * 输入参数  : 参数file类型结构变量
 * 返 回 值  : file size
 */
...
/*
 * 函 数 名  : oal_kernel_file_read_etc
 * 功能描述  : 内核文件读函数
 * 输入参数  : 参数file类型结构变量
 * 返 回 值  : file size
 */
...
/*
 * 函 数 名  : oal_kernel_file_write_etc
 * 功能描述  : 内核文件读函数
 * 输入参数  : 参数file类型结构变量
 * 返 回 值  : file size
 */
...
/*
 * 函 数 名  : oal_kernel_file_print_etc
 * 功能描述  : 内核文件读函数
 * 输入参数  : 参数file类型结构变量
 * 返 回 值  : file size
 */
