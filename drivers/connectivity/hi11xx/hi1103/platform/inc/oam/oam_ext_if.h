...
#define OAM_INFO_LOG0(_uc_vap_id, _en_feature_id, fmt)                                                        \
    oam_log_print0_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_INFO), \
        (oal_uint16)__LINE__, fmt)
#define OAM_INFO_LOG1(_uc_vap_id, _en_feature_id, fmt, p1)                                                    \
    oam_log_print1_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_INFO), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1))
#define OAM_INFO_LOG2(_uc_vap_id, _en_feature_id, fmt, p1, p2)                                                \
    oam_log_print2_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_INFO), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2))
#define OAM_INFO_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3)                                            \
    oam_log_print3_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_INFO), \
...
#define OAM_INFO_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4)                                        \
    oam_log_print4_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_INFO), \
...
#define OAM_WARNING_LOG0(_uc_vap_id, _en_feature_id, fmt)                                                        \
    oam_log_print0_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_WARNING), \
        (oal_uint16)__LINE__, fmt)
#define OAM_WARNING_LOG1(_uc_vap_id, _en_feature_id, fmt, p1)                                                    \
    oam_log_print1_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_WARNING), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1))
#define OAM_WARNING_LOG2(_uc_vap_id, _en_feature_id, fmt, p1, p2)                                                \
    oam_log_print2_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_WARNING), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2))
#define OAM_WARNING_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3)                                            \
    oam_log_print3_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_WARNING), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2), (oal_uint)(p3))
#define OAM_WARNING_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4)                                        \
    oam_log_print4_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_WARNING), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2), (oal_uint)(p3), (oal_uint)(p4))

#define OAM_ERROR_LOG0(_uc_vap_id, _en_feature_id, fmt)                                                        \
    oam_log_print0_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_ERROR), \
        (oal_uint16)__LINE__, fmt)
#define OAM_ERROR_LOG1(_uc_vap_id, _en_feature_id, fmt, p1)                                                    \
    oam_log_print1_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_ERROR), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1))
#define OAM_ERROR_LOG2(_uc_vap_id, _en_feature_id, fmt, p1, p2)                                                \
    oam_log_print2_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_ERROR), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2))
#define OAM_ERROR_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3)                                            \
    oam_log_print3_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_ERROR), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2), (oal_uint)(p3))
#define OAM_ERROR_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4)                                        \
    oam_log_print4_etc(OAM_WIFI_LOG_PARA_PRESS(_uc_vap_id, _en_feature_id, THIS_FILE_ID, OAM_LOG_LEVEL_ERROR), \
        (oal_uint16)__LINE__, fmt, (oal_uint)(p1), (oal_uint)(p2), (oal_uint)(p3), (oal_uint)(p4))
...
#define OAM_STAT_DEV_INCR(_uc_dev_id, _member, _num)                                 \
    do {                                                                             \
        if (_uc_dev_id < WLAN_DEVICE_MAX_NUM_PER_CHIP) {                             \
            stat_info_etc.ast_dev_stat_info[_uc_dev_id].ul_##_member += (_num); \
        }                                                                            \
    } while (0)
...
#define OAM_STAT_DEV_ARRAY_INCR(_uc_dev_id, _member, _uc_array_index, _uc_array_max_size)                \
    do {                                                                                                 \
        if ((_uc_dev_id < WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC) && (_uc_array_index < _uc_array_max_size)) { \
            stat_info_etc.ast_dev_stat_info[_uc_dev_id].aul_##_member[_uc_array_index]++;           \
        }                                                                                                \
    } while (0)
...
#define OAM_STAT_DEV_UPDATE(_uc_dev_id, _member, _uc_q_id, _uc_index, _ul_val)                               \
    do {                                                                                                     \
        if ((_uc_dev_id < WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC) \
            ...
            stat_info_etc.ast_dev_stat_info[_uc_dev_id].aul_##_member[_uc_q_id][_uc_index] = (_ul_val); \
        }                                                                                                    \
    } while (0)
...
#define OAM_STAT_DEV_GET_VAL(_uc_dev_id, _member, _pul_val)                              \
    do {                                                                                 \
        if (_uc_dev_id < WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC) {                             \
            *(_pul_val) = stat_info_etc.ast_dev_stat_info[_uc_dev_id].ul_##_member; \
        }                                                                                \
    } while (0)
...
#define OAM_STAT_DEV_SET_VAL(_uc_dev_id, _member, _uc_val)                             \
    do {                                                                               \
        if (_uc_dev_id < WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC) {                           \
            stat_info_etc.ast_dev_stat_info[_uc_dev_id].ul_##_member = (_uc_val); \
        }                                                                              \
    } while (0)
...
#define OAM_STAT_VAP_INCR(_uc_vap_id, _member, _num)                                 \
    do {                                                                             \
        if (_uc_vap_id < WLAN_VAP_SUPPORT_MAX_NUM_LIMIT) {                           \
            stat_info_etc.ast_vap_stat_info[_uc_vap_id].ul_##_member += (_num); \
        }                                                                            \
    } while (0)
...
#define OAM_STAT_MGMT_INCR(_uc_vap_id, _uc_mgmt_id, _member)                                           \
    do {                                                                                               \
        if ((_uc_vap_id < WLAN_VAP_SUPPORT_MAX_NUM_LIMIT) && (_uc_mgmt_id < WLAN_MGMT_SUBTYPE_BUTT)) { \
            stat_info_etc.ast_vap_stat_info[_uc_vap_id].aul_##_member[_uc_mgmt_id]++;             \
        }                                                                                              \
    } while (0)
...
#define OAM_STAT_USER_INCR(_us_user_id, _member, _num)                                 \
    do {                                                                               \
        if (_us_user_id < WLAN_USER_MAX_USER_LIMIT) {                                  \
            stat_info_etc.ast_user_stat_info[_us_user_id].ul_##_member += (_num); \
        }                                                                              \
    } while (0)
...
#define OAM_STAT_TID_INCR(_us_user_id, _uc_tid_num, _member, _num)                                   \
    do {                                                                                             \
        if ((_us_user_id < WLAN_USER_MAX_USER_LIMIT) && (_uc_tid_num < WLAN_TIDNO_BUTT)) {           \
            stat_info_etc.ast_user_stat_info[_us_user_id].aul_##_member[_uc_tid_num] += (_num); \
        }                                                                                            \
    } while (0)

#define OAM_STAT_GET_STAT_ALL() (&stat_info_etc)
#else
#define OAM_STAT_DEV_INCR(_uc_dev_id, _member, _num)
#define OAM_STAT_DEV_ARRAY_INCR(_uc_dev_id, _member, _uc_array_index, _uc_array_max_size)
#define OAM_STAT_DEV_UPDATE(_uc_dev_id, _member, _uc_q_id, _uc_index, _ul_val)
...
#ifdef _PRE_DEBUG_MODE
extern oal_uint32 debug_feature_switch_etc[];
...
extern oal_uint8 bcast_addr_etc[WLAN_MAC_ADDR_LEN];
#define BROADCAST_MACADDR bcast_addr_etc
...
/* 外部函数声明 */
extern oam_sdt_func_hook_stru oam_sdt_func_hook_etc;
...
extern oam_wal_func_hook_stru oam_wal_func_hook_etc;
...
typedef struct {
    ...
    oal_uint32 ul_curr_tx_bytes;  /* 当前秒发送统计 */
    oal_uint32 ul_last_tx_bytes;  /* 上一秒发送统计 */
    oal_uint32 ul_last2_tx_bytes; /* 上上秒发送统计 */
#endif
...
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1151) || defined(_PRE_PRODUCT_ID_HI110X_HOST)
extern oam_stat_info_stru stat_info_etc;
#endif
extern oam_sdt_stat_info_stru sdt_stat_info_etc;
...
/* 函数声明    OAM模块对外提供的接口 */
extern oam_mng_ctx_stru oam_mng_ctx_etc;
...
extern oal_uint32 oam_print_etc(const char *pc_string);
...
extern oal_uint32 oam_log_set_ratelimit_param_etc(oam_ratelimit_type_enum_uint8 en_ratelimit_type,
...
extern oal_uint32 oam_log_console_printk_etc(oal_uint16 us_file_no,
                                             oal_uint16 us_line_num,
...
/* EVENT模块对外接口 */
extern oal_uint32 oam_event_set_switch_etc(oal_uint8 uc_vap_id,
                                           oal_switch_enum_uint8 en_switch_type);
extern oal_uint32 oam_event_get_switch_etc(oal_uint8 uc_vap_id,
                                           oal_switch_enum_uint8 *pen_switch_type);
extern oal_uint32 oam_event_report_etc(oal_uint8 *puc_user_macaddr,
                                       oal_uint8 uc_vap_id,
...
extern oal_uint32 oam_ota_set_beacon_switch_etc(oal_uint8 uc_vap_id,
...
extern oal_uint32 oam_ota_set_rx_dscr_switch_etc(oal_uint8 uc_vap_id,
                                                 oam_sdt_print_beacon_rxdscr_type_enum_uint8 en_switch_type);
...
extern oal_uint32 oam_report_dscr_etc(oal_uint8 *puc_user_macaddr,
                                      ...
                                      oam_ota_type_enum_uint8 en_ota_type);
extern oal_uint32 oam_report_beacon_etc(oal_uint8 *puc_beacon_hdr_addr,
...
extern oal_uint32 oam_report_80211_frame_etc(oal_uint8 *puc_user_macaddr,
...
extern oal_uint32 oam_report_80211_mcast_get_switch_etc(oam_ota_frame_direction_type_enum_uint8 en_mcast_direction,
...
extern oal_uint32 oam_report_80211_ucast_get_switch_etc(oam_ota_frame_direction_type_enum_uint8 en_ucast_direction,
                                                        oam_user_track_frame_type_enum_uint8 en_frame_type,
                                                        oal_switch_enum_uint8 *pen_frame_switch,
                                                        oal_switch_enum_uint8 *pen_cb_switch,
                                                        oal_switch_enum_uint8 *pen_dscr_switch,
                                                        oal_uint16 us_user_idx);
extern oal_uint32 oam_report_80211_probe_get_switch_etc(oam_ota_frame_direction_type_enum_uint8 en_probereq_direction,
                                                        oal_switch_enum_uint8 *pen_frame_switch,
                                                        oal_switch_enum_uint8 *pen_cb_switch,
                                                        oal_switch_enum_uint8 *pen_dscr_switch);
extern oal_uint32 oam_report_80211_probe_set_switch_etc(oam_ota_frame_direction_type_enum_uint8 en_probe_direction,
                                                        oal_switch_enum_uint8 en_frame_switch,
                                                        oal_switch_enum_uint8 en_cb_switch,
                                                        oal_switch_enum_uint8 en_dscr_switch);
extern oal_uint32 oam_report_eth_frame_get_switch_etc(oal_uint16 us_user_idx,
...
extern oal_uint32 oam_report_80211_ucast_set_switch_etc(oam_ota_frame_direction_type_enum_uint8 en_ucast_direction,
                                                        oam_user_track_frame_type_enum_uint8 en_frame_type,
                                                        oal_switch_enum_uint8 en_frame_switch,
                                                        oal_switch_enum_uint8 en_cb_switch,
                                                        oal_switch_enum_uint8 en_dscr_switch,
...
extern oal_uint32 oam_report_eth_frame_set_switch_etc(oal_uint16 us_user_idx,
                                                      oal_switch_enum_uint8 en_switch,
                                                      oam_ota_frame_direction_type_enum_uint8 en_eth_direction);
extern oal_uint32 oam_report_80211_mcast_set_switch_etc(oam_ota_frame_direction_type_enum_uint8 en_mcast_direction,
                                                        oam_user_track_frame_type_enum_uint8 en_frame_type,
                                                        oal_switch_enum_uint8 en_frame_switch,
                                                        oal_switch_enum_uint8 en_cb_switch,
                                                        oal_switch_enum_uint8 en_dscr_switch);
...
extern oal_uint32 oam_event_set_specific_type_switch_etc(oal_uint8 uc_vap_id,
                                                         oal_switch_enum_uint8 en_switch_type,
                                                         oam_event_type_enum_uint16 en_event_type);
...
/* STATISTICS模块对外接口 */
extern oal_uint32 oam_stats_report_timer_info_to_sdt_etc(oal_uint8 *puc_timer_addr,
                                                         oal_uint8 uc_timer_len);
extern oal_uint32 oam_stats_report_event_queue_info_to_sdt_etc(oal_uint8 *puc_event_queue_addr,
...
extern oal_uint32 oam_stats_report_mempool_info_to_sdt_etc(oal_uint8 uc_pool_id,
...
extern oal_void oam_stats_report_irq_info_to_sdt_etc(oal_uint8 *puc_irq_info_addr,
...
#ifdef _PRE_DEBUG_MODE
extern oam_tx_complete_stat_stru tx_complete_stat_etc[WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC];
#endif
extern oal_void oam_netlink_ops_register_etc (oam_nl_cmd_enum_uint8 en_type,
...
extern oal_int32 oam_netlink_kernel_send_etc(oal_uint8 *puc_data, oal_uint32 ul_data_len,
...
OAL_STATIC OAL_INLINE oal_switch_enum_uint8 oam_get_log_switch(oal_uint32 ul_para)
{
    ...
    if (oam_mng_ctx_etc.st_log_ctx.en_global_log_switch == OAL_SWITCH_OFF) {
        return OAL_SWITCH_OFF;
    } else if (oam_mng_ctx_etc.st_log_ctx.st_vap_log_info.aen_vap_log_switch[uc_vap_id] == OAL_SWITCH_OFF) {
        return OAL_SWITCH_OFF;
    } else if (en_log_level > oam_mng_ctx_etc.st_log_ctx.st_vap_log_info.aen_vap_log_level[uc_vap_id]) {
        return OAL_SWITCH_OFF;
    } else if (en_log_level >
               oam_mng_ctx_etc.st_log_ctx.st_vap_log_info.aen_feature_log_level[uc_vap_id][en_feature_id]) {
        return OAL_SWITCH_OFF;
    }
