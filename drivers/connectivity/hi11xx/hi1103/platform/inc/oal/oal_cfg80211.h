...
extern oal_cfg80211_bss_stru *oal_cfg80211_inform_bss_frame_etc(oal_wiphy_stru *pst_wiphy,
                                                                oal_ieee80211_channel_stru *pst_ieee80211_channel,
                                                                oal_ieee80211_mgmt_stru *pst_mgmt,
                                                                oal_uint32 ul_len,
                                                                oal_int32 l_signal,
                                                                oal_gfp_enum_uint8 en_ftp);
extern oal_void oal_cfg80211_scan_done_etc(oal_cfg80211_scan_request_stru *pst_cfg80211_scan_request,
                                           oal_int8 c_aborted);
extern oal_void oal_cfg80211_sched_scan_result_etc(oal_wiphy_stru *pst_wiphy);
extern oal_uint32 oal_cfg80211_connect_result_etc(oal_net_device_stru *pst_net_device,
...
extern oal_uint32 oal_cfg80211_notify_cac_event(oal_net_device_stru *pst_net_device,
                                                ...
                                                oal_gfp_enum_uint8 en_gfp);
#endif
extern oal_uint32 oal_cfg80211_disconnected_etc(oal_net_device_stru *pst_net_device,
                                                oal_uint16 us_reason,
                                                oal_uint8 *puc_ie,
                                                oal_uint32 ul_ie_len,
                                                oal_gfp_enum_uint8 en_gfp);
extern oal_uint32 oal_cfg80211_new_sta_etc(oal_net_device_stru *pst_net_device,
...
extern oal_uint32 oal_cfg80211_fbt_notify_find_sta(oal_net_device_stru *pst_net_device,
                                                   ...
                                                   oal_gfp_enum_uint8 en_gfp);
#endif
extern oal_void oal_cfg80211_mic_failure_etc(oal_net_device_stru *pst_net_device,
                                             const oal_uint8 *puc_mac_addr,
                                             enum nl80211_key_type key_type,
                                             oal_int32 key_id,
                                             const oal_uint8 *tsc,
                                             oal_gfp_enum_uint8 en_gfp);
extern oal_int32 oal_cfg80211_del_sta_etc(oal_net_device_stru *pst_net_device,
                                          const oal_uint8 *puc_mac_addr,
                                          oal_gfp_enum_uint8 en_gfp);
extern oal_uint32 oal_cfg80211_rx_mgmt_etc(oal_net_device_stru *pst_dev,
                                           oal_int32 l_freq,
                                           oal_uint8 uc_rssi,
                                           const oal_uint8 *puc_buf,
                                           oal_uint32 ul_len,
...
extern oal_uint32 oal_cfg80211_roamed_etc(oal_net_device_stru *pst_net_device,
                                          ...
                                          oal_uint32 ul_resp_ie_len,
                                          oal_gfp_enum_uint8 en_gfp);
extern oal_uint32 oal_cfg80211_ft_event_etc(oal_net_device_stru *pst_net_device,
                                            oal_cfg80211_ft_event_stru *pst_ft_event);
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
#if defined(_PRE_PRODUCT_ID_HI110X_HOST)
extern oal_void oal_kobject_uevent_env_sta_join_etc(oal_net_device_stru *pst_net_device,
                                                    const oal_uint8 *puc_mac_addr);
extern oal_void oal_kobject_uevent_env_sta_leave_etc(oal_net_device_stru *pst_net_device,
                                                     const oal_uint8 *puc_mac_addr);
#endif
#endif
