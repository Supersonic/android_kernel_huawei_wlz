...
extern oal_int32 hcc_rx_register_etc(struct hcc_handler *hcc, oal_uint8 mtype,
                                     hcc_rx_post_do post_do, hcc_rx_pre_do pre_do);
extern oal_int32 hcc_rx_unregister_etc(struct hcc_handler *hcc, oal_uint8 mtype);
extern oal_void hcc_tx_wlan_queue_map_set_etc(struct hcc_handler *hcc, hcc_queue_type hcc_queue_id,
                                              wlan_net_queue_type wlan_queue_id);
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
extern struct custom_process_func_handler custom_process_func_etc;
#endif
