...
/* 函数声明 */
extern oal_void *oal_mem_alloc_etc(oal_uint32 ul_file_id,
...
extern oal_uint32 oal_mem_free_array_etc(oal_uint32 ul_file_id,
                                         oal_uint32 ul_line_num,
                                         oal_void *p_data,
                                         oal_uint8 uc_mem_num);

extern oal_mem_stru *oal_mem_alloc_enhanced_etc(oal_uint32 ul_file_id,
                                                oal_uint32 ul_line_num,
                                                oal_mem_pool_id_enum_uint8 en_pool_id,
                                                oal_uint16 us_len,
                                                oal_uint8 uc_lock);
extern oal_uint32 oal_mem_free_enhanced_etc(oal_uint32 ul_file_id, oal_uint32 ul_line_num,
...
extern oal_uint32 oal_mem_incr_user_etc(oal_uint32 ul_file_id,
                                        oal_uint32 ul_line_num,
