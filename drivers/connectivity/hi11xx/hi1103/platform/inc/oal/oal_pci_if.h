...
/* 全局变量声明 */
extern oal_pci_bar_idx_enum_uint8 en_bar_table[1];

/* 宏定义 */
#define OAL_WITP_MAX_BARS OAL_ARRAY_SIZE(en_bar_table)
...
#elif defined _PRE_CPE_711_PLATFORM
#define OAL_PCIE_SYS_BASE_PHYS 0x9002B000 /* SYSCTRL */
#define OAL_DBI_BASE_ADDR_0    0x38000000
#define OAL_DBI_BASE_ADDR_1    0xA8010000

#define OAL_PERI_W_PCIE0 0x4E8
#define OAL_PERI_R_PCIE0 0x4EC
#define OAL_PERI_W_PCIE1 0xC88
#define OAL_PERI_R_PCIE1 0xC8C

#define OAL_PCIE_LINK_STATUS_OFFSET 0xE38

#define OAL_PCIE_TARGET_ADDR 0x55E00000
#endif
...
extern oal_void oal_pcie_set_inbound_iatu_slip_window_fpga(oal_pci_dev_stru *pst_pci_dev);
#endif
#endif
...
extern oal_void oal_pcie_internal_set(oal_uint32 ul_inter_addr, oal_uint32 bit_offset,
                                      oal_uint32 bit_width, oal_uint32 bit_value);

#if (_PRE_CONFIG_TARGET_PRODUCT == _PRE_TARGET_PRODUCT_TYPE_E5)
extern oal_void oal_register_syscore_ops(oal_void);
extern oal_void oal_unregister_syscore_ops(oal_void);
#endif
