...
#define BFGX_AND_WIFI_CFG_HI1105_ASIC_PATH  "/vendor/firmware/hi1105/asic/bfgx_and_wifi_cfg"
#define WIFI_CFG_HI1105_ASIC_PATH           "/vendor/firmware/hi1105/asic/wifi_cfg"
#define BFGX_CFG_HI1105_ASIC_PATH           "/vendor/firmware/hi1105/asic/bfgx_cfg"
#define RAM_CHECK_CFG_HI1105_ASIC_PATH      "/vendor/firmware/hi1105/asic/ram_reg_test_cfg"
#define RAM_BCPU_CHECK_CFG_HI1105_ASIC_PATH "/vendor/firmware/hi1105/asic/reg_bcpu_mem_test_cfg"
...
extern FIRMWARE_GLOBALS_STRUCT cfg_info_etc;

/* 函数声明 */
extern void set_hi1103_asic_type(uint32 ul_asic_type);
extern uint32 get_hi1103_asic_type(void);
extern int32 firmware_read_cfg_etc(const char *puc_CfgPatch, uint8 *puc_read_buffer);
extern int32 firmware_parse_cmd_etc(uint8 *puc_cfg_buffer, uint8 *puc_cmd_name, uint32 cmd_name_len,
