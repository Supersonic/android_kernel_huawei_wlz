...
#define CVDR_AXI_JPEG_VP_WR_CFG_30_OFFSET           (0x210)
#define CVDR_AXI_JPEG_VP_WR_AXI_FS_30_OFFSET        (0x214)
#define CVDR_AXI_JPEG_VP_WR_AXI_LINE_30_OFFSET      (0x218)
#define CVDR_AXI_JPEG_VP_WR_IF_CFG_30_OFFSET        (0x21c)
#define CVDR_AXI_JPEG_LIMITER_VP_WR_30_OFFSET       (0x8a8)

#define CVDR_AXI_JPEG_LINE_STRIDE_VAL               (0x3F)
#define CVDR_AXI_JPEG_LINE_START_WSTRB_VAL          (0xF)
...
typedef enum _cvdr_wr_port_update
{
   ...
   CVDR_WR_PORT_ADDR_AXILINE_UPDATE3 = 3,
} cvdr_wr_port_update;
...
typedef union
{
    /* Define the struct bits */
    struct {
        uint32_t    vpwr_line_stride          : 14  ; /* [13..0]  */
        uint32_t    vpwr_line_start_wstrb     : 4   ; /* [17..14]  */
        uint32_t    vpwr_line_wrap            : 14  ; /* [31..18]  */
    } bits;

    /* Define an unsigned member */
    uint32_t    reg32;

} U_VP_WR_AXI_LINE_UPDATE_3;
