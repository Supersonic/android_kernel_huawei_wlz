...
#ifdef CONFIG_HISI_CAMERA_FPGA_ICE40
...
static struct sensor_power_setting imx600hybrid_power_setting_fpga [] = {
    {
...
static struct sensor_power_setting imx600hybrid_power_setting_laya [] = {
    //AFVDD GPIO 004 ENABLE
    // Power up vcm first, then power up AVDD1
    // XBUCK_AFVDD 2V55---| bucker |---> AVDD1 1V8
    {
...
//lint -save -e826 -e778 -e774 -e747
    ...
    if (hw_is_fpga_board()) {
        cam_info("%s. fpga ignore.", __func__);
        return 0;
    }
...
static sensor_t s_imx600hybrid_fpga =
{
    .intf = { .vtbl = &s_imx600hybrid_vtbl, },
    .power_setting_array = {
        .size = ARRAY_SIZE(imx600hybrid_power_setting_fpga),
        .power_setting = imx600hybrid_power_setting_fpga,
    },
};
...
static sensor_t s_imx600hybrid_laya =
{
    .intf = { .vtbl = &s_imx600hybrid_vtbl, },
    .power_setting_array = {
        .size = ARRAY_SIZE(imx600hybrid_power_setting_laya),
        .power_setting = imx600hybrid_power_setting_laya,
    },
};
