...
VOID handle_vp8hal_cfg_dnmsg(UINT32 d32, UINT32 *p32, vdmhal_hwmem_s *hw_mem)
{
	...
	((vp8_picdnmsg_d36 *)(&d32))->sed_top_addr =
		align_up(hw_mem->sed_top_addr, MSG_SLOT_ALIGN_BYTE);   // caution!!
	d32 = hw_addr_rshift(d32);
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d37 *)(&d32))->pmv_top_addr =
		align_up(hw_mem->pmv_top_addr, MSG_SLOT_ALIGN_BYTE);   // caution!
	d32 = hw_addr_rshift(d32);
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d38 *)(&d32))->rcn_top_addr =
		align_up(hw_mem->rcn_top_addr, MSG_SLOT_ALIGN_BYTE);   // caution!
	d32 = hw_addr_rshift(d32);
	wr_msgword(p32, d32);
	...
	((vp8_picdnmsg_d39 *)(&d32))->tab_addr =
		align_up(hw_mem->vp8_tab_addr, MSG_SLOT_ALIGN_BYTE); // caution!
	d32 = hw_addr_rshift(d32);
	wr_msgword(p32, d32);
