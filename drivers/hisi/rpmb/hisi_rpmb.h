...
extern void rpmb_print_frame_buf(char* name, const void *buf, int len, int format);
extern int atfd_hisi_rpmb_smc(u64 _function_id, u64 _arg0, u64 _arg1,  u64 _arg2);
