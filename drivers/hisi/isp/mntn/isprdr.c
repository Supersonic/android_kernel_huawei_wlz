 ...
 */
/*
 * lint -e715 -e838 -e529 -e438 -e30 -e142 -e528 -e750 -e753 -e754 -e785 -e655
 * -e749 -e732 -e747 -e708 -e712 -e64 -e661 -e574 -e737 -e713 -e826 -e530 -e570
 * -esym(715,*) -esym(838,*) -esym(529,*) -esym(438,*) -esym(30,*) -esym(142,*)
 * -esym(528,*) -esym(750,*) -esym(753,*) -esym(754,*) -esym(785,*) -esym(655,*)
 * -esym(749,*) -esym(732,*) -esym(747,*) -esym(708,*) -esym(712,*) -esym(64,*)
 * -esym(661,*) -esym(574,*) -esym(737,*) -esym(713,*) -esym(826,*) -esym(530,*)
 * -esym(570,*)
 */
	...
	list_for_each_entry_safe(entry, tmp, &dev->dump_list, node) {
		if (entry->modid == ISP_WDT_TIMEOUT) {
			...
			do {
				...
				msleep(100);
			} while (sync_word != RDR_ISP_SYNC && timeout-- > 0);
...
void ap_send_fiq2ispcpu(void)
{
	...
	if (wait_share_excflag_timeout(ISP_CPU_POWER_DOWN, 10) == 0x0) {
		...
		value = readl((volatile void __iomem *)(
				dev->sctrl_addr + SCTRL_SCBAKDATA10_ADDR));
		...
		if ((wdt_flag) && (dev->sctrl_addr != NULL)) {
			...
			writel(0, (volatile void __iomem *)(
				dev->pctrl_addr + PCTRL_PERI_CTRL27_ADDR));
			writel(1, (volatile void __iomem *)(
				dev->pctrl_addr + PCTRL_PERI_CTRL27_ADDR));
			writel(0, (volatile void __iomem *)(
				dev->pctrl_addr + PCTRL_PERI_CTRL27_ADDR));
		}
...
static irqreturn_t isp_wdt_irq_handler(int irq, void *data)
{
	...
	writel(WDT_UNLOCK, (volatile void __iomem *)(dev->wdt_addr +
					ISP_WatchDog_WDG_LOCK_ADDR));
	writel(0, (volatile void __iomem *)(dev->wdt_addr +
				ISP_WatchDog_WDG_CONTROL_ADDR));
	writel(WDT_LOCK, (volatile void __iomem *)(dev->wdt_addr +
					ISP_WatchDog_WDG_LOCK_ADDR));
...
static int rdr_isp_dev_map(struct rdr_isp_device *dev)
{
	...
	value = readl((volatile void __iomem *)(dev->sctrl_addr +
					SCTRL_SCBAKDATA10_ADDR));
