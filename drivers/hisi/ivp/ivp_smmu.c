...
int ivp_iommu_fault_handler_t(struct iommu_domain *pdomain __attribute__((unused)),
	struct device *pdev __attribute__((unused)), unsigned long size __attribute__((unused)),
