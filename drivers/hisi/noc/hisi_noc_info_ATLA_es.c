...
static const struct datapath_routid_addr vcodec_routeid_addr_tbl[] = {
	...
	{0x01, 0x04, 0x0, 0xe8800000},/*noc_vdec_cfg*/
	{0x01, 0x05, 0x0, 0xe8880000},/*noc_venc_cfg*/
	{0x00, 0x06, 0x0, 0x0},/*noc_vcodecbus_ddrc0*/
	{0x00, 0x06, 0x1, 0x10000000000},/*noc_vcodecbus_ddrc0*/
	{0x00, 0x07, 0x0, 0x8000000000},/*noc_vcodecbus_ddrc1*/
	{0x00, 0x07, 0x1, 0x18000000000},/*noc_vcodecbus_ddrc1*/
	{0x01, 0x08, 0x0, 0xe8920000},/*vcdoecbus_service_target*/
	{0x01, 0x08, 0x1, 0x0},/*vcdoecbus_service_target*/
	{0x01, 0x09, 0x0, 0xe8930000},/*vdec_service_target*/
	{0x01, 0x0A, 0x0, 0xe8940000},/*venc_service_target*/
};
...
static const struct datapath_routid_addr vivo_routeid_addr_tbl[] = {
	...
	{0x00, 0x06, 0x0, 0xe8300000},/*noc_jpeg_fd_cfg*/
	{0x07, 0x07, 0x0, 0x0},/*noc_media2cfg*/
	{0x00, 0x08, 0x0, 0xe87fe000},/*noc_media_crg_cfg*/
	{0x01, 0x09, 0x0, 0x0},/*noc_vivobus_ddrc0_rd*/
	{0x01, 0x09, 0x1, 0x10000000000},/*noc_vivobus_ddrc0_rd*/
	{0x02, 0x0A, 0x0, 0x0},/*noc_vivobus_ddrc0_wr*/
	{0x02, 0x0A, 0x1, 0x10000000000},/*noc_vivobus_ddrc0_wr*/
	{0x01, 0x0B, 0x0, 0x8000000000},/*noc_vivobus_ddrc1_rd*/
	{0x01, 0x0B, 0x1, 0x18000000000},/*noc_vivobus_ddrc1_rd*/
	{0x02, 0x0C, 0x0, 0x8000000000},/*noc_vivobus_ddrc1_wr*/
	{0x02, 0x0C, 0x1, 0x18000000000},/*noc_vivobus_ddrc1_wr*/
	{0x00, 0x0D, 0x0, 0xe87d0000},/*vivo_service_target*/
	{0x00, 0x0D, 0x1, 0x0},/*vivo_service_target*/
};

struct noc_mid_info noc_mid_ATLA_es[] = {
	...
	{0, 0x0B, 0x003f, 0x18, "BBE16_0_NXDSP"},  /*noc_modem_mst,*/
	...
	{2, 0xFF, 0x003f, 0x1D, "JPEG_FD_SUBSYS_JPGENC"},/*TPEG_FD_SUBSYS*/
	{2, 0xFF, 0x003f, 0x1E, "MEDIA_COMMON_CMDLIST"},/*MEDIA_COMMON*/
	{2, 0xFF, 0x003f, 0x1F, "MEDIA_COMMON_RCH_WCH"},/*MEDIA_COMMON*/
	{1, 0x03, 0x003f, 0x20, "VENC1"},/*VENC1*/
	{1, 0x03, 0x003f, 0x21, "VENC2"},/*VENC2*/
	{1, 0x02, 0x003f, 0x22, "VDEC_OR_VDEC_ATGM"},/*VDEC1*/
	{1, 0x02, 0x003f, 0x23, "VDEC2"},/*VDEC2*/
	{1, 0x02, 0x003f, 0x24, "VDEC3"},/*VDEC3*/
	{1, 0x02, 0x003f, 0x25, "VDEC4"},/*VDEC4*/
	{1, 0x02, 0x003f, 0x26, "VDEC5"},/*VDEC5*/
	{1, 0x02, 0x003f, 0x27, "VDEC6"},/*VDEC6*/
	...
	{2, 0xFF, 0x003f, 0x2C, "JPGDEC"},/*TPEG_FD_SUBSYS*/
	{2, 0xFF, 0x003f, 0x2D, "FD"},/*TPEG_FD_SUBSYS*/
};

struct noc_sec_info noc_sec_ATLA_es[] = {
...
struct noc_dump_reg noc_dump_reg_list_ATLA_es[] = {
 ...
 */
const struct noc_busid_initflow hisi_filter_initflow_ATLA_es[] = {
...
const struct noc_bus_info noc_buses_info_ATLA_es[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_ATLA_es,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_ATLA_es),
		.p_noc_sec_info = noc_sec_ATLA_es,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_ATLA_es),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void hisi_noc_get_array_size_ATLA_es(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_ATLA_es);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_ATLA_es);
}
 ...
 */
unsigned int hisi_noc_clock_enable_ATLA_es(struct hisi_noc_device *noc_dev,
