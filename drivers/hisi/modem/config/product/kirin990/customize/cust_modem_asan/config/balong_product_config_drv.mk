# MD5: 57b7154e01dd2526bfaf3cb8c8f547f0
CFG_ENABLE_BUILD_VARS := YES
CFG_FEATURE_UPGRADE_TL := YES
CFG_PRODUCT_NAME                      :="kirin990"
CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME    :="Balong"
CFG_CCPU_OS                           := RTOSCK_SMP
CFG_HCC_VERSION                       := 4.9
CFG_PLATFORM := kirin990
CFG_PLATFORM_HISI_BALONG :=kirin990
CFG_CONFIG_VERSION_STUB             :=NO
CFG_HW_VERSION_STUB                 :=0x36F5FC08
...
CFG_CCPU_LLRAM_BASE_SIZE := 0x50000
...
CFG_MPU_ALGN_RESERVE            :=  0x400000
CFG_DDR_MEM_ADDR                :=  0x20000000
CFG_DDR_SECMEM_SIZE             := 0xDE00000
CFG_DDR_MCORE_SIZE        := 0x8A00000
CFG_DDR_HARQ_UP_SIZE      := 0x100000
...
CFG_DDR_HARQ_UP_ADDR      := $(CFG_DDR_MCORE_ADDR)+$(CFG_DDR_MCORE_SIZE)
CFG_DDR_TLPHY_IMAGE_ADDR  := $(CFG_DDR_HARQ_UP_ADDR)+$(CFG_DDR_HARQ_UP_SIZE)
...
CFG_DDR_MCORE_UNCACHE_SIZE:=0x4000000
CFG_DDR_MCORE_UNCACHE_ADDR:=0xA4000000
...
CFG_DDR_SHA_NV_SIZE       := 0x978000
CFG_DDR_SHA_SEC_ICC_SIZE  := 0x8000
CFG_DDR_SHA_MEM_SIZE      := 0x180000
CFG_DDR_SHARED_MEM_SIZE   := $(CFG_DDR_SHA_NV_SIZE)+$(CFG_DDR_SHA_SEC_ICC_SIZE)+$(CFG_DDR_SHA_MEM_SIZE)
...
CFG_DDR_HIFI_MBX_ADDR               := ((DDR_SHARED_MEM_ADDR) + (DDR_SHA_NV_SIZE)+ (DDR_SHA_SEC_ICC_SIZE))
...
CFG_SHM_SIZE_SHA_SEC_ICC            :=(DDR_SHA_SEC_ICC_SIZE)
