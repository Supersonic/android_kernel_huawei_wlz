# MD5: d0e787e3ad05c9f7a465704149de0f9a
...
CFG_CONFIG_EXTRA_MODEM_SIM := YES
...
CFG_CONFIG_BALONG_PCIE_DEV_PM := YES
CFG_CONFIG_BALONG_PCIE_DEV_PM_TEST := NO
CFG_CONFIG_MODEM_BOOT := YES
CFG_CONFIG_UART_BOOT := YES
CFG_CONFIG_XLOADER_DBG := YES
CFG_CONFIG_BALONG_ADC := YES
CFG_CONFIG_EFUSE := YES
CFG_CONFIG_EXTRA_ONOFF := YES
CFG_CONFIG_RFILE_ON := YES
CFG_CONFIG_EXTRA_SLICE_SYNC  := YES
CFG_CONFIG_BALONG_MODEM_GLOBAL_RESET := YES
CFG_CONFIG_BALONG_MODEM_PMU_GPIO := YES
CFG_CONFIG_MODULE_TIMER := YES
CFG_CONFIG_EXTRA_TIMERSLICE := YES
CFG_CONFIG_EXTRA_PM_OM := YES
