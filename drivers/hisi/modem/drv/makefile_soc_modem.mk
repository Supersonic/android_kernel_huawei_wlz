...
drv-$(CONFIG_RFILE_SUPPORT)  += rfile/adp_rfile.o
...
drv-y               += espe/espe_core.o espe/espe_platform_balong.o espe/espe_desc.o espe/espe_ip_entry.o espe/espe_mac_entry.o espe/espe_port.o espe/espe_dbg.o espe/espe_modem_reset.o
...
ifeq ($(strip $(CFG_CONFIG_COLD_PATCH)),YES)
drv-y           += mloader/modem_cold_patch.o
else
drv-y           += mloader/modem_cold_patch_stub.o
endif
endif
