...
#define HISI_AP_AUDIO_LP_WAKEUP_RINGBUFEER_SIZE HISI_AP_AUDIO_WAKEUP_RINGBUFEER_SIZE
#define HISI_AP_AUDIO_LP_WAKEUP_CAPTURE_SIZE HISI_AP_AUDIO_WAKEUP_CAPTURE_SIZE
...
#define HISI_AP_AUDIO_LP_WAKEUP_RINGBUFFER_ADDR   (HISI_AP_AUDIO_WAKEUP_MODEL_ADDR + HISI_AP_AUDIO_WAKEUP_MODEL_SIZE)
#define HISI_AP_AUDIO_LP_WAKEUP_CAPTURE_ADDR      (HISI_AP_AUDIO_LP_WAKEUP_RINGBUFFER_ADDR + HISI_AP_AUDIO_LP_WAKEUP_RINGBUFEER_SIZE)
#define HISI_AP_B5000_NV_ADDR (HISI_AP_AUDIO_LP_WAKEUP_CAPTURE_ADDR + HISI_AP_AUDIO_LP_WAKEUP_CAPTURE_SIZE)
...
#endif
	ID_AP_HIFI_I2S_TEST_POWER_REQ = 0xDF38, // AP notifies HiFi to power on for i2s test
	ID_HIFI_AP_I2S_TEST_POWER_CNF = 0xDF39, // HiFi returns to the AP to power off the result
} HIFI_MSG_ID;
