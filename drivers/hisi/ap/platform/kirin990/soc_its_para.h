...
static struct core_parameters its_core_para[CORE_NUMBER] = {
...
static unsigned int cluster_para[CLUSTER_NUMBER][COEFFICIENT_SIZE] = {
{
...
static unsigned int its_window_num[CLUSTER_NUMBER][FREQIDX_UPPER_BOUND] = {
{
 0x2A44,
 0x3D92,
 0x44E5,
