...
#define DDR_SHMEMEXT_ADDR_AP HISI_RESERVED_SENSORHUB_SHMEMEXT_PHYMEM_BASE
#define DDR_SHMEMEXT_SIZE HISI_RESERVED_SENSORHUB_SHMEMEXT_PHYMEM_SIZE
...
#define DDR_DTS_CONFIG_SIZE (0x2000)
...
#define DDR_IMAGE_SIZE (0x380000)
#define DDR_IMAGE_END_AP (DDR_IMAGE_BASE_AP + DDR_IMAGE_SIZE)
#define DDR_CODE_ISOLATION_SIZE (0x100000)
#define DDR_CODE_BASE_AP (DDR_IMAGE_END_AP + DDR_CODE_ISOLATION_SIZE)
#define DDR_CODE_SIZE (0x280000)
#define DDR_CODE_END_AP (DDR_CODE_BASE_AP + DDR_CODE_SIZE)
#define DDR_HEAP_START_AP (DDR_CODE_END_AP + DDR_CODE_ISOLATION_SIZE)
...
#define DDR_DUMP_BASE_AP DDR_IPC_SHMEM_CH_TEE_END_AP
...
#define DDR_AOD_BASE_AP DDR_FP_IMAGE_END_AP
#define DDR_AOD_SIZE (0x300000)
#define DDR_AOD_END_AP (DDR_AOD_BASE_AP + DDR_AOD_SIZE)
#define DDR_RESERVED_USED_END DDR_AOD_END_AP
#if DDR_RESERVED_USED_END > (DDR_RESERVE_ADDR_AP + DDR_RESERVE_SIZE)
 #error "DDR_RESERVED_USED overflow"
#endif
#define DDR_TINY_RESERVE_ADDR_AP HISI_RESERVED_NPU_TINY_PHYMEM_BASE
#define DDR_TINY_RESERVE_SIZE HISI_RESERVED_NPU_TINY_PHYMEM_SIZE
#define DDR_TINY_FACEID_RESERVE_SIZE (0x100000)
#endif
