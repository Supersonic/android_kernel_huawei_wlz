...
#define SYS_CODE_SEC_RESERVED_SIZE (0x900)
#define SYS_CODE_SEC_SIZE (0x1AC00-SYS_CODE_SEC_RESERVED_SIZE)
#define SYS_BSS_SEC_BASE (SYS_CODE_SEC_BASE + SYS_CODE_SEC_SIZE + SYS_CODE_SEC_RESERVED_SIZE)
#define SYS_BSS_SEC_RESERVED_SIZE (0x400)
#define SYS_BSS_SEC_SIZE (0x4000-SYS_BSS_SEC_RESERVED_SIZE)
...
#define SYS_DATA_SEC_SIZE (0x2500-SYS_DATA_SEC_RESERVED_SIZE)
