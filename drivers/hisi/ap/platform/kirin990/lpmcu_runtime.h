...
enum {
 GPU_LOG_EN_OFFSET = 0,
 GPU_DVFS_ONLY_DVS_OFFSET = 1,
 GPU_DVFS_AGAIN_OFFSET = 2,
 GPU_CTRL_MAX = 7
};
#define GPU_LOG_ENABLE ((u8)BIT(GPU_LOG_EN_OFFSET))
#define GPU_DVFS_ONLY_DVS ((u8)BIT(GPU_DVFS_ONLY_DVS_OFFSET))
#define GPU_DVFS_AGAIN ((u8)BIT(GPU_DVFS_AGAIN_OFFSET))
typedef union {
 unsigned char value;
 struct {
  unsigned char lit : 1;
...
#define RUNTIME_PERIL_RSV0 (RUNTIME_VAR_BASE + 0xAC)
...
#define RUNTIME_AO_SUSPEND_VOLT_BIAS_ADDR (RUNTIME_VAR_BASE + 0xB2)
#define AO_SUSPEND_VOLT_BIAS (BYTE_REF(RUNTIME_AO_SUSPEND_VOLT_BIAS_ADDR))
#define RUNTIME_CPU_LOWTEMP_VOLT_BIAS_ADDR(n) (RUNTIME_VAR_BASE + 0xB3 + (n) * 1)
...
#define RUNTIME_RTX_TIMER_CALLBACK_ADDR (RUNTIME_SHARE_MEM_END_ADDR + 0x038)
...
#define RUNTIME_LPMCU_RUN_VAR_END_ADDR (RUNTIME_BUGON_REASON_ADDR)
...
#define RUNTIME_SPACE_ADDR_END (RUNTIME_CCPUNR_RESUME_CNT_ADDR)
...
#define LP_FEATURE_EXCEPT_LPM3_MAX 15
