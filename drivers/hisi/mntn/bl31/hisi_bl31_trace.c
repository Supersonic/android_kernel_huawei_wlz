...
/*
 * func name: dmss_trace_buffer_init
 *
...
/*
 * func name: bl31_trace_dmss_init
 *
...
static int bl31_cleartext_exception_print(char *dir_path, u64 log_addr, u32 log_len)
{
	...
	if (memcpy_s(&temp, sizeof(struct hisiap_ringbuffer_s), q, sizeof(struct hisiap_ringbuffer_s)) != EOK)
...
/*
 * func name: bl31_cleartext_dmss_print
 *
 ...
 */
/*lint -e679*/
static int bl31_cleartext_dmss_print(char *dir_path, u64 log_addr, u32 log_len)
{
	struct hisiap_ringbuffer_s *q = NULL;
	struct hisiap_ringbuffer_s temp;
