...
struct gamma_info {
	uint32_t enable;
	uint32_t gama_effect_roi; /* 0: take effect in roi; 1: take effect out roi */
	uint32_t roi_region_num;
...
*/
	uint32_t gmp_buf_save_status    : 2;
	uint32_t gama_buf_save_status   : 2;
	uint32_t degama_buf_save_status : 2;
	uint32_t xcc_buf_save_status    : 2;
	// status: defult value is 0
	...
	uint32_t gmp_effect_roi         : 1;
	uint32_t gama_effect_roi        : 1;
	uint32_t degama_effect_roi      : 1;
	uint32_t xcc0_effect_roi        : 1;
	uint32_t xcc1_effect_roi        : 1;
