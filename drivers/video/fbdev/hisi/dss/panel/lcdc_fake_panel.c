...
#define DTS_COMP_LCDC_FAKE_PANEL	"hisilicon,lcdc_fake_panel"
...
static int lcdc_fake_panel_probe(struct platform_device *pdev)
{
	...
	if (hisi_fb_device_probe_defer(PANEL_NO, BL_SET_BY_NONE)) {
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_LCDC_FAKE_PANEL,
		.data = NULL,
	},
	{},
};
...
static struct platform_driver this_driver = {
	.probe = lcdc_fake_panel_probe,
	.remove = NULL,
	.suspend = NULL,
	.resume = NULL,
	.shutdown = NULL,
	.driver = {
		.name = "lcdc_fake_panel",
		.owner = THIS_MODULE,
...
module_init(lcdc_fake_panel_init);
