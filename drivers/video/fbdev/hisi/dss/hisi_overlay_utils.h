...
int hisi_dss_smmu_off(struct hisi_fb_data_type *hisifd);
...
#endif
#if defined(CONFIG_HISI_FB_V501) || defined(CONFIG_HISI_FB_V330) || defined(CONFIG_HISI_FB_V510) || defined (CONFIG_HISI_FB_V350) || defined (CONFIG_HISI_FB_V320)
...
#endif
#if defined (CONFIG_HISI_FB_V510) || defined (CONFIG_HISI_FB_V350) || defined (CONFIG_HISI_FB_V320)
