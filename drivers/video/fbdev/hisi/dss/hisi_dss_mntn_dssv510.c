...
{
	uint32_t ret;
	char __iomem *peri_crg_base = hisifd->peri_crg_base;//iomap(1)
	char __iomem *pctrl_base = hisifd->pctrl_base;//iomap(3)
...
{
	uint32_t ret;
	char __iomem *media_crg_base = hisifd->media_crg_base;//iomap(7)
	char __iomem *pmctrl_base = hisifd->pmctrl_base;//iomap(6)
