 ...
 */
#define TCPC_V10_REG_ALERT_FR_SWAP		(1<<15)
 ...
 */
#define TCPC_V10_REG_TCPC_CTRL_ORIENT			(1<<0)
...
#define TCPC_V10_REG_POWER_CTRL_AUTO_DISCHARGE_DISCONNECT	(1 << 4)
#define TCPC_V10_REG_POWER_CTRL_FORCE_DISCHARGE_DISCONNECT	(1 << 2)
...
#define TCPC_V10_REG_CC_VAL_MASK	(0xF)
...
#define TCPC_V10_REG_MSG_HDR_INFO_SET(drole, prole) ((drole) << 3 | (PD_REV20 << 1) | (prole))
...
#define TCPC_V10_REG_TRANSMIT_SET(type)	(PD_RETRY_COUNT << 4 | (type))
