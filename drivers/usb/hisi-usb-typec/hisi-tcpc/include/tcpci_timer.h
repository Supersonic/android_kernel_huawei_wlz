...
extern int hisi_tcpci_timer_init(struct tcpc_device *tcpc);
extern int hisi_tcpci_timer_deinit(struct tcpc_device *tcpc);
extern void hisi_tcpc_restart_timer(struct tcpc_device *tcpc, uint32_t timer_id);
extern  void hisi_tcpc_enable_timer(struct tcpc_device *tcpc, uint32_t timer_id);
extern  void hisi_tcpc_disable_timer(struct tcpc_device *tcpc, uint32_t timer_id);
extern void hisi_tcpc_reset_typec_try_timer(struct tcpc_device *tcpc);
extern void hisi_tcpc_reset_typec_debounce_timer(struct tcpc_device *tcpc);

extern void hisi_tcpc_reset_pe_timer(struct tcpc_device *tcpc);
