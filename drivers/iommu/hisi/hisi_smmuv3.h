...
#define Q_OVF(q, p) (((unsigned int)p) & Q_OVERFLOW_FLAG)
...
#define EVTQ_TYPE_WITH_ADDR(id)                                                \
	((EVTQ_TYPE_TRANSLATION == (id)) || (EVTQ_TYPE_WALK_EABT == (id)) ||   \
	 (EVTQ_TYPE_TRANSL_FORBIDDEN == (id)) ||                               \
	 (EVTQ_TYPE_ADDR_SIZE == (id)) || (EVTQ_TYPE_ACCESS == (id)) ||        \
