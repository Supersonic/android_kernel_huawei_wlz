...
struct hi6522_device_info {
	...
	/*batfet on-off flag*/
	unsigned int batfet_disable_flag;
};
...
/*charger version reg*/
#define CHG_CHIP_VERSION_REG            	(SOC_SCHARGER_CHIP_VERSION_ADDR(0))
#define CHIP_VER_V2XXX                  	(0x20)
...
#define CHG_STATUS0_BUCK_DPM_STAT           (1 << SOC_SCHARGER_STATUS0_buck_dpm_stat_2d_START)
...
/*wled contorl*/
#define WLED_REG5_CONTROL                   (SOC_SCHARGER_WLED_REG5_ADDR(0))
#define WLED_REG8_CONTROL                   (SOC_SCHARGER_WLED_REG8_ADDR(0))

#define HI6XXX_WLED_REG8_CHOOPER_MASK       (0xFD)
#define HI6XXX_IFB1_IFB2_ENABLE_MASK        (0xFC)
#define WLED_IRQ_ONCE_COUNT          	    (1)
#define WLED_IRQ_SECOND_COUNT          	    (2)
#define WLED_IRQ_THIRD_COUNT          	    (3)
#define HI6XXX_WLED_REG8_CHOOPER_ENABLE     (0x2)
/*chg v210 version*/
...
#define FLASH_BST_REG10_REG             (SOC_SCHARGER_FLASH_BST_REG10_ADDR(0))
#define FLASH_BST_VOL_SHIFT             (SOC_SCHARGER_FLASH_BST_REG10_flash_bst_vo_START)
#define FLASH_BST_VOL_MSK               (0x1f<<FLASH_BST_VOL_SHIFT)
#define FLASH_BST_VOL_MIN               (3200)
#define FLASH_BST_VOL_MAX               (5500)
#define FLASH_BST_VOL_STEP_100          (100)

#define SCHARGER_VERSION_HI6522_VALUE       (0x20)


#define IIN_OPTION_NUM                  (7)
#define SCHARGER_ICHG_MAX               (2000)
#define DPM_CHECK_VOLTAGE               (4370)
#define IIN_LIMIT_1A                    (1000)
#define IIN_LIMIT_2A                    (2000)
#define IIN_LIMIT_500mA                 (500)
#define VBATT_AVR_MAX_COUNT             (5)
