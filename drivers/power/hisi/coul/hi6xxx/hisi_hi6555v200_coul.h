...
*
* Discription:  hi6555v200 coulometer driver headfile.
...
#define HI6XXX_VOL_OFFSET_B_ADDR            PMIC_OTP_34_R_ADDR(0)
...
#define HI6XXX_VOL_FIFO_BASE                PMIC_V_OUT0_PRE0_ADDR(0)
#define HI6XXX_CUR_FIFO_BASE                PMIC_CURRENT0_PRE0_ADDR(0)

#define HI6XXX_COUL_ECO_MASK                PMIC_COUL_ECO_MASK_ADDR(0)

#define HI6XXX_FIFO_CLEAR                   PMIC_CLJ_CTRL_REGS2_ADDR(0)         // use bit 1

#define HI6XXX_ECO_FIFO_CLEAR               PMIC_CLJ_CTRL_REGS4_ADDR(0)
...
#define COUL_INT_MASK_ALL                   (COUL_VBAT_INT_MASK | COUL_CL_IN_MASK | COUL_CL_OUT_MASK|COUL_CL_INT_MASK)
