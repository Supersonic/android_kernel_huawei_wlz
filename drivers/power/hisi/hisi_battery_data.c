...
static struct hisi_coul_battery_data **p_data;
static unsigned int hisi_bat_data_size;	/* used to store number of bat types defined in DTS */
/* used to judege whether bat_drv works fine or not, 1 means yes,0 means no */
static int bat_param_status;
