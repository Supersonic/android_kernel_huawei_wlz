...
#define BQ25892_REG_02_CONV_START_SHIFT            7
#define BQ25892_REG_02_CONV_RATE_MASK              BIT(6)
#define BQ25892_REG_02_CONV_RATE_SHIFT             6
#define BQ25892_REG_02_ICO_EN_MASK                 BIT(4)
#define BQ25892_REG_02_ICO_EN_SHIFT                4
#define BQ25892_REG_02_FORCE_DPDM_MASK             BIT(1)
#define BQ25892_REG_02_FORCE_DPDM_SHIFT            1
#define BQ25892_REG_02_AUTO_DPDM_EN_MASK           BIT(0)
#define BQ25892_REG_02_AUTO_DPDM_EN_SHIFT          0
...
#define BQ25892_ICO_EN_SHIFT                       4
#define EN_ICO                                     1
#define DIS_ICO                                    0
#define BQ25892_HVDCP_HANDSHAKE_EN_SHIFT           3
#define EN_HVDCP_HANDSHAKE                         1
#define DIS_HVDCP_HANDSHAKE                        0
#define BQ25892_MAXC_EN_SHIFT                      2
#define EN_MAXC                                    1
#define DIS_MAXC                                   0
...
#define BQ25892_REG_03_CHG_CONFIG_SHIFT            4
#define BQ25892_REG_03_OTG_CONFIG_MASK             BIT(5)
#define BQ25892_REG_03_OTG_CONFIG_SHIFT            5
#define BQ25892_REG_03_WDT_RESET_MASK              BIT(6)
#define BQ25892_REG_03_WDT_RESET_SHIFT             6
#define BQ25892_REG_03_SYS_MIN_MASK                (BIT(3) | BIT(2) | BIT(1))
#define BQ25892_REG_03_SYS_MIN_SHIFT               1

#define BAT_LOADEN_SHIFT                           7
#define EN_BAT_LOADEN                              1
#define DIS_BAT_LOADEN                             0
#define WATCHDOG_TIMER_RST                         (1 << 6)
#define BQ25892_EN_CHARGER_SHIFT                   4
#define DIS_CHARGER                                0
#define EN_CHARGER                                 1
#define BQ25892_EN_OTG_SHIFT                       5
#define EN_OTG                                     1
#define DIS_OTG                                    0
#define BQ25892_SYS_MIN_SHIFT                      1
...
#define BQ25892_REG_07_EN_TERM_MASK                BIT(7)
#define BQ25892_REG_07_EN_TERM_SHIFT               7
#define BQ25892_REG_07_WATCHDOG_MASK               (BIT(5) | BIT(4))
#define BQ25892_REG_07_WATCHDOG_SHIFT              4
#define BQ25892_REG_07_EN_TIMER_MASK               BIT(3)
#define BQ25892_REG_07_EN_TIMER_SHIFT              3
#define BQ25892_REG_07_CHG_TIMER_MASK              (BIT(2) | BIT(1))
#define BQ25892_REG_07_CHG_TIMER_SHIFT             1
#define BQ25892_REG_07_JEITA_ISET_MASK             BIT(0)
#define BQ25892_REG_07_JEITA_ISET_SHIFT            0
#define BQ25892_REG_07_WATCHDOG_DIS                0
#define BQ25892_REG_07_WATCHDOG_40                 1
#define BQ25892_REG_07_WATCHDOG_80                 2
#define BQ25892_REG_07_WATCHDOG_160                3
...
#define BQ25892_REG_08_BAT_COMP_SHIFT              5
#define BQ25892_REG_08_VCLAMP_MASK                 (BIT(4) | BIT(3) | BIT(2))
#define BQ25892_REG_08_VCLAMP_SHIFT                2
#define BQ25892_REG_08_TREG_MASK                   (BIT(1) | BIT(0))
#define BQ25892_REG_08_TREG_SHIFT                  0
...
#define BQ25892_REG_09_FORCE_ICO_SHIFT             7
#define BQ25892_REG_09_BATFET_DISABLE_MASK         BIT(5)
#define BQ25892_REG_09_BATFET_DISABLE_SHIFT        5
#define BQ25892_REG_09_JEITA_VSET_MASK             BIT(4)
#define BQ25892_REG_09_JEITA_VSET_SHIFT            4

#define BQ25892_FORCE_ICO_SHIFT                    7
#define BQ25892_REG_09_FORCE_ICO                   1
#define EN_FORCE_ICO                               1
#define DIS_FORCE_ICO                              0
#define TMR2X_EN                                   (1 << 6)
#define TMR2X_DIS                                  (0 << 6)
#define BQ25892_BATFET_EN_SHIFT                    5
#define EN_BATFET                                  0
#define DIS_BATFET                                 1
...
#define BQ25892_VBUS_STAT_ADATPTER                 0x40
#define BQ25892_CHGR_STAT_NOT_CHARGING             0x00
#define BQ25892_CHGR_STAT_PRE_CHARGING             0x08
#define BQ25892_CHGR_STAT_FAST_CHARGING            0x10
#define BQ25892_CHGR_STAT_CHARGE_DONE              (BIT(4) | BIT(3))
#define BQ25892_PG_STAT                            0x04
...
#define BQ25892_REG_0C_WATCHDOG_FAULT_SHIFT        7
#define BQ25892_REG_0C_BOOST_FAULT_MASK            BIT(6)
#define BQ25892_REG_0C_BOOST_FAULT_SHIFT           6
#define BQ25892_REG_0C_CHRG_FAULT_MASK             (BIT(5) | BIT(4))
#define BQ25892_REG_0C_CHRG_FAULT_SHIFT            4
#define BQ25892_REG_0C_BAT_FAULT_MASK              BIT(3)
#define BQ25892_REG_0C_BAT_FAULT_SHIFT             3
#define BQ25892_REG_0C_NTC_FAULT_MASK              (BIT(2) | BIT(1) | BIT(0))
#define BQ25892_REG_0C_NTC_FAULT_SHIFT             0

#define BQ25892_POWER_SUPPLY_OVP_MASK              (BIT(5) | BIT(4))
#define BQ25892_POWER_SUPPLY_OVP                   (1 << 4)
#define BQ25892_THERMAL_SHUTDOWN                   (2 << 4)
#define BQ25892_WATCHDOG_FAULT                     (1 << 7)
#define BQ25892_OTG_FAULT                          (1 << 6)
#define BQ25892_BAT_FAULT_OVP                      (1 << 3)
#define BQ25892_NTC_NORMAL                         0x00
#define BQ25892_NTC_WARM                           0x02
#define BQ25892_NTC_COOL                           0x03
#define BQ25892_NTC_COLD                           0x05
#define BQ25892_NTC_HOT                            0x06
#define BQ25892_NTC_FAULT                          0x07
...
#define BQ25892_REG_11_VBUSV_OFFSET_MV             2600
#define BQ25892_REG_11_VBUS_GD_MASK                BIT(7)
...
#define BQ25892_REG_13_VDPM_STAT_MASK              BIT(7)
...
#define BQ25892_REG_13_IDPM_OFFSET_MV              100

/* REG_RST / ICO_OPTIMIZED / Revision Status Register REG0x14 */
#define BQ25892_REG_14                             0x14

#define BQ25892_REG_14_REG_RST_MASK                BIT(7)
#define BQ25892_REG_14_REG_RST_SHIFT               7
#define BQ25892_REG_14_ICO_OPTIMIZED_MASK          BIT(6)
#define BQ25892_REG_14_ICO_OPTIMIZED_SHIFT         6
#define BQ25892_REG_14_REG_PN_MASK                 (BIT(5) | BIT(4) | BIT(3))
#define BQ25892_REG_14_REG_PN_IS_25892             0
