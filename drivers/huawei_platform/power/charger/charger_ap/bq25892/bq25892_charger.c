...
#define BQ25892_SYSFS_FIELD_RW(_name, r, f) \
	BQ25892_SYSFS_FIELD(_name, r, f, 0640, bq25892_sysfs_store)

#define BQ25892_SYSFS_FIELD_RO(_name, r, f) \
	BQ25892_SYSFS_FIELD(_name, r, f, 0440, NULL)
...
{
	int i;
	int limit = ARRAY_SIZE(bq25892_sysfs_field_tbl);
...
static ssize_t bq25892_sysfs_show(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	struct bq25892_sysfs_field_info *info = NULL;
	struct bq25892_sysfs_field_info *info2 = NULL;
	int ret;
	u8 v;
...
static void bq25892_sysfs_create_group(struct device *dev)
{
	bq25892_sysfs_init_attrs();
	power_sysfs_create_link_group("hw_power", "charger", "bq25892",
		dev, &bq25892_sysfs_attr_group);
}

static void bq25892_sysfs_remove_group(struct device *dev)
{
	power_sysfs_remove_link_group("hw_power", "charger", "bq25892",
		dev, &bq25892_sysfs_attr_group);
}
#else
static inline void bq25892_sysfs_create_group(struct device *dev)
{
}

static inline void bq25892_sysfs_remove_group(struct device *dev)
{
}
#endif /* CONFIG_SYSFS */
	...
	const struct i2c_device_id *id)
{
	...
	bq25892_sysfs_create_group(di->dev);
...
static int bq25892_remove(struct i2c_client *client)
{
	...
	bq25892_sysfs_remove_group(di->dev);
