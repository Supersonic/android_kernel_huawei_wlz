...
static void hl7019_sysfs_create_group(struct device *dev)
{
	hl7019_sysfs_init_attrs();
	power_sysfs_create_link_group("hw_power", "charger", "hl7019",
		dev, &g_hl7019_sysfs_attr_group);
}

static void hl7019_sysfs_remove_group(struct device *dev)
{
	power_sysfs_remove_link_group("hw_power", "charger", "hl7019",
		dev, &g_hl7019_sysfs_attr_group);
}
#else
static inline void hl7019_sysfs_create_group(struct device *dev)
{
}

static inline void hl7019_sysfs_remove_group(struct device *dev)
{
}
#endif /* CONFIG_SYSFS */
	...
	const struct i2c_device_id *id)
{
	...
	hl7019_sysfs_create_group(di->dev);
...
static int hl7019_remove(struct i2c_client *client)
{
	...
	hl7019_sysfs_remove_group(di->dev);
