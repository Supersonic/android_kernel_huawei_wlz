...
static void bq25882_sysfs_create_group(struct device *dev)
{
	bq25882_sysfs_init_attrs();
	power_sysfs_create_link_group("hw_power", "charger", "bq25882",
		dev, &bq25882_sysfs_attr_group);
}

static void bq25882_sysfs_remove_group(struct device *dev)
{
	power_sysfs_remove_link_group("hw_power", "charger", "bq25882",
		dev, &bq25882_sysfs_attr_group);
}
#else
static inline void bq25882_sysfs_create_group(struct device *dev)
{
}

static inline void bq25882_sysfs_remove_group(struct device *dev)
{
}
#endif /* CONFIG_SYSFS */
	...
	const struct i2c_device_id *id)
{
	...
	bq25882_sysfs_create_group(di->dev);
...
bq25882_fail_3:
	bq25882_sysfs_remove_group(di->dev);
