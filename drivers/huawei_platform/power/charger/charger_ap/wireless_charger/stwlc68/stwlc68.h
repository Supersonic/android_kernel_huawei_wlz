...
#define STWLC68_RX_20W_RPP_VAL                0xA8
...
#define STWLC68_TIME_PARA_LEVEL               2
#define STWLC68_TEMP_PARA_LEVEL               3
#define STWLC68_START_TIME_TH                 10
#define STWLC68_IOUT_MAX                      1500
#define STWLC68_DFT_IOUT_MAX                  1300

enum stwlc68_time_info {
	ST68_TIME_INFO_TIME_TH,
	ST68_TIME_INFO_IOUT_MAX,
	ST68_TIME_INFO_MAX
};

struct stwlc68_time_para {
	int time_th;
	int iout_max;
};

enum stwlc68_temp_info {
...
struct stwlc68_dev_info {
	...
	struct wireless_cp_ops *cp_ops;
	struct mutex mutex_irq;
	struct stwlc68_temp_para temp_para[STWLC68_TEMP_PARA_LEVEL];
	struct stwlc68_time_para time_para[STWLC68_TIME_PARA_LEVEL];
	u8 rx_fod_5v[STWLC68_RX_FOD_LEN];
	u8 ext_rx_fod_5v[STWLC68_RX_FOD_LEN];
