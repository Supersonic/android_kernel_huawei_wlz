...
static const int bq2419x_ichg_values[] = {
...
static const int bq2419x_vsysmin_values[] = {
	3000, 3100, 3200, 3300, 3400, 3500, 3600, 3700
};

/* REG00[2:0] (IINLIM) in mAh */
static const int bq2419x_iin_values[] = {
	100, 150, 500, 900, 1200, 1500, 2000, 3000
};

/* REG03[7:4] (IPRECHG) in mAh */
static const int bq2419x_iprechg_values[] = {
	128, 256, 384, 512, 640, 768, 896, 1024,
	1152, 1280, 1408, 1536, 1664, 1792, 1920, 2048
};

/* REG03[3:0] (ITERM) in mAh */
static const int bq2419x_iterm_values[] = {
	128, 256, 384, 512, 640, 768, 896, 1024,
	1152, 1280, 1408, 1536, 1664, 1792, 1920, 2048
};

/* REG04[7:2] (VREG) in mV */
static const int bq2419x_vreg_values[] = {
...
#define BQ2419X_REG_CCC                             0x02

#define BQ2419X_REG_CCC_ICHG_MASK                   (BIT(7) | BIT(6) | \
...
#define BQ2419X_REG_PCTCC                           0x03

#define BQ2419X_REG_PCTCC_IPRECHG_MASK              (BIT(7) | BIT(6) | \
	BIT(5) | BIT(4))
#define BQ2419X_REG_PCTCC_IPRECHG_SHIFT             4
#define BQ2419X_REG_PCTCC_ITERM_MASK                (BIT(3) | BIT(2) | \
	BIT(1) | BIT(0))
#define BQ2419X_REG_PCTCC_ITERM_SHIFT               0

/* Charge Voltage Control */
#define BQ2419X_REG_CVC                             0x04

#define BQ2419X_REG_CVC_VREG_MASK                   (BIT(7) | BIT(6) | \
	BIT(5) | BIT(4) | BIT(3) | BIT(2))
