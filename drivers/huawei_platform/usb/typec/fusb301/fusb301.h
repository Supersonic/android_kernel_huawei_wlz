...
/* interrupt of accessory change */
#define FUSB301_REG_INT_ACC_CH                      BIT(3)
/* interrupt of cc current change */
#define FUSB301_REG_INT_CC_CUR_CH                   BIT(2)
