...
static void register_my_debug_operations(void)
{
	...
	REGISTER_SENSORHUB_DEBUG_OPERATION(set_fp_event);
...
static void unregister_my_debug_operations(void)
{
	...
	UNREGISTER_SENSORHUB_DEBUG_OPERATION(set_fp_event);
}
