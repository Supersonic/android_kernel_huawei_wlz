...
#define DTS_COMP_TM_DUKE_TD4302 "hisilicon,mipi_tianma_duke_TD4302_5P7"
...
//STF
#define DTS_COMP_BOE_TD4310_5P2_1080P	"boe_td4310_5p2_1080p_video"
#define DTS_COMP_JDI_R63452_5P2_1080P	"jdi_r63452_5p2_1080P_cmd"
#define DTS_COMP_SHARP_NT35695_5P2_1080P	"sharp_nt35695_5p2_1080P_cmd"
#define DTS_COMP_JDI_35596S_5P2_1080P	"jdi_35596s_5p2_1080P_video"
#define DTS_COMP_LG_R69006_5P2_1080P "lg_r69006_5p2_1080P_cmd"
#define DTS_COMP_TIANMA_TD4310_5P2_1080P	"tianma_td4310_5p2_1080p_video"
...
#define SENSOR_REBOOT_REASON_MAX_LEN			(128)

static int sensorhub_reboot_reason_flag = SENSOR_POWER_DO_RESET;
...
BH1745_ALS_PARA_TABLE als_para_diff_tp_color_table[] = {
	...
	{DUKE, V3, TM_TPLCD, BLACK,
	 {504, 1826, 236, 11410, 10313, 504, 1390, 4538, 100, -2646, 9370, -3522,
	  11918, 1516, 1672, 5723, 2135, 400, 334, 104, 40, 2200, 5800, 30000,
	  0} },
	{DUKE, V3, TM_TPLCD, BLUE,
	 {438, 4079, 764, 4506, 3207, 438, 183, 404, 100, -4988, 3572, -1371,
	  1865, 588, 566, 558, 1832, 172, 1214, 2102, 117, 2500, 5800, 5000,
	  200} },
	{DUKE, V3, TM_TPLCD, WHITE,
	 {317, 320, 183, 1427, 1289, 217, 663, 1724, 100, -2273, 6050, -2606,
	  6240, 966, 1636, 1865, 1969, 2462, 3229, 1549, 313, 2700, 5970, 5000,
	  200} },
	...
	{DUKE, V3, DEFAULT_TPLCD, BLUE,
	 {438, 4079, 764, 4506, 3207, 438, 183, 404, 100, -4988, 3572, -1371,
	  1865, 588, 566, 558, 1832, 172, 1214, 2102, 117, 2500, 5800, 30000,
	  0} },
	{DUKE, V3, DEFAULT_TPLCD, WHITE,
	 {317, 320, 183, 1427, 1289, 217, 663, 1724, 100, -2273, 6050, -2606,
	  ...
	  0} },
//BH1745
	{STF, V3, BOE_TPLCD, BLACK,//BOEN
	 {482, 1878, 467, 11841, 11442, 482, 1576, 5511, 100, -2481, 13634, -5098, 19434, 1424, 1796, 18984, 2010,
	  274, 243, 52, 28, 3900, 6000, 5000, 200} },
	{STF, V3, JDI_TPLCD, BLACK,//OF
	 {545, 1474, 748, 6232, 5172, 545, 644, 2064, 100, -2310, 6547, -2306, 5644, 967, 1626, 1484, 2099,
	  449, 656, 273, 63, 3900, 6000, 5000, 200} },
	{STF, V3, LG_TPLCD, BLACK,//BOEN
	 {482, 1878, 467, 11841, 11442, 482, 1576, 5511, 100, -2481, 13634, -5098, 19434, 1424, 1796, 18984, 2010,
	  274, 243, 52, 28, 3900, 6000, 5000, 200} },
	{STF, V3, TM_TPLCD, BLACK,//OF
	 {545, 1474, 748, 6232, 5172, 545, 644, 2064, 100, -2310, 6547, -2306, 5644, 967, 1626, 1484, 2099,
	  449, 656, 273, 63, 3900, 6000, 5000, 200} },

	{STF, V3, DEFAULT_TPLCD, BLUE,
	 {335, 1511, 558, 2804, 1694, 335, 161, 409, 100, -3356, 3120, -2043, 2447, 610, 821, 745, 1561,
	  476, 1905, 3381, 200, 3900, 6000, 30000, 200} },
	{STF, V3, DEFAULT_TPLCD, GOLD,
	 {163, 986, 456, 4008, 3748, 163, 593, 2402, 100, -2295, 8533, -2911, 7170, 978, 1678, 2277, 2056,
	  849, 1227, 333, 114, 3900, 6000, 5000, 200} },
	{STF, V3, DEFAULT_TPLCD, SILVER,
	 {121, 2361, 1700, 4328, 2794, 121, 194, 498, 100, -3011, 3395, -2376, 2785, 632, 1054, 872, 1678,
	  265, 1010, 1084, 89, 3900, 6000, 30000, 200} },
	{STF, V3, DEFAULT_TPLCD, WHITE,
	 {168, 163, 94, 644, 575, 168, 480, 1695, 100, -2328, 6677, -2835, 6077, 941, 1607, 2018, 1958,
	  5902, 8770, 3683, 826, 3900, 6000, 5000, 200} },
	{STF, V3, DEFAULT_TPLCD, BLACK,
	 {507, 1629, 708, 6973, 5471, 507, 640, 1919, 100, -2308, 6572, -2421, 5960, 973, 1630, 1603, 2000,
	  485, 684, 289, 69, 3900, 6000, 5000, 200} },
	...
	{SHT, V3, DEFAULT_TPLCD, WHITE,
	 {161, 310, 153, 967, 853, 161, 292, 591, 100, -3800, 5369, -3050, 5308, 1868, 1297, 2075, 1286,
	  5010, 6044, 2774, 662, 4755, 6229, 10000, 100} },
	{SHT, V3, DEFAULT_TPLCD, BLACK,
	 {241, 490, 80, 1710, 2140, 241, 326, 700, 100, -1600, 5718, -3260, 5642, 881, 1397, 3098, 1390,
	  2173, 2118, 798, 262, 2586, 5808, 10000, 100} },

	{CMR, V3, DEFAULT_TPLCD, WHITE,
	 {175, 449, 268, 1597, 1437, 175, 355, 723, 100, -3186, 6141, -3464, 6519, 1705, 1430, 2952, 1266,
	  3755, 4000, 1397, 430, 4036, 6081, 10000, 100} },
	{CMR, V3, DEFAULT_TPLCD, BLACK,
	 {216, 702, 70, 2863, 1983, 216, 381, 798, 100, -2944, 6500, -3518, 6855, 1714, 1460, 3501, 1310,
	  2204, 1961, 587, 234, 3187, 5513, 10000, 100} },

	{HWI, V3, DEFAULT_TPLCD, BLACK,
	 {548, 1116, 73, 6173, 5983, 548, 1074 , 3731, 100, -2260, 6946, -368, 825, 1095, 1734, 348, 2483,
	  964, 670, 346, 105, 3900, 6000, 30000, 0} },
	{HWI, V3, DEFAULT_TPLCD, RED,
	 {1263, 42, 26, 1595, 1237, 1263, 917, 6703, 100, -4466, 8404, -6220, 9682, 14718, 1949, 1071, 2354,
	  8130, 850, 903, 543, 3900, 6500, 30000, 0} },
	{HWI, V3, DEFAULT_TPLCD, PINK,
	 {350, 96, 43, 628, 654, 350, 1955 , 6010, 100, -2854, 16548, -3691, 16203, 1870, 1702, 6196, 2188,
	  13331, 8468, 1856, 1300, 3900, 6000, 30000, 0} },
	  {HWI, V3, DEFAULT_TPLCD, GRAY,
	 {216, 1308, 508, 3350, 2723, 216, 315, 780, 100, -2746, 4066, -1863, 2968, 763, 1205, 926, 1978,
	  900, 1688, 1765, 182, 3416, 6265, 30000, 0} },
	  {HWI, V3, DEFAULT_TPLCD, BLUE,
	{199, 352, 142, 598, 489, 199, 379, 883, 100, -2962, 4923, -1830, 3712, 685, 1243, 809, 1908,
	  3931, 11430, 7689, 967, 4109, 6416, 30000, 0} },	 
};
...
APDS9251_ALS_PARA_TABLE apds_als_para_diff_tp_color_table[] = {
	...
	//avago
	{STF, V3, BOE_TPLCD, BLACK,//BOEN
	 {15703, 1662, 11584, 8726, 5000, 775, 1030, 605, 396, 269, 119,
	  228, 238, 51, 7, 3900, 6000, 5000, 200, 0, 100} },
	{STF, V3, JDI_TPLCD, BLACK,//OF
	 {5718, 1992, 6979, 4912, 3805, 914, 1195, 741, 656, 459, 205,
	  389, 552, 224, 20, 3900, 6000, 5000, 200, 0, 100} },
	{STF, V3, LG_TPLCD, BLACK,//BOEN
	 {15703, 1662, 11584, 8726, 5000, 775, 1030, 605, 396, 269, 119,
	  228, 238, 51, 7, 3900, 6000, 5000, 200, 0, 100} },
	{STF, V3, TM_TPLCD, BLACK,//OF
	...
	{STF, V3, DEFAULT_TPLCD, BLUE,
	 {783, 775, 6244, 3027, 2662, 2276, 2032, 2021, 1323, 968, 531,
	  270, 923, 2080, 73, 3900, 6000, 10000, 200, 0, 100} },
	{STF, V3, DEFAULT_TPLCD, GOLD,
	 {8053, 1675, 4390, 4110, 3600, 990, 1156, 865, 148, 86, 41,
	  743, 1104, 317, 23, 3900, 6000, 5000, 200, 0, 100} },
	{STF, V3, DEFAULT_TPLCD, SILVER,
	 {1263, 1681, 5892, 4475, 5149, 1169, 1187, 1078, 178, 104, 50,
	  256, 725, 794, 23, 3900, 6000, 5000, 200, 0, 100} },
	{STF, V3, DEFAULT_TPLCD, WHITE,
	 {6431, 1624, 657, 631, 570, 1023, 1190, 906, 216, 132, 53,
	  5166, 7981, 3211, 197, 3900, 6000, 5000, 200, 0, 100} },
	{STF, V3, DEFAULT_TPLCD, BLACK,
	 {6875, 1601, 7208, 5377, 3966, 972, 1304, 786, 657, 454, 199,
	  391, 559, 227, 19, 3900, 6000, 30000, 0, 0, 100} },
	...
	{LON, VN1, DEFAULT_TPLCD, BLACK,
	 {13825, -329, 27567, 20936, 15216, 1272, 1046, 1272, 661, 290, 260,
	...
	{SHT, V3, DEFAULT_TPLCD, WHITE,
	 {6101, 1157, 1407, 1323, 1357, 1039, 1000, 1027, 390, 215, 75,
	  3211, 5059, 2189, 167, 3954, 5316, 10000, 100, 1, 38} },
	{SHT, V3, DEFAULT_TPLCD, BLACK,
	 {7885, 1191, 2910, 2368, 2117, 993, 1000, 897, 1124, 578, 205,
	  1406, 1969, 712, 87, 2443, 5141, 10000, 100, 1, 38} },

	{CMR, V3, DEFAULT_TPLCD, WHITE,
	 {6961, 1129, 1775, 1771, 1728, 1014, 1000, 987, 499, 279, 97,
	  2368, 3791, 1449, 126, 2793, 5329, 10000, 100, 1, 38} },
	{CMR, V3, DEFAULT_TPLCD, BLACK,
	 {11616, 1030, 4812, 3693, 3094, 980, 1000, 922, 874, 423, 148,
	  894, 1146, 313, 46, 3063, 5083, 10000, 100, 1, 38} },

	{HWI, V3, DEFAULT_TPLCD, BLACK,
	 {5557, 1785, 7546 , 6961, 5764, 1122, 1174, 1243, 1590, 930, 378,
	  461, 587, 276, 43, 3900, 6000, 30000, 0, 0, 100} },
	{HWI, V3, DEFAULT_TPLCD, RED,
	 {12807, 2057, 905, 845, 615, 977, 1142, 855, 536, 311, 122,
	  15461, 6049, 2768, 658, 3000, 6000, 5000, 200, 0, 100} },
	{HWI, V3, DEFAULT_TPLCD, PINK,
	 {16394, 1563, 693 , 717, 696, 955, 1008, 898, 590, 338, 131,
	  7492, 7936, 1710, 274, 3900, 6000, 30000, 0, 0, 100} },
	{HWI, V3, DEFAULT_TPLCD, GRAY,
	 {1652, 1748, 4663, 3882, 4457, 1048, 1027, 999, 1189, 654, 256,
	  520, 1177, 1259, 46, 3051, 5747, 30000, 0, 0, 100} },
	{HWI, V3, DEFAULT_TPLCD, BLUE,
	 {1725, 1639 , 915 , 809, 932, 1009, 980, 1009, 2364, 1334, 503,
	  2235, 7398, 5367, 267, 3760, 5781, 30000, 0, 0, 100} },
};
...
int write_gyro_sensor_offset_to_nv(char *temp, int length)
{
	...
	length = (int)sizeof(gyro_sensor_calibrate_data) < length ?
			(int)sizeof(gyro_sensor_calibrate_data) : length;
...
void read_als_data_from_dts(struct device_node *dn)
{
	...
	if (rohm_rgb_flag == 1) {
			...
			hwlog_err
			    ("data[0]=%d, als_para_tabel=%d ,bh1745 phone_color=0x%x  tplcd_manufacture=%d, phone_type=%d,phone_version=%d\n",
...
int read_tpcolor_from_nv(void)
{
	...
	memcpy(nv_tp_color, user_info.nv_data, sizeof(nv_tp_color));
...
int rpc_motion(uint16_t  motion)
{
	unsigned int cmd = 0;
	unsigned int sub_cmd = 0;
	unsigned int ret = -1;
	if (1 == rpc_motion_request) {
...
int get_lcd_module(void)
{
	...
	np = of_find_compatible_node(NULL, NULL, DTS_COMP_TM_DUKE_TD4302);
	ret = of_device_is_available(np);
	if (np && ret) {
		hwlog_info("%s is present\n", DTS_COMP_TM_DUKE_TD4302);
		return TM_TPLCD;
	}
	...
	/* These logs may contain some infomation of LCD. Use them ONLY for debug */
	...
	if(!strncmp(lcd_model, DTS_COMP_BOE_TD4310_5P2_1080P, strlen(DTS_COMP_BOE_TD4310_5P2_1080P))){
		//hwlog_info("%s is present\n", DTS_COMP_BOE_TD4310_5P2_1080P);
		return BOE_TPLCD;
	}

	if(!strncmp(lcd_model, DTS_COMP_JDI_R63452_5P2_1080P, strlen(DTS_COMP_JDI_R63452_5P2_1080P))){
		//hwlog_info("%s is present\n", DTS_COMP_JDI_R63452_5P2_1080P);
		return JDI_TPLCD;
	}

	if(!strncmp(lcd_model, DTS_COMP_SHARP_NT35695_5P2_1080P, strlen(DTS_COMP_SHARP_NT35695_5P2_1080P))){
		//hwlog_info("%s is present\n", DTS_COMP_SHARP_NT35695_5P2_1080P);
		return SHARP_TPLCD;
	}

	if(!strncmp(lcd_model, DTS_COMP_JDI_35596S_5P2_1080P, strlen(DTS_COMP_JDI_35596S_5P2_1080P))){
		//hwlog_info("%s is present\n", DTS_COMP_JDI_35596S_5P2_1080P);
		return JDI_TPLCD;
	}

	if(!strncmp(lcd_model, DTS_COMP_LG_R69006_5P2_1080P, strlen(DTS_COMP_LG_R69006_5P2_1080P))){
		//hwlog_info("%s is present\n", DTS_COMP_LG_R69006_5P2_1080P);
		return LG_TPLCD;
	}

	if(!strncmp(lcd_model, DTS_COMP_TIANMA_TD4310_5P2_1080P, strlen(DTS_COMP_TIANMA_TD4310_5P2_1080P))){
		//hwlog_info("%s is present\n", DTS_COMP_TIANMA_TD4310_5P2_1080P);
		return TM_TPLCD;
	}
...
extern void kbhb_notify_mcu_state(sys_status_t status);
...
int mcu_sys_ready_callback(const pkt_header_t *head)
{
	...
	if (ST_MINSYSREADY == ((pkt_sys_statuschange_req_t *) head)->status) {
		...
		if(need_reset_io_power &&
		   (SENSOR_POWER_DO_RESET == sensorhub_reboot_reason_flag)) {
		...
		if (strlen(sensor_chip_info[CHARGER]) != 0) {
			type = hisi_get_charger_type();/*sensrohub is ready need get charger type again*/
...
static int __init sensorhub_read_reboot_reason_cmdline(char *arg)
{
	char reboot_reason_buf[SENSOR_REBOOT_REASON_MAX_LEN] = { 0 };
	int length = 0;

	if (NULL == arg) {
		hwlog_err("input arg null\n");
		return 0;
	}

	length = strlen(arg);
	if (length >= SENSOR_REBOOT_REASON_MAX_LEN) {
		length = SENSOR_REBOOT_REASON_MAX_LEN-1;
	}
	memset(reboot_reason_buf, 0, sizeof(reboot_reason_buf));
	memcpy(reboot_reason_buf, arg, length);
	...
	hwlog_info("sensorhub get reboot reason:%s length:%d flag:%d\n",
			reboot_reason_buf, length,
			sensorhub_reboot_reason_flag);
	return 0;
}
early_param("reboot_reason", sensorhub_read_reboot_reason_cmdline);
